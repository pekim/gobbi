...
<p class="api-ctype">G_DESKTOP_APP_INFO_LOOKUP_EXTENSION_POINT_NAME</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_DELETE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_EXECUTE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_READ</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_RENAME</p>
...
the trash.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_TRASH</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ACCESS_CAN_WRITE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_DOS_IS_ARCHIVE</p>
...
is only available for DOS file systems. Corresponding #GFileAttributeType
is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_DOS_IS_SYSTEM</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ETAG_VALUE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_FREE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_READONLY</p>
<p class="api-heading">FILE_ATTRIBUTE_FILESYSTEM_REMOTE</p>
<p class="api-doc">A key in the "filesystem" namespace for checking if the file system
is remote. Is set to %TRUE if the file system is remote.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_REMOTE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_SIZE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_TYPE</p>
...
file system. Corresponding #GFileAttributeType is
%G_FILE_ATTRIBUTE_TYPE_UINT64.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_USED</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_FILESYSTEM_USE_PREVIEW</p>
...
%G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_GVFS_BACKEND</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_ID_FILE</p>
...
to copy).</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_ID_FILESYSTEM</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_EJECT</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_MOUNT</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_POLL</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START</p>
<p class="api-heading">FILE_ATTRIBUTE_MOUNTABLE_CAN_START_DEGRADED</p>
<p class="api-doc">A key in the "mountable" namespace for checking if a file (of type G_FILE_TYPE_MOUNTABLE) can be started
degraded.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START_DEGRADED</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_STOP</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_CAN_UNMOUNT</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_HAL_UDI</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_IS_MEDIA_CHECK_AUTOMATIC</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_START_STOP_TYPE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE_FILE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_OWNER_GROUP</p>
...
%G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_OWNER_USER</p>
...
%G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_OWNER_USER_REAL</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_PREVIEW_ICON</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_RECENT_MODIFIED</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_SELINUX_CONTEXT</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_ALLOCATED_SIZE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_CONTENT_TYPE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_COPY_NAME</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_DESCRIPTION</p>
...
the UI.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_DISPLAY_NAME</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_EDIT_NAME</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_FAST_CONTENT_TYPE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_ICON</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_IS_BACKUP</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_IS_HIDDEN</p>
...
to get the type.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_IS_SYMLINK</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_IS_VIRTUAL</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_IS_VOLATILE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_NAME</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT64.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_SIZE</p>
...
was zero.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_SORT_ORDER</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_OBJECT.
The value for this key should contain a #GIcon.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_SYMBOLIC_ICON</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_SYMLINK_TARGET</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_TARGET_URI</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_STANDARD_TYPE</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_THUMBNAILING_FAILED</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID</p>
...
%G_FILE_ATTRIBUTE_TYPE_BYTE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_THUMBNAIL_PATH</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_ACCESS</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_ACCESS_USEC</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_CHANGED</p>
<p class="api-heading">FILE_ATTRIBUTE_TIME_CHANGED_USEC</p>
<p class="api-doc">A key in the "time" namespace for getting the microseconds of the time
the file was last changed. This should be used in conjunction with
#G_FILE_ATTRIBUTE_TIME_CHANGED. Corresponding #GFileAttributeType is
%G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_CHANGED_USEC</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_CREATED</p>
<p class="api-heading">FILE_ATTRIBUTE_TIME_CREATED_USEC</p>
<p class="api-doc">A key in the "time" namespace for getting the microseconds of the time
the file was created. This should be used in conjunction with
#G_FILE_ATTRIBUTE_TIME_CREATED. Corresponding #GFileAttributeType is
%G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_CREATED_USEC</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_MODIFIED</p>
<p class="api-heading">FILE_ATTRIBUTE_TIME_MODIFIED_USEC</p>
<p class="api-doc">A key in the "time" namespace for getting the microseconds of the time
the file was last modified. This should be used in conjunction with
#G_FILE_ATTRIBUTE_TIME_MODIFIED. Corresponding #GFileAttributeType is
%G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TIME_MODIFIED_USEC</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TRASH_DELETION_DATE</p>
<p class="api-heading">FILE_ATTRIBUTE_TRASH_ITEM_COUNT</p>
<p class="api-doc">A key in the "trash" namespace.  When requested against
`trash:///` returns the number of (toplevel) items in the trash folder.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TRASH_ITEM_COUNT</p>
<p class="api-heading">FILE_ATTRIBUTE_TRASH_ORIG_PATH</p>
<p class="api-doc">A key in the "trash" namespace.  When requested against
items in `trash:///`, will return the original path to the file before it
was trashed. Corresponding #GFileAttributeType is
%G_FILE_ATTRIBUTE_TYPE_BYTE_STRING.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_TRASH_ORIG_PATH</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT64.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_BLOCKS</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_BLOCK_SIZE</p>
...
%G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_DEVICE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_GID</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_INODE</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_IS_MOUNTPOINT</p>
...
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_MODE</p>
...
%G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_NLINK</p>
...
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_RDEV</p>
...
This attribute is only available for UNIX file systems.
Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT32.</p>
<p class="api-ctype">G_FILE_ATTRIBUTE_UNIX_UID</p>
...
<p class="api-ctype">G_MENU_ATTRIBUTE_ACTION</p>
...
<p class="api-ctype">G_MENU_ATTRIBUTE_ACTION_NAMESPACE</p>
...
<p class="api-ctype">G_MENU_ATTRIBUTE_TARGET</p>
...
<p class="api-ctype">G_NETWORK_MONITOR_EXTENSION_POINT_NAME</p>
<p class="api-heading">PROXY_EXTENSION_POINT_NAME</p>
<p class="api-doc">Extension point for proxy functionality.
See [Extending GIO][extending-gio].</p>
<p class="api-ctype">G_PROXY_EXTENSION_POINT_NAME</p>
...
See [Extending GIO][extending-gio].</p>
<p class="api-ctype">G_PROXY_RESOLVER_EXTENSION_POINT_NAME</p>
<p class="api-heading">SETTINGS_BACKEND_EXTENSION_POINT_NAME</p>
<p class="api-doc">Extension point for #GSettingsBackend functionality.</p>
<p class="api-ctype">G_SETTINGS_BACKEND_EXTENSION_POINT_NAME</p>
...
See [Extending GIO][extending-gio].</p>
<p class="api-ctype">G_TLS_BACKEND_EXTENSION_POINT_NAME</p>
...
<p class="api-ctype">G_TLS_DATABASE_PURPOSE_AUTHENTICATE_CLIENT</p>
...
<p class="api-ctype">G_TLS_DATABASE_PURPOSE_AUTHENTICATE_SERVER</p>
<p class="api-heading">VFS_EXTENSION_POINT_NAME</p>
<p class="api-doc">Extension point for #GVfs functionality.
See [Extending GIO][extending-gio].</p>
<p class="api-ctype">G_VFS_EXTENSION_POINT_NAME</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_CLASS</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_HAL_UDI</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_LABEL</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_NFS_MOUNT</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_UNIX_DEVICE</p>
...
<p class="api-ctype">G_VOLUME_IDENTIFIER_KIND_UUID</p>
...
See [Extending GIO][extending-gio].</p>
<p class="api-ctype">G_VOLUME_MONITOR_EXTENSION_POINT_NAME</p>
