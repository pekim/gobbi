...
<p class="api-heading">KEY_FILE_DESKTOP_ACTION_GROUP_PREFIX</p>
<p class="api-ctype">G_KEY_FILE_DESKTOP_ACTION_GROUP_PREFIX</p>
...
<p class="api-heading">WIN32_MSG_HANDLE</p>
<p class="api-ctype">G_WIN32_MSG_HANDLE</p>
