...
type Namespace struct {
	...
	GenerateGobjectclassToGotypeMap bool         `xml:"generate-gobjectclass-to-gotype-map,attr"`
...
func (ns *Namespace) mergeAddenda(addenda *Namespace) {
	if addenda != nil {
		...
		ns.GenerateGobjectclassToGotypeMap = addenda.GenerateGobjectclassToGotypeMap
