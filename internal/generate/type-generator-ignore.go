...
func (t *TypeGeneratorIgnore) isSupportedAsArrayParam(direction string) (supported bool, reason string) {
	return false, ""
}
...
func (t *TypeGeneratorIgnore) generateParamGoVar(g *jen.Group, goVarName string, cVarName string, pkg string) {
}
