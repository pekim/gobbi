...
var cursorNewFromPixbufFunction *gi.Function
var cursorNewFromPixbufFunction_Once sync.Once

func cursorNewFromPixbufFunction_Set() error {
	var err error
	cursorNewFromPixbufFunction_Once.Do(func() {
		err = cursorObject_Set()
		if err != nil {
			return
		}
		cursorNewFromPixbufFunction, err = cursorObject.InvokerNew("new_from_pixbuf")
	})
	return err
}

// CursorNewFromPixbuf is a representation of the C type gdk_cursor_new_from_pixbuf.
func CursorNewFromPixbuf(display *Display, pixbuf *gdkpixbuf.Pixbuf, x int32, y int32) *Cursor {
	...
	err := cursorNewFromPixbufFunction_Set()
	if err == nil {
		ret = cursorNewFromPixbufFunction.Invoke(inArgs[:], nil)
	}
...
var cursorNewFromSurfaceFunction *gi.Function
var cursorNewFromSurfaceFunction_Once sync.Once

func cursorNewFromSurfaceFunction_Set() error {
	var err error
	cursorNewFromSurfaceFunction_Once.Do(func() {
		err = cursorObject_Set()
		if err != nil {
			return
		}
		cursorNewFromSurfaceFunction, err = cursorObject.InvokerNew("new_from_surface")
	})
	return err
}

// CursorNewFromSurface is a representation of the C type gdk_cursor_new_from_surface.
func CursorNewFromSurface(display *Display, surface *cairo.Surface, x float64, y float64) *Cursor {
	...
	err := cursorNewFromSurfaceFunction_Set()
	if err == nil {
		ret = cursorNewFromSurfaceFunction.Invoke(inArgs[:], nil)
	}
...
var cursorGetImageFunction *gi.Function
var cursorGetImageFunction_Once sync.Once

func cursorGetImageFunction_Set() error {
	var err error
	cursorGetImageFunction_Once.Do(func() {
		err = cursorObject_Set()
		if err != nil {
			return
		}
		cursorGetImageFunction, err = cursorObject.InvokerNew("get_image")
	})
	return err
}

// GetImage is a representation of the C type gdk_cursor_get_image.
func (recv *Cursor) GetImage() *gdkpixbuf.Pixbuf {
	...
	err := cursorGetImageFunction_Set()
	if err == nil {
		ret = cursorGetImageFunction.Invoke(inArgs[:], nil)
	}
...
var cursorGetSurfaceFunction *gi.Function
var cursorGetSurfaceFunction_Once sync.Once

func cursorGetSurfaceFunction_Set() error {
	var err error
	cursorGetSurfaceFunction_Once.Do(func() {
		err = cursorObject_Set()
		if err != nil {
			return
		}
		cursorGetSurfaceFunction, err = cursorObject.InvokerNew("get_surface")
	})
	return err
}

// GetSurface is a representation of the C type gdk_cursor_get_surface.
func (recv *Cursor) GetSurface() (*cairo.Surface, float64, float64) {
	...
	err := cursorGetSurfaceFunction_Set()
	if err == nil {
		ret = cursorGetSurfaceFunction.Invoke(inArgs[:], outArgs[:])
	}
...
var deviceGetAxesFunction *gi.Function
var deviceGetAxesFunction_Once sync.Once

func deviceGetAxesFunction_Set() error {
	var err error
	deviceGetAxesFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceGetAxesFunction, err = deviceObject.InvokerNew("get_axes")
	})
	return err
}

// GetAxes is a representation of the C type gdk_device_get_axes.
func (recv *Device) GetAxes() AxisFlags {
	...
	err := deviceGetAxesFunction_Set()
	if err == nil {
		ret = deviceGetAxesFunction.Invoke(inArgs[:], nil)
	}

	retGo := AxisFlags(ret.Int32())
...
func deviceGetKeyFunction_Set() error {
	var err error
	deviceGetKeyFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceGetKeyFunction, err = deviceObject.InvokerNew("get_key")
	})
	return err
}

// GetKey is a representation of the C type gdk_device_get_key.
func (recv *Device) GetKey(index uint32) (bool, uint32, ModifierType) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetUint32(index)
	...
	err := deviceGetKeyFunction_Set()
	if err == nil {
		ret = deviceGetKeyFunction.Invoke(inArgs[:], outArgs[:])
	}

	retGo := ret.Boolean()
	out0 := outArgs[0].Uint32()
	out1 := ModifierType(outArgs[1].Int32())
...
var deviceGrabFunction *gi.Function
var deviceGrabFunction_Once sync.Once

func deviceGrabFunction_Set() error {
	var err error
	deviceGrabFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceGrabFunction, err = deviceObject.InvokerNew("grab")
	})
	return err
}

// Grab is a representation of the C type gdk_device_grab.
func (recv *Device) Grab(window *Window, grabOwnership GrabOwnership, ownerEvents bool, eventMask EventMask, cursor *Cursor, time uint32) GrabStatus {
	...
	inArgs[2].SetInt32(int32(grabOwnership))
	inArgs[3].SetBoolean(ownerEvents)
	inArgs[4].SetInt32(int32(eventMask))
	inArgs[5].SetPointer(cursor.Native())
	inArgs[6].SetUint32(time)

	var ret gi.Argument

	err := deviceGrabFunction_Set()
	if err == nil {
		ret = deviceGrabFunction.Invoke(inArgs[:], nil)
	}
...
var deviceListAxesFunction *gi.Function
var deviceListAxesFunction_Once sync.Once

func deviceListAxesFunction_Set() error {
	var err error
	deviceListAxesFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceListAxesFunction, err = deviceObject.InvokerNew("list_axes")
	})
	return err
}

// ListAxes is a representation of the C type gdk_device_list_axes.
func (recv *Device) ListAxes() *glib.List {
	...
	err := deviceListAxesFunction_Set()
	if err == nil {
		ret = deviceListAxesFunction.Invoke(inArgs[:], nil)
	}
...
var deviceListSlaveDevicesFunction *gi.Function
var deviceListSlaveDevicesFunction_Once sync.Once

func deviceListSlaveDevicesFunction_Set() error {
	var err error
	deviceListSlaveDevicesFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceListSlaveDevicesFunction, err = deviceObject.InvokerNew("list_slave_devices")
	})
	return err
}

// ListSlaveDevices is a representation of the C type gdk_device_list_slave_devices.
func (recv *Device) ListSlaveDevices() *glib.List {
	...
	err := deviceListSlaveDevicesFunction_Set()
	if err == nil {
		ret = deviceListSlaveDevicesFunction.Invoke(inArgs[:], nil)
	}
...
var deviceSetKeyFunction *gi.Function
var deviceSetKeyFunction_Once sync.Once

func deviceSetKeyFunction_Set() error {
	var err error
	deviceSetKeyFunction_Once.Do(func() {
		err = deviceObject_Set()
		if err != nil {
			return
		}
		deviceSetKeyFunction, err = deviceObject.InvokerNew("set_key")
	})
	return err
}

// SetKey is a representation of the C type gdk_device_set_key.
func (recv *Device) SetKey(index uint32, keyval uint32, modifiers ModifierType) {
	var inArgs [4]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetUint32(index)
	inArgs[2].SetUint32(keyval)
	inArgs[3].SetInt32(int32(modifiers))

	err := deviceSetKeyFunction_Set()
	if err == nil {
		deviceSetKeyFunction.Invoke(inArgs[:], nil)
	}
...
var deviceManagerListDevicesFunction *gi.Function
var deviceManagerListDevicesFunction_Once sync.Once

func deviceManagerListDevicesFunction_Set() error {
	var err error
	deviceManagerListDevicesFunction_Once.Do(func() {
		err = deviceManagerObject_Set()
		if err != nil {
			return
		}
		deviceManagerListDevicesFunction, err = deviceManagerObject.InvokerNew("list_devices")
	})
	return err
}

// ListDevices is a representation of the C type gdk_device_manager_list_devices.
func (recv *DeviceManager) ListDevices(type_ DeviceType) *glib.List {
	...
	err := deviceManagerListDevicesFunction_Set()
	if err == nil {
		ret = deviceManagerListDevicesFunction.Invoke(inArgs[:], nil)
	}
...
func (recv *DeviceManager) ConnectDeviceAdded(handler func(instance *DeviceManager, device *Device)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := DeviceManagerNewFromNative(objectInstance.GetObject().Native())
...
var displayGetPointerFunction *gi.Function
var displayGetPointerFunction_Once sync.Once

func displayGetPointerFunction_Set() error {
	var err error
	displayGetPointerFunction_Once.Do(func() {
		err = displayObject_Set()
		if err != nil {
			return
		}
		displayGetPointerFunction, err = displayObject.InvokerNew("get_pointer")
	})
	return err
}

// GetPointer is a representation of the C type gdk_display_get_pointer.
func (recv *Display) GetPointer() (*Screen, int32, int32, ModifierType) {
	...
	err := displayGetPointerFunction_Set()
	if err == nil {
		displayGetPointerFunction.Invoke(inArgs[:], outArgs[:])
	}

	out0 := ScreenNewFromNative(outArgs[0].Pointer())
	out1 := outArgs[1].Int32()
	out2 := outArgs[2].Int32()
	out3 := ModifierType(outArgs[3].Int32())
...
var displayListDevicesFunction *gi.Function
var displayListDevicesFunction_Once sync.Once

func displayListDevicesFunction_Set() error {
	var err error
	displayListDevicesFunction_Once.Do(func() {
		err = displayObject_Set()
		if err != nil {
			return
		}
		displayListDevicesFunction, err = displayObject.InvokerNew("list_devices")
	})
	return err
}

// ListDevices is a representation of the C type gdk_display_list_devices.
func (recv *Display) ListDevices() *glib.List {
	...
	err := displayListDevicesFunction_Set()
	if err == nil {
		ret = displayListDevicesFunction.Invoke(inArgs[:], nil)
	}
...
var displayListSeatsFunction *gi.Function
var displayListSeatsFunction_Once sync.Once

func displayListSeatsFunction_Set() error {
	var err error
	displayListSeatsFunction_Once.Do(func() {
		err = displayObject_Set()
		if err != nil {
			return
		}
		displayListSeatsFunction, err = displayObject.InvokerNew("list_seats")
	})
	return err
}

// ListSeats is a representation of the C type gdk_display_list_seats.
func (recv *Display) ListSeats() *glib.List {
	...
	err := displayListSeatsFunction_Set()
	if err == nil {
		ret = displayListSeatsFunction.Invoke(inArgs[:], nil)
	}
...
var displayManagerListDisplaysFunction *gi.Function
var displayManagerListDisplaysFunction_Once sync.Once

func displayManagerListDisplaysFunction_Set() error {
	var err error
	displayManagerListDisplaysFunction_Once.Do(func() {
		err = displayManagerObject_Set()
		if err != nil {
			return
		}
		displayManagerListDisplaysFunction, err = displayManagerObject.InvokerNew("list_displays")
	})
	return err
}

// ListDisplays is a representation of the C type gdk_display_manager_list_displays.
func (recv *DisplayManager) ListDisplays() *glib.SList {
	...
	err := displayManagerListDisplaysFunction_Set()
	if err == nil {
		ret = displayManagerListDisplaysFunction.Invoke(inArgs[:], nil)
	}
...
func (recv *DisplayManager) ConnectDisplayOpened(handler func(instance *DisplayManager, display *Display)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := DisplayManagerNewFromNative(objectInstance.GetObject().Native())
...
var dragContextGetActionsFunction *gi.Function
var dragContextGetActionsFunction_Once sync.Once

func dragContextGetActionsFunction_Set() error {
	var err error
	dragContextGetActionsFunction_Once.Do(func() {
		err = dragContextObject_Set()
		if err != nil {
			return
		}
		dragContextGetActionsFunction, err = dragContextObject.InvokerNew("get_actions")
	})
	return err
}

// GetActions is a representation of the C type gdk_drag_context_get_actions.
func (recv *DragContext) GetActions() DragAction {
	...
	err := dragContextGetActionsFunction_Set()
	if err == nil {
		ret = dragContextGetActionsFunction.Invoke(inArgs[:], nil)
	}

	retGo := DragAction(ret.Int32())
...
var dragContextGetSelectedActionFunction *gi.Function
var dragContextGetSelectedActionFunction_Once sync.Once

func dragContextGetSelectedActionFunction_Set() error {
	var err error
	dragContextGetSelectedActionFunction_Once.Do(func() {
		err = dragContextObject_Set()
		if err != nil {
			return
		}
		dragContextGetSelectedActionFunction, err = dragContextObject.InvokerNew("get_selected_action")
	})
	return err
}

// GetSelectedAction is a representation of the C type gdk_drag_context_get_selected_action.
func (recv *DragContext) GetSelectedAction() DragAction {
	...
	err := dragContextGetSelectedActionFunction_Set()
	if err == nil {
		ret = dragContextGetSelectedActionFunction.Invoke(inArgs[:], nil)
	}
...
var dragContextGetSuggestedActionFunction *gi.Function
var dragContextGetSuggestedActionFunction_Once sync.Once

func dragContextGetSuggestedActionFunction_Set() error {
	var err error
	dragContextGetSuggestedActionFunction_Once.Do(func() {
		err = dragContextObject_Set()
		if err != nil {
			return
		}
		dragContextGetSuggestedActionFunction, err = dragContextObject.InvokerNew("get_suggested_action")
	})
	return err
}

// GetSuggestedAction is a representation of the C type gdk_drag_context_get_suggested_action.
func (recv *DragContext) GetSuggestedAction() DragAction {
	...
	err := dragContextGetSuggestedActionFunction_Set()
	if err == nil {
		ret = dragContextGetSuggestedActionFunction.Invoke(inArgs[:], nil)
	}
...
var dragContextListTargetsFunction *gi.Function
var dragContextListTargetsFunction_Once sync.Once

func dragContextListTargetsFunction_Set() error {
	var err error
	dragContextListTargetsFunction_Once.Do(func() {
		err = dragContextObject_Set()
		if err != nil {
			return
		}
		dragContextListTargetsFunction, err = dragContextObject.InvokerNew("list_targets")
	})
	return err
}

// ListTargets is a representation of the C type gdk_drag_context_list_targets.
func (recv *DragContext) ListTargets() *glib.List {
	...
	err := dragContextListTargetsFunction_Set()
	if err == nil {
		ret = dragContextListTargetsFunction.Invoke(inArgs[:], nil)
	}
...
var dragContextManageDndFunction *gi.Function
var dragContextManageDndFunction_Once sync.Once

func dragContextManageDndFunction_Set() error {
	var err error
	dragContextManageDndFunction_Once.Do(func() {
		err = dragContextObject_Set()
		if err != nil {
			return
		}
		dragContextManageDndFunction, err = dragContextObject.InvokerNew("manage_dnd")
	})
	return err
}

// ManageDnd is a representation of the C type gdk_drag_context_manage_dnd.
func (recv *DragContext) ManageDnd(ipcWindow *Window, actions DragAction) bool {
	var inArgs [3]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(ipcWindow.Native())
	inArgs[2].SetInt32(int32(actions))

	var ret gi.Argument

	err := dragContextManageDndFunction_Set()
	if err == nil {
		ret = dragContextManageDndFunction.Invoke(inArgs[:], nil)
	}
...
/*
ConnectActionChanged connects a callback to the 'action-changed' signal of the DragContext.

The returned value represents the connection, and may be passed to the Disconnect method to remove it.
*/
func (recv *DragContext) ConnectActionChanged(handler func(instance *DragContext, action DragAction)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
...
var drawingContextGetCairoContextFunction *gi.Function
var drawingContextGetCairoContextFunction_Once sync.Once

func drawingContextGetCairoContextFunction_Set() error {
	var err error
	drawingContextGetCairoContextFunction_Once.Do(func() {
		err = drawingContextObject_Set()
		if err != nil {
			return
		}
		drawingContextGetCairoContextFunction, err = drawingContextObject.InvokerNew("get_cairo_context")
	})
	return err
}

// GetCairoContext is a representation of the C type gdk_drawing_context_get_cairo_context.
func (recv *DrawingContext) GetCairoContext() *cairo.Context {
	...
	err := drawingContextGetCairoContextFunction_Set()
	if err == nil {
		ret = drawingContextGetCairoContextFunction.Invoke(inArgs[:], nil)
	}
...
var drawingContextGetClipFunction *gi.Function
var drawingContextGetClipFunction_Once sync.Once

func drawingContextGetClipFunction_Set() error {
	var err error
	drawingContextGetClipFunction_Once.Do(func() {
		err = drawingContextObject_Set()
		if err != nil {
			return
		}
		drawingContextGetClipFunction, err = drawingContextObject.InvokerNew("get_clip")
	})
	return err
}

// GetClip is a representation of the C type gdk_drawing_context_get_clip.
func (recv *DrawingContext) GetClip() *cairo.Region {
	...
	err := drawingContextGetClipFunction_Set()
	if err == nil {
		ret = drawingContextGetClipFunction.Invoke(inArgs[:], nil)
	}
...
var frameClockRequestPhaseFunction *gi.Function
var frameClockRequestPhaseFunction_Once sync.Once

func frameClockRequestPhaseFunction_Set() error {
	var err error
	frameClockRequestPhaseFunction_Once.Do(func() {
		err = frameClockObject_Set()
		if err != nil {
			return
		}
		frameClockRequestPhaseFunction, err = frameClockObject.InvokerNew("request_phase")
	})
	return err
}

// RequestPhase is a representation of the C type gdk_frame_clock_request_phase.
func (recv *FrameClock) RequestPhase(phase FrameClockPhase) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(phase))

	err := frameClockRequestPhaseFunction_Set()
	if err == nil {
		frameClockRequestPhaseFunction.Invoke(inArgs[:], nil)
	}
...
var keymapAddVirtualModifiersFunction *gi.Function
var keymapAddVirtualModifiersFunction_Once sync.Once

func keymapAddVirtualModifiersFunction_Set() error {
	var err error
	keymapAddVirtualModifiersFunction_Once.Do(func() {
		err = keymapObject_Set()
		if err != nil {
			return
		}
		keymapAddVirtualModifiersFunction, err = keymapObject.InvokerNew("add_virtual_modifiers")
	})
	return err
}

// AddVirtualModifiers is a representation of the C type gdk_keymap_add_virtual_modifiers.
func (recv *Keymap) AddVirtualModifiers(state ModifierType) ModifierType {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	...
	err := keymapAddVirtualModifiersFunction_Set()
	if err == nil {
		keymapAddVirtualModifiersFunction.Invoke(inArgs[:], outArgs[:])
	}

	out0 := ModifierType(outArgs[0].Int32())
...
func keymapGetModifierMaskFunction_Set() error {
	var err error
	keymapGetModifierMaskFunction_Once.Do(func() {
		err = keymapObject_Set()
		if err != nil {
			return
		}
		keymapGetModifierMaskFunction, err = keymapObject.InvokerNew("get_modifier_mask")
	})
	return err
}

// GetModifierMask is a representation of the C type gdk_keymap_get_modifier_mask.
func (recv *Keymap) GetModifierMask(intent ModifierIntent) ModifierType {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(intent))

	var ret gi.Argument

	err := keymapGetModifierMaskFunction_Set()
	if err == nil {
		ret = keymapGetModifierMaskFunction.Invoke(inArgs[:], nil)
	}

	retGo := ModifierType(ret.Int32())
...
var keymapMapVirtualModifiersFunction *gi.Function
var keymapMapVirtualModifiersFunction_Once sync.Once

func keymapMapVirtualModifiersFunction_Set() error {
	var err error
	keymapMapVirtualModifiersFunction_Once.Do(func() {
		err = keymapObject_Set()
		if err != nil {
			return
		}
		keymapMapVirtualModifiersFunction, err = keymapObject.InvokerNew("map_virtual_modifiers")
	})
	return err
}

// MapVirtualModifiers is a representation of the C type gdk_keymap_map_virtual_modifiers.
func (recv *Keymap) MapVirtualModifiers(state ModifierType) (bool, ModifierType) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(state))
	...
	err := keymapMapVirtualModifiersFunction_Set()
	if err == nil {
		ret = keymapMapVirtualModifiersFunction.Invoke(inArgs[:], outArgs[:])
	}
...
var keymapTranslateKeyboardStateFunction *gi.Function
var keymapTranslateKeyboardStateFunction_Once sync.Once

func keymapTranslateKeyboardStateFunction_Set() error {
	var err error
	keymapTranslateKeyboardStateFunction_Once.Do(func() {
		err = keymapObject_Set()
		if err != nil {
			return
		}
		keymapTranslateKeyboardStateFunction, err = keymapObject.InvokerNew("translate_keyboard_state")
	})
	return err
}

// TranslateKeyboardState is a representation of the C type gdk_keymap_translate_keyboard_state.
func (recv *Keymap) TranslateKeyboardState(hardwareKeycode uint32, state ModifierType, group int32) (bool, uint32, int32, int32, ModifierType) {
	var inArgs [4]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetUint32(hardwareKeycode)
	inArgs[2].SetInt32(int32(state))
	inArgs[3].SetInt32(group)

	var outArgs [4]gi.Argument
	var ret gi.Argument

	err := keymapTranslateKeyboardStateFunction_Set()
	if err == nil {
		ret = keymapTranslateKeyboardStateFunction.Invoke(inArgs[:], outArgs[:])
	}
...
var screenGetFontOptionsFunction *gi.Function
var screenGetFontOptionsFunction_Once sync.Once

func screenGetFontOptionsFunction_Set() error {
	var err error
	screenGetFontOptionsFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenGetFontOptionsFunction, err = screenObject.InvokerNew("get_font_options")
	})
	return err
}

// GetFontOptions is a representation of the C type gdk_screen_get_font_options.
func (recv *Screen) GetFontOptions() *cairo.FontOptions {
	...
	err := screenGetFontOptionsFunction_Set()
	if err == nil {
		ret = screenGetFontOptionsFunction.Invoke(inArgs[:], nil)
	}
...
var screenGetSettingFunction *gi.Function
var screenGetSettingFunction_Once sync.Once

func screenGetSettingFunction_Set() error {
	var err error
	screenGetSettingFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenGetSettingFunction, err = screenObject.InvokerNew("get_setting")
	})
	return err
}

// GetSetting is a representation of the C type gdk_screen_get_setting.
func (recv *Screen) GetSetting(name string, value *gobject.Value) bool {
	...
	err := screenGetSettingFunction_Set()
	if err == nil {
		ret = screenGetSettingFunction.Invoke(inArgs[:], nil)
	}
...
var screenGetToplevelWindowsFunction *gi.Function
var screenGetToplevelWindowsFunction_Once sync.Once

func screenGetToplevelWindowsFunction_Set() error {
	var err error
	screenGetToplevelWindowsFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenGetToplevelWindowsFunction, err = screenObject.InvokerNew("get_toplevel_windows")
	})
	return err
}

// GetToplevelWindows is a representation of the C type gdk_screen_get_toplevel_windows.
func (recv *Screen) GetToplevelWindows() *glib.List {
	...
	err := screenGetToplevelWindowsFunction_Set()
	if err == nil {
		ret = screenGetToplevelWindowsFunction.Invoke(inArgs[:], nil)
	}
...
var screenGetWindowStackFunction *gi.Function
var screenGetWindowStackFunction_Once sync.Once

func screenGetWindowStackFunction_Set() error {
	var err error
	screenGetWindowStackFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenGetWindowStackFunction, err = screenObject.InvokerNew("get_window_stack")
	})
	return err
}

// GetWindowStack is a representation of the C type gdk_screen_get_window_stack.
func (recv *Screen) GetWindowStack() *glib.List {
	...
	err := screenGetWindowStackFunction_Set()
	if err == nil {
		ret = screenGetWindowStackFunction.Invoke(inArgs[:], nil)
	}
...
var screenListVisualsFunction *gi.Function
var screenListVisualsFunction_Once sync.Once

func screenListVisualsFunction_Set() error {
	var err error
	screenListVisualsFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenListVisualsFunction, err = screenObject.InvokerNew("list_visuals")
	})
	return err
}

// ListVisuals is a representation of the C type gdk_screen_list_visuals.
func (recv *Screen) ListVisuals() *glib.List {
	...
	err := screenListVisualsFunction_Set()
	if err == nil {
		ret = screenListVisualsFunction.Invoke(inArgs[:], nil)
	}
...
var screenSetFontOptionsFunction *gi.Function
var screenSetFontOptionsFunction_Once sync.Once

func screenSetFontOptionsFunction_Set() error {
	var err error
	screenSetFontOptionsFunction_Once.Do(func() {
		err = screenObject_Set()
		if err != nil {
			return
		}
		screenSetFontOptionsFunction, err = screenObject.InvokerNew("set_font_options")
	})
	return err
}

// SetFontOptions is a representation of the C type gdk_screen_set_font_options.
func (recv *Screen) SetFontOptions(options *cairo.FontOptions) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(options.Native())

	err := screenSetFontOptionsFunction_Set()
	if err == nil {
		screenSetFontOptionsFunction.Invoke(inArgs[:], nil)
	}
...
var seatGetCapabilitiesFunction *gi.Function
var seatGetCapabilitiesFunction_Once sync.Once

func seatGetCapabilitiesFunction_Set() error {
	var err error
	seatGetCapabilitiesFunction_Once.Do(func() {
		err = seatObject_Set()
		if err != nil {
			return
		}
		seatGetCapabilitiesFunction, err = seatObject.InvokerNew("get_capabilities")
	})
	return err
}

// GetCapabilities is a representation of the C type gdk_seat_get_capabilities.
func (recv *Seat) GetCapabilities() SeatCapabilities {
	...
	err := seatGetCapabilitiesFunction_Set()
	if err == nil {
		ret = seatGetCapabilitiesFunction.Invoke(inArgs[:], nil)
	}

	retGo := SeatCapabilities(ret.Int32())
...
var seatGetSlavesFunction *gi.Function
var seatGetSlavesFunction_Once sync.Once

func seatGetSlavesFunction_Set() error {
	var err error
	seatGetSlavesFunction_Once.Do(func() {
		err = seatObject_Set()
		if err != nil {
			return
		}
		seatGetSlavesFunction, err = seatObject.InvokerNew("get_slaves")
	})
	return err
}

// GetSlaves is a representation of the C type gdk_seat_get_slaves.
func (recv *Seat) GetSlaves(capabilities SeatCapabilities) *glib.List {
	...
	err := seatGetSlavesFunction_Set()
	if err == nil {
		ret = seatGetSlavesFunction.Invoke(inArgs[:], nil)
	}
...
// UNSUPPORTED : C value 'gdk_seat_grab' : parameter 'event' of type 'Event' not supported
...
func (recv *Seat) ConnectDeviceAdded(handler func(instance *Seat, device *Device)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := SeatNewFromNative(objectInstance.GetObject().Native())
...
var windowNewFunction *gi.Function
var windowNewFunction_Once sync.Once

func windowNewFunction_Set() error {
	var err error
	windowNewFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowNewFunction, err = windowObject.InvokerNew("new")
	})
	return err
}

// WindowNew is a representation of the C type gdk_window_new.
func WindowNew(parent *Window, attributes *WindowAttr, attributesMask WindowAttributesType) *Window {
	...
	inArgs[1].SetPointer(attributes.Native())
	inArgs[2].SetInt32(int32(attributesMask))

	var ret gi.Argument

	err := windowNewFunction_Set()
	if err == nil {
		ret = windowNewFunction.Invoke(inArgs[:], nil)
	}
...
var windowBeginDrawFrameFunction *gi.Function
var windowBeginDrawFrameFunction_Once sync.Once

func windowBeginDrawFrameFunction_Set() error {
	var err error
	windowBeginDrawFrameFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowBeginDrawFrameFunction, err = windowObject.InvokerNew("begin_draw_frame")
	})
	return err
}

// BeginDrawFrame is a representation of the C type gdk_window_begin_draw_frame.
func (recv *Window) BeginDrawFrame(region *cairo.Region) *DrawingContext {
	...
	err := windowBeginDrawFrameFunction_Set()
	if err == nil {
		ret = windowBeginDrawFrameFunction.Invoke(inArgs[:], nil)
	}
...
var windowBeginPaintRegionFunction *gi.Function
var windowBeginPaintRegionFunction_Once sync.Once

func windowBeginPaintRegionFunction_Set() error {
	var err error
	windowBeginPaintRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowBeginPaintRegionFunction, err = windowObject.InvokerNew("begin_paint_region")
	})
	return err
}

// BeginPaintRegion is a representation of the C type gdk_window_begin_paint_region.
func (recv *Window) BeginPaintRegion(region *cairo.Region) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(region.Native())

	err := windowBeginPaintRegionFunction_Set()
	if err == nil {
		windowBeginPaintRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowCreateSimilarImageSurfaceFunction *gi.Function
var windowCreateSimilarImageSurfaceFunction_Once sync.Once

func windowCreateSimilarImageSurfaceFunction_Set() error {
	var err error
	windowCreateSimilarImageSurfaceFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowCreateSimilarImageSurfaceFunction, err = windowObject.InvokerNew("create_similar_image_surface")
	})
	return err
}

// CreateSimilarImageSurface is a representation of the C type gdk_window_create_similar_image_surface.
func (recv *Window) CreateSimilarImageSurface(format int32, width int32, height int32, scale int32) *cairo.Surface {
	var inArgs [5]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(format)
	inArgs[2].SetInt32(width)
	inArgs[3].SetInt32(height)
	inArgs[4].SetInt32(scale)

	var ret gi.Argument

	err := windowCreateSimilarImageSurfaceFunction_Set()
	if err == nil {
		ret = windowCreateSimilarImageSurfaceFunction.Invoke(inArgs[:], nil)
	}
...
var windowGetBackgroundPatternFunction *gi.Function
var windowGetBackgroundPatternFunction_Once sync.Once

func windowGetBackgroundPatternFunction_Set() error {
	var err error
	windowGetBackgroundPatternFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetBackgroundPatternFunction, err = windowObject.InvokerNew("get_background_pattern")
	})
	return err
}

// GetBackgroundPattern is a representation of the C type gdk_window_get_background_pattern.
func (recv *Window) GetBackgroundPattern() *cairo.Pattern {
	...
	err := windowGetBackgroundPatternFunction_Set()
	if err == nil {
		ret = windowGetBackgroundPatternFunction.Invoke(inArgs[:], nil)
	}
...
var windowGetChildrenFunction *gi.Function
var windowGetChildrenFunction_Once sync.Once

func windowGetChildrenFunction_Set() error {
	var err error
	windowGetChildrenFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetChildrenFunction, err = windowObject.InvokerNew("get_children")
	})
	return err
}

// GetChildren is a representation of the C type gdk_window_get_children.
func (recv *Window) GetChildren() *glib.List {
	...
	err := windowGetChildrenFunction_Set()
	if err == nil {
		ret = windowGetChildrenFunction.Invoke(inArgs[:], nil)
	}
...
func windowGetClipRegionFunction_Set() error {
	var err error
	windowGetClipRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetClipRegionFunction, err = windowObject.InvokerNew("get_clip_region")
	})
	return err
}

// GetClipRegion is a representation of the C type gdk_window_get_clip_region.
func (recv *Window) GetClipRegion() *cairo.Region {
	...
	err := windowGetClipRegionFunction_Set()
	if err == nil {
		ret = windowGetClipRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowGetDecorationsFunction *gi.Function
var windowGetDecorationsFunction_Once sync.Once

func windowGetDecorationsFunction_Set() error {
	var err error
	windowGetDecorationsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetDecorationsFunction, err = windowObject.InvokerNew("get_decorations")
	})
	return err
}

// GetDecorations is a representation of the C type gdk_window_get_decorations.
func (recv *Window) GetDecorations() (bool, WMDecoration) {
	...
	err := windowGetDecorationsFunction_Set()
	if err == nil {
		ret = windowGetDecorationsFunction.Invoke(inArgs[:], outArgs[:])
	}

	retGo := ret.Boolean()
	out0 := WMDecoration(outArgs[0].Int32())
...
var windowGetDeviceEventsFunction *gi.Function
var windowGetDeviceEventsFunction_Once sync.Once

func windowGetDeviceEventsFunction_Set() error {
	var err error
	windowGetDeviceEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetDeviceEventsFunction, err = windowObject.InvokerNew("get_device_events")
	})
	return err
}

// GetDeviceEvents is a representation of the C type gdk_window_get_device_events.
func (recv *Window) GetDeviceEvents(device *Device) EventMask {
	...
	err := windowGetDeviceEventsFunction_Set()
	if err == nil {
		ret = windowGetDeviceEventsFunction.Invoke(inArgs[:], nil)
	}

	retGo := EventMask(ret.Int32())

	return retGo
}

var windowGetDevicePositionFunction *gi.Function
var windowGetDevicePositionFunction_Once sync.Once

func windowGetDevicePositionFunction_Set() error {
	var err error
	windowGetDevicePositionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetDevicePositionFunction, err = windowObject.InvokerNew("get_device_position")
	})
	return err
}

// GetDevicePosition is a representation of the C type gdk_window_get_device_position.
func (recv *Window) GetDevicePosition(device *Device) (*Window, int32, int32, ModifierType) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(device.Native())
	...
	err := windowGetDevicePositionFunction_Set()
	if err == nil {
		ret = windowGetDevicePositionFunction.Invoke(inArgs[:], outArgs[:])
	}

	retGo := WindowNewFromNative(ret.Pointer())
	out0 := outArgs[0].Int32()
	out1 := outArgs[1].Int32()
	out2 := ModifierType(outArgs[2].Int32())

	return retGo, out0, out1, out2
}

var windowGetDevicePositionDoubleFunction *gi.Function
var windowGetDevicePositionDoubleFunction_Once sync.Once

func windowGetDevicePositionDoubleFunction_Set() error {
	var err error
	windowGetDevicePositionDoubleFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetDevicePositionDoubleFunction, err = windowObject.InvokerNew("get_device_position_double")
	})
	return err
}

// GetDevicePositionDouble is a representation of the C type gdk_window_get_device_position_double.
func (recv *Window) GetDevicePositionDouble(device *Device) (*Window, float64, float64, ModifierType) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(device.Native())
	...
	err := windowGetDevicePositionDoubleFunction_Set()
	if err == nil {
		ret = windowGetDevicePositionDoubleFunction.Invoke(inArgs[:], outArgs[:])
	}
...
var windowGetEventsFunction *gi.Function
var windowGetEventsFunction_Once sync.Once

func windowGetEventsFunction_Set() error {
	var err error
	windowGetEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetEventsFunction, err = windowObject.InvokerNew("get_events")
	})
	return err
}

// GetEvents is a representation of the C type gdk_window_get_events.
func (recv *Window) GetEvents() EventMask {
	...
	err := windowGetEventsFunction_Set()
	if err == nil {
		ret = windowGetEventsFunction.Invoke(inArgs[:], nil)
	}
...
var windowGetPointerFunction *gi.Function
var windowGetPointerFunction_Once sync.Once

func windowGetPointerFunction_Set() error {
	var err error
	windowGetPointerFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetPointerFunction, err = windowObject.InvokerNew("get_pointer")
	})
	return err
}

// GetPointer is a representation of the C type gdk_window_get_pointer.
func (recv *Window) GetPointer() (*Window, int32, int32, ModifierType) {
	...
	err := windowGetPointerFunction_Set()
	if err == nil {
		ret = windowGetPointerFunction.Invoke(inArgs[:], outArgs[:])
	}
...
var windowGetSourceEventsFunction *gi.Function
var windowGetSourceEventsFunction_Once sync.Once

func windowGetSourceEventsFunction_Set() error {
	var err error
	windowGetSourceEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetSourceEventsFunction, err = windowObject.InvokerNew("get_source_events")
	})
	return err
}

// GetSourceEvents is a representation of the C type gdk_window_get_source_events.
func (recv *Window) GetSourceEvents(source InputSource) EventMask {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(source))

	var ret gi.Argument

	err := windowGetSourceEventsFunction_Set()
	if err == nil {
		ret = windowGetSourceEventsFunction.Invoke(inArgs[:], nil)
	}
...
var windowGetStateFunction *gi.Function
var windowGetStateFunction_Once sync.Once

func windowGetStateFunction_Set() error {
	var err error
	windowGetStateFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetStateFunction, err = windowObject.InvokerNew("get_state")
	})
	return err
}

// GetState is a representation of the C type gdk_window_get_state.
func (recv *Window) GetState() WindowState {
	...
	err := windowGetStateFunction_Set()
	if err == nil {
		ret = windowGetStateFunction.Invoke(inArgs[:], nil)
	}

	retGo := WindowState(ret.Int32())
...
var windowGetUpdateAreaFunction *gi.Function
var windowGetUpdateAreaFunction_Once sync.Once

func windowGetUpdateAreaFunction_Set() error {
	var err error
	windowGetUpdateAreaFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetUpdateAreaFunction, err = windowObject.InvokerNew("get_update_area")
	})
	return err
}

// GetUpdateArea is a representation of the C type gdk_window_get_update_area.
func (recv *Window) GetUpdateArea() *cairo.Region {
	...
	err := windowGetUpdateAreaFunction_Set()
	if err == nil {
		ret = windowGetUpdateAreaFunction.Invoke(inArgs[:], nil)
	}
...
func windowGetVisibleRegionFunction_Set() error {
	var err error
	windowGetVisibleRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowGetVisibleRegionFunction, err = windowObject.InvokerNew("get_visible_region")
	})
	return err
}

// GetVisibleRegion is a representation of the C type gdk_window_get_visible_region.
func (recv *Window) GetVisibleRegion() *cairo.Region {
	...
	err := windowGetVisibleRegionFunction_Set()
	if err == nil {
		ret = windowGetVisibleRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowInputShapeCombineRegionFunction *gi.Function
var windowInputShapeCombineRegionFunction_Once sync.Once

func windowInputShapeCombineRegionFunction_Set() error {
	var err error
	windowInputShapeCombineRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowInputShapeCombineRegionFunction, err = windowObject.InvokerNew("input_shape_combine_region")
	})
	return err
}

// InputShapeCombineRegion is a representation of the C type gdk_window_input_shape_combine_region.
func (recv *Window) InputShapeCombineRegion(shapeRegion *cairo.Region, offsetX int32, offsetY int32) {
	var inArgs [4]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(shapeRegion.Native())
	inArgs[2].SetInt32(offsetX)
	inArgs[3].SetInt32(offsetY)

	err := windowInputShapeCombineRegionFunction_Set()
	if err == nil {
		windowInputShapeCombineRegionFunction.Invoke(inArgs[:], nil)
	}

	return
}

// UNSUPPORTED : C value 'gdk_window_invalidate_maybe_recurse' : parameter 'child_func' of type 'WindowChildFunc' not supported
...
var windowInvalidateRegionFunction *gi.Function
var windowInvalidateRegionFunction_Once sync.Once

func windowInvalidateRegionFunction_Set() error {
	var err error
	windowInvalidateRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowInvalidateRegionFunction, err = windowObject.InvokerNew("invalidate_region")
	})
	return err
}

// InvalidateRegion is a representation of the C type gdk_window_invalidate_region.
func (recv *Window) InvalidateRegion(region *cairo.Region, invalidateChildren bool) {
	...
	err := windowInvalidateRegionFunction_Set()
	if err == nil {
		windowInvalidateRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowMarkPaintFromClipFunction *gi.Function
var windowMarkPaintFromClipFunction_Once sync.Once

func windowMarkPaintFromClipFunction_Set() error {
	var err error
	windowMarkPaintFromClipFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowMarkPaintFromClipFunction, err = windowObject.InvokerNew("mark_paint_from_clip")
	})
	return err
}

// MarkPaintFromClip is a representation of the C type gdk_window_mark_paint_from_clip.
func (recv *Window) MarkPaintFromClip(cr *cairo.Context) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(cr.Native())

	err := windowMarkPaintFromClipFunction_Set()
	if err == nil {
		windowMarkPaintFromClipFunction.Invoke(inArgs[:], nil)
	}
...
var windowMoveRegionFunction *gi.Function
var windowMoveRegionFunction_Once sync.Once

func windowMoveRegionFunction_Set() error {
	var err error
	windowMoveRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowMoveRegionFunction, err = windowObject.InvokerNew("move_region")
	})
	return err
}

// MoveRegion is a representation of the C type gdk_window_move_region.
func (recv *Window) MoveRegion(region *cairo.Region, dx int32, dy int32) {
	var inArgs [4]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(region.Native())
	inArgs[2].SetInt32(dx)
	inArgs[3].SetInt32(dy)

	err := windowMoveRegionFunction_Set()
	if err == nil {
		windowMoveRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowMoveToRectFunction *gi.Function
var windowMoveToRectFunction_Once sync.Once

func windowMoveToRectFunction_Set() error {
	var err error
	windowMoveToRectFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowMoveToRectFunction, err = windowObject.InvokerNew("move_to_rect")
	})
	return err
}

// MoveToRect is a representation of the C type gdk_window_move_to_rect.
func (recv *Window) MoveToRect(rect *Rectangle, rectAnchor Gravity, windowAnchor Gravity, anchorHints AnchorHints, rectAnchorDx int32, rectAnchorDy int32) {
	var inArgs [7]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(rect.Native())
	inArgs[2].SetInt32(int32(rectAnchor))
	inArgs[3].SetInt32(int32(windowAnchor))
	inArgs[4].SetInt32(int32(anchorHints))
	inArgs[5].SetInt32(rectAnchorDx)
	inArgs[6].SetInt32(rectAnchorDy)

	err := windowMoveToRectFunction_Set()
	if err == nil {
		windowMoveToRectFunction.Invoke(inArgs[:], nil)
	}

	return
}

var windowPeekChildrenFunction *gi.Function
var windowPeekChildrenFunction_Once sync.Once

func windowPeekChildrenFunction_Set() error {
	var err error
	windowPeekChildrenFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowPeekChildrenFunction, err = windowObject.InvokerNew("peek_children")
	})
	return err
}

// PeekChildren is a representation of the C type gdk_window_peek_children.
func (recv *Window) PeekChildren() *glib.List {
	...
	err := windowPeekChildrenFunction_Set()
	if err == nil {
		ret = windowPeekChildrenFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetBackgroundPatternFunction *gi.Function
var windowSetBackgroundPatternFunction_Once sync.Once

func windowSetBackgroundPatternFunction_Set() error {
	var err error
	windowSetBackgroundPatternFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetBackgroundPatternFunction, err = windowObject.InvokerNew("set_background_pattern")
	})
	return err
}

// SetBackgroundPattern is a representation of the C type gdk_window_set_background_pattern.
func (recv *Window) SetBackgroundPattern(pattern *cairo.Pattern) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(pattern.Native())

	err := windowSetBackgroundPatternFunction_Set()
	if err == nil {
		windowSetBackgroundPatternFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetDecorationsFunction *gi.Function
var windowSetDecorationsFunction_Once sync.Once

func windowSetDecorationsFunction_Set() error {
	var err error
	windowSetDecorationsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetDecorationsFunction, err = windowObject.InvokerNew("set_decorations")
	})
	return err
}

// SetDecorations is a representation of the C type gdk_window_set_decorations.
func (recv *Window) SetDecorations(decorations WMDecoration) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(decorations))

	err := windowSetDecorationsFunction_Set()
	if err == nil {
		windowSetDecorationsFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetDeviceEventsFunction *gi.Function
var windowSetDeviceEventsFunction_Once sync.Once

func windowSetDeviceEventsFunction_Set() error {
	var err error
	windowSetDeviceEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetDeviceEventsFunction, err = windowObject.InvokerNew("set_device_events")
	})
	return err
}

// SetDeviceEvents is a representation of the C type gdk_window_set_device_events.
func (recv *Window) SetDeviceEvents(device *Device, eventMask EventMask) {
	...
	err := windowSetDeviceEventsFunction_Set()
	if err == nil {
		windowSetDeviceEventsFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetEventsFunction *gi.Function
var windowSetEventsFunction_Once sync.Once

func windowSetEventsFunction_Set() error {
	var err error
	windowSetEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetEventsFunction, err = windowObject.InvokerNew("set_events")
	})
	return err
}

// SetEvents is a representation of the C type gdk_window_set_events.
func (recv *Window) SetEvents(eventMask EventMask) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(eventMask))

	err := windowSetEventsFunction_Set()
	if err == nil {
		windowSetEventsFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetFunctionsFunction *gi.Function
var windowSetFunctionsFunction_Once sync.Once

func windowSetFunctionsFunction_Set() error {
	var err error
	windowSetFunctionsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetFunctionsFunction, err = windowObject.InvokerNew("set_functions")
	})
	return err
}

// SetFunctions is a representation of the C type gdk_window_set_functions.
func (recv *Window) SetFunctions(functions WMFunction) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetInt32(int32(functions))

	err := windowSetFunctionsFunction_Set()
	if err == nil {
		windowSetFunctionsFunction.Invoke(inArgs[:], nil)
	}

	return
}

var windowSetGeometryHintsFunction *gi.Function
var windowSetGeometryHintsFunction_Once sync.Once

func windowSetGeometryHintsFunction_Set() error {
	var err error
	windowSetGeometryHintsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetGeometryHintsFunction, err = windowObject.InvokerNew("set_geometry_hints")
	})
	return err
}

// SetGeometryHints is a representation of the C type gdk_window_set_geometry_hints.
func (recv *Window) SetGeometryHints(geometry *Geometry, geomMask WindowHints) {
	var inArgs [3]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(geometry.Native())
	inArgs[2].SetInt32(int32(geomMask))

	err := windowSetGeometryHintsFunction_Set()
	if err == nil {
		windowSetGeometryHintsFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetIconListFunction *gi.Function
var windowSetIconListFunction_Once sync.Once

func windowSetIconListFunction_Set() error {
	var err error
	windowSetIconListFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetIconListFunction, err = windowObject.InvokerNew("set_icon_list")
	})
	return err
}

// SetIconList is a representation of the C type gdk_window_set_icon_list.
func (recv *Window) SetIconList(pixbufs *glib.List) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(pixbufs.Native())

	err := windowSetIconListFunction_Set()
	if err == nil {
		windowSetIconListFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetOpaqueRegionFunction *gi.Function
var windowSetOpaqueRegionFunction_Once sync.Once

func windowSetOpaqueRegionFunction_Set() error {
	var err error
	windowSetOpaqueRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetOpaqueRegionFunction, err = windowObject.InvokerNew("set_opaque_region")
	})
	return err
}

// SetOpaqueRegion is a representation of the C type gdk_window_set_opaque_region.
func (recv *Window) SetOpaqueRegion(region *cairo.Region) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(region.Native())

	err := windowSetOpaqueRegionFunction_Set()
	if err == nil {
		windowSetOpaqueRegionFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetSourceEventsFunction *gi.Function
var windowSetSourceEventsFunction_Once sync.Once

func windowSetSourceEventsFunction_Set() error {
	var err error
	windowSetSourceEventsFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetSourceEventsFunction, err = windowObject.InvokerNew("set_source_events")
	})
	return err
}

// SetSourceEvents is a representation of the C type gdk_window_set_source_events.
func (recv *Window) SetSourceEvents(source InputSource, eventMask EventMask) {
	...
	err := windowSetSourceEventsFunction_Set()
	if err == nil {
		windowSetSourceEventsFunction.Invoke(inArgs[:], nil)
	}
...
var windowSetUserDataFunction *gi.Function
var windowSetUserDataFunction_Once sync.Once

func windowSetUserDataFunction_Set() error {
	var err error
	windowSetUserDataFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowSetUserDataFunction, err = windowObject.InvokerNew("set_user_data")
	})
	return err
}

// SetUserData is a representation of the C type gdk_window_set_user_data.
func (recv *Window) SetUserData(userData *gobject.Object) {
	var inArgs [2]gi.Argument
	inArgs[0].SetPointer(recv.Native())
	inArgs[1].SetPointer(userData.Native())

	err := windowSetUserDataFunction_Set()
	if err == nil {
		windowSetUserDataFunction.Invoke(inArgs[:], nil)
	}

	return
}

var windowShapeCombineRegionFunction *gi.Function
var windowShapeCombineRegionFunction_Once sync.Once

func windowShapeCombineRegionFunction_Set() error {
	var err error
	windowShapeCombineRegionFunction_Once.Do(func() {
		err = windowObject_Set()
		if err != nil {
			return
		}
		windowShapeCombineRegionFunction, err = windowObject.InvokerNew("shape_combine_region")
	})
	return err
}

// ShapeCombineRegion is a representation of the C type gdk_window_shape_combine_region.
func (recv *Window) ShapeCombineRegion(shapeRegion *cairo.Region, offsetX int32, offsetY int32) {
	...
	err := windowShapeCombineRegionFunction_Set()
	if err == nil {
		windowShapeCombineRegionFunction.Invoke(inArgs[:], nil)
	}
