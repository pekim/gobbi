...
// Blacklisted : gdk_get_display_arg_name

// Blacklisted : gdk_notify_startup_complete

// Blacklisted : gdk_pango_context_get_for_screen

// Blacklisted : gdk_parse_args

// Blacklisted : gdk_selection_owner_get_for_display

// Blacklisted : gdk_selection_owner_set_for_display

// Blacklisted : gdk_selection_send_notify_for_display
