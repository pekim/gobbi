...
func (recv *WindowAttr) FieldWclass() WindowWindowClass {
	var nilValue WindowWindowClass
	err := windowAttrStruct_Set()
	if err != nil {
		return nilValue
	}
