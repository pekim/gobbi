...
// Blacklisted : GSocketClient

// Blacklisted : GSocketConnection

// Blacklisted : GSocketListener

// Blacklisted : GSocketService

// Blacklisted : GTcpConnection

// Blacklisted : GThreadedSocketService
