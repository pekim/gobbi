...
// Equals compares this AppInfoMonitor with another AppInfoMonitor, and returns true if they represent the same Object.
...
// Equals compares this Application with another Application, and returns true if they represent the same Object.
...
// Equals compares this ApplicationCommandLine with another ApplicationCommandLine, and returns true if they represent the same Object.
...
// Equals compares this BufferedInputStream with another BufferedInputStream, and returns true if they represent the same Object.
...
// Equals compares this BufferedOutputStream with another BufferedOutputStream, and returns true if they represent the same Object.
...
// Equals compares this BytesIcon with another BytesIcon, and returns true if they represent the same Object.
...
// Equals compares this Cancellable with another Cancellable, and returns true if they represent the same Object.
...
// Equals compares this CharsetConverter with another CharsetConverter, and returns true if they represent the same Object.
...
// Equals compares this ConverterInputStream with another ConverterInputStream, and returns true if they represent the same Object.
...
// Equals compares this ConverterOutputStream with another ConverterOutputStream, and returns true if they represent the same Object.
...
// Equals compares this Credentials with another Credentials, and returns true if they represent the same Object.
...
// Equals compares this DBusActionGroup with another DBusActionGroup, and returns true if they represent the same Object.
...
// Equals compares this DBusAuthObserver with another DBusAuthObserver, and returns true if they represent the same Object.
...
// Equals compares this DBusConnection with another DBusConnection, and returns true if they represent the same Object.
...
func (recv *DBusConnection) ConnectClosed(handler func(instance *DBusConnection, remotePeerVanished bool, error *glib.Error)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := DBusConnectionNewFromNative(objectInstance.GetObject().Native())
...
// Equals compares this DBusInterfaceSkeleton with another DBusInterfaceSkeleton, and returns true if they represent the same Object.
...
// Equals compares this DBusMenuModel with another DBusMenuModel, and returns true if they represent the same Object.
...
// Equals compares this DBusMessage with another DBusMessage, and returns true if they represent the same Object.
...
// Equals compares this DBusMethodInvocation with another DBusMethodInvocation, and returns true if they represent the same Object.
...
// Equals compares this DBusObjectManagerClient with another DBusObjectManagerClient, and returns true if they represent the same Object.
...
func (recv *DBusObjectManagerClient) ConnectInterfaceProxySignal(handler func(instance *DBusObjectManagerClient, objectProxy *DBusObjectProxy, interfaceProxy *DBusProxy, senderName string, signalName string, parameters *glib.Variant)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := DBusObjectManagerClientNewFromNative(objectInstance.GetObject().Native())

		object1 := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[1]))
		arg1 := DBusObjectProxyNewFromNative(object1.GetObject().Native())

		object2 := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[2]))
		arg2 := DBusProxyNewFromNative(object2.GetObject().Native())
...
// Equals compares this DBusObjectManagerServer with another DBusObjectManagerServer, and returns true if they represent the same Object.
...
// Equals compares this DBusObjectProxy with another DBusObjectProxy, and returns true if they represent the same Object.
...
// Equals compares this DBusObjectSkeleton with another DBusObjectSkeleton, and returns true if they represent the same Object.
...
// Equals compares this DBusProxy with another DBusProxy, and returns true if they represent the same Object.
...
func (recv *DBusProxy) ConnectGSignal(handler func(instance *DBusProxy, senderName string, signalName string, parameters *glib.Variant)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := DBusProxyNewFromNative(objectInstance.GetObject().Native())
...
// Equals compares this DBusServer with another DBusServer, and returns true if they represent the same Object.
...
// Equals compares this DataInputStream with another DataInputStream, and returns true if they represent the same Object.
...
// Equals compares this DataOutputStream with another DataOutputStream, and returns true if they represent the same Object.
...
// Equals compares this DesktopAppInfo with another DesktopAppInfo, and returns true if they represent the same Object.
...
// Equals compares this Emblem with another Emblem, and returns true if they represent the same Object.
...
// Equals compares this EmblemedIcon with another EmblemedIcon, and returns true if they represent the same Object.
...
// Equals compares this FileEnumerator with another FileEnumerator, and returns true if they represent the same Object.
...
// Equals compares this FileIOStream with another FileIOStream, and returns true if they represent the same Object.
...
// Equals compares this FileIcon with another FileIcon, and returns true if they represent the same Object.
...
// Equals compares this FileInfo with another FileInfo, and returns true if they represent the same Object.
...
// Equals compares this FileInputStream with another FileInputStream, and returns true if they represent the same Object.
...
// Equals compares this FileMonitor with another FileMonitor, and returns true if they represent the same Object.
...
// Equals compares this FileOutputStream with another FileOutputStream, and returns true if they represent the same Object.
...
// Equals compares this FilenameCompleter with another FilenameCompleter, and returns true if they represent the same Object.
...
// Equals compares this FilterInputStream with another FilterInputStream, and returns true if they represent the same Object.
...
// Equals compares this FilterOutputStream with another FilterOutputStream, and returns true if they represent the same Object.
...
// Equals compares this IOModule with another IOModule, and returns true if they represent the same Object.
...
// Equals compares this IOStream with another IOStream, and returns true if they represent the same Object.
...
// Equals compares this InetAddress with another InetAddress, and returns true if they represent the same Object.
...
// Equals compares this InetAddressMask with another InetAddressMask, and returns true if they represent the same Object.
...
// Equals compares this InetSocketAddress with another InetSocketAddress, and returns true if they represent the same Object.
...
// Equals compares this InputStream with another InputStream, and returns true if they represent the same Object.
...
// Equals compares this ListStore with another ListStore, and returns true if they represent the same Object.
...
// Equals compares this MemoryInputStream with another MemoryInputStream, and returns true if they represent the same Object.
...
// Equals compares this MemoryOutputStream with another MemoryOutputStream, and returns true if they represent the same Object.
...
// Equals compares this Menu with another Menu, and returns true if they represent the same Object.
...
// Equals compares this MenuAttributeIter with another MenuAttributeIter, and returns true if they represent the same Object.
...
// Equals compares this MenuItem with another MenuItem, and returns true if they represent the same Object.
...
// Equals compares this MenuLinkIter with another MenuLinkIter, and returns true if they represent the same Object.
...
// Equals compares this MenuModel with another MenuModel, and returns true if they represent the same Object.
...
func (recv *MenuModel) ConnectItemsChanged(handler func(instance *MenuModel, position int32, removed int32, added int32)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := MenuModelNewFromNative(objectInstance.GetObject().Native())
...
// Equals compares this MountOperation with another MountOperation, and returns true if they represent the same Object.
...
// Equals compares this NativeSocketAddress with another NativeSocketAddress, and returns true if they represent the same Object.
...
// Equals compares this NativeVolumeMonitor with another NativeVolumeMonitor, and returns true if they represent the same Object.
...
// Equals compares this NetworkAddress with another NetworkAddress, and returns true if they represent the same Object.
...
// Equals compares this NetworkService with another NetworkService, and returns true if they represent the same Object.
...
// Equals compares this OutputStream with another OutputStream, and returns true if they represent the same Object.
...
// Equals compares this Permission with another Permission, and returns true if they represent the same Object.
...
// Equals compares this PropertyAction with another PropertyAction, and returns true if they represent the same Object.
...
// Equals compares this ProxyAddress with another ProxyAddress, and returns true if they represent the same Object.
...
func ProxyAddressEnumeratorNewFromNative(native unsafe.Pointer) *ProxyAddressEnumerator {
	err := proxyAddressEnumeratorObject_Set()
	if err != nil {
		return nil
	}
...
// Equals compares this ProxyAddressEnumerator with another ProxyAddressEnumerator, and returns true if they represent the same Object.
...
// Equals compares this Resolver with another Resolver, and returns true if they represent the same Object.
...
// Equals compares this SettingsBackend with another SettingsBackend, and returns true if they represent the same Object.
...
// Equals compares this SimpleAction with another SimpleAction, and returns true if they represent the same Object.
...
// Equals compares this SimpleActionGroup with another SimpleActionGroup, and returns true if they represent the same Object.
...
// Equals compares this SimpleAsyncResult with another SimpleAsyncResult, and returns true if they represent the same Object.
...
// Equals compares this SimpleIOStream with another SimpleIOStream, and returns true if they represent the same Object.
...
// Equals compares this SimplePermission with another SimplePermission, and returns true if they represent the same Object.
...
// Equals compares this SimpleProxyResolver with another SimpleProxyResolver, and returns true if they represent the same Object.
...
// Equals compares this SocketAddress with another SocketAddress, and returns true if they represent the same Object.
...
// Equals compares this SocketAddressEnumerator with another SocketAddressEnumerator, and returns true if they represent the same Object.
...
// Equals compares this SocketClient with another SocketClient, and returns true if they represent the same Object.
...
// Equals compares this SocketConnection with another SocketConnection, and returns true if they represent the same Object.
...
// Equals compares this SocketControlMessage with another SocketControlMessage, and returns true if they represent the same Object.
...
// Equals compares this SocketListener with another SocketListener, and returns true if they represent the same Object.
...
func (recv *SocketListener) ConnectEvent(handler func(instance *SocketListener, event SocketListenerEvent, socket *Socket)) int {
	marshal := func(returnValue *callback.Value, paramValues []callback.Value) {
		objectInstance := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[0]))
		argInstance := SocketListenerNewFromNative(objectInstance.GetObject().Native())

		object1 := gobject.ValueNewFromNative(unsafe.Pointer(&paramValues[1]))
		arg1 := (SocketListenerEvent)(object1.GetInt())
...
// Equals compares this SocketService with another SocketService, and returns true if they represent the same Object.
...
// Equals compares this Subprocess with another Subprocess, and returns true if they represent the same Object.
...
// Equals compares this SubprocessLauncher with another SubprocessLauncher, and returns true if they represent the same Object.
...
// Equals compares this Task with another Task, and returns true if they represent the same Object.
...
// Equals compares this TcpConnection with another TcpConnection, and returns true if they represent the same Object.
...
// Equals compares this TcpWrapperConnection with another TcpWrapperConnection, and returns true if they represent the same Object.
...
// Equals compares this TestDBus with another TestDBus, and returns true if they represent the same Object.
...
// Equals compares this ThemedIcon with another ThemedIcon, and returns true if they represent the same Object.
...
// Equals compares this ThreadedSocketService with another ThreadedSocketService, and returns true if they represent the same Object.
...
// Equals compares this TlsCertificate with another TlsCertificate, and returns true if they represent the same Object.
...
// Equals compares this TlsConnection with another TlsConnection, and returns true if they represent the same Object.
...
// Equals compares this TlsDatabase with another TlsDatabase, and returns true if they represent the same Object.
...
// Equals compares this TlsInteraction with another TlsInteraction, and returns true if they represent the same Object.
...
// Equals compares this TlsPassword with another TlsPassword, and returns true if they represent the same Object.
...
// Equals compares this UnixConnection with another UnixConnection, and returns true if they represent the same Object.
...
// Equals compares this UnixCredentialsMessage with another UnixCredentialsMessage, and returns true if they represent the same Object.
...
// Equals compares this UnixFDList with another UnixFDList, and returns true if they represent the same Object.
...
// Equals compares this UnixFDMessage with another UnixFDMessage, and returns true if they represent the same Object.
...
// Equals compares this UnixInputStream with another UnixInputStream, and returns true if they represent the same Object.
...
// Equals compares this UnixMountMonitor with another UnixMountMonitor, and returns true if they represent the same Object.
...
// Equals compares this UnixOutputStream with another UnixOutputStream, and returns true if they represent the same Object.
...
// Equals compares this UnixSocketAddress with another UnixSocketAddress, and returns true if they represent the same Object.
...
// Equals compares this Vfs with another Vfs, and returns true if they represent the same Object.
...
// Equals compares this VolumeMonitor with another VolumeMonitor, and returns true if they represent the same Object.
...
// Equals compares this ZlibCompressor with another ZlibCompressor, and returns true if they represent the same Object.
...
// Equals compares this ZlibDecompressor with another ZlibDecompressor, and returns true if they represent the same Object.
