...
// Blacklisted : GPollableInputStream

// Blacklisted : GPollableOutputStream

// Blacklisted : GTlsBackend

// Blacklisted : GTlsClientConnection

// Blacklisted : GTlsServerConnection
