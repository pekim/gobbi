...
func Fn_g_content_type_is_mime_type(type_ string, mimeType string) {
	sys_type_ := string(type_)
	sys_mimeType := string(mimeType)
}
...
func Fn_g_unix_is_system_device_path(devicePath string) {
	sys_devicePath := string(devicePath)
}

func Fn_g_unix_is_system_fs_type(fsType string) {
...
func Fn_g_unix_mount_copy(mountEntry *UnixMountEntry) {
	sys_mountEntry := unsafe.Pointer(mountEntry)
}

func Fn_g_unix_mount_for(filePath string) {
...
func Fn_g_unix_mount_get_options(mountEntry *UnixMountEntry) {
	sys_mountEntry := unsafe.Pointer(mountEntry)
}

func Fn_g_unix_mount_get_root_path(mountEntry *UnixMountEntry) {
	sys_mountEntry := unsafe.Pointer(mountEntry)
}
