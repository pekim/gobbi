...
// Unsupported : g_byte_array_free_to_bytes : return type :

// Unsupported : g_byte_array_new_take : array return type :

// Unsupported : g_environ_getenv : return type :

// Unsupported : g_environ_setenv : array return type :

// Unsupported : g_environ_unsetenv : array return type :
...
// Unsupported : g_main_context_ref_thread_default : return type :
