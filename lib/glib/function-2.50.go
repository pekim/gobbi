...
// Unsupported : g_compute_hmac_for_bytes : unsupported parameter digest_type : type ChecksumType, GChecksumType

// Unsupported : g_log_set_writer_func : unsupported parameter func : type LogWriterFunc, GLogWriterFunc

// Unsupported : g_log_structured : unsupported parameter log_level : type LogLevelFlags, GLogLevelFlags

// Unsupported : g_log_structured_array : unsupported parameter log_level : type LogLevelFlags, GLogLevelFlags

// Unsupported : g_log_variant : unsupported parameter log_level : type LogLevelFlags, GLogLevelFlags

// Unsupported : g_log_writer_default : unsupported parameter log_level : type LogLevelFlags, GLogLevelFlags
