...
// Unsupported : g_datalist_get_flags : unsupported parameter datalist : record param - coming soon

// Unsupported : g_datalist_set_flags : unsupported parameter datalist : record param - coming soon

// Unsupported : g_datalist_unset_flags : unsupported parameter datalist : record param - coming soon
