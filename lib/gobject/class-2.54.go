...
// Unsupported : g_object_getv : unsupported parameter names : no type generator for utf8 (gchar) for array param names

// Unsupported : g_object_setv : unsupported parameter names : no type generator for utf8 (gchar) for array param names
