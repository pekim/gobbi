...
// UNSUPPORTED : C value 'g_object_new_with_properties' : array parameter 'names'

// UNSUPPORTED : C value 'g_object_newv' : array parameter 'parameters'
...
// UNSUPPORTED : C value 'g_object_getv' : array parameter 'names'
...
// UNSUPPORTED : C value 'g_object_setv' : array parameter 'names'
