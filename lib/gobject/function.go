...
// UNSUPPORTED : C value 'g_cclosure_marshal_BOOLEAN__FLAGS' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_STRING__OBJECT_POINTER' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__BOOLEAN' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__BOXED' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__CHAR' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__DOUBLE' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__ENUM' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__FLAGS' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__FLOAT' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__INT' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__LONG' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__OBJECT' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__PARAM' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__POINTER' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__STRING' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__UCHAR' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__UINT' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__UINT_POINTER' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__ULONG' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__VARIANT' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_VOID__VOID' : parameter 'closure' of type 'Closure' not supported

// UNSUPPORTED : C value 'g_cclosure_marshal_generic' : parameter 'closure' of type 'Closure' not supported
...
// UNSUPPORTED : C value 'g_enum_get_value_by_name' : parameter 'enum_class' of type 'EnumClass' not supported
...
// UNSUPPORTED : C value 'g_flags_get_first_value' : parameter 'flags_class' of type 'FlagsClass' not supported

// UNSUPPORTED : C value 'g_flags_get_value_by_name' : parameter 'flags_class' of type 'FlagsClass' not supported
...
// UNSUPPORTED : C value 'g_signal_chain_from_overridden_handler' : parameter 'instance' of type 'TypeInstance' not supported
...
// UNSUPPORTED : C value 'g_signal_connect_object' : parameter 'instance' of type 'TypeInstance' not supported
...
// UNSUPPORTED : C value 'g_signal_emit_valist' : parameter 'instance' of type 'TypeInstance' not supported
...
// UNSUPPORTED : C value 'g_strdup_value_contents' : parameter 'value' of type 'Value' not supported
...
// UNSUPPORTED : C value 'g_type_check_class_cast' : parameter 'g_class' of type 'TypeClass' not supported

// UNSUPPORTED : C value 'g_type_check_class_is_a' : parameter 'g_class' of type 'TypeClass' not supported

// UNSUPPORTED : C value 'g_type_check_instance' : parameter 'instance' of type 'TypeInstance' not supported

// UNSUPPORTED : C value 'g_type_check_instance_cast' : parameter 'instance' of type 'TypeInstance' not supported

// UNSUPPORTED : C value 'g_type_check_instance_is_a' : parameter 'instance' of type 'TypeInstance' not supported

// UNSUPPORTED : C value 'g_type_check_instance_is_fundamentally_a' : parameter 'instance' of type 'TypeInstance' not supported

// UNSUPPORTED : C value 'g_type_check_is_value_type' : parameter 'type' of type 'GType' not supported

// UNSUPPORTED : C value 'g_type_check_value' : parameter 'value' of type 'Value' not supported

// UNSUPPORTED : C value 'g_type_check_value_holds' : parameter 'value' of type 'Value' not supported
...
// UNSUPPORTED : C value 'g_type_default_interface_unref' : parameter 'g_iface' of type 'TypeInterface' not supported
...
// UNSUPPORTED : C value 'g_type_interface_peek' : parameter 'instance_class' of type 'TypeClass' not supported
...
// UNSUPPORTED : C value 'g_type_name_from_class' : parameter 'g_class' of type 'TypeClass' not supported

// UNSUPPORTED : C value 'g_type_name_from_instance' : parameter 'instance' of type 'TypeInstance' not supported
