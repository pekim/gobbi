...
/*
	...
	static void _g_signal_chain_from_overridden_handler(gpointer instance) {
...
// SignalChainFromOverriddenHandler is a wrapper around the C function g_signal_chain_from_overridden_handler.
func SignalChainFromOverriddenHandler(instance *TypeInstance) {
	c_instance := (C.gpointer)(C.NULL)
	if instance != nil {
		c_instance = (C.gpointer)(instance.ToC())
	}

	C._g_signal_chain_from_overridden_handler(c_instance)
