...
// ClearSignalHandler wraps the C function g_clear_signal_handler.
//
// since 2.62
...
func EnumGetValue(enumClass *EnumClass, value int) *EnumValue {
	...
	return EnumValueNewFromC(retSys)
}
...
func FlagsGetFirstValue(flagsClass *FlagsClass, value uint) *FlagsValue {
	...
	return FlagsValueNewFromC(retSys)
}
...
func ParamSpecBoolean_(name string, nick string, blurb string, defaultValue bool, flags ParamFlags) *ParamSpec {
	...
	return ParamSpecNewFromC(retSys)
}
...
// SignalAccumulatorFirstWins wraps the C function g_signal_accumulator_first_wins.
//
// since 2.28
...
func SignalGetInvocationHint(instance unsafe.Pointer) *SignalInvocationHint {
	...
	return SignalInvocationHintNewFromC(retSys)
}
...
// TypeAddClassPrivate wraps the C function g_type_add_class_private.
//
// since 2.24
...
func TypeCheckClassCast(gClass *TypeClass, isAType uint64) *TypeClass {
	...
	return TypeClassNewFromC(retSys)
}
...
func TypeCheckInstanceCast(instance *TypeInstance, ifaceType uint64) *TypeInstance {
	...
	return TypeInstanceNewFromC(retSys)
}
...
func TypeDefaultInterfacePeek(gType uint64) *TypeInterface {
	...
	return TypeInterfaceNewFromC(retSys)
}
...
// TypeEnsure wraps the C function g_type_ensure.
//
// since 2.34
...
func TypeGetPlugin(type_ uint64) *TypePlugin {
	...
	return TypePluginNewFromC(retSys)
}
...
// TypeGetTypeRegistrationSerial wraps the C function g_type_get_type_registration_serial.
//
// since 2.36
