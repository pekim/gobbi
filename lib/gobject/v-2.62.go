...
func EnumToString(gEnumType uint64, value int) string {
	...
	sys_value := value
	ret := gobject.Fn_g_enum_to_string(sys_gEnumType, sys_value)
...
func FlagsToString(flagsType uint64, value uint) string {
	...
	sys_value := value
	ret := gobject.Fn_g_flags_to_string(sys_flagsType, sys_value)
...
func TypeGetInstanceCount(type_ uint64) int {
	sys_type_ := type_
	ret := gobject.Fn_g_type_get_instance_count(sys_type_)
...
func TypeGetTypeRegistrationSerial() uint {
	ret := gobject.Fn_g_type_get_type_registration_serial()
