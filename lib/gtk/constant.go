...
// UNSUPPORTED : C value 'STOCK_ADD' : missing Type

// UNSUPPORTED : C value 'STOCK_APPLY' : missing Type

// UNSUPPORTED : C value 'STOCK_BOLD' : missing Type

// UNSUPPORTED : C value 'STOCK_CANCEL' : missing Type

// UNSUPPORTED : C value 'STOCK_CAPS_LOCK_WARNING' : missing Type

// UNSUPPORTED : C value 'STOCK_CDROM' : missing Type

// UNSUPPORTED : C value 'STOCK_CLEAR' : missing Type

// UNSUPPORTED : C value 'STOCK_CLOSE' : missing Type

// UNSUPPORTED : C value 'STOCK_COLOR_PICKER' : missing Type

// UNSUPPORTED : C value 'STOCK_CONVERT' : missing Type

// UNSUPPORTED : C value 'STOCK_CONNECT' : missing Type

// UNSUPPORTED : C value 'STOCK_COPY' : missing Type

// UNSUPPORTED : C value 'STOCK_CUT' : missing Type

// UNSUPPORTED : C value 'STOCK_DELETE' : missing Type

// UNSUPPORTED : C value 'STOCK_DIALOG_AUTHENTICATION' : missing Type

// UNSUPPORTED : C value 'STOCK_DIALOG_ERROR' : missing Type

// UNSUPPORTED : C value 'STOCK_DIALOG_INFO' : missing Type

// UNSUPPORTED : C value 'STOCK_DIALOG_QUESTION' : missing Type

// UNSUPPORTED : C value 'STOCK_DIALOG_WARNING' : missing Type

// UNSUPPORTED : C value 'STOCK_DIRECTORY' : missing Type

// UNSUPPORTED : C value 'STOCK_DISCARD' : missing Type

// UNSUPPORTED : C value 'STOCK_DISCONNECT' : missing Type

// UNSUPPORTED : C value 'STOCK_DND' : missing Type

// UNSUPPORTED : C value 'STOCK_DND_MULTIPLE' : missing Type

// UNSUPPORTED : C value 'STOCK_EDIT' : missing Type

// UNSUPPORTED : C value 'STOCK_EXECUTE' : missing Type

// UNSUPPORTED : C value 'STOCK_FILE' : missing Type

// UNSUPPORTED : C value 'STOCK_FIND' : missing Type

// UNSUPPORTED : C value 'STOCK_FIND_AND_REPLACE' : missing Type

// UNSUPPORTED : C value 'STOCK_FLOPPY' : missing Type

// UNSUPPORTED : C value 'STOCK_FULLSCREEN' : missing Type

// UNSUPPORTED : C value 'STOCK_GOTO_BOTTOM' : missing Type

// UNSUPPORTED : C value 'STOCK_GOTO_FIRST' : missing Type

// UNSUPPORTED : C value 'STOCK_GOTO_LAST' : missing Type

// UNSUPPORTED : C value 'STOCK_GOTO_TOP' : missing Type

// UNSUPPORTED : C value 'STOCK_GO_BACK' : missing Type

// UNSUPPORTED : C value 'STOCK_GO_DOWN' : missing Type

// UNSUPPORTED : C value 'STOCK_GO_FORWARD' : missing Type

// UNSUPPORTED : C value 'STOCK_GO_UP' : missing Type

// UNSUPPORTED : C value 'STOCK_HARDDISK' : missing Type

// UNSUPPORTED : C value 'STOCK_HELP' : missing Type

// UNSUPPORTED : C value 'STOCK_HOME' : missing Type

// UNSUPPORTED : C value 'STOCK_INDENT' : missing Type

// UNSUPPORTED : C value 'STOCK_INDEX' : missing Type

// UNSUPPORTED : C value 'STOCK_INFO' : missing Type

// UNSUPPORTED : C value 'STOCK_ITALIC' : missing Type

// UNSUPPORTED : C value 'STOCK_JUMP_TO' : missing Type

// UNSUPPORTED : C value 'STOCK_JUSTIFY_CENTER' : missing Type

// UNSUPPORTED : C value 'STOCK_JUSTIFY_FILL' : missing Type

// UNSUPPORTED : C value 'STOCK_JUSTIFY_LEFT' : missing Type

// UNSUPPORTED : C value 'STOCK_JUSTIFY_RIGHT' : missing Type

// UNSUPPORTED : C value 'STOCK_LEAVE_FULLSCREEN' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_FORWARD' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_NEXT' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_PAUSE' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_PLAY' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_PREVIOUS' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_RECORD' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_REWIND' : missing Type

// UNSUPPORTED : C value 'STOCK_MEDIA_STOP' : missing Type

// UNSUPPORTED : C value 'STOCK_MISSING_IMAGE' : missing Type

// UNSUPPORTED : C value 'STOCK_NETWORK' : missing Type

// UNSUPPORTED : C value 'STOCK_NEW' : missing Type

// UNSUPPORTED : C value 'STOCK_NO' : missing Type

// UNSUPPORTED : C value 'STOCK_OK' : missing Type

// UNSUPPORTED : C value 'STOCK_OPEN' : missing Type

// UNSUPPORTED : C value 'STOCK_ORIENTATION_LANDSCAPE' : missing Type

// UNSUPPORTED : C value 'STOCK_ORIENTATION_PORTRAIT' : missing Type

// UNSUPPORTED : C value 'STOCK_ORIENTATION_REVERSE_LANDSCAPE' : missing Type

// UNSUPPORTED : C value 'STOCK_ORIENTATION_REVERSE_PORTRAIT' : missing Type

// UNSUPPORTED : C value 'STOCK_PAGE_SETUP' : missing Type

// UNSUPPORTED : C value 'STOCK_PASTE' : missing Type

// UNSUPPORTED : C value 'STOCK_PREFERENCES' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT_ERROR' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT_PAUSED' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT_PREVIEW' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT_REPORT' : missing Type

// UNSUPPORTED : C value 'STOCK_PRINT_WARNING' : missing Type

// UNSUPPORTED : C value 'STOCK_PROPERTIES' : missing Type

// UNSUPPORTED : C value 'STOCK_QUIT' : missing Type

// UNSUPPORTED : C value 'STOCK_REDO' : missing Type

// UNSUPPORTED : C value 'STOCK_REFRESH' : missing Type

// UNSUPPORTED : C value 'STOCK_REMOVE' : missing Type

// UNSUPPORTED : C value 'STOCK_REVERT_TO_SAVED' : missing Type

// UNSUPPORTED : C value 'STOCK_SAVE' : missing Type

// UNSUPPORTED : C value 'STOCK_SAVE_AS' : missing Type

// UNSUPPORTED : C value 'STOCK_SELECT_ALL' : missing Type

// UNSUPPORTED : C value 'STOCK_SELECT_COLOR' : missing Type

// UNSUPPORTED : C value 'STOCK_SELECT_FONT' : missing Type

// UNSUPPORTED : C value 'STOCK_SORT_ASCENDING' : missing Type

// UNSUPPORTED : C value 'STOCK_SORT_DESCENDING' : missing Type

// UNSUPPORTED : C value 'STOCK_SPELL_CHECK' : missing Type

// UNSUPPORTED : C value 'STOCK_STOP' : missing Type

// UNSUPPORTED : C value 'STOCK_STRIKETHROUGH' : missing Type

// UNSUPPORTED : C value 'STOCK_UNDELETE' : missing Type

// UNSUPPORTED : C value 'STOCK_UNDERLINE' : missing Type

// UNSUPPORTED : C value 'STOCK_UNDO' : missing Type

// UNSUPPORTED : C value 'STOCK_UNINDENT' : missing Type

// UNSUPPORTED : C value 'STOCK_YES' : missing Type

// UNSUPPORTED : C value 'STOCK_ZOOM_100' : missing Type

// UNSUPPORTED : C value 'STOCK_ZOOM_FIT' : missing Type

// UNSUPPORTED : C value 'STOCK_ZOOM_IN' : missing Type

// UNSUPPORTED : C value 'STOCK_ZOOM_OUT' : missing Type
