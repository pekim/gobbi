...
// Unsupported : gtk_invisible_new_for_screen : return type :

// Blacklisted : STOCK_COLOR_PICKER

// Unsupported : gtk_icon_size_lookup_for_settings : return type :

// Unsupported : gtk_selection_owner_set_for_display : return type :
