...
// Unsupported : gtk_container_class_install_child_properties : unsupported parameter pspecs : no type generator for GObject.ParamSpec (GParamSpec*) for array param pspecs
