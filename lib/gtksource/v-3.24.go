...
type SpaceLocationFlags C.GtkSourceSpaceLocationFlags

const (
	GTK_SOURCE_SPACE_LOCATION_NONE        SpaceLocationFlags = 0
	GTK_SOURCE_SPACE_LOCATION_LEADING     SpaceLocationFlags = 1
	GTK_SOURCE_SPACE_LOCATION_INSIDE_TEXT SpaceLocationFlags = 2
	GTK_SOURCE_SPACE_LOCATION_TRAILING    SpaceLocationFlags = 4
	GTK_SOURCE_SPACE_LOCATION_ALL         SpaceLocationFlags = 7
)

type SpaceTypeFlags C.GtkSourceSpaceTypeFlags

const (
	GTK_SOURCE_SPACE_TYPE_NONE    SpaceTypeFlags = 0
	GTK_SOURCE_SPACE_TYPE_SPACE   SpaceTypeFlags = 1
	GTK_SOURCE_SPACE_TYPE_TAB     SpaceTypeFlags = 2
	GTK_SOURCE_SPACE_TYPE_NEWLINE SpaceTypeFlags = 4
...
type BufferSignalBracketMatchedCallback func(iter *gtk.TextIter, state BracketMatchType)
...
func buffer_bracketMatchedHandler(_ *C.GObject, c_iter *C.GtkTextIter, c_state C.GtkSourceBracketMatchType, data C.gpointer) {
...
// CompletionItemNew2 is a wrapper around the C function gtk_source_completion_item_new2.
func CompletionItemNew2() *CompletionItem {
	retC := C.gtk_source_completion_item_new2()
	retGo := CompletionItemNewFromC(unsafe.Pointer(retC))

	return retGo
}

// SetGicon is a wrapper around the C function gtk_source_completion_item_set_gicon.
func (recv *CompletionItem) SetGicon(gicon *gio.Icon) {
	c_gicon := (*C.GIcon)(gicon.ToC())

	C.gtk_source_completion_item_set_gicon((*C.GtkSourceCompletionItem)(recv.native), c_gicon)

	return
}

// SetIcon is a wrapper around the C function gtk_source_completion_item_set_icon.
func (recv *CompletionItem) SetIcon(icon *gdkpixbuf.Pixbuf) {
	...
	C.gtk_source_completion_item_set_icon((*C.GtkSourceCompletionItem)(recv.native), c_icon)

	return
}

// SetIconName is a wrapper around the C function gtk_source_completion_item_set_icon_name.
func (recv *CompletionItem) SetIconName(iconName string) {
	c_icon_name := C.CString(iconName)
	defer C.free(unsafe.Pointer(c_icon_name))

	C.gtk_source_completion_item_set_icon_name((*C.GtkSourceCompletionItem)(recv.native), c_icon_name)

	return
}

// SetInfo is a wrapper around the C function gtk_source_completion_item_set_info.
func (recv *CompletionItem) SetInfo(info string) {
	c_info := C.CString(info)
	defer C.free(unsafe.Pointer(c_info))

	C.gtk_source_completion_item_set_info((*C.GtkSourceCompletionItem)(recv.native), c_info)

	return
}

// SetLabel is a wrapper around the C function gtk_source_completion_item_set_label.
func (recv *CompletionItem) SetLabel(label string) {
	c_label := C.CString(label)
	defer C.free(unsafe.Pointer(c_label))

	C.gtk_source_completion_item_set_label((*C.GtkSourceCompletionItem)(recv.native), c_label)

	return
}

// SetMarkup is a wrapper around the C function gtk_source_completion_item_set_markup.
func (recv *CompletionItem) SetMarkup(markup string) {
	c_markup := C.CString(markup)
	defer C.free(unsafe.Pointer(c_markup))

	C.gtk_source_completion_item_set_markup((*C.GtkSourceCompletionItem)(recv.native), c_markup)

	return
}

// SetText is a wrapper around the C function gtk_source_completion_item_set_text.
func (recv *CompletionItem) SetText(text string) {
	c_text := C.CString(text)
	defer C.free(unsafe.Pointer(c_text))

	C.gtk_source_completion_item_set_text((*C.GtkSourceCompletionItem)(recv.native), c_text)
...
// GetView is a wrapper around the C function gtk_source_gutter_get_view.
func (recv *Gutter) GetView() *View {
	retC := C.gtk_source_gutter_get_view((*C.GtkSourceGutter)(recv.native))
	retGo := ViewNewFromC(unsafe.Pointer(retC))
...
// GetWindowType is a wrapper around the C function gtk_source_gutter_get_window_type.
func (recv *Gutter) GetWindowType() gtk.TextWindowType {
	retC := C.gtk_source_gutter_get_window_type((*C.GtkSourceGutter)(recv.native))
...
func SpaceDrawerNewFromC(u unsafe.Pointer) *SpaceDrawer {
	c := (*C.GtkSourceSpaceDrawer)(u)
	if c == nil {
		return nil
	}

	g := &SpaceDrawer{native: c}
	...
	runtime.SetFinalizer(g, func(o *SpaceDrawer) {
		C.g_object_unref((C.gpointer)(o.native))
	})
...
func (recv *SpaceDrawer) ToC() unsafe.Pointer {

	return (unsafe.Pointer)(recv.native)
}

// Equals compares this SpaceDrawer with another SpaceDrawer, and returns true if they represent the same GObject.
...
// CastToWidget down casts any arbitrary Object to SpaceDrawer.
// Exercise care, as this is a potentially dangerous function if the Object is not a SpaceDrawer.
func CastToSpaceDrawer(object *gobject.Object) *SpaceDrawer {
	return SpaceDrawerNewFromC(object.ToC())
}

// SpaceDrawerNew is a wrapper around the C function gtk_source_space_drawer_new.
func SpaceDrawerNew() *SpaceDrawer {
	retC := C.gtk_source_space_drawer_new()
	retGo := SpaceDrawerNewFromC(unsafe.Pointer(retC))
...
// BindMatrixSetting is a wrapper around the C function gtk_source_space_drawer_bind_matrix_setting.
func (recv *SpaceDrawer) BindMatrixSetting(settings *gio.Settings, key string, flags gio.SettingsBindFlags) {
	c_settings := (*C.GSettings)(C.NULL)
	if settings != nil {
		c_settings = (*C.GSettings)(settings.ToC())
	}
	...
	C.gtk_source_space_drawer_bind_matrix_setting((*C.GtkSourceSpaceDrawer)(recv.native), c_settings, c_key, c_flags)

	return
}

// GetEnableMatrix is a wrapper around the C function gtk_source_space_drawer_get_enable_matrix.
func (recv *SpaceDrawer) GetEnableMatrix() bool {
	retC := C.gtk_source_space_drawer_get_enable_matrix((*C.GtkSourceSpaceDrawer)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetMatrix is a wrapper around the C function gtk_source_space_drawer_get_matrix.
func (recv *SpaceDrawer) GetMatrix() *glib.Variant {
	retC := C.gtk_source_space_drawer_get_matrix((*C.GtkSourceSpaceDrawer)(recv.native))
	retGo := glib.VariantNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetTypesForLocations is a wrapper around the C function gtk_source_space_drawer_get_types_for_locations.
func (recv *SpaceDrawer) GetTypesForLocations(locations SpaceLocationFlags) SpaceTypeFlags {
	c_locations := (C.GtkSourceSpaceLocationFlags)(locations)

	retC := C.gtk_source_space_drawer_get_types_for_locations((*C.GtkSourceSpaceDrawer)(recv.native), c_locations)
	retGo := (SpaceTypeFlags)(retC)

	return retGo
}

// SetEnableMatrix is a wrapper around the C function gtk_source_space_drawer_set_enable_matrix.
func (recv *SpaceDrawer) SetEnableMatrix(enableMatrix bool) {
	c_enable_matrix :=
		boolToGboolean(enableMatrix)

	C.gtk_source_space_drawer_set_enable_matrix((*C.GtkSourceSpaceDrawer)(recv.native), c_enable_matrix)

	return
}

// SetMatrix is a wrapper around the C function gtk_source_space_drawer_set_matrix.
func (recv *SpaceDrawer) SetMatrix(matrix *glib.Variant) {
	c_matrix := (*C.GVariant)(C.NULL)
	if matrix != nil {
		c_matrix = (*C.GVariant)(matrix.ToC())
	}

	C.gtk_source_space_drawer_set_matrix((*C.GtkSourceSpaceDrawer)(recv.native), c_matrix)

	return
}

// SetTypesForLocations is a wrapper around the C function gtk_source_space_drawer_set_types_for_locations.
func (recv *SpaceDrawer) SetTypesForLocations(locations SpaceLocationFlags, types SpaceTypeFlags) {
	c_locations := (C.GtkSourceSpaceLocationFlags)(locations)

	c_types := (C.GtkSourceSpaceTypeFlags)(types)

	C.gtk_source_space_drawer_set_types_for_locations((*C.GtkSourceSpaceDrawer)(recv.native), c_locations, c_types)
...
type ViewSignalChangeCaseCallback func(caseType ChangeCaseType)
...
func view_changeCaseHandler(_ *C.GObject, c_case_type C.GtkSourceChangeCaseType, data C.gpointer) {
...
type ViewSignalChangeNumberCallback func(count int32)
...
func view_changeNumberHandler(_ *C.GObject, c_count C.gint, data C.gpointer) {
...
type ViewSignalJoinLinesCallback func()
...
func view_joinLinesHandler(_ *C.GObject, data C.gpointer) {
...
type ViewSignalMoveLinesCallback func(copy bool, count int32)
...
func view_moveLinesHandler(_ *C.GObject, c_copy C.gboolean, c_count C.gint, data C.gpointer) {
...
type ViewSignalMoveToMatchingBracketCallback func(extendSelection bool)
...
func view_moveToMatchingBracketHandler(_ *C.GObject, c_extend_selection C.gboolean, data C.gpointer) {
...
type ViewSignalMoveWordsCallback func(count int32)
...
func view_moveWordsHandler(_ *C.GObject, c_count C.gint, data C.gpointer) {
...
type ViewSignalSmartHomeEndCallback func(iter *gtk.TextIter, count int32)
...
func view_smartHomeEndHandler(_ *C.GObject, c_iter *C.GtkTextIter, c_count C.gint, data C.gpointer) {
...
// GetSpaceDrawer is a wrapper around the C function gtk_source_view_get_space_drawer.
func (recv *View) GetSpaceDrawer() *SpaceDrawer {
	retC := C.gtk_source_view_get_space_drawer((*C.GtkSourceView)(recv.native))
	retGo := SpaceDrawerNewFromC(unsafe.Pointer(retC))
...
type UndoManagerSignalCanRedoChangedCallback func()
...
func undomanager_canRedoChangedHandler(_ *C.GObject, data C.gpointer) {
...
type UndoManagerSignalCanUndoChangedCallback func()
...
func undomanager_canUndoChangedHandler(_ *C.GObject, data C.gpointer) {
...
// SpaceDrawerClass is a wrapper around the C record GtkSourceSpaceDrawerClass.
...
func SpaceDrawerClassNewFromC(u unsafe.Pointer) *SpaceDrawerClass {
	c := (*C.GtkSourceSpaceDrawerClass)(u)
	if c == nil {
		return nil
	}

	g := &SpaceDrawerClass{native: c}

	return g
}

func (recv *SpaceDrawerClass) ToC() unsafe.Pointer {
