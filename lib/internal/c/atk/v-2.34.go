...
func Fn_atk_range_new(lowerLimit float64, upperLimit float64, description string) unsafe.Pointer {
	c_lowerLimit := (C.gdouble)(lowerLimit)

	c_upperLimit := (C.gdouble)(upperLimit)

	c_description := (*C.gchar)(C.CString(description))
	defer C.free(unsafe.Pointer(c_description))

	ret := C.atk_range_new(c_lowerLimit, c_upperLimit, c_description)

	return unsafe.Pointer(ret)
}

func Fn_atk_range_copy(src unsafe.Pointer) unsafe.Pointer {
	c_src := (*C.AtkRange)(unsafe.Pointer(src))

	ret := C.atk_range_copy(c_src)

	return unsafe.Pointer(ret)
}

func Fn_atk_range_free(range_ unsafe.Pointer) {
	c_range_ := (*C.AtkRange)(unsafe.Pointer(range_))

	C.atk_range_free(c_range_)
}

func Fn_atk_range_get_description(range_ unsafe.Pointer) string {
	c_range_ := (*C.AtkRange)(unsafe.Pointer(range_))

	ret := C.atk_range_get_description(c_range_)

	return C.GoString(ret)
}

func Fn_atk_range_get_lower_limit(range_ unsafe.Pointer) float64 {
	c_range_ := (*C.AtkRange)(unsafe.Pointer(range_))

	ret := C.atk_range_get_lower_limit(c_range_)

	return (float64)(ret)
}

func Fn_atk_range_get_upper_limit(range_ unsafe.Pointer) float64 {
	c_range_ := (*C.AtkRange)(unsafe.Pointer(range_))

	ret := C.atk_range_get_upper_limit(c_range_)
...
func Fn_atk_object_get_accessible_id(accessible unsafe.Pointer) string {
	c_accessible := (*C.AtkObject)(unsafe.Pointer(accessible))

	ret := C.atk_object_get_accessible_id(c_accessible)
...
func Fn_atk_object_set_accessible_id(accessible unsafe.Pointer, name string) {
	c_accessible := (*C.AtkObject)(unsafe.Pointer(accessible))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	C.atk_object_set_accessible_id(c_accessible, c_name)
}
...
func Fn_atk_component_scroll_to(component unsafe.Pointer, type_ int) bool {
	c_component := (*C.AtkComponent)(unsafe.Pointer(component))

	c_type_ := (C.AtkScrollType)(type_)

	ret := C.atk_component_scroll_to(c_component, c_type_)

	return toGoBool(ret)
}

func Fn_atk_component_scroll_to_point(component unsafe.Pointer, coords int, x int, y int) bool {
	c_component := (*C.AtkComponent)(unsafe.Pointer(component))
	...
	ret := C.atk_component_scroll_to_point(c_component, c_coords, c_x, c_y)
...
func Fn_atk_document_get_current_page_number(document unsafe.Pointer) int {
	c_document := (*C.AtkDocument)(unsafe.Pointer(document))

	ret := C.atk_document_get_current_page_number(c_document)
...
func Fn_atk_document_get_page_count(document unsafe.Pointer) int {
	c_document := (*C.AtkDocument)(unsafe.Pointer(document))

	ret := C.atk_document_get_page_count(c_document)
...
func Fn_atk_table_cell_get_column_span(cell unsafe.Pointer) int {
	c_cell := (*C.AtkTableCell)(unsafe.Pointer(cell))

	ret := C.atk_table_cell_get_column_span(c_cell)

	return (int)(ret)
}

func Fn_atk_table_cell_get_position(cell unsafe.Pointer, row *int, column *int) bool {
	c_cell := (*C.AtkTableCell)(unsafe.Pointer(cell))

	c_row := (*C.gint)(unsafe.Pointer(row))

	c_column := (*C.gint)(unsafe.Pointer(column))

	ret := C.atk_table_cell_get_position(c_cell, c_row, c_column)

	return toGoBool(ret)
}

func Fn_atk_table_cell_get_row_column_span(cell unsafe.Pointer, row *int, column *int, rowSpan *int, columnSpan *int) bool {
	c_cell := (*C.AtkTableCell)(unsafe.Pointer(cell))
	...
	c_rowSpan := (*C.gint)(unsafe.Pointer(rowSpan))

	c_columnSpan := (*C.gint)(unsafe.Pointer(columnSpan))

	ret := C.atk_table_cell_get_row_column_span(c_cell, c_row, c_column, c_rowSpan, c_columnSpan)
...
func Fn_atk_table_cell_get_row_span(cell unsafe.Pointer) int {
	c_cell := (*C.AtkTableCell)(unsafe.Pointer(cell))

	ret := C.atk_table_cell_get_row_span(c_cell)

	return (int)(ret)
}

func Fn_atk_table_cell_get_table(cell unsafe.Pointer) unsafe.Pointer {
	c_cell := (*C.AtkTableCell)(unsafe.Pointer(cell))

	ret := C.atk_table_cell_get_table(c_cell)
...
func Fn_atk_text_scroll_substring_to(text unsafe.Pointer, startOffset int, endOffset int, type_ int) bool {
	c_text := (*C.AtkText)(unsafe.Pointer(text))
	...
	ret := C.atk_text_scroll_substring_to(c_text, c_startOffset, c_endOffset, c_type_)

	return toGoBool(ret)
}

func Fn_atk_text_scroll_substring_to_point(text unsafe.Pointer, startOffset int, endOffset int, coords int, x int, y int) bool {
	c_text := (*C.AtkText)(unsafe.Pointer(text))
	...
	ret := C.atk_text_scroll_substring_to_point(c_text, c_startOffset, c_endOffset, c_coords, c_x, c_y)
...
func Fn_atk_value_get_increment(obj unsafe.Pointer) float64 {
	c_obj := (*C.AtkValue)(unsafe.Pointer(obj))

	ret := C.atk_value_get_increment(c_obj)
...
func Fn_atk_value_get_range(obj unsafe.Pointer) unsafe.Pointer {
	c_obj := (*C.AtkValue)(unsafe.Pointer(obj))

	ret := C.atk_value_get_range(c_obj)

	return unsafe.Pointer(ret)
}

func Fn_atk_value_get_sub_ranges(obj unsafe.Pointer) unsafe.Pointer {
	c_obj := (*C.AtkValue)(unsafe.Pointer(obj))

	ret := C.atk_value_get_sub_ranges(c_obj)
...
func Fn_atk_value_set_value(obj unsafe.Pointer, newValue float64) {
	c_obj := (*C.AtkValue)(unsafe.Pointer(obj))

	c_newValue := (C.gdouble)(newValue)

	C.atk_value_set_value(c_obj, c_newValue)
}
