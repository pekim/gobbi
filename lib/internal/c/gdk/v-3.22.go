...
func Fn_cairo_draw_from_gl(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 int, param3 int, param4 int, param5 int, param6 int, param7 int, param8 int) {
}

func Fn_cairo_get_clip_rectangle(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_cairo_get_drawing_context(param0 unsafe.Pointer) {}
...
func Fn_cairo_surface_create_from_pixbuf(param0 unsafe.Pointer, param1 int, param2 unsafe.Pointer) {}
...
func Fn_drag_begin_from_point(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 unsafe.Pointer, param3 int, param4 int) {
}

func Fn_drag_drop(param0 unsafe.Pointer, param1 uint32) {}

func Fn_drag_drop_done(param0 unsafe.Pointer, param1 bool) {}
...
func Fn_pango_context_get_for_display(param0 unsafe.Pointer) {}
...
func Fn_set_allowed_backends(param0 string) {}
