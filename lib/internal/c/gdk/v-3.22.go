...
func Fn_cairo_get_drawing_context(cr unsafe.Pointer) {}
...
func Fn_drag_begin_from_point(window unsafe.Pointer, device unsafe.Pointer, targets unsafe.Pointer, xRoot int, yRoot int) {
}

func Fn_drag_drop(context unsafe.Pointer, time uint32) {}

func Fn_drag_drop_done(context unsafe.Pointer, success bool) {}
...
func Fn_pango_context_get_for_display(display unsafe.Pointer) {}
