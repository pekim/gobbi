...
func Fn_gdk_pixbuf_save_to_streamv(paramInstance unsafe.Pointer, param0 unsafe.Pointer, param1 string, param2 []string, param3 []string, param4 unsafe.Pointer, error unsafe.Pointer) bool {
	cValueInstance := (*C.GdkPixbuf)(unsafe.Pointer(paramInstance))
	...
	ret := C.gdk_pixbuf_save_to_streamv(cValueInstance, cValue0, cValue1, cValue2, cValue3, cValue4, cError)
...
func Fn_gdk_pixbuf_init_modules(param0 string, error unsafe.Pointer) bool {
	cValue0 := (*C.char)(C.CString(param0))
	defer C.free(unsafe.Pointer(cValue0))

	cError := (**C.GError)(error)

	ret := C.gdk_pixbuf_init_modules(cValue0, cError)
...
func Fn_gdk_pixbuf_loader_write_bytes(paramInstance unsafe.Pointer, param0 unsafe.Pointer, error unsafe.Pointer) bool {
	cValueInstance := (*C.GdkPixbufLoader)(unsafe.Pointer(paramInstance))
	...
	ret := C.gdk_pixbuf_loader_write_bytes(cValueInstance, cValue0, cError)
