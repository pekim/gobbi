...
func Fn_g_app_info_launch_default_for_uri_finish(param0 unsafe.Pointer, error unsafe.Pointer) bool {
	cValue0 := (*C.GAsyncResult)(unsafe.Pointer(param0))

	cError := (**C.GError)(error)

	ret := C.g_app_info_launch_default_for_uri_finish(cValue0, cError)
...
func Fn_g_dtls_client_connection_new(param0 unsafe.Pointer, param1 unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	...
	ret := C.g_dtls_client_connection_new(cValue0, cValue1, cError)

	return unsafe.Pointer(ret)
}

func Fn_g_dtls_server_connection_new(param0 unsafe.Pointer, param1 unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	cValue0 := (*C.GDatagramBased)(unsafe.Pointer(param0))
	...
	ret := C.g_dtls_server_connection_new(cValue0, cValue1, cError)
...
func Fn_g_dbus_interface_get_object(paramInstance unsafe.Pointer) unsafe.Pointer {
	cValueInstance := (*C.GDBusInterface)(unsafe.Pointer(paramInstance))

	ret := C.g_dbus_interface_get_object(cValueInstance)
...
func Fn_g_list_model_get_item(paramInstance unsafe.Pointer, param0 uint) unsafe.Pointer {
	cValueInstance := (*C.GListModel)(unsafe.Pointer(paramInstance))

	cValue0 := (C.guint)(param0)

	ret := C.g_list_model_get_item(cValueInstance, cValue0)
