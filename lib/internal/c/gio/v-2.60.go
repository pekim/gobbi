...
func Fn_app_info_launch_default_for_uri_finish(result unsafe.Pointer) {}
...
func Fn_content_type_set_mime_dirs(dirs []string) {}
...
func Fn_dtls_client_connection_new(baseSocket unsafe.Pointer, serverIdentity unsafe.Pointer) {}

func Fn_dtls_server_connection_new(baseSocket unsafe.Pointer, certificate unsafe.Pointer) {}
...
func Fn_icon_deserialize(value unsafe.Pointer) {}
...
func Fn_unix_mount_copy(mountEntry unsafe.Pointer) {}

func Fn_unix_mount_for(filePath string, timeRead *uint64) {}
...
func Fn_unix_mount_get_options(mountEntry unsafe.Pointer) {}

func Fn_unix_mount_get_root_path(mountEntry unsafe.Pointer) {}
