...
func Fn_g_application_bind_busy_property(param0 *unsafe.Pointer, param1 string) {}
...
func Fn_g_application_get_is_busy() {}
...
func Fn_g_application_set_option_context_description(param0 string) {}

func Fn_g_application_set_option_context_parameter_string(param0 string) {}

func Fn_g_application_set_option_context_summary(param0 string) {}

func Fn_g_application_set_resource_base_path(param0 string) {}

func Fn_g_application_unbind_busy_property(param0 *unsafe.Pointer, param1 string) {}
...
func Fn_g_dbus_connection_get_flags() {}
...
func Fn_g_dbus_connection_register_object_with_closures(param0 string, param1 unsafe.Pointer, param2 unsafe.Pointer, param3 unsafe.Pointer, param4 unsafe.Pointer) {
}
...
func Fn_g_desktop_app_info_get_locale_string(param0 string) {}
...
func Fn_g_desktop_app_info_get_string_list(param0 string, param1 *uint64) {}
...
func Fn_g_file_enumerator_iterate(param0 *unsafe.Pointer, param1 *unsafe.Pointer, param2 unsafe.Pointer) {
}
...
func Fn_g_input_stream_read_all_finish(param0 unsafe.Pointer, param1 *uint64) {}
...
func Fn_g_list_store_append(param0 *unsafe.Pointer) {}

func Fn_g_list_store_insert(param0 uint, param1 *unsafe.Pointer) {}

// UNSUPPORTED : insert_sorted : has callback

func Fn_g_list_store_remove(param0 uint) {}

func Fn_g_list_store_remove_all() {}

// UNSUPPORTED : sort : has callback

func Fn_g_list_store_splice(param0 uint, param1 uint, param2 []unsafe.Pointer, param3 uint) {}
...
func Fn_g_mount_operation_get_is_tcrypt_hidden_volume() {}

func Fn_g_mount_operation_get_is_tcrypt_system_volume() {}

func Fn_g_mount_operation_get_password() {}

func Fn_g_mount_operation_get_password_save() {}

func Fn_g_mount_operation_get_pim() {}
...
func Fn_g_mount_operation_set_is_tcrypt_hidden_volume(param0 bool) {}

func Fn_g_mount_operation_set_is_tcrypt_system_volume(param0 bool) {}

func Fn_g_mount_operation_set_password(param0 string) {}

func Fn_g_mount_operation_set_password_save(param0 int) {}

func Fn_g_mount_operation_set_pim(param0 uint) {}
...
func Fn_g_output_stream_write_all_finish(param0 unsafe.Pointer, param1 *uint64) {}
...
func Fn_g_output_stream_writev(param0 []OutputVector, param1 uint64, param2 *uint64, param3 unsafe.Pointer) {
}

func Fn_g_output_stream_writev_all(param0 []OutputVector, param1 uint64, param2 *uint64, param3 unsafe.Pointer) {
}

// UNSUPPORTED : writev_all_async : has callback

func Fn_g_output_stream_writev_all_finish(param0 unsafe.Pointer, param1 *uint64) {}

// UNSUPPORTED : writev_async : has callback

func Fn_g_output_stream_writev_finish(param0 unsafe.Pointer, param1 *uint64) {}
...
func Fn_g_resolver_lookup_by_name_with_flags(param0 string, param1 int, param2 unsafe.Pointer) {}

// UNSUPPORTED : lookup_by_name_with_flags_async : has callback

func Fn_g_resolver_lookup_by_name_with_flags_finish(param0 unsafe.Pointer) {}
...
func Fn_g_settings_get_int64(param0 string) {}
...
func Fn_g_settings_get_uint64(param0 string) {}
...
func Fn_g_settings_set_int64(param0 string, param1 int64) {}
...
func Fn_g_settings_set_uint64(param0 string, param1 uint64) {}
...
func Fn_g_simple_action_set_state_hint(param0 unsafe.Pointer) {}
...
func Fn_g_socket_join_multicast_group_ssm(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 string) {
}

func Fn_g_socket_leave_multicast_group(param0 unsafe.Pointer, param1 bool, param2 string) {}

func Fn_g_socket_leave_multicast_group_ssm(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 string) {
}
...
func Fn_g_socket_receive_messages(param0 []InputMessage, param1 uint, param2 int, param3 unsafe.Pointer) {
}
...
func Fn_g_socket_send_message_with_timeout(param0 unsafe.Pointer, param1 []OutputVector, param2 int, param3 []unsafe.Pointer, param4 int, param5 int, param6 int64, param7 *uint64, param8 unsafe.Pointer) {
}

func Fn_g_socket_send_messages(param0 []OutputMessage, param1 uint, param2 int, param3 unsafe.Pointer) {
}
...
func Fn_g_task_get_completed() {}

func Fn_g_task_get_context() {}

func Fn_g_task_get_name() {}
...
func Fn_g_task_set_name(param0 string) {}
...
func Fn_g_tls_connection_get_negotiated_protocol() {}
...
func Fn_g_tls_connection_set_advertised_protocols(param0 []string) {}
...
func Fn_g_vfs_unregister_uri_scheme(param0 string) {}
