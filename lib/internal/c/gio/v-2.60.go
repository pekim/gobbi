...
func Fn_app_info_launch_default_for_uri_async(uri c.UndefinedParamType, context c.UndefinedParamType, cancellable c.UndefinedParamType, callback c.UndefinedParamType, userData unsafe.Pointer) {
}
...
func Fn_unix_mount_for(filePath c.UndefinedParamType, timeRead *uint64) {}
