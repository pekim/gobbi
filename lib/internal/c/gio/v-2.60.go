...
func Fn_app_info_launch_default_for_uri_finish(param0 unsafe.Pointer) {}
...
func Fn_content_type_is_mime_type(param0 string, param1 string) {}

func Fn_content_type_is_unknown(param0 string) {}

func Fn_content_type_set_mime_dirs(param0 []string) {}
...
func Fn_dtls_client_connection_new(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_dtls_server_connection_new(param0 unsafe.Pointer, param1 unsafe.Pointer) {}
...
func Fn_unix_is_system_device_path(param0 string) {}

func Fn_unix_is_system_fs_type(param0 string) {}

func Fn_unix_mount_at(param0 string, param1 *uint64) {}

func Fn_unix_mount_compare(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_unix_mount_copy(param0 unsafe.Pointer) {}

func Fn_unix_mount_for(param0 string, param1 *uint64) {}
...
func Fn_unix_mount_get_options(param0 unsafe.Pointer) {}

func Fn_unix_mount_get_root_path(param0 unsafe.Pointer) {}
