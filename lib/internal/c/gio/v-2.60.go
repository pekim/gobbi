...
func Fn_g_application_run(paramInstance unsafe.Pointer, param0 int, param1 []string) {
	...
	C.g_application_run(cValueInstance, cValue0, cValue1)
}
...
func Fn_g_output_stream_writev(paramInstance unsafe.Pointer, param0 []OutputVector, param1 uint64, param2 *uint64, param3 unsafe.Pointer, error unsafe.Pointer) {
	// has non-string array param
}

func Fn_g_output_stream_writev_all(paramInstance unsafe.Pointer, param0 []OutputVector, param1 uint64, param2 *uint64, param3 unsafe.Pointer, error unsafe.Pointer) {
	// has non-string array param
}

// UNSUPPORTED : writev_all_async : has callback

func Fn_g_output_stream_writev_all_finish(paramInstance unsafe.Pointer, param0 unsafe.Pointer, param1 *uint64, error unsafe.Pointer) {
	cValueInstance := (*C.GOutputStream)(unsafe.Pointer(paramInstance))
	cValue0 := (*C.GAsyncResult)(unsafe.Pointer(param0))
	cValue1 := (*C.gsize)(unsafe.Pointer(param1))
	cError := (**C.GError)(error)

	C.g_output_stream_writev_all_finish(cValueInstance, cValue0, cValue1, cError)
}

// UNSUPPORTED : writev_async : has callback

func Fn_g_output_stream_writev_finish(paramInstance unsafe.Pointer, param0 unsafe.Pointer, param1 *uint64, error unsafe.Pointer) {
	cValueInstance := (*C.GOutputStream)(unsafe.Pointer(paramInstance))
	cValue0 := (*C.GAsyncResult)(unsafe.Pointer(param0))
	cValue1 := (*C.gsize)(unsafe.Pointer(param1))
	cError := (**C.GError)(error)

	C.g_output_stream_writev_finish(cValueInstance, cValue0, cValue1, cError)
}
...
func Fn_g_resolver_lookup_by_name_with_flags(paramInstance unsafe.Pointer, param0 string, param1 int, param2 unsafe.Pointer, error unsafe.Pointer) {
	cValueInstance := (*C.GResolver)(unsafe.Pointer(paramInstance))
	cValue0 := (*C.gchar)(C.CString(param0))
	defer C.free(unsafe.Pointer(cValue0))
	...
	C.g_resolver_lookup_by_name_with_flags(cValueInstance, cValue0, cValue1, cValue2, cError)
}

// UNSUPPORTED : lookup_by_name_with_flags_async : has callback

func Fn_g_resolver_lookup_by_name_with_flags_finish(paramInstance unsafe.Pointer, param0 unsafe.Pointer, error unsafe.Pointer) {
	cValueInstance := (*C.GResolver)(unsafe.Pointer(paramInstance))
	cValue0 := (*C.GAsyncResult)(unsafe.Pointer(param0))
	cError := (**C.GError)(error)

	C.g_resolver_lookup_by_name_with_flags_finish(cValueInstance, cValue0, cError)
}
...
func Fn_g_settings_set_strv(paramInstance unsafe.Pointer, param0 string, param1 []string) {
	...
	C.g_settings_set_strv(cValueInstance, cValue0, cValue1)
}
...
func Fn_g_socket_receive_messages(paramInstance unsafe.Pointer, param0 []InputMessage, param1 uint, param2 int, param3 unsafe.Pointer, error unsafe.Pointer) {
	// has non-string array param
}
...
func Fn_g_socket_send_message_with_timeout(paramInstance unsafe.Pointer, param0 unsafe.Pointer, param1 []OutputVector, param2 int, param3 []unsafe.Pointer, param4 int, param5 int, param6 int64, param7 *uint64, param8 unsafe.Pointer, error unsafe.Pointer) {
	// has non-string array param
}

func Fn_g_socket_send_messages(paramInstance unsafe.Pointer, param0 []OutputMessage, param1 uint, param2 int, param3 unsafe.Pointer, error unsafe.Pointer) {
	// has non-string array param
}
