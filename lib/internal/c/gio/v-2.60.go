...
func Fn_app_info_get_fallback_for_type(contentType c.UndefinedParamType) {}

func Fn_app_info_get_recommended_for_type(contentType c.UndefinedParamType) {}

func Fn_app_info_launch_default_for_uri(uri c.UndefinedParamType, context c.UndefinedParamType) {}

func Fn_app_info_launch_default_for_uri_async(uri c.UndefinedParamType, context c.UndefinedParamType, cancellable c.UndefinedParamType, callback c.UndefinedParamType, userData c.UndefinedParamType) {
}
...
func Fn_content_type_get_generic_icon_name(type_ c.UndefinedParamType) {}
...
func Fn_content_type_is_mime_type(type_ c.UndefinedParamType, mimeType c.UndefinedParamType) {}
...
func Fn_dbus_address_escape_value(string_ c.UndefinedParamType) {}
...
func Fn_file_new_for_commandline_arg_and_cwd(arg c.UndefinedParamType, cwd c.UndefinedParamType) {}
...
func Fn_io_modules_load_all_in_directory_with_scope(dirname c.UndefinedParamType, scope c.UndefinedParamType) {
}

func Fn_io_modules_scan_all_in_directory(dirname c.UndefinedParamType) {}

func Fn_io_modules_scan_all_in_directory_with_scope(dirname c.UndefinedParamType, scope c.UndefinedParamType) {
}
...
func Fn_resource_load(filename c.UndefinedParamType) {}
...
func Fn_resources_open_stream(path c.UndefinedParamType, lookupFlags c.UndefinedParamType) {}
...
func Fn_tls_file_database_new(anchors c.UndefinedParamType) {}
...
func Fn_unix_is_system_device_path(devicePath c.UndefinedParamType) {}

func Fn_unix_is_system_fs_type(fsType c.UndefinedParamType) {}
...
func Fn_unix_mount_copy(mountEntry c.UndefinedParamType) {}

func Fn_unix_mount_for(filePath c.UndefinedParamType, timeRead c.UndefinedParamType) {}
...
func Fn_unix_mount_get_options(mountEntry c.UndefinedParamType) {}

func Fn_unix_mount_get_root_path(mountEntry c.UndefinedParamType) {}
