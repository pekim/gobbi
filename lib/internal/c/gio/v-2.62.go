...
func Fn_g_unix_mount_point_copy(mountPoint unsafe.Pointer) unsafe.Pointer {
	c_mountPoint := (*C.GUnixMountPoint)(unsafe.Pointer(mountPoint))

	ret := C.g_unix_mount_point_copy(c_mountPoint)
...
func Fn_g_content_type_set_mime_dirs(dirs []string) {
	dirsLen := len(dirs)
	c_dirsArray := C.malloc((C.ulong)(dirsLen) * C.sizeof_gpointer)
	defer C.free(unsafe.Pointer(c_dirsArray))
	dirsSlice := (*[1 << 30](*C.gchar))(unsafe.Pointer(c_dirsArray))[:dirsLen:dirsLen]
	for dirsi, dirsString := range dirs {
		dirsSlice[dirsi] = (*C.gchar)(C.CString(dirsString))
		defer C.free(unsafe.Pointer(dirsSlice[dirsi]))
	}
	c_dirs := &dirsSlice[0]

	C.g_content_type_set_mime_dirs(c_dirs)
}
...
func Fn_g_unix_is_system_device_path(devicePath string) bool {
	c_devicePath := (*C.char)(C.CString(devicePath))
	defer C.free(unsafe.Pointer(c_devicePath))

	ret := C.g_unix_is_system_device_path(c_devicePath)

	return toGoBool(ret)
}

func Fn_g_unix_is_system_fs_type(fsType string) bool {
	c_fsType := (*C.char)(C.CString(fsType))
	defer C.free(unsafe.Pointer(c_fsType))

	ret := C.g_unix_is_system_fs_type(c_fsType)
...
func Fn_g_unix_mount_copy(mountEntry unsafe.Pointer) unsafe.Pointer {
	c_mountEntry := (*C.GUnixMountEntry)(unsafe.Pointer(mountEntry))

	ret := C.g_unix_mount_copy(c_mountEntry)
...
func Fn_g_unix_mount_get_options(mountEntry unsafe.Pointer) string {
	c_mountEntry := (*C.GUnixMountEntry)(unsafe.Pointer(mountEntry))

	ret := C.g_unix_mount_get_options(c_mountEntry)

	return C.GoString(ret)
}

func Fn_g_unix_mount_get_root_path(mountEntry unsafe.Pointer) string {
	c_mountEntry := (*C.GUnixMountEntry)(unsafe.Pointer(mountEntry))

	ret := C.g_unix_mount_get_root_path(c_mountEntry)
...
func Fn_g_application_set_option_context_description(application unsafe.Pointer, description *string) {
	c_application := (*C.GApplication)(unsafe.Pointer(application))

	var c_descriptionValue (*C.gchar)
	if description != nil {
		c_descriptionValue = (*C.gchar)(C.CString(*description))
		defer C.free(unsafe.Pointer(c_descriptionValue))
	}
	c_description := c_descriptionValue

	C.g_application_set_option_context_description(c_application, c_description)
}

func Fn_g_application_set_option_context_parameter_string(application unsafe.Pointer, parameterString *string) {
	c_application := (*C.GApplication)(unsafe.Pointer(application))
	...
	C.g_application_set_option_context_parameter_string(c_application, c_parameterString)
}

func Fn_g_application_set_option_context_summary(application unsafe.Pointer, summary *string) {
	c_application := (*C.GApplication)(unsafe.Pointer(application))

	var c_summaryValue (*C.gchar)
	if summary != nil {
		c_summaryValue = (*C.gchar)(C.CString(*summary))
		defer C.free(unsafe.Pointer(c_summaryValue))
	}
	c_summary := c_summaryValue

	C.g_application_set_option_context_summary(c_application, c_summary)
}
...
func Fn_g_dbus_connection_get_flags(connection unsafe.Pointer) int {
	c_connection := (*C.GDBusConnection)(unsafe.Pointer(connection))

	ret := C.g_dbus_connection_get_flags(c_connection)
...
func Fn_g_desktop_app_info_get_locale_string(info unsafe.Pointer, key string) string {
	c_info := (*C.GDesktopAppInfo)(unsafe.Pointer(info))

	c_key := (*C.char)(C.CString(key))
	defer C.free(unsafe.Pointer(c_key))

	ret := C.g_desktop_app_info_get_locale_string(c_info, c_key)
...
func Fn_g_desktop_app_info_get_string_list(info unsafe.Pointer, key string, length *uint64) []string {
	c_info := (*C.GDesktopAppInfo)(unsafe.Pointer(info))
	...
	ret := C.g_desktop_app_info_get_string_list(c_info, c_key, c_length)
...
func Fn_g_file_info_get_modification_date_time(info unsafe.Pointer) unsafe.Pointer {
	c_info := (*C.GFileInfo)(unsafe.Pointer(info))

	ret := C.g_file_info_get_modification_date_time(c_info)
...
func Fn_g_file_info_set_modification_date_time(info unsafe.Pointer, mtime unsafe.Pointer) {
	c_info := (*C.GFileInfo)(unsafe.Pointer(info))

	c_mtime := (*C.GDateTime)(unsafe.Pointer(mtime))

	C.g_file_info_set_modification_date_time(c_info, c_mtime)
}
...
func Fn_g_mount_operation_get_is_tcrypt_hidden_volume(op unsafe.Pointer) bool {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	ret := C.g_mount_operation_get_is_tcrypt_hidden_volume(c_op)

	return toGoBool(ret)
}

func Fn_g_mount_operation_get_is_tcrypt_system_volume(op unsafe.Pointer) bool {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	ret := C.g_mount_operation_get_is_tcrypt_system_volume(c_op)
...
func Fn_g_mount_operation_get_pim(op unsafe.Pointer) uint {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	ret := C.g_mount_operation_get_pim(c_op)
...
func Fn_g_mount_operation_set_is_tcrypt_hidden_volume(op unsafe.Pointer, hiddenVolume bool) {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	c_hiddenVolume := toCBool(hiddenVolume)

	C.g_mount_operation_set_is_tcrypt_hidden_volume(c_op, c_hiddenVolume)
}

func Fn_g_mount_operation_set_is_tcrypt_system_volume(op unsafe.Pointer, systemVolume bool) {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	c_systemVolume := toCBool(systemVolume)

	C.g_mount_operation_set_is_tcrypt_system_volume(c_op, c_systemVolume)
}
...
func Fn_g_mount_operation_set_pim(op unsafe.Pointer, pim uint) {
	c_op := (*C.GMountOperation)(unsafe.Pointer(op))

	c_pim := (C.guint)(pim)

	C.g_mount_operation_set_pim(c_op, c_pim)
}
...
func Fn_g_output_stream_writev(stream unsafe.Pointer, vectors []OutputVector, nVectors uint64, bytesWritten *uint64, cancellable unsafe.Pointer, error unsafe.Pointer) bool {
	c_stream := (*C.GOutputStream)(unsafe.Pointer(stream))

	c_vectors := (*C.GOutputVector)(unsafe.Pointer(&vectors[0]))

	c_nVectors := (C.gsize)(nVectors)
	...
	ret := C.g_output_stream_writev(c_stream, c_vectors, c_nVectors, c_bytesWritten, c_cancellable, cError)

	return toGoBool(ret)
}

func Fn_g_output_stream_writev_all(stream unsafe.Pointer, vectors []OutputVector, nVectors uint64, bytesWritten *uint64, cancellable unsafe.Pointer, error unsafe.Pointer) bool {
	c_stream := (*C.GOutputStream)(unsafe.Pointer(stream))
	...
	ret := C.g_output_stream_writev_all(c_stream, c_vectors, c_nVectors, c_bytesWritten, c_cancellable, cError)
...
func Fn_g_output_stream_writev_all_finish(stream unsafe.Pointer, result unsafe.Pointer, bytesWritten *uint64, error unsafe.Pointer) bool {
	c_stream := (*C.GOutputStream)(unsafe.Pointer(stream))
	...
	ret := C.g_output_stream_writev_all_finish(c_stream, c_result, c_bytesWritten, cError)
...
func Fn_g_output_stream_writev_finish(stream unsafe.Pointer, result unsafe.Pointer, bytesWritten *uint64, error unsafe.Pointer) bool {
	c_stream := (*C.GOutputStream)(unsafe.Pointer(stream))
	...
	ret := C.g_output_stream_writev_finish(c_stream, c_result, c_bytesWritten, cError)
...
func Fn_g_resolver_lookup_by_name_with_flags(resolver unsafe.Pointer, hostname string, flags int, cancellable unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	c_resolver := (*C.GResolver)(unsafe.Pointer(resolver))

	c_hostname := (*C.gchar)(C.CString(hostname))
	defer C.free(unsafe.Pointer(c_hostname))

	c_flags := (C.GResolverNameLookupFlags)(flags)

	c_cancellable := (*C.GCancellable)(unsafe.Pointer(cancellable))

	cError := (**C.GError)(error)

	ret := C.g_resolver_lookup_by_name_with_flags(c_resolver, c_hostname, c_flags, c_cancellable, cError)
...
func Fn_g_resolver_lookup_by_name_with_flags_finish(resolver unsafe.Pointer, result unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	c_resolver := (*C.GResolver)(unsafe.Pointer(resolver))
	...
	ret := C.g_resolver_lookup_by_name_with_flags_finish(c_resolver, c_result, cError)
...
func Fn_g_socket_join_multicast_group_ssm(socket unsafe.Pointer, group unsafe.Pointer, sourceSpecific unsafe.Pointer, iface *string, error unsafe.Pointer) bool {
	c_socket := (*C.GSocket)(unsafe.Pointer(socket))

	c_group := (*C.GInetAddress)(unsafe.Pointer(group))

	c_sourceSpecific := (*C.GInetAddress)(unsafe.Pointer(sourceSpecific))
	...
	ret := C.g_socket_join_multicast_group_ssm(c_socket, c_group, c_sourceSpecific, c_iface, cError)
...
func Fn_g_socket_leave_multicast_group_ssm(socket unsafe.Pointer, group unsafe.Pointer, sourceSpecific unsafe.Pointer, iface *string, error unsafe.Pointer) bool {
	c_socket := (*C.GSocket)(unsafe.Pointer(socket))
	...
	ret := C.g_socket_leave_multicast_group_ssm(c_socket, c_group, c_sourceSpecific, c_iface, cError)
...
func Fn_g_socket_send_message_with_timeout(socket unsafe.Pointer, address unsafe.Pointer, vectors []OutputVector, numVectors int, messages []unsafe.Pointer, numMessages int, flags int, timeoutUs int64, bytesWritten *uint64, cancellable unsafe.Pointer, error unsafe.Pointer) int {
	c_socket := (*C.GSocket)(unsafe.Pointer(socket))
	...
	ret := C.g_socket_send_message_with_timeout(c_socket, c_address, c_vectors, c_numVectors, c_messages, c_numMessages, c_flags, c_timeoutUs, c_bytesWritten, c_cancellable, cError)
...
func Fn_g_task_get_name(task unsafe.Pointer) string {
	c_task := (*C.GTask)(unsafe.Pointer(task))

	ret := C.g_task_get_name(c_task)
...
func Fn_g_task_set_name(task unsafe.Pointer, name *string) {
	c_task := (*C.GTask)(unsafe.Pointer(task))
	...
	C.g_task_set_name(c_task, c_name)
}
...
func Fn_g_tls_connection_get_negotiated_protocol(conn unsafe.Pointer) string {
	c_conn := (*C.GTlsConnection)(unsafe.Pointer(conn))

	ret := C.g_tls_connection_get_negotiated_protocol(c_conn)
...
func Fn_g_tls_connection_set_advertised_protocols(conn unsafe.Pointer, protocols []string) {
	c_conn := (*C.GTlsConnection)(unsafe.Pointer(conn))

	protocolsLen := len(protocols)
	c_protocolsArray := C.malloc((C.ulong)(protocolsLen) * C.sizeof_gpointer)
	defer C.free(unsafe.Pointer(c_protocolsArray))
	protocolsSlice := (*[1 << 30](*C.gchar))(unsafe.Pointer(c_protocolsArray))[:protocolsLen:protocolsLen]
	for protocolsi, protocolsString := range protocols {
		protocolsSlice[protocolsi] = (*C.gchar)(C.CString(protocolsString))
		defer C.free(unsafe.Pointer(protocolsSlice[protocolsi]))
	}
	c_protocols := &protocolsSlice[0]

	C.g_tls_connection_set_advertised_protocols(c_conn, c_protocols)
}
...
func Fn_g_app_info_launch_uris_finish(appinfo unsafe.Pointer, result unsafe.Pointer, error unsafe.Pointer) bool {
	c_appinfo := (*C.GAppInfo)(unsafe.Pointer(appinfo))
	...
	ret := C.g_app_info_launch_uris_finish(c_appinfo, c_result, cError)
...
func Fn_g_dtls_connection_get_negotiated_protocol(conn unsafe.Pointer) string {
	c_conn := (*C.GDtlsConnection)(unsafe.Pointer(conn))

	ret := C.g_dtls_connection_get_negotiated_protocol(c_conn)
...
func Fn_g_dtls_connection_set_advertised_protocols(conn unsafe.Pointer, protocols []string) {
	c_conn := (*C.GDtlsConnection)(unsafe.Pointer(conn))
	...
	C.g_dtls_connection_set_advertised_protocols(c_conn, c_protocols)
}
...
func Fn_g_file_peek_path(file unsafe.Pointer) string {
	c_file := (*C.GFile)(unsafe.Pointer(file))

	ret := C.g_file_peek_path(c_file)
...
func Fn_g_file_query_default_handler_finish(file unsafe.Pointer, result unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	c_file := (*C.GFile)(unsafe.Pointer(file))
	...
	ret := C.g_file_query_default_handler_finish(c_file, c_result, cError)
...
func Fn_g_pollable_output_stream_writev_nonblocking(stream unsafe.Pointer, vectors []OutputVector, nVectors uint64, bytesWritten *uint64, cancellable unsafe.Pointer, error unsafe.Pointer) int {
	c_stream := (*C.GPollableOutputStream)(unsafe.Pointer(stream))
	...
	ret := C.g_pollable_output_stream_writev_nonblocking(c_stream, c_vectors, c_nVectors, c_bytesWritten, c_cancellable, cError)
...
func Fn_g_tls_backend_set_default_database(backend unsafe.Pointer, database unsafe.Pointer) {
	c_backend := (*C.GTlsBackend)(unsafe.Pointer(backend))

	c_database := (*C.GTlsDatabase)(unsafe.Pointer(database))

	C.g_tls_backend_set_default_database(c_backend, c_database)
}
