...
static GError* c_g_error_new(GQuark domain, gint code, const gchar* format) {
    return g_error_new(domain, code, format, NULL);
}
*/
/*

static void c_g_scanner_error(GScanner* scanner, const gchar* format) {
    return g_scanner_error(scanner, format, NULL);
}
*/
/*

static void c_g_scanner_warn(GScanner* scanner, const gchar* format) {
    return g_scanner_warn(scanner, format, NULL);
}
*/
/*

static void c_g_string_append_printf(GString* string, const gchar* format) {
    return g_string_append_printf(string, format, NULL);
}
*/
/*

static void c_g_string_printf(GString* string, const gchar* format) {
    return g_string_printf(string, format, NULL);
}
*/
/*

static GVariant* c_g_variant_new(const gchar* format_string) {
    return g_variant_new(format_string, NULL);
}
*/
/*

static GVariant* c_g_variant_new_parsed(const gchar* format) {
    return g_variant_new_parsed(format, NULL);
}
*/
/*

static GVariant* c_g_variant_new_printf(const gchar* format_string) {
    return g_variant_new_printf(format_string, NULL);
}
*/
/*

static void c_g_variant_get(GVariant* value, const gchar* format_string) {
    return g_variant_get(value, format_string, NULL);
}
*/
/*

static void c_g_variant_get_child(GVariant* value, gsize index_, const gchar* format_string) {
    return g_variant_get_child(value, index_, format_string, NULL);
}
*/
/*

static gboolean c_g_variant_lookup(GVariant* dictionary, const gchar* key, const gchar* format_string) {
    return g_variant_lookup(dictionary, key, format_string, NULL);
}
*/
/*

static void c_g_variant_builder_add(GVariantBuilder* builder, const gchar* format_string) {
    return g_variant_builder_add(builder, format_string, NULL);
}
*/
/*

static void c_g_variant_builder_add_parsed(GVariantBuilder* builder, const gchar* format) {
    return g_variant_builder_add_parsed(builder, format, NULL);
}
*/
/*

static void c_g_variant_dict_insert(GVariantDict* dict, const gchar* key, const gchar* format_string) {
    return g_variant_dict_insert(dict, key, format_string, NULL);
}
*/
/*

static gboolean c_g_variant_dict_lookup(GVariantDict* dict, const gchar* key, const gchar* format_string) {
    return g_variant_dict_lookup(dict, key, format_string, NULL);
}
*/
/*

static gboolean c_g_variant_iter_loop(GVariantIter* iter, const gchar* format_string) {
    return g_variant_iter_loop(iter, format_string, NULL);
}
*/
/*

static gboolean c_g_variant_iter_next(GVariantIter* iter, const gchar* format_string) {
    return g_variant_iter_next(iter, format_string, NULL);
}
*/
/*

static gchar* c_g_build_filename(const gchar* first_element) {
    return g_build_filename(first_element, NULL);
}
*/
/*

static gchar* c_g_build_path(const gchar* separator, const gchar* first_element) {
    return g_build_path(separator, first_element, NULL);
}
*/
/*

static gint c_g_fprintf(FILE* file, const gchar* format) {
    return g_fprintf(file, format, NULL);
}
*/
/*

static void c_g_log(const gchar* log_domain, GLogLevelFlags log_level, const gchar* format) {
    return g_log(log_domain, log_level, format, NULL);
}
*/
/*

static void c_g_log_structured(const gchar* log_domain, GLogLevelFlags log_level) {
    return g_log_structured(log_domain, log_level, NULL);
}
*/
/*

static void c_g_log_structured_standard(const gchar* log_domain, GLogLevelFlags log_level, const gchar* file, const gchar* line, const gchar* func, const gchar* message_format) {
    return g_log_structured_standard(log_domain, log_level, file, line, func, message_format, NULL);
}
*/
/*

static gboolean c_g_markup_collect_attributes(const gchar* element_name, const gchar** attribute_names, const gchar** attribute_values, GError** error, GMarkupCollectType first_type, const gchar* first_attr) {
    return g_markup_collect_attributes(element_name, attribute_names, attribute_values, error, first_type, first_attr, NULL);
}
*/
/*

static gchar* c_g_markup_printf_escaped(const char* format) {
    return g_markup_printf_escaped(format, NULL);
}
*/
/*

static void c_g_prefix_error(GError** err, const gchar* format) {
    return g_prefix_error(err, format, NULL);
}
*/
/*

static void c_g_print(const gchar* format) {
    return g_print(format, NULL);
}
*/
/*

static void c_g_printerr(const gchar* format) {
    return g_printerr(format, NULL);
}
*/
/*

static gint c_g_printf(const gchar* format) {
    return g_printf(format, NULL);
}
*/
/*

static void c_g_propagate_prefixed_error(GError** dest, GError* src, const gchar* format) {
    return g_propagate_prefixed_error(dest, src, format, NULL);
}
*/
/*

static void c_g_set_error(GError** err, GQuark domain, gint code, const gchar* format) {
    return g_set_error(err, domain, code, format, NULL);
}
*/
/*

static gint c_g_snprintf(gchar* string, gulong n, const gchar* format) {
    return g_snprintf(string, n, format, NULL);
}
*/
/*

static gint c_g_sprintf(gchar* string, const gchar* format) {
    return g_sprintf(string, format, NULL);
}
*/
/*

static gchar* c_g_strconcat(const gchar* string1) {
    return g_strconcat(string1, NULL);
}
*/
/*

static gchar* c_g_strdup_printf(const gchar* format) {
    return g_strdup_printf(format, NULL);
}
*/
/*

static gchar* c_g_strjoin(const gchar* separator) {
    return g_strjoin(separator, NULL);
}
*/
/*

static gchar* c_g_test_build_filename(GTestFileType file_type, const gchar* first_path) {
    return g_test_build_filename(file_type, first_path, NULL);
}
*/
/*

static const gchar* c_g_test_get_filename(GTestFileType file_type, const gchar* first_path) {
    return g_test_get_filename(file_type, first_path, NULL);
}
*/
/*

static void c_g_test_init(int* argc, char*** argv) {
    return g_test_init(argc, argv, NULL);
}
*/
/*

static void c_g_test_maximized_result(double maximized_quantity, const char* format) {
    return g_test_maximized_result(maximized_quantity, format, NULL);
}
*/
/*

static void c_g_test_message(const char* format) {
    return g_test_message(format, NULL);
}
*/
/*

static void c_g_test_minimized_result(double minimized_quantity, const char* format) {
    return g_test_minimized_result(minimized_quantity, format, NULL);
}
*/
import "C"
