...
func Fn_g_ascii_string_to_signed(param0 string, param1 uint, param2 int64, param3 int64, param4 *int64) {
	cValue0 := 42
	cValue1 := (C.guint)(param1)
	cValue2 := (C.gint64)(param2)
	cValue3 := (C.gint64)(param3)
	cValue4 := (*C.gint64)(unsafe.Pointer(param4))

	C.g_ascii_string_to_signed(cValue0, cValue1, cValue2, cValue3, cValue4)
}

func Fn_g_ascii_string_to_unsigned(param0 string, param1 uint, param2 uint64, param3 uint64, param4 *uint64) {
	cValue0 := 42
	cValue1 := (C.guint)(param1)
	cValue2 := (C.guint64)(param2)
	cValue3 := (C.guint64)(param3)
	cValue4 := (*C.guint64)(unsafe.Pointer(param4))

	C.g_ascii_string_to_unsigned(cValue0, cValue1, cValue2, cValue3, cValue4)
}
...
func Fn_g_atomic_rc_box_acquire(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_atomic_rc_box_acquire(cValue0)
}

func Fn_g_atomic_rc_box_alloc(param0 uint64) {
	cValue0 := (C.gsize)(param0)

	C.g_atomic_rc_box_alloc(cValue0)
}

func Fn_g_atomic_rc_box_alloc0(param0 uint64) {
	cValue0 := (C.gsize)(param0)

	C.g_atomic_rc_box_alloc0(cValue0)
}

func Fn_g_atomic_rc_box_dup(param0 uint64, param1 unsafe.Pointer) {
	cValue0 := (C.gsize)(param0)
	cValue1 := (C.gconstpointer)(param1)

	C.g_atomic_rc_box_dup(cValue0, cValue1)
}

func Fn_g_atomic_rc_box_get_size(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_atomic_rc_box_get_size(cValue0)
}

func Fn_g_atomic_rc_box_release(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_atomic_rc_box_release(cValue0)
}

// UNSUPPORTED : atomic_rc_box_release_full : has callback

func Fn_g_atomic_ref_count_compare(param0 *int, param1 int) {
	cValue0 := (*C.gatomicrefcount)(unsafe.Pointer(param0))
	cValue1 := (C.gint)(param1)

	C.g_atomic_ref_count_compare(cValue0, cValue1)
}

func Fn_g_atomic_ref_count_dec(param0 *int) {
	cValue0 := (*C.gatomicrefcount)(unsafe.Pointer(param0))

	C.g_atomic_ref_count_dec(cValue0)
}

func Fn_g_atomic_ref_count_inc(param0 *int) {
	cValue0 := (*C.gatomicrefcount)(unsafe.Pointer(param0))

	C.g_atomic_ref_count_inc(cValue0)
}

func Fn_g_atomic_ref_count_init(param0 *int) {
	cValue0 := (*C.gatomicrefcount)(unsafe.Pointer(param0))

	C.g_atomic_ref_count_init(cValue0)
}
...
func Fn_g_canonicalize_filename(param0 string, param1 string) {
	cValue0 := 42
	cValue1 := 42

	C.g_canonicalize_filename(cValue0, cValue1)
}
...
func Fn_g_compute_hmac_for_bytes(param0 int, param1 unsafe.Pointer, param2 unsafe.Pointer) {
	cValue0 := (C.GChecksumType)(param0)
	cValue1 := (*C.GBytes)(unsafe.Pointer(param1))
	cValue2 := (*C.GBytes)(unsafe.Pointer(param2))

	C.g_compute_hmac_for_bytes(cValue0, cValue1, cValue2)
}
...
func Fn_g_get_language_names_with_category(param0 string) {
	cValue0 := 42

	C.g_get_language_names_with_category(cValue0)
}
...
func Fn_g_hash_table_steal_extended(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 *unsafe.Pointer, param3 *unsafe.Pointer) {
	cValue0 := (*C.GHashTable)(unsafe.Pointer(param0))
	cValue1 := (C.gconstpointer)(param1)
	cValue2 := (*C.gpointer)(unsafe.Pointer(param2))
	cValue3 := (*C.gpointer)(unsafe.Pointer(param3))

	C.g_hash_table_steal_extended(cValue0, cValue1, cValue2, cValue3)
}
...
func Fn_g_log_structured_array(param0 int, param1 []LogField, param2 uint64) {
	// has array param
}

// UNSUPPORTED : log_structured_standard : has varargs

func Fn_g_log_variant(param0 string, param1 int, param2 unsafe.Pointer) {
	cValue0 := 42
	cValue1 := (C.GLogLevelFlags)(param1)
	cValue2 := (*C.GVariant)(unsafe.Pointer(param2))

	C.g_log_variant(cValue0, cValue1, cValue2)
}

func Fn_g_log_writer_default(param0 int, param1 []LogField, param2 uint64, param3 *unsafe.Pointer) {
	// has array param
}

func Fn_g_log_writer_format_fields(param0 int, param1 []LogField, param2 uint64, param3 bool) {
	// has array param
}

func Fn_g_log_writer_is_journald(param0 int) {
	cValue0 := (C.gint)(param0)

	C.g_log_writer_is_journald(cValue0)
}

func Fn_g_log_writer_journald(param0 int, param1 []LogField, param2 uint64, param3 *unsafe.Pointer) {
	// has array param
}

func Fn_g_log_writer_standard_streams(param0 int, param1 []LogField, param2 uint64, param3 *unsafe.Pointer) {
	// has array param
}

func Fn_g_log_writer_supports_color(param0 int) {
	cValue0 := (C.gint)(param0)

	C.g_log_writer_supports_color(cValue0)
}
...
func Fn_g_ptr_array_find(param0 []*unsafe.Pointer, param1 unsafe.Pointer, param2 *uint) {
	// has array param
}
...
func Fn_g_rc_box_acquire(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_rc_box_acquire(cValue0)
}

func Fn_g_rc_box_alloc(param0 uint64) {
	cValue0 := (C.gsize)(param0)

	C.g_rc_box_alloc(cValue0)
}

func Fn_g_rc_box_alloc0(param0 uint64) {
	cValue0 := (C.gsize)(param0)

	C.g_rc_box_alloc0(cValue0)
}

func Fn_g_rc_box_dup(param0 uint64, param1 unsafe.Pointer) {
	cValue0 := (C.gsize)(param0)
	cValue1 := (C.gconstpointer)(param1)

	C.g_rc_box_dup(cValue0, cValue1)
}

func Fn_g_rc_box_get_size(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_rc_box_get_size(cValue0)
}

func Fn_g_rc_box_release(param0 *unsafe.Pointer) {
	cValue0 := (*C.gpointer)(unsafe.Pointer(param0))

	C.g_rc_box_release(cValue0)
}
...
func Fn_g_ref_count_compare(param0 *int, param1 int) {
	cValue0 := (*C.grefcount)(unsafe.Pointer(param0))
	cValue1 := (C.gint)(param1)

	C.g_ref_count_compare(cValue0, cValue1)
}

func Fn_g_ref_count_dec(param0 *int) {
	cValue0 := (*C.grefcount)(unsafe.Pointer(param0))

	C.g_ref_count_dec(cValue0)
}

func Fn_g_ref_count_inc(param0 *int) {
	cValue0 := (*C.grefcount)(unsafe.Pointer(param0))

	C.g_ref_count_inc(cValue0)
}

func Fn_g_ref_count_init(param0 *int) {
	cValue0 := (*C.grefcount)(unsafe.Pointer(param0))

	C.g_ref_count_init(cValue0)
}

func Fn_g_ref_string_acquire(param0 string) {
	cValue0 := 42

	C.g_ref_string_acquire(cValue0)
}

func Fn_g_ref_string_length(param0 string) {
	cValue0 := 42

	C.g_ref_string_length(cValue0)
}

func Fn_g_ref_string_new(param0 string) {
	cValue0 := 42

	C.g_ref_string_new(cValue0)
}

func Fn_g_ref_string_new_intern(param0 string) {
	cValue0 := 42

	C.g_ref_string_new_intern(cValue0)
}

func Fn_g_ref_string_new_len(param0 string, param1 uint64) {
	cValue0 := 42
	cValue1 := (C.gssize)(param1)

	C.g_ref_string_new_len(cValue0, cValue1)
}

func Fn_g_ref_string_release(param0 string) {
	cValue0 := 42

	C.g_ref_string_release(cValue0)
}
...
func Fn_g_strv_contains(param0 string, param1 string) {
	cValue0 := 42
	cValue1 := 42

	C.g_strv_contains(cValue0, cValue1)
}

func Fn_g_strv_equal(param0 string, param1 string) {
	cValue0 := 42
	cValue1 := 42

	C.g_strv_equal(cValue0, cValue1)
}
...
func Fn_g_utf8_make_valid(param0 string, param1 uint64) {
	cValue0 := 42
	cValue1 := (C.gssize)(param1)

	C.g_utf8_make_valid(cValue0, cValue1)
}
...
func Fn_g_utf8_validate_len(param0 []uint8, param1 uint64, param2 string) {
	// has array param
}

func Fn_g_uuid_string_is_valid(param0 string) {
	cValue0 := 42

	C.g_uuid_string_is_valid(cValue0)
}

func Fn_g_uuid_string_random() {
