...
func Fn_ascii_string_to_signed(str c.UndefinedParamType, base uint, min int64, max int64) {}

func Fn_ascii_string_to_unsigned(str c.UndefinedParamType, base uint, min uint64, max uint64) {}
...
func Fn_set_error_literal(domain c.UndefinedParamType, code int, message c.UndefinedParamType) {}
...
func Fn_str_tokenize_and_fold(string_ c.UndefinedParamType, translitLocale c.UndefinedParamType) {}
...
func Fn_variant_type_string_scan(string_ c.UndefinedParamType, limit c.UndefinedParamType) {}
