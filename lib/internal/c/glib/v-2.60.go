...
func Fn_ascii_string_to_signed(param0 string, param1 uint, param2 int64, param3 int64, param4 *int64) {
}

func Fn_ascii_string_to_unsigned(param0 string, param1 uint, param2 uint64, param3 uint64, param4 *uint64) {
}
...
func Fn_atomic_int_and(param0 *uint, param1 uint) {}
...
func Fn_atomic_int_or(param0 *uint, param1 uint) {}

func Fn_atomic_int_set(param0 *int, param1 int) {}

func Fn_atomic_int_xor(param0 *uint, param1 uint) {}

func Fn_atomic_pointer_add(param0 unsafe.Pointer, param1 uint64) {}

func Fn_atomic_pointer_and(param0 unsafe.Pointer, param1 uint64) {}
...
func Fn_atomic_pointer_or(param0 unsafe.Pointer, param1 uint64) {}

func Fn_atomic_pointer_set(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_atomic_pointer_xor(param0 unsafe.Pointer, param1 uint64) {}

func Fn_atomic_rc_box_acquire(param0 unsafe.Pointer) {}

func Fn_atomic_rc_box_alloc(param0 uint64) {}

func Fn_atomic_rc_box_alloc0(param0 uint64) {}

func Fn_atomic_rc_box_dup(param0 uint64, param1 unsafe.Pointer) {}

func Fn_atomic_rc_box_get_size(param0 unsafe.Pointer) {}

func Fn_atomic_rc_box_release(param0 unsafe.Pointer) {}

// UNSUPPORTED : atomic_rc_box_release_full : has callback

func Fn_atomic_ref_count_compare(param0 *int, param1 int) {}

func Fn_atomic_ref_count_dec(param0 *int) {}

func Fn_atomic_ref_count_inc(param0 *int) {}

func Fn_atomic_ref_count_init(param0 *int) {}

func Fn_base64_decode(param0 string, param1 *uint64) {}

func Fn_base64_decode_inplace(param0 []uint8, param1 *uint64) {}
...
func Fn_bit_lock(param0 *int, param1 int) {}
...
func Fn_bit_trylock(param0 *int, param1 int) {}

func Fn_bit_unlock(param0 *int, param1 int) {}
...
func Fn_byte_array_free_to_bytes(param0 []uint8) {}

func Fn_byte_array_new() {
	C.g_byte_array_new()
}

func Fn_byte_array_new_take(param0 []uint8, param1 uint64) {}

func Fn_byte_array_unref(param0 []uint8) {}

func Fn_canonicalize_filename(param0 string, param1 string) {}

func Fn_chdir(param0 string) {}

func Fn_check_version(param0 uint, param1 uint, param2 uint) {}

func Fn_checksum_type_get_length(param0 int) {}
...
func Fn_close(param0 int) {}

func Fn_compute_checksum_for_bytes(param0 int, param1 unsafe.Pointer) {}

func Fn_compute_checksum_for_data(param0 int, param1 []uint8, param2 uint64) {}

func Fn_compute_checksum_for_string(param0 int, param1 string, param2 uint64) {}

func Fn_compute_hmac_for_bytes(param0 int, param1 unsafe.Pointer, param2 unsafe.Pointer) {}

func Fn_compute_hmac_for_data(param0 int, param1 []uint8, param2 uint64, param3 []uint8, param4 uint64) {
}

func Fn_compute_hmac_for_string(param0 int, param1 []uint8, param2 uint64, param3 string, param4 uint64) {
}
...
func Fn_date_time_compare(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_date_time_equal(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_date_time_hash(param0 unsafe.Pointer) {}
...
func Fn_dcgettext(param0 string, param1 string, param2 int) {}

func Fn_dgettext(param0 string, param1 string) {}

func Fn_dir_make_tmp(param0 string) {}

func Fn_direct_equal(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_direct_hash(param0 unsafe.Pointer) {}

func Fn_dngettext(param0 string, param1 string, param2 string, param3 uint64) {}

func Fn_double_equal(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_double_hash(param0 unsafe.Pointer) {}

func Fn_dpgettext(param0 string, param1 string, param2 uint64) {}

func Fn_dpgettext2(param0 string, param1 string, param2 string) {}

func Fn_environ_getenv(param0 []string, param1 string) {}

func Fn_environ_setenv(param0 []string, param1 string, param2 string, param3 bool) {}

func Fn_environ_unsetenv(param0 []string, param1 string) {}
...
func Fn_format_size(param0 uint64) {}

func Fn_format_size_for_display(param0 int64) {}

func Fn_format_size_full(param0 uint64, param1 int) {}
...
func Fn_get_language_names_with_category(param0 string) {}

func Fn_get_locale_variants(param0 string) {}
...
func Fn_hash_table_add(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_hash_table_contains(param0 unsafe.Pointer, param1 unsafe.Pointer) {}
...
func Fn_hash_table_steal_extended(param0 unsafe.Pointer, param1 unsafe.Pointer, param2 *unsafe.Pointer, param3 *unsafe.Pointer) {
}
...
func Fn_hostname_is_ascii_encoded(param0 string) {}

func Fn_hostname_is_ip_address(param0 string) {}

func Fn_hostname_is_non_ascii(param0 string) {}

func Fn_hostname_to_ascii(param0 string) {}

func Fn_hostname_to_unicode(param0 string) {}
...
func Fn_int64_equal(param0 unsafe.Pointer, param1 unsafe.Pointer) {}

func Fn_int64_hash(param0 unsafe.Pointer) {}
...
func Fn_log_structured_array(param0 int, param1 []LogField, param2 uint64) {}

// UNSUPPORTED : log_structured_standard : has varargs

func Fn_log_variant(param0 string, param1 int, param2 unsafe.Pointer) {}

func Fn_log_writer_default(param0 int, param1 []LogField, param2 uint64, param3 unsafe.Pointer) {}

func Fn_log_writer_format_fields(param0 int, param1 []LogField, param2 uint64, param3 bool) {}

func Fn_log_writer_is_journald(param0 int) {}

func Fn_log_writer_journald(param0 int, param1 []LogField, param2 uint64, param3 unsafe.Pointer) {}

func Fn_log_writer_standard_streams(param0 int, param1 []LogField, param2 uint64, param3 unsafe.Pointer) {
}

func Fn_log_writer_supports_color(param0 int) {}
...
func Fn_malloc0_n(param0 uint64, param1 uint64) {}

func Fn_malloc_n(param0 uint64, param1 uint64) {}
...
func Fn_mkdtemp(param0 string) {}

func Fn_mkdtemp_full(param0 string, param1 int) {}

func Fn_mkstemp(param0 string) {}

func Fn_mkstemp_full(param0 string, param1 int, param2 int) {}
...
func Fn_pointer_bit_lock(param0 unsafe.Pointer, param1 int) {}

func Fn_pointer_bit_trylock(param0 unsafe.Pointer, param1 int) {}

func Fn_pointer_bit_unlock(param0 unsafe.Pointer, param1 int) {}

func Fn_poll(param0 unsafe.Pointer, param1 uint, param2 int) {}
...
func Fn_ptr_array_find(param0 []unsafe.Pointer, param1 unsafe.Pointer, param2 *uint) {}
...
func Fn_rc_box_acquire(param0 unsafe.Pointer) {}

func Fn_rc_box_alloc(param0 uint64) {}

func Fn_rc_box_alloc0(param0 uint64) {}

func Fn_rc_box_dup(param0 uint64, param1 unsafe.Pointer) {}

func Fn_rc_box_get_size(param0 unsafe.Pointer) {}

func Fn_rc_box_release(param0 unsafe.Pointer) {}

// UNSUPPORTED : rc_box_release_full : has callback

func Fn_realloc(param0 unsafe.Pointer, param1 uint64) {}

func Fn_realloc_n(param0 unsafe.Pointer, param1 uint64, param2 uint64) {}

func Fn_ref_count_compare(param0 *int, param1 int) {}

func Fn_ref_count_dec(param0 *int) {}

func Fn_ref_count_inc(param0 *int) {}

func Fn_ref_count_init(param0 *int) {}

func Fn_ref_string_acquire(param0 string) {}

func Fn_ref_string_length(param0 string) {}

func Fn_ref_string_new(param0 string) {}

func Fn_ref_string_new_intern(param0 string) {}

func Fn_ref_string_new_len(param0 string, param1 uint64) {}

func Fn_ref_string_release(param0 string) {}
...
func Fn_regex_escape_nul(param0 string, param1 int) {}
...
func Fn_set_error_literal(param0 *unsafe.Pointer, param1 uint32, param2 int, param3 string) {}
...
func Fn_source_set_name_by_id(param0 uint, param1 string) {}
...
func Fn_spawn_check_exit_status(param0 int) {}
...
func Fn_str_is_ascii(param0 string) {}

func Fn_str_match_string(param0 string, param1 string, param2 bool) {}

func Fn_str_to_ascii(param0 string, param1 string) {}

func Fn_str_tokenize_and_fold(param0 string, param1 string, param2 *[]string) {}
...
func Fn_strcmp0(param0 string, param1 string) {}
...
func Fn_strv_contains(param0 string, param1 string) {}

func Fn_strv_equal(param0 string, param1 string) {}
...
func Fn_test_bug(param0 string) {}

func Fn_test_bug_base(param0 string) {}

// UNSUPPORTED : test_build_filename : has varargs

// UNSUPPORTED : test_create_case : has callback

func Fn_test_create_suite(param0 string) {}

func Fn_test_expect_message(param0 string, param1 int, param2 string) {}
...
func Fn_test_get_dir(param0 int) {}
...
func Fn_test_incomplete(param0 string) {}
...
func Fn_test_queue_free(param0 unsafe.Pointer) {}

func Fn_test_rand_double() {
	C.g_test_rand_double()
}

func Fn_test_rand_double_range(param0 float64, param1 float64) {}

func Fn_test_rand_int() {
	C.g_test_rand_int()
}

func Fn_test_rand_int_range(param0 int32, param1 int32) {}

func Fn_test_run() {
	C.g_test_run()
}

func Fn_test_run_suite(param0 unsafe.Pointer) {}

func Fn_test_set_nonfatal_assertions() {
	C.g_test_set_nonfatal_assertions()
}

func Fn_test_skip(param0 string) {}
...
func Fn_test_trap_fork(param0 uint64, param1 int) {}
...
func Fn_test_trap_subprocess(param0 string, param1 uint64, param2 int) {}
...
func Fn_try_malloc0_n(param0 uint64, param1 uint64) {}

func Fn_try_malloc_n(param0 uint64, param1 uint64) {}

func Fn_try_realloc(param0 unsafe.Pointer, param1 uint64) {}

func Fn_try_realloc_n(param0 unsafe.Pointer, param1 uint64, param2 uint64) {}
...
func Fn_unichar_compose(param0 rune, param1 rune, param2 *rune) {}

func Fn_unichar_decompose(param0 rune, param1 *rune, param2 *rune) {}

func Fn_unichar_digit_value(param0 rune) {}

func Fn_unichar_fully_decompose(param0 rune, param1 bool, param2 *rune, param3 uint64) {}
...
func Fn_unicode_script_from_iso15924(param0 uint32) {}

func Fn_unicode_script_to_iso15924(param0 int) {}
...
func Fn_unix_fd_source_new(param0 int, param1 int) {}

func Fn_unix_open_pipe(param0 *int, param1 int) {}

func Fn_unix_set_fd_nonblocking(param0 int, param1 bool) {}

// UNSUPPORTED : unix_signal_add : has callback

// UNSUPPORTED : unix_signal_add_full : has callback

func Fn_unix_signal_source_new(param0 int) {}

func Fn_unlink(param0 string) {}

func Fn_unsetenv(param0 string) {}

func Fn_uri_escape_string(param0 string, param1 string, param2 bool) {}

func Fn_uri_list_extract_uris(param0 string) {}

func Fn_uri_parse_scheme(param0 string) {}

func Fn_uri_unescape_segment(param0 string, param1 string, param2 string) {}

func Fn_uri_unescape_string(param0 string, param1 string) {}
...
func Fn_utf8_make_valid(param0 string, param1 uint64) {}
...
func Fn_utf8_substring(param0 string, param1 int64, param2 int64) {}
...
func Fn_utf8_validate_len(param0 []uint8, param1 uint64, param2 string) {}

func Fn_uuid_string_is_valid(param0 string) {}
...
func Fn_variant_is_object_path(param0 string) {}

func Fn_variant_is_signature(param0 string) {}

func Fn_variant_parse(param0 unsafe.Pointer, param1 string, param2 string, param3 string) {}

func Fn_variant_parse_error_print_context(param0 unsafe.Pointer, param1 string) {}
...
func Fn_variant_type_string_scan(param0 string, param1 string, param2 string) {}
