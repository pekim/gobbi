...
func Fn_atomic_rc_box_acquire(memBlock c.UndefinedParamType) {}

func Fn_atomic_rc_box_alloc(blockSize c.UndefinedParamType) {}

func Fn_atomic_rc_box_alloc0(blockSize c.UndefinedParamType) {}

func Fn_atomic_rc_box_dup(blockSize c.UndefinedParamType, memBlock c.UndefinedParamType) {}

func Fn_atomic_rc_box_get_size(memBlock c.UndefinedParamType) {}

func Fn_atomic_rc_box_release(memBlock c.UndefinedParamType) {}

func Fn_atomic_rc_box_release_full(memBlock c.UndefinedParamType, clearFunc c.UndefinedParamType) {}

func Fn_atomic_ref_count_compare(arc c.UndefinedParamType, val c.UndefinedParamType) {}
...
func Fn_clear_handle_id(tagPtr c.UndefinedParamType, clearFunc c.UndefinedParamType) {}
...
func Fn_get_language_names_with_category(categoryName c.UndefinedParamType) {}
...
func Fn_hash_table_steal_extended(hashTable c.UndefinedParamType, lookupKey c.UndefinedParamType, stolenKey c.UndefinedParamType, stolenValue c.UndefinedParamType) {
}
...
func Fn_rc_box_acquire(memBlock c.UndefinedParamType) {}

func Fn_rc_box_alloc(blockSize c.UndefinedParamType) {}

func Fn_rc_box_alloc0(blockSize c.UndefinedParamType) {}

func Fn_rc_box_dup(blockSize c.UndefinedParamType, memBlock c.UndefinedParamType) {}

func Fn_rc_box_get_size(memBlock c.UndefinedParamType) {}

func Fn_rc_box_release(memBlock c.UndefinedParamType) {}

func Fn_rc_box_release_full(memBlock c.UndefinedParamType, clearFunc c.UndefinedParamType) {}
...
func Fn_ref_count_compare(rc c.UndefinedParamType, val c.UndefinedParamType) {}
...
func Fn_ref_string_acquire(str c.UndefinedParamType) {}

func Fn_ref_string_length(str c.UndefinedParamType) {}

func Fn_ref_string_new(str c.UndefinedParamType) {}

func Fn_ref_string_new_intern(str c.UndefinedParamType) {}

func Fn_ref_string_new_len(str c.UndefinedParamType, len c.UndefinedParamType) {}

func Fn_ref_string_release(str c.UndefinedParamType) {}
...
func Fn_str_tokenize_and_fold(string_ c.UndefinedParamType, translitLocale c.UndefinedParamType, asciiAlternates c.UndefinedParamType) {
}
...
func Fn_strv_contains(strv c.UndefinedParamType, str c.UndefinedParamType) {}

func Fn_strv_equal(strv1 c.UndefinedParamType, strv2 c.UndefinedParamType) {}
...
func Fn_utf8_validate_len(str c.UndefinedParamType, maxLen c.UndefinedParamType, end c.UndefinedParamType) {
}
...
func Fn_variant_parse_error_print_context(error c.UndefinedParamType, sourceStr c.UndefinedParamType) {
}
