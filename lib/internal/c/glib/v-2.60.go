...
func Fn_ascii_string_to_signed(str string, base uint, min int64, max int64, outNum *int64) {}

func Fn_ascii_string_to_unsigned(str string, base uint, min uint64, max uint64, outNum *uint64) {}
...
func Fn_atomic_rc_box_dup(blockSize uint64, memBlock unsafe.Pointer) {}
...
func Fn_checksum_type_get_length(checksumType int) {}
...
func Fn_compute_checksum_for_bytes(checksumType int, data unsafe.Pointer) {}

func Fn_compute_checksum_for_data(checksumType int, data *uint8, length uint64) {}

func Fn_compute_checksum_for_string(checksumType int, str string, length uint64) {}

func Fn_compute_hmac_for_bytes(digestType int, key unsafe.Pointer, data unsafe.Pointer) {}

func Fn_compute_hmac_for_data(digestType int, key *uint8, keyLen uint64, data *uint8, length uint64) {
}
...
func Fn_date_time_compare(dt1 unsafe.Pointer, dt2 unsafe.Pointer) {}

func Fn_date_time_equal(dt1 unsafe.Pointer, dt2 unsafe.Pointer) {}

func Fn_date_time_hash(datetime unsafe.Pointer) {}
...
func Fn_format_size_full(size uint64, flags int) {}
...
func Fn_hash_table_add(hashTable unsafe.Pointer, key unsafe.Pointer) {}

func Fn_hash_table_contains(hashTable unsafe.Pointer, key unsafe.Pointer) {}
...
func Fn_hash_table_steal_extended(hashTable unsafe.Pointer, lookupKey unsafe.Pointer, stolenKey *unsafe.Pointer, stolenValue *unsafe.Pointer) {
}
...
func Fn_log_structured_array(logLevel int, fields *LogField, nFields uint64) {}

// UNSUPPORTED : log_structured_standard : has varargs

func Fn_log_variant(logDomain string, logLevel int, fields unsafe.Pointer) {}

func Fn_log_writer_default(logLevel int, fields *LogField, nFields uint64, userData unsafe.Pointer) {
}

func Fn_log_writer_format_fields(logLevel int, fields *LogField, nFields uint64, useColor bool) {}

func Fn_log_writer_is_journald(outputFd int) {}

func Fn_log_writer_journald(logLevel int, fields *LogField, nFields uint64, userData unsafe.Pointer) {
}

func Fn_log_writer_standard_streams(logLevel int, fields *LogField, nFields uint64, userData unsafe.Pointer) {
}
...
func Fn_mkdtemp_full(tmpl string, mode int) {}
...
func Fn_poll(fds unsafe.Pointer, nfds uint, timeout int) {}
...
func Fn_ptr_array_find(haystack *unsafe.Pointer, needle unsafe.Pointer, index *uint) {}
...
func Fn_rc_box_dup(blockSize uint64, memBlock unsafe.Pointer) {}
...
func Fn_test_expect_message(logDomain string, logLevel int, pattern string) {}
...
func Fn_test_get_dir(fileType int) {}
...
func Fn_test_run_suite(suite unsafe.Pointer) {}
...
func Fn_test_trap_fork(usecTimeout uint64, testTrapFlags int) {}
...
func Fn_test_trap_subprocess(testPath string, usecTimeout uint64, testFlags int) {}
...
func Fn_unicode_script_to_iso15924(script int) {}
...
func Fn_unix_fd_source_new(fd int, condition int) {}
...
func Fn_utf8_validate_len(str *uint8, maxLen uint64, end string) {}
...
func Fn_variant_parse_error_print_context(error unsafe.Pointer, sourceStr string) {}
