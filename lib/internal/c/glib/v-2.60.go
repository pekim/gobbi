...
func Fn_hash_table_steal_extended(hashTable c.UndefinedParamType, lookupKey c.UndefinedParamType, stolenKey *unsafe.Pointer, stolenValue *unsafe.Pointer) {
}
...
func Fn_ref_string_new_len(str c.UndefinedParamType, len uint64) {}
...
func Fn_spawn_async_with_fds(workingDirectory c.UndefinedParamType, argv c.UndefinedParamType, envp c.UndefinedParamType, flags c.UndefinedParamType, childSetup c.UndefinedParamType, userData unsafe.Pointer, childPid c.UndefinedParamType, stdinFd int, stdoutFd int, stderrFd int) {
}
...
func Fn_utf8_validate_len(str c.UndefinedParamType, maxLen uint64, end c.UndefinedParamType) {}
