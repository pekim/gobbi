...
func Fn_cclosure_marshal_VOID__VARIANT(closure unsafe.Pointer, returnValue unsafe.Pointer, nParamValues uint, paramValues unsafe.Pointer, invocationHint unsafe.Pointer, marshalData unsafe.Pointer) {
}
...
func Fn_param_spec_gtype(name string, nick string, blurb string, isAType uint64, flags int) {}
...
func Fn_param_spec_variant(name string, nick string, blurb string, type_ unsafe.Pointer, defaultValue unsafe.Pointer, flags int) {
}
...
func Fn_type_add_class_private(classType uint64, privateSize uint64) {}
