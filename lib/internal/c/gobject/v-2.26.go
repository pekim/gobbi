...
func Fn_cclosure_marshal_VOID__VARIANT(closure c.UndefinedParamType, returnValue c.UndefinedParamType, nParamValues uint, paramValues c.UndefinedParamType, invocationHint unsafe.Pointer, marshalData unsafe.Pointer) {
}
