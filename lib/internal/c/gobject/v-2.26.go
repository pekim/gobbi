...
func Fn_g_binding_get_flags() {}

func Fn_g_binding_get_source() {}

func Fn_g_binding_get_source_property() {}

func Fn_g_binding_get_target() {}

func Fn_g_binding_get_target_property() {}
...
func Fn_g_object_bind_property(param0 string, param1 *unsafe.Pointer, param2 string, param3 int) {}

// UNSUPPORTED : bind_property_full : has callback

func Fn_g_object_bind_property_with_closures(param0 string, param1 *unsafe.Pointer, param2 string, param3 int, param4 unsafe.Pointer, param5 unsafe.Pointer) {
}
...
func Fn_g_object_notify_by_pspec(param0 unsafe.Pointer) {}
