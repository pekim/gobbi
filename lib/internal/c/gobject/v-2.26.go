...
func Fn_cclosure_marshal_VOID__VARIANT(closure *Closure, returnValue *Value, nParamValues uint, paramValues *Value, invocationHint unsafe.Pointer, marshalData unsafe.Pointer) {
}
...
func Fn_param_spec_gtype(name string, nick string, blurb string, isAType c.UndefinedParamType, flags ParamFlags) {
}
...
func Fn_param_spec_variant(name string, nick string, blurb string, type_ *glib.VariantType, defaultValue *glib.Variant, flags ParamFlags) {
}
...
func Fn_type_add_class_private(classType c.UndefinedParamType, privateSize uint64) {}
...
func Fn_type_register_static_simple(parentType c.UndefinedParamType, typeName string, classSize uint, classInit c.UndefinedParamType, instanceSize uint, instanceInit c.UndefinedParamType, flags TypeFlags) {
}
