...
func Fn_gtk_binding_entry_add_signal_from_string(bindingSet unsafe.Pointer, signalDesc string) int {
	c_bindingSet := (*C.GtkBindingSet)(unsafe.Pointer(bindingSet))

	c_signalDesc := (*C.gchar)(C.CString(signalDesc))
	defer C.free(unsafe.Pointer(c_signalDesc))

	ret := C.gtk_binding_entry_add_signal_from_string(c_bindingSet, c_signalDesc)
...
func Fn_gtk_cell_area_class_find_cell_property(aclass unsafe.Pointer, propertyName string) unsafe.Pointer {
	c_aclass := (*C.GtkCellAreaClass)(unsafe.Pointer(aclass))

	c_propertyName := (*C.gchar)(C.CString(propertyName))
	defer C.free(unsafe.Pointer(c_propertyName))

	ret := C.gtk_cell_area_class_find_cell_property(c_aclass, c_propertyName)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_class_install_cell_property(aclass unsafe.Pointer, propertyId uint, pspec unsafe.Pointer) {
	c_aclass := (*C.GtkCellAreaClass)(unsafe.Pointer(aclass))
	...
	C.gtk_cell_area_class_install_cell_property(c_aclass, c_propertyId, c_pspec)
}

func Fn_gtk_cell_area_class_list_cell_properties(aclass unsafe.Pointer, nProperties *uint) []unsafe.Pointer {
	c_aclass := (*C.GtkCellAreaClass)(unsafe.Pointer(aclass))

	c_nProperties := (*C.guint)(unsafe.Pointer(nProperties))

	ret := C.gtk_cell_area_class_list_cell_properties(c_aclass, c_nProperties)
...
func Fn_gtk_css_section_get_end_line(section unsafe.Pointer) uint {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_end_line(c_section)

	return (uint)(ret)
}

func Fn_gtk_css_section_get_end_position(section unsafe.Pointer) uint {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_end_position(c_section)

	return (uint)(ret)
}

func Fn_gtk_css_section_get_file(section unsafe.Pointer) unsafe.Pointer {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_file(c_section)

	return unsafe.Pointer(ret)
}

func Fn_gtk_css_section_get_parent(section unsafe.Pointer) unsafe.Pointer {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_parent(c_section)

	return unsafe.Pointer(ret)
}

func Fn_gtk_css_section_get_section_type(section unsafe.Pointer) int {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_section_type(c_section)

	return (int)(ret)
}

func Fn_gtk_css_section_get_start_line(section unsafe.Pointer) uint {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_start_line(c_section)

	return (uint)(ret)
}

func Fn_gtk_css_section_get_start_position(section unsafe.Pointer) uint {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_get_start_position(c_section)

	return (uint)(ret)
}

func Fn_gtk_css_section_ref(section unsafe.Pointer) unsafe.Pointer {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	ret := C.gtk_css_section_ref(c_section)

	return unsafe.Pointer(ret)
}

func Fn_gtk_css_section_unref(section unsafe.Pointer) {
	c_section := (*C.GtkCssSection)(unsafe.Pointer(section))

	C.gtk_css_section_unref(c_section)
}

func Fn_gtk_gradient_new_linear(x0 float64, y0 float64, x1 float64, y1 float64) unsafe.Pointer {
	c_x0 := (C.gdouble)(x0)
	...
	ret := C.gtk_gradient_new_linear(c_x0, c_y0, c_x1, c_y1)

	return unsafe.Pointer(ret)
}

func Fn_gtk_gradient_new_radial(x0 float64, y0 float64, radius0 float64, x1 float64, y1 float64, radius1 float64) unsafe.Pointer {
	c_x0 := (C.gdouble)(x0)
	...
	ret := C.gtk_gradient_new_radial(c_x0, c_y0, c_radius0, c_x1, c_y1, c_radius1)

	return unsafe.Pointer(ret)
}

func Fn_gtk_gradient_add_color_stop(gradient unsafe.Pointer, offset float64, color unsafe.Pointer) {
	...
	C.gtk_gradient_add_color_stop(c_gradient, c_offset, c_color)
}

func Fn_gtk_gradient_ref(gradient unsafe.Pointer) unsafe.Pointer {
	c_gradient := (*C.GtkGradient)(unsafe.Pointer(gradient))

	ret := C.gtk_gradient_ref(c_gradient)
...
func Fn_gtk_gradient_unref(gradient unsafe.Pointer) {
	c_gradient := (*C.GtkGradient)(unsafe.Pointer(gradient))

	C.gtk_gradient_unref(c_gradient)
}
...
func Fn_gtk_icon_set_render_icon_pixbuf(iconSet unsafe.Pointer, context unsafe.Pointer, size int) unsafe.Pointer {
	c_iconSet := (*C.GtkIconSet)(unsafe.Pointer(iconSet))
	...
	ret := C.gtk_icon_set_render_icon_pixbuf(c_iconSet, c_context, c_size)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_set_render_icon_surface(iconSet unsafe.Pointer, context unsafe.Pointer, size int, scale int, forWindow unsafe.Pointer) unsafe.Pointer {
	c_iconSet := (*C.GtkIconSet)(unsafe.Pointer(iconSet))
	...
	c_forWindow := (*C.GdkWindow)(unsafe.Pointer(forWindow))

	ret := C.gtk_icon_set_render_icon_surface(c_iconSet, c_context, c_size, c_scale, c_forWindow)
...
func Fn_gtk_recent_info_get_gicon(info unsafe.Pointer) unsafe.Pointer {
	c_info := (*C.GtkRecentInfo)(unsafe.Pointer(info))

	ret := C.gtk_recent_info_get_gicon(c_info)
...
func Fn_gtk_selection_data_get_data_with_length(selectionData unsafe.Pointer, length *int) []uint8 {
	c_selectionData := (*C.GtkSelectionData)(unsafe.Pointer(selectionData))

	c_length := (*C.gint)(unsafe.Pointer(length))

	ret := C.gtk_selection_data_get_data_with_length(c_selectionData, c_length)
...
func Fn_gtk_selection_data_get_selection(selectionData unsafe.Pointer) unsafe.Pointer {
	c_selectionData := (*C.GtkSelectionData)(unsafe.Pointer(selectionData))

	ret := C.gtk_selection_data_get_selection(c_selectionData)
...
func Fn_gtk_symbolic_color_new_alpha(color unsafe.Pointer, factor float64) unsafe.Pointer {
	c_color := (*C.GtkSymbolicColor)(unsafe.Pointer(color))

	c_factor := (C.gdouble)(factor)

	ret := C.gtk_symbolic_color_new_alpha(c_color, c_factor)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_new_literal(color unsafe.Pointer) unsafe.Pointer {
	c_color := (*C.GdkRGBA)(unsafe.Pointer(color))

	ret := C.gtk_symbolic_color_new_literal(c_color)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_new_mix(color1 unsafe.Pointer, color2 unsafe.Pointer, factor float64) unsafe.Pointer {
	c_color1 := (*C.GtkSymbolicColor)(unsafe.Pointer(color1))

	c_color2 := (*C.GtkSymbolicColor)(unsafe.Pointer(color2))

	c_factor := (C.gdouble)(factor)

	ret := C.gtk_symbolic_color_new_mix(c_color1, c_color2, c_factor)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_new_name(name string) unsafe.Pointer {
	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	ret := C.gtk_symbolic_color_new_name(c_name)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_new_shade(color unsafe.Pointer, factor float64) unsafe.Pointer {
	c_color := (*C.GtkSymbolicColor)(unsafe.Pointer(color))

	c_factor := (C.gdouble)(factor)

	ret := C.gtk_symbolic_color_new_shade(c_color, c_factor)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_new_win32(themeClass string, id int) unsafe.Pointer {
	c_themeClass := (*C.gchar)(C.CString(themeClass))
	defer C.free(unsafe.Pointer(c_themeClass))

	c_id := (C.gint)(id)

	ret := C.gtk_symbolic_color_new_win32(c_themeClass, c_id)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_ref(color unsafe.Pointer) unsafe.Pointer {
	c_color := (*C.GtkSymbolicColor)(unsafe.Pointer(color))

	ret := C.gtk_symbolic_color_ref(c_color)

	return unsafe.Pointer(ret)
}

func Fn_gtk_symbolic_color_resolve(color unsafe.Pointer, props unsafe.Pointer, resolvedColor unsafe.Pointer) bool {
	c_color := (*C.GtkSymbolicColor)(unsafe.Pointer(color))

	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_resolvedColor := (*C.GdkRGBA)(unsafe.Pointer(resolvedColor))

	ret := C.gtk_symbolic_color_resolve(c_color, c_props, c_resolvedColor)
...
func Fn_gtk_symbolic_color_unref(color unsafe.Pointer) {
	c_color := (*C.GtkSymbolicColor)(unsafe.Pointer(color))

	C.gtk_symbolic_color_unref(c_color)
}
...
func Fn_gtk_text_iter_assign(iter unsafe.Pointer, other unsafe.Pointer) {
	c_iter := (*C.GtkTextIter)(unsafe.Pointer(iter))

	c_other := (*C.GtkTextIter)(unsafe.Pointer(other))

	C.gtk_text_iter_assign(c_iter, c_other)
}
...
func Fn_gtk_tree_path_new_from_indicesv(indices []int, length uint64) unsafe.Pointer {
	c_indices := (*C.gint)(unsafe.Pointer(&indices[0]))

	c_length := (C.gsize)(length)

	ret := C.gtk_tree_path_new_from_indicesv(c_indices, c_length)
...
func Fn_gtk_tree_path_get_indices_with_depth(path unsafe.Pointer, depth *int) []int {
	c_path := (*C.GtkTreePath)(unsafe.Pointer(path))

	c_depth := (*C.gint)(unsafe.Pointer(depth))

	ret := C.gtk_tree_path_get_indices_with_depth(c_path, c_depth)
...
func Fn_gtk_widget_class_bind_template_child_full(widgetClass unsafe.Pointer, name string, internalChild bool, structOffset uint64) {
	c_widgetClass := (*C.GtkWidgetClass)(unsafe.Pointer(widgetClass))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	c_internalChild := toCBool(internalChild)

	c_structOffset := (C.gssize)(structOffset)

	C.gtk_widget_class_bind_template_child_full(c_widgetClass, c_name, c_internalChild, c_structOffset)
}
...
func Fn_gtk_widget_class_set_accessible_role(widgetClass unsafe.Pointer, role int) {
	c_widgetClass := (*C.GtkWidgetClass)(unsafe.Pointer(widgetClass))

	c_role := (C.AtkRole)(role)

	C.gtk_widget_class_set_accessible_role(c_widgetClass, c_role)
}

func Fn_gtk_widget_class_set_accessible_type(widgetClass unsafe.Pointer, type_ uint64) {
	c_widgetClass := (*C.GtkWidgetClass)(unsafe.Pointer(widgetClass))

	c_type_ := (C.GType)(type_)

	C.gtk_widget_class_set_accessible_type(c_widgetClass, c_type_)
}

// UNSUPPORTED : gtk_widget_class_set_connect_func : parameter 'connect_func' is callback

func Fn_gtk_widget_class_set_template(widgetClass unsafe.Pointer, templateBytes unsafe.Pointer) {
	c_widgetClass := (*C.GtkWidgetClass)(unsafe.Pointer(widgetClass))

	c_templateBytes := (*C.GBytes)(unsafe.Pointer(templateBytes))

	C.gtk_widget_class_set_template(c_widgetClass, c_templateBytes)
}

func Fn_gtk_widget_class_set_template_from_resource(widgetClass unsafe.Pointer, resourceName string) {
	c_widgetClass := (*C.GtkWidgetClass)(unsafe.Pointer(widgetClass))

	c_resourceName := (*C.gchar)(C.CString(resourceName))
	defer C.free(unsafe.Pointer(c_resourceName))

	C.gtk_widget_class_set_template_from_resource(c_widgetClass, c_resourceName)
}
...
func Fn_gtk_widget_path_append_for_widget(path unsafe.Pointer, widget unsafe.Pointer) int {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_path_append_for_widget(c_path, c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_path_append_type(path unsafe.Pointer, type_ uint64) int {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_type_ := (C.GType)(type_)

	ret := C.gtk_widget_path_append_type(c_path, c_type_)

	return (int)(ret)
}

func Fn_gtk_widget_path_append_with_siblings(path unsafe.Pointer, siblings unsafe.Pointer, siblingIndex uint) int {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_siblings := (*C.GtkWidgetPath)(unsafe.Pointer(siblings))

	c_siblingIndex := (C.guint)(siblingIndex)

	ret := C.gtk_widget_path_append_with_siblings(c_path, c_siblings, c_siblingIndex)

	return (int)(ret)
}

func Fn_gtk_widget_path_copy(path unsafe.Pointer) unsafe.Pointer {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_widget_path_copy(c_path)

	return unsafe.Pointer(ret)
}

func Fn_gtk_widget_path_free(path unsafe.Pointer) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	C.gtk_widget_path_free(c_path)
}

func Fn_gtk_widget_path_get_object_type(path unsafe.Pointer) uint64 {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_widget_path_get_object_type(c_path)

	return (uint64)(ret)
}

func Fn_gtk_widget_path_has_parent(path unsafe.Pointer, type_ uint64) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_type_ := (C.GType)(type_)

	ret := C.gtk_widget_path_has_parent(c_path, c_type_)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_is_type(path unsafe.Pointer, type_ uint64) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_type_ := (C.GType)(type_)

	ret := C.gtk_widget_path_is_type(c_path, c_type_)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_add_class(path unsafe.Pointer, pos int, name string) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_add_class(c_path, c_pos, c_name)
}

func Fn_gtk_widget_path_iter_add_region(path unsafe.Pointer, pos int, name string, flags int) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_add_region(c_path, c_pos, c_name, c_flags)
}

func Fn_gtk_widget_path_iter_clear_classes(path unsafe.Pointer, pos int) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_pos := (C.gint)(pos)

	C.gtk_widget_path_iter_clear_classes(c_path, c_pos)
}

func Fn_gtk_widget_path_iter_clear_regions(path unsafe.Pointer, pos int) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_pos := (C.gint)(pos)

	C.gtk_widget_path_iter_clear_regions(c_path, c_pos)
}
...
func Fn_gtk_widget_path_iter_get_object_type(path unsafe.Pointer, pos int) uint64 {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_pos := (C.gint)(pos)

	ret := C.gtk_widget_path_iter_get_object_type(c_path, c_pos)
...
func Fn_gtk_widget_path_iter_has_class(path unsafe.Pointer, pos int, name string) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	ret := C.gtk_widget_path_iter_has_class(c_path, c_pos, c_name)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_has_name(path unsafe.Pointer, pos int, name string) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	ret := C.gtk_widget_path_iter_has_name(c_path, c_pos, c_name)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_has_qclass(path unsafe.Pointer, pos int, qname uint32) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	ret := C.gtk_widget_path_iter_has_qclass(c_path, c_pos, c_qname)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_has_qname(path unsafe.Pointer, pos int, qname uint32) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	ret := C.gtk_widget_path_iter_has_qname(c_path, c_pos, c_qname)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_has_qregion(path unsafe.Pointer, pos int, qname uint32, flags *int) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	c_flags := (*C.GtkRegionFlags)(unsafe.Pointer(flags))

	ret := C.gtk_widget_path_iter_has_qregion(c_path, c_pos, c_qname, c_flags)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_has_region(path unsafe.Pointer, pos int, name string, flags *int) bool {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	ret := C.gtk_widget_path_iter_has_region(c_path, c_pos, c_name, c_flags)

	return toGoBool(ret)
}

func Fn_gtk_widget_path_iter_list_classes(path unsafe.Pointer, pos int) unsafe.Pointer {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_pos := (C.gint)(pos)

	ret := C.gtk_widget_path_iter_list_classes(c_path, c_pos)

	return unsafe.Pointer(ret)
}

func Fn_gtk_widget_path_iter_list_regions(path unsafe.Pointer, pos int) unsafe.Pointer {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_pos := (C.gint)(pos)

	ret := C.gtk_widget_path_iter_list_regions(c_path, c_pos)

	return unsafe.Pointer(ret)
}

func Fn_gtk_widget_path_iter_remove_class(path unsafe.Pointer, pos int, name string) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_remove_class(c_path, c_pos, c_name)
}

func Fn_gtk_widget_path_iter_remove_region(path unsafe.Pointer, pos int, name string) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_remove_region(c_path, c_pos, c_name)
}

func Fn_gtk_widget_path_iter_set_name(path unsafe.Pointer, pos int, name string) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_set_name(c_path, c_pos, c_name)
}

func Fn_gtk_widget_path_iter_set_object_type(path unsafe.Pointer, pos int, type_ uint64) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))
	...
	C.gtk_widget_path_iter_set_object_type(c_path, c_pos, c_type_)
}

func Fn_gtk_widget_path_length(path unsafe.Pointer) int {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_widget_path_length(c_path)

	return (int)(ret)
}

func Fn_gtk_widget_path_prepend_type(path unsafe.Pointer, type_ uint64) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	c_type_ := (C.GType)(type_)

	C.gtk_widget_path_prepend_type(c_path, c_type_)
}

func Fn_gtk_widget_path_ref(path unsafe.Pointer) unsafe.Pointer {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_widget_path_ref(c_path)

	return unsafe.Pointer(ret)
}

func Fn_gtk_widget_path_to_string(path unsafe.Pointer) string {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_widget_path_to_string(c_path)

	return C.GoString(ret)
}

func Fn_gtk_widget_path_unref(path unsafe.Pointer) {
	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	C.gtk_widget_path_unref(c_path)
}
...
func Fn_gtk_accelerator_get_label_with_keycode(display unsafe.Pointer, acceleratorKey uint, keycode uint, acceleratorMods int) string {
	...
	ret := C.gtk_accelerator_get_label_with_keycode(c_display, c_acceleratorKey, c_keycode, c_acceleratorMods)
...
func Fn_gtk_accelerator_name_with_keycode(display unsafe.Pointer, acceleratorKey uint, keycode uint, acceleratorMods int) string {
	c_display := (*C.GdkDisplay)(unsafe.Pointer(display))
	...
	ret := C.gtk_accelerator_name_with_keycode(c_display, c_acceleratorKey, c_keycode, c_acceleratorMods)
...
func Fn_gtk_accelerator_parse_with_keycode(accelerator string, acceleratorKey *uint, acceleratorCodes *[]uint, acceleratorMods *int) {
	c_accelerator := (*C.gchar)(C.CString(accelerator))
	defer C.free(unsafe.Pointer(c_accelerator))
	...
	// TODO
	var c_acceleratorCodesArrayPointer (*C.guint)
	c_acceleratorCodes := &c_acceleratorCodesArrayPointer

	c_acceleratorMods := (*C.GdkModifierType)(unsafe.Pointer(acceleratorMods))

	C.gtk_accelerator_parse_with_keycode(c_accelerator, c_acceleratorKey, c_acceleratorCodes, c_acceleratorMods)
...
func Fn_gtk_cairo_should_draw_window(cr unsafe.Pointer, window unsafe.Pointer) bool {
	c_cr := (*C.cairo_t)(unsafe.Pointer(cr))

	c_window := (*C.GdkWindow)(unsafe.Pointer(window))

	ret := C.gtk_cairo_should_draw_window(c_cr, c_window)

	return toGoBool(ret)
}

func Fn_gtk_cairo_transform_to_window(cr unsafe.Pointer, widget unsafe.Pointer, window unsafe.Pointer) {
	c_cr := (*C.cairo_t)(unsafe.Pointer(cr))
...
func Fn_gtk_device_grab_add(widget unsafe.Pointer, device unsafe.Pointer, blockOthers bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	c_blockOthers := toCBool(blockOthers)

	C.gtk_device_grab_add(c_widget, c_device, c_blockOthers)
}

func Fn_gtk_device_grab_remove(widget unsafe.Pointer, device unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
...
func Fn_gtk_drag_set_icon_gicon(context unsafe.Pointer, icon unsafe.Pointer, hotX int, hotY int) {
	c_context := (*C.GdkDragContext)(unsafe.Pointer(context))
	...
	C.gtk_drag_set_icon_gicon(c_context, c_icon, c_hotX, c_hotY)
}
...
func Fn_gtk_draw_insertion_cursor(widget unsafe.Pointer, cr unsafe.Pointer, location unsafe.Pointer, isPrimary bool, direction int, drawArrow bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	c_isPrimary := toCBool(isPrimary)

	c_direction := (C.GtkTextDirection)(direction)

	c_drawArrow := toCBool(drawArrow)

	C.gtk_draw_insertion_cursor(c_widget, c_cr, c_location, c_isPrimary, c_direction, c_drawArrow)
}
...
func Fn_gtk_render_activity(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_arrow(context unsafe.Pointer, cr unsafe.Pointer, angle float64, x float64, y float64, size float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_background(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_check(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_expander(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_extension(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64, gapSide int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_render_extension(c_context, c_cr, c_x, c_y, c_width, c_height, c_gapSide)
}

func Fn_gtk_render_focus(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_frame(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_frame_gap(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64, gapSide int, xy0Gap float64, xy1Gap float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	c_xy0Gap := (C.gdouble)(xy0Gap)

	c_xy1Gap := (C.gdouble)(xy1Gap)

	C.gtk_render_frame_gap(c_context, c_cr, c_x, c_y, c_width, c_height, c_gapSide, c_xy0Gap, c_xy1Gap)
}

func Fn_gtk_render_handle(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_icon(context unsafe.Pointer, cr unsafe.Pointer, pixbuf unsafe.Pointer, x float64, y float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_icon_pixbuf(context unsafe.Pointer, source unsafe.Pointer, size int) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	ret := C.gtk_render_icon_pixbuf(c_context, c_source, c_size)

	return unsafe.Pointer(ret)
}

func Fn_gtk_render_icon_surface(context unsafe.Pointer, cr unsafe.Pointer, surface unsafe.Pointer, x float64, y float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_insertion_cursor(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, layout unsafe.Pointer, index int, direction int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_layout(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, layout unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_line(context unsafe.Pointer, cr unsafe.Pointer, x0 float64, y0 float64, x1 float64, y1 float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_option(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_render_slider(context unsafe.Pointer, cr unsafe.Pointer, x float64, y float64, width float64, height float64, orientation int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
...
func Fn_gtk_test_widget_wait_for_draw(widget unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
...
func Fn_gtk_about_dialog_add_credit_section(about unsafe.Pointer, sectionName string, people []string) {
	c_about := (*C.GtkAboutDialog)(unsafe.Pointer(about))

	c_sectionName := (*C.gchar)(C.CString(sectionName))
	defer C.free(unsafe.Pointer(c_sectionName))

	peopleLen := len(people)
	c_peopleArray := C.malloc((C.ulong)(peopleLen) * C.sizeof_gpointer)
	defer C.free(unsafe.Pointer(c_peopleArray))
	peopleSlice := (*[1 << 30](*C.gchar))(unsafe.Pointer(c_peopleArray))[:peopleLen:peopleLen]
	for peoplei, peopleString := range people {
		peopleSlice[peoplei] = (*C.gchar)(C.CString(peopleString))
		defer C.free(unsafe.Pointer(peopleSlice[peoplei]))
	}
	c_people := &peopleSlice[0]

	C.gtk_about_dialog_add_credit_section(c_about, c_sectionName, c_people)
}
...
func Fn_gtk_about_dialog_get_license_type(about unsafe.Pointer) int {
	c_about := (*C.GtkAboutDialog)(unsafe.Pointer(about))

	ret := C.gtk_about_dialog_get_license_type(c_about)
...
func Fn_gtk_about_dialog_set_license_type(about unsafe.Pointer, licenseType int) {
	c_about := (*C.GtkAboutDialog)(unsafe.Pointer(about))

	c_licenseType := (C.GtkLicense)(licenseType)

	C.gtk_about_dialog_set_license_type(c_about, c_licenseType)
}
...
func Fn_gtk_accel_label_get_accel(accelLabel unsafe.Pointer, acceleratorKey *uint, acceleratorMods *int) {
	...
	C.gtk_accel_label_get_accel(c_accelLabel, c_acceleratorKey, c_acceleratorMods)
}
...
func Fn_gtk_accel_label_set_accel(accelLabel unsafe.Pointer, acceleratorKey uint, acceleratorMods int) {
	c_accelLabel := (*C.GtkAccelLabel)(unsafe.Pointer(accelLabel))
	...
	C.gtk_accel_label_set_accel(c_accelLabel, c_acceleratorKey, c_acceleratorMods)
}
...
func Fn_gtk_accessible_get_widget(accessible unsafe.Pointer) unsafe.Pointer {
	c_accessible := (*C.GtkAccessible)(unsafe.Pointer(accessible))

	ret := C.gtk_accessible_get_widget(c_accessible)

	return unsafe.Pointer(ret)
}

func Fn_gtk_accessible_set_widget(accessible unsafe.Pointer, widget unsafe.Pointer) {
	c_accessible := (*C.GtkAccessible)(unsafe.Pointer(accessible))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_accessible_set_widget(c_accessible, c_widget)
}
...
func Fn_gtk_action_block_activate(action unsafe.Pointer) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	C.gtk_action_block_activate(c_action)
}
...
func Fn_gtk_action_get_always_show_image(action unsafe.Pointer) bool {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_always_show_image(c_action)

	return toGoBool(ret)
}

func Fn_gtk_action_get_gicon(action unsafe.Pointer) unsafe.Pointer {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_gicon(c_action)

	return unsafe.Pointer(ret)
}

func Fn_gtk_action_get_icon_name(action unsafe.Pointer) string {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_icon_name(c_action)

	return C.GoString(ret)
}

func Fn_gtk_action_get_is_important(action unsafe.Pointer) bool {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_is_important(c_action)

	return toGoBool(ret)
}

func Fn_gtk_action_get_label(action unsafe.Pointer) string {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_label(c_action)
...
func Fn_gtk_action_get_short_label(action unsafe.Pointer) string {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_short_label(c_action)

	return C.GoString(ret)
}

func Fn_gtk_action_get_stock_id(action unsafe.Pointer) string {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_stock_id(c_action)

	return C.GoString(ret)
}

func Fn_gtk_action_get_tooltip(action unsafe.Pointer) string {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_tooltip(c_action)
...
func Fn_gtk_action_get_visible_horizontal(action unsafe.Pointer) bool {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_visible_horizontal(c_action)

	return toGoBool(ret)
}

func Fn_gtk_action_get_visible_vertical(action unsafe.Pointer) bool {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	ret := C.gtk_action_get_visible_vertical(c_action)
...
func Fn_gtk_action_set_always_show_image(action unsafe.Pointer, alwaysShow bool) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_alwaysShow := toCBool(alwaysShow)

	C.gtk_action_set_always_show_image(c_action, c_alwaysShow)
}

func Fn_gtk_action_set_gicon(action unsafe.Pointer, icon unsafe.Pointer) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_icon := (*C.GIcon)(unsafe.Pointer(icon))

	C.gtk_action_set_gicon(c_action, c_icon)
}

func Fn_gtk_action_set_icon_name(action unsafe.Pointer, iconName string) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_iconName := (*C.gchar)(C.CString(iconName))
	defer C.free(unsafe.Pointer(c_iconName))

	C.gtk_action_set_icon_name(c_action, c_iconName)
}

func Fn_gtk_action_set_is_important(action unsafe.Pointer, isImportant bool) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_isImportant := toCBool(isImportant)

	C.gtk_action_set_is_important(c_action, c_isImportant)
}

func Fn_gtk_action_set_label(action unsafe.Pointer, label string) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_label := (*C.gchar)(C.CString(label))
	defer C.free(unsafe.Pointer(c_label))

	C.gtk_action_set_label(c_action, c_label)
}
...
func Fn_gtk_action_set_short_label(action unsafe.Pointer, shortLabel string) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_shortLabel := (*C.gchar)(C.CString(shortLabel))
	defer C.free(unsafe.Pointer(c_shortLabel))

	C.gtk_action_set_short_label(c_action, c_shortLabel)
}

func Fn_gtk_action_set_stock_id(action unsafe.Pointer, stockId string) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_stockId := (*C.gchar)(C.CString(stockId))
	defer C.free(unsafe.Pointer(c_stockId))

	C.gtk_action_set_stock_id(c_action, c_stockId)
}

func Fn_gtk_action_set_tooltip(action unsafe.Pointer, tooltip string) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_tooltip := (*C.gchar)(C.CString(tooltip))
	defer C.free(unsafe.Pointer(c_tooltip))

	C.gtk_action_set_tooltip(c_action, c_tooltip)
}
...
func Fn_gtk_action_set_visible_horizontal(action unsafe.Pointer, visibleHorizontal bool) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_visibleHorizontal := toCBool(visibleHorizontal)

	C.gtk_action_set_visible_horizontal(c_action, c_visibleHorizontal)
}

func Fn_gtk_action_set_visible_vertical(action unsafe.Pointer, visibleVertical bool) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	c_visibleVertical := toCBool(visibleVertical)

	C.gtk_action_set_visible_vertical(c_action, c_visibleVertical)
}

func Fn_gtk_action_unblock_activate(action unsafe.Pointer) {
	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	C.gtk_action_unblock_activate(c_action)
}
...
func Fn_gtk_action_bar_get_center_widget(actionBar unsafe.Pointer) unsafe.Pointer {
	c_actionBar := (*C.GtkActionBar)(unsafe.Pointer(actionBar))

	ret := C.gtk_action_bar_get_center_widget(c_actionBar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_action_bar_pack_end(actionBar unsafe.Pointer, child unsafe.Pointer) {
	c_actionBar := (*C.GtkActionBar)(unsafe.Pointer(actionBar))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_action_bar_pack_end(c_actionBar, c_child)
}

func Fn_gtk_action_bar_pack_start(actionBar unsafe.Pointer, child unsafe.Pointer) {
	c_actionBar := (*C.GtkActionBar)(unsafe.Pointer(actionBar))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_action_bar_pack_start(c_actionBar, c_child)
}

func Fn_gtk_action_bar_set_center_widget(actionBar unsafe.Pointer, centerWidget unsafe.Pointer) {
	c_actionBar := (*C.GtkActionBar)(unsafe.Pointer(actionBar))

	c_centerWidget := (*C.GtkWidget)(unsafe.Pointer(centerWidget))

	C.gtk_action_bar_set_center_widget(c_actionBar, c_centerWidget)
}
...
func Fn_gtk_action_group_get_accel_group(actionGroup unsafe.Pointer) unsafe.Pointer {
	c_actionGroup := (*C.GtkActionGroup)(unsafe.Pointer(actionGroup))

	ret := C.gtk_action_group_get_accel_group(c_actionGroup)
...
func Fn_gtk_action_group_set_accel_group(actionGroup unsafe.Pointer, accelGroup unsafe.Pointer) {
	c_actionGroup := (*C.GtkActionGroup)(unsafe.Pointer(actionGroup))

	c_accelGroup := (*C.GtkAccelGroup)(unsafe.Pointer(accelGroup))

	C.gtk_action_group_set_accel_group(c_actionGroup, c_accelGroup)
}
...
func Fn_gtk_adjustment_get_minimum_increment(adjustment unsafe.Pointer) float64 {
	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	ret := C.gtk_adjustment_get_minimum_increment(c_adjustment)
...
func Fn_gtk_app_chooser_button_new(contentType string) unsafe.Pointer {
	c_contentType := (*C.gchar)(C.CString(contentType))
	defer C.free(unsafe.Pointer(c_contentType))

	ret := C.gtk_app_chooser_button_new(c_contentType)

	return unsafe.Pointer(ret)
}

func Fn_gtk_app_chooser_button_append_custom_item(self unsafe.Pointer, name string, label string, icon unsafe.Pointer) {
	...
	C.gtk_app_chooser_button_append_custom_item(c_self, c_name, c_label, c_icon)
}

func Fn_gtk_app_chooser_button_append_separator(self unsafe.Pointer) {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	C.gtk_app_chooser_button_append_separator(c_self)
}
...
func Fn_gtk_app_chooser_button_get_show_default_item(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_button_get_show_default_item(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_button_get_show_dialog_item(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_button_get_show_dialog_item(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_button_set_active_custom_item(self unsafe.Pointer, name string) {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	C.gtk_app_chooser_button_set_active_custom_item(c_self, c_name)
}
...
func Fn_gtk_app_chooser_button_set_show_default_item(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_button_set_show_default_item(c_self, c_setting)
}

func Fn_gtk_app_chooser_button_set_show_dialog_item(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserButton)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_button_set_show_dialog_item(c_self, c_setting)
}

func Fn_gtk_app_chooser_dialog_new(parent unsafe.Pointer, flags int, file unsafe.Pointer) unsafe.Pointer {
	c_parent := (*C.GtkWindow)(unsafe.Pointer(parent))
	...
	ret := C.gtk_app_chooser_dialog_new(c_parent, c_flags, c_file)

	return unsafe.Pointer(ret)
}

func Fn_gtk_app_chooser_dialog_new_for_content_type(parent unsafe.Pointer, flags int, contentType string) unsafe.Pointer {
	c_parent := (*C.GtkWindow)(unsafe.Pointer(parent))
	...
	ret := C.gtk_app_chooser_dialog_new_for_content_type(c_parent, c_flags, c_contentType)
...
func Fn_gtk_app_chooser_dialog_get_widget(self unsafe.Pointer) unsafe.Pointer {
	c_self := (*C.GtkAppChooserDialog)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_dialog_get_widget(c_self)
...
func Fn_gtk_app_chooser_widget_new(contentType string) unsafe.Pointer {
	c_contentType := (*C.gchar)(C.CString(contentType))
	defer C.free(unsafe.Pointer(c_contentType))

	ret := C.gtk_app_chooser_widget_new(c_contentType)

	return unsafe.Pointer(ret)
}

func Fn_gtk_app_chooser_widget_get_default_text(self unsafe.Pointer) string {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_default_text(c_self)

	return C.GoString(ret)
}

func Fn_gtk_app_chooser_widget_get_show_all(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_show_all(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_widget_get_show_default(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_show_default(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_widget_get_show_fallback(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_show_fallback(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_widget_get_show_other(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_show_other(c_self)

	return toGoBool(ret)
}

func Fn_gtk_app_chooser_widget_get_show_recommended(self unsafe.Pointer) bool {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_widget_get_show_recommended(c_self)
...
func Fn_gtk_app_chooser_widget_set_show_all(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_widget_set_show_all(c_self, c_setting)
}

func Fn_gtk_app_chooser_widget_set_show_default(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_widget_set_show_default(c_self, c_setting)
}

func Fn_gtk_app_chooser_widget_set_show_fallback(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_widget_set_show_fallback(c_self, c_setting)
}

func Fn_gtk_app_chooser_widget_set_show_other(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_widget_set_show_other(c_self, c_setting)
}

func Fn_gtk_app_chooser_widget_set_show_recommended(self unsafe.Pointer, setting bool) {
	c_self := (*C.GtkAppChooserWidget)(unsafe.Pointer(self))

	c_setting := toCBool(setting)

	C.gtk_app_chooser_widget_set_show_recommended(c_self, c_setting)
}

func Fn_gtk_application_new(applicationId *string, flags int) unsafe.Pointer {
	...
	ret := C.gtk_application_new(c_applicationId, c_flags)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_add_accelerator(application unsafe.Pointer, accelerator string, actionName string, parameter unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))
	...
	C.gtk_application_add_accelerator(c_application, c_accelerator, c_actionName, c_parameter)
}

func Fn_gtk_application_add_window(application unsafe.Pointer, window unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	C.gtk_application_add_window(c_application, c_window)
}
...
func Fn_gtk_application_get_active_window(application unsafe.Pointer) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	ret := C.gtk_application_get_active_window(c_application)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_get_app_menu(application unsafe.Pointer) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	ret := C.gtk_application_get_app_menu(c_application)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_get_menubar(application unsafe.Pointer) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	ret := C.gtk_application_get_menubar(c_application)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_get_window_by_id(application unsafe.Pointer, id uint) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_id := (C.guint)(id)

	ret := C.gtk_application_get_window_by_id(c_application, c_id)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_get_windows(application unsafe.Pointer) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	ret := C.gtk_application_get_windows(c_application)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_inhibit(application unsafe.Pointer, window unsafe.Pointer, flags int, reason *string) uint {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))
	...
	var c_reasonValue (*C.gchar)
	if reason != nil {
		c_reasonValue = (*C.gchar)(C.CString(*reason))
		defer C.free(unsafe.Pointer(c_reasonValue))
	}
	c_reason := c_reasonValue

	ret := C.gtk_application_inhibit(c_application, c_window, c_flags, c_reason)

	return (uint)(ret)
}

func Fn_gtk_application_is_inhibited(application unsafe.Pointer, flags int) bool {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_flags := (C.GtkApplicationInhibitFlags)(flags)

	ret := C.gtk_application_is_inhibited(c_application, c_flags)
...
func Fn_gtk_application_remove_accelerator(application unsafe.Pointer, actionName string, parameter unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))
	...
	C.gtk_application_remove_accelerator(c_application, c_actionName, c_parameter)
}

func Fn_gtk_application_remove_window(application unsafe.Pointer, window unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	C.gtk_application_remove_window(c_application, c_window)
}

func Fn_gtk_application_set_accels_for_action(application unsafe.Pointer, detailedActionName string, accels []string) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_detailedActionName := (*C.gchar)(C.CString(detailedActionName))
	defer C.free(unsafe.Pointer(c_detailedActionName))

	accelsLen := len(accels)
	c_accelsArray := C.malloc((C.ulong)(accelsLen) * C.sizeof_gpointer)
	defer C.free(unsafe.Pointer(c_accelsArray))
	accelsSlice := (*[1 << 30](*C.gchar))(unsafe.Pointer(c_accelsArray))[:accelsLen:accelsLen]
	for accelsi, accelsString := range accels {
		accelsSlice[accelsi] = (*C.gchar)(C.CString(accelsString))
		defer C.free(unsafe.Pointer(accelsSlice[accelsi]))
	}
	c_accels := &accelsSlice[0]

	C.gtk_application_set_accels_for_action(c_application, c_detailedActionName, c_accels)
}

func Fn_gtk_application_set_app_menu(application unsafe.Pointer, appMenu unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_appMenu := (*C.GMenuModel)(unsafe.Pointer(appMenu))

	C.gtk_application_set_app_menu(c_application, c_appMenu)
}

func Fn_gtk_application_set_menubar(application unsafe.Pointer, menubar unsafe.Pointer) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_menubar := (*C.GMenuModel)(unsafe.Pointer(menubar))

	C.gtk_application_set_menubar(c_application, c_menubar)
}

func Fn_gtk_application_uninhibit(application unsafe.Pointer, cookie uint) {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	c_cookie := (C.guint)(cookie)

	C.gtk_application_uninhibit(c_application, c_cookie)
}

func Fn_gtk_application_window_new(application unsafe.Pointer) unsafe.Pointer {
	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	ret := C.gtk_application_window_new(c_application)

	return unsafe.Pointer(ret)
}

func Fn_gtk_application_window_get_id(window unsafe.Pointer) uint {
	c_window := (*C.GtkApplicationWindow)(unsafe.Pointer(window))

	ret := C.gtk_application_window_get_id(c_window)

	return (uint)(ret)
}

func Fn_gtk_application_window_get_show_menubar(window unsafe.Pointer) bool {
	c_window := (*C.GtkApplicationWindow)(unsafe.Pointer(window))

	ret := C.gtk_application_window_get_show_menubar(c_window)

	return toGoBool(ret)
}

func Fn_gtk_application_window_set_show_menubar(window unsafe.Pointer, showMenubar bool) {
	c_window := (*C.GtkApplicationWindow)(unsafe.Pointer(window))

	c_showMenubar := toCBool(showMenubar)

	C.gtk_application_window_set_show_menubar(c_window, c_showMenubar)
}
...
func Fn_gtk_assistant_commit(assistant unsafe.Pointer) {
	c_assistant := (*C.GtkAssistant)(unsafe.Pointer(assistant))

	C.gtk_assistant_commit(c_assistant)
}
...
func Fn_gtk_assistant_next_page(assistant unsafe.Pointer) {
	c_assistant := (*C.GtkAssistant)(unsafe.Pointer(assistant))

	C.gtk_assistant_next_page(c_assistant)
}
...
func Fn_gtk_assistant_previous_page(assistant unsafe.Pointer) {
	c_assistant := (*C.GtkAssistant)(unsafe.Pointer(assistant))

	C.gtk_assistant_previous_page(c_assistant)
}
...
func Fn_gtk_assistant_remove_page(assistant unsafe.Pointer, pageNum int) {
	c_assistant := (*C.GtkAssistant)(unsafe.Pointer(assistant))

	c_pageNum := (C.gint)(pageNum)

	C.gtk_assistant_remove_page(c_assistant, c_pageNum)
}
...
func Fn_gtk_box_new(orientation int, spacing int) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	c_spacing := (C.gint)(spacing)

	ret := C.gtk_box_new(c_orientation, c_spacing)

	return unsafe.Pointer(ret)
}

func Fn_gtk_box_get_baseline_position(box unsafe.Pointer) int {
	c_box := (*C.GtkBox)(unsafe.Pointer(box))

	ret := C.gtk_box_get_baseline_position(c_box)

	return (int)(ret)
}

func Fn_gtk_box_get_center_widget(box unsafe.Pointer) unsafe.Pointer {
	c_box := (*C.GtkBox)(unsafe.Pointer(box))

	ret := C.gtk_box_get_center_widget(c_box)
...
func Fn_gtk_box_set_baseline_position(box unsafe.Pointer, position int) {
	c_box := (*C.GtkBox)(unsafe.Pointer(box))

	c_position := (C.GtkBaselinePosition)(position)

	C.gtk_box_set_baseline_position(c_box, c_position)
}

func Fn_gtk_box_set_center_widget(box unsafe.Pointer, widget unsafe.Pointer) {
	c_box := (*C.GtkBox)(unsafe.Pointer(box))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_box_set_center_widget(c_box, c_widget)
}
...
func Fn_gtk_builder_new_from_file(filename string) unsafe.Pointer {
	c_filename := (*C.gchar)(C.CString(filename))
	defer C.free(unsafe.Pointer(c_filename))

	ret := C.gtk_builder_new_from_file(c_filename)

	return unsafe.Pointer(ret)
}

func Fn_gtk_builder_new_from_resource(resourcePath string) unsafe.Pointer {
	c_resourcePath := (*C.gchar)(C.CString(resourcePath))
	defer C.free(unsafe.Pointer(c_resourcePath))

	ret := C.gtk_builder_new_from_resource(c_resourcePath)

	return unsafe.Pointer(ret)
}

func Fn_gtk_builder_new_from_string(string_ string, length uint64) unsafe.Pointer {
	c_string_ := (*C.gchar)(C.CString(string_))
	defer C.free(unsafe.Pointer(c_string_))

	c_length := (C.gssize)(length)

	ret := C.gtk_builder_new_from_string(c_string_, c_length)
...
func Fn_gtk_builder_add_from_resource(builder unsafe.Pointer, resourcePath string, error unsafe.Pointer) uint {
	c_builder := (*C.GtkBuilder)(unsafe.Pointer(builder))
	...
	ret := C.gtk_builder_add_from_resource(c_builder, c_resourcePath, cError)
...
func Fn_gtk_builder_add_objects_from_resource(builder unsafe.Pointer, resourcePath string, objectIds []string, error unsafe.Pointer) uint {
	c_builder := (*C.GtkBuilder)(unsafe.Pointer(builder))
	...
	ret := C.gtk_builder_add_objects_from_resource(c_builder, c_resourcePath, c_objectIds, cError)
...
func Fn_gtk_builder_expose_object(builder unsafe.Pointer, name string, object unsafe.Pointer) {
	c_builder := (*C.GtkBuilder)(unsafe.Pointer(builder))
	...
	C.gtk_builder_expose_object(c_builder, c_name, c_object)
}
...
func Fn_gtk_builder_get_application(builder unsafe.Pointer) unsafe.Pointer {
	c_builder := (*C.GtkBuilder)(unsafe.Pointer(builder))

	ret := C.gtk_builder_get_application(c_builder)
...
func Fn_gtk_builder_set_application(builder unsafe.Pointer, application unsafe.Pointer) {
	c_builder := (*C.GtkBuilder)(unsafe.Pointer(builder))

	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	C.gtk_builder_set_application(c_builder, c_application)
}
...
func Fn_gtk_button_new_from_icon_name(iconName *string, size int) unsafe.Pointer {
	var c_iconNameValue (*C.gchar)
	if iconName != nil {
		c_iconNameValue = (*C.gchar)(C.CString(*iconName))
		defer C.free(unsafe.Pointer(c_iconNameValue))
	...
	ret := C.gtk_button_new_from_icon_name(c_iconName, c_size)
...
func Fn_gtk_button_get_always_show_image(button unsafe.Pointer) bool {
	c_button := (*C.GtkButton)(unsafe.Pointer(button))

	ret := C.gtk_button_get_always_show_image(c_button)

	return toGoBool(ret)
}

func Fn_gtk_button_get_event_window(button unsafe.Pointer) unsafe.Pointer {
	c_button := (*C.GtkButton)(unsafe.Pointer(button))

	ret := C.gtk_button_get_event_window(c_button)
...
func Fn_gtk_button_set_always_show_image(button unsafe.Pointer, alwaysShow bool) {
	c_button := (*C.GtkButton)(unsafe.Pointer(button))

	c_alwaysShow := toCBool(alwaysShow)

	C.gtk_button_set_always_show_image(c_button, c_alwaysShow)
}
...
func Fn_gtk_button_box_new(orientation int) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	ret := C.gtk_button_box_new(c_orientation)

	return unsafe.Pointer(ret)
}

func Fn_gtk_button_box_get_child_non_homogeneous(widget unsafe.Pointer, child unsafe.Pointer) bool {
	c_widget := (*C.GtkButtonBox)(unsafe.Pointer(widget))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	ret := C.gtk_button_box_get_child_non_homogeneous(c_widget, c_child)
...
func Fn_gtk_button_box_set_child_non_homogeneous(widget unsafe.Pointer, child unsafe.Pointer, nonHomogeneous bool) {
	c_widget := (*C.GtkButtonBox)(unsafe.Pointer(widget))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	c_nonHomogeneous := toCBool(nonHomogeneous)

	C.gtk_button_box_set_child_non_homogeneous(c_widget, c_child, c_nonHomogeneous)
}
...
func Fn_gtk_calendar_get_day_is_marked(calendar unsafe.Pointer, day uint) bool {
	c_calendar := (*C.GtkCalendar)(unsafe.Pointer(calendar))

	c_day := (C.guint)(day)

	ret := C.gtk_calendar_get_day_is_marked(c_calendar, c_day)
...
func Fn_gtk_cell_area_activate(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, cellArea unsafe.Pointer, flags int, editOnly bool) bool {
	...
	c_editOnly := toCBool(editOnly)

	ret := C.gtk_cell_area_activate(c_area, c_context, c_widget, c_cellArea, c_flags, c_editOnly)

	return toGoBool(ret)
}

func Fn_gtk_cell_area_activate_cell(area unsafe.Pointer, widget unsafe.Pointer, renderer unsafe.Pointer, event unsafe.Pointer, cellArea unsafe.Pointer, flags int) bool {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	ret := C.gtk_cell_area_activate_cell(c_area, c_widget, c_renderer, c_event, c_cellArea, c_flags)

	return toGoBool(ret)
}

func Fn_gtk_cell_area_add(area unsafe.Pointer, renderer unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	C.gtk_cell_area_add(c_area, c_renderer)
}

func Fn_gtk_cell_area_add_focus_sibling(area unsafe.Pointer, renderer unsafe.Pointer, sibling unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	c_sibling := (*C.GtkCellRenderer)(unsafe.Pointer(sibling))

	C.gtk_cell_area_add_focus_sibling(c_area, c_renderer, c_sibling)
}

func Fn_gtk_cell_area_add_with_properties(area unsafe.Pointer, renderer unsafe.Pointer, firstPropName string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.c_gtk_cell_area_add_with_properties(c_area, c_renderer, c_firstPropName)
}

func Fn_gtk_cell_area_apply_attributes(area unsafe.Pointer, treeModel unsafe.Pointer, iter unsafe.Pointer, isExpander bool, isExpanded bool) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_apply_attributes(c_area, c_treeModel, c_iter, c_isExpander, c_isExpanded)
}

func Fn_gtk_cell_area_attribute_connect(area unsafe.Pointer, renderer unsafe.Pointer, attribute string, column int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_attribute_connect(c_area, c_renderer, c_attribute, c_column)
}

func Fn_gtk_cell_area_attribute_disconnect(area unsafe.Pointer, renderer unsafe.Pointer, attribute string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_attribute_disconnect(c_area, c_renderer, c_attribute)
}

func Fn_gtk_cell_area_cell_get(area unsafe.Pointer, renderer unsafe.Pointer, firstPropName string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.c_gtk_cell_area_cell_get(c_area, c_renderer, c_firstPropName)
}

func Fn_gtk_cell_area_cell_get_property(area unsafe.Pointer, renderer unsafe.Pointer, propertyName string, value unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_cell_get_property(c_area, c_renderer, c_propertyName, c_value)
}

func Fn_gtk_cell_area_cell_get_valist(area unsafe.Pointer, renderer unsafe.Pointer, firstPropertyName string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.c_gtk_cell_area_cell_get_valist(c_area, c_renderer, c_firstPropertyName)
}

func Fn_gtk_cell_area_cell_set(area unsafe.Pointer, renderer unsafe.Pointer, firstPropName string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.c_gtk_cell_area_cell_set(c_area, c_renderer, c_firstPropName)
}

func Fn_gtk_cell_area_cell_set_property(area unsafe.Pointer, renderer unsafe.Pointer, propertyName string, value unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_cell_set_property(c_area, c_renderer, c_propertyName, c_value)
}

func Fn_gtk_cell_area_cell_set_valist(area unsafe.Pointer, renderer unsafe.Pointer, firstPropertyName string) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.c_gtk_cell_area_cell_set_valist(c_area, c_renderer, c_firstPropertyName)
}

func Fn_gtk_cell_area_copy_context(area unsafe.Pointer, context unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))

	ret := C.gtk_cell_area_copy_context(c_area, c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_create_context(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_create_context(c_area)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_event(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, event unsafe.Pointer, cellArea unsafe.Pointer, flags int) int {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	ret := C.gtk_cell_area_event(c_area, c_context, c_widget, c_event, c_cellArea, c_flags)

	return (int)(ret)
}

func Fn_gtk_cell_area_focus(area unsafe.Pointer, direction int) bool {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_direction := (C.GtkDirectionType)(direction)

	ret := C.gtk_cell_area_focus(c_area, c_direction)
...
func Fn_gtk_cell_area_get_cell_allocation(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, renderer unsafe.Pointer, cellArea unsafe.Pointer, allocation unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_allocation := (*C.GdkRectangle)(unsafe.Pointer(allocation))

	C.gtk_cell_area_get_cell_allocation(c_area, c_context, c_widget, c_renderer, c_cellArea, c_allocation)
}

func Fn_gtk_cell_area_get_cell_at_position(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, cellArea unsafe.Pointer, x int, y int, allocArea unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_allocArea := (*C.GdkRectangle)(unsafe.Pointer(allocArea))

	ret := C.gtk_cell_area_get_cell_at_position(c_area, c_context, c_widget, c_cellArea, c_x, c_y, c_allocArea)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_current_path_string(area unsafe.Pointer) string {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_get_current_path_string(c_area)

	return C.GoString(ret)
}

func Fn_gtk_cell_area_get_edit_widget(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_get_edit_widget(c_area)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_edited_cell(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_get_edited_cell(c_area)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_focus_cell(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_get_focus_cell(c_area)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_focus_from_sibling(area unsafe.Pointer, renderer unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	ret := C.gtk_cell_area_get_focus_from_sibling(c_area, c_renderer)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_focus_siblings(area unsafe.Pointer, renderer unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	ret := C.gtk_cell_area_get_focus_siblings(c_area, c_renderer)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_get_preferred_height(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, minimumHeight *int, naturalHeight *int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_minimumHeight := (*C.gint)(unsafe.Pointer(minimumHeight))

	c_naturalHeight := (*C.gint)(unsafe.Pointer(naturalHeight))

	C.gtk_cell_area_get_preferred_height(c_area, c_context, c_widget, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_area_get_preferred_height_for_width(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, width int, minimumHeight *int, naturalHeight *int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_get_preferred_height_for_width(c_area, c_context, c_widget, c_width, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_area_get_preferred_width(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, minimumWidth *int, naturalWidth *int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_minimumWidth := (*C.gint)(unsafe.Pointer(minimumWidth))

	c_naturalWidth := (*C.gint)(unsafe.Pointer(naturalWidth))

	C.gtk_cell_area_get_preferred_width(c_area, c_context, c_widget, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_cell_area_get_preferred_width_for_height(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, height int, minimumWidth *int, naturalWidth *int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_get_preferred_width_for_height(c_area, c_context, c_widget, c_height, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_cell_area_get_request_mode(area unsafe.Pointer) int {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_get_request_mode(c_area)

	return (int)(ret)
}

func Fn_gtk_cell_area_has_renderer(area unsafe.Pointer, renderer unsafe.Pointer) bool {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	ret := C.gtk_cell_area_has_renderer(c_area, c_renderer)

	return toGoBool(ret)
}

func Fn_gtk_cell_area_inner_cell_area(area unsafe.Pointer, widget unsafe.Pointer, cellArea unsafe.Pointer, innerArea unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_innerArea := (*C.GdkRectangle)(unsafe.Pointer(innerArea))

	C.gtk_cell_area_inner_cell_area(c_area, c_widget, c_cellArea, c_innerArea)
}

func Fn_gtk_cell_area_is_activatable(area unsafe.Pointer) bool {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_cell_area_is_activatable(c_area)

	return toGoBool(ret)
}

func Fn_gtk_cell_area_is_focus_sibling(area unsafe.Pointer, renderer unsafe.Pointer, sibling unsafe.Pointer) bool {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	ret := C.gtk_cell_area_is_focus_sibling(c_area, c_renderer, c_sibling)

	return toGoBool(ret)
}

func Fn_gtk_cell_area_remove(area unsafe.Pointer, renderer unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	C.gtk_cell_area_remove(c_area, c_renderer)
}

func Fn_gtk_cell_area_remove_focus_sibling(area unsafe.Pointer, renderer unsafe.Pointer, sibling unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	C.gtk_cell_area_remove_focus_sibling(c_area, c_renderer, c_sibling)
}

func Fn_gtk_cell_area_render(area unsafe.Pointer, context unsafe.Pointer, widget unsafe.Pointer, cr unsafe.Pointer, backgroundArea unsafe.Pointer, cellArea unsafe.Pointer, flags int, paintFocus bool) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_paintFocus := toCBool(paintFocus)

	C.gtk_cell_area_render(c_area, c_context, c_widget, c_cr, c_backgroundArea, c_cellArea, c_flags, c_paintFocus)
}

func Fn_gtk_cell_area_request_renderer(area unsafe.Pointer, renderer unsafe.Pointer, orientation int, widget unsafe.Pointer, forSize int, minimumSize *int, naturalSize *int) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))
	...
	c_forSize := (C.gint)(forSize)

	c_minimumSize := (*C.gint)(unsafe.Pointer(minimumSize))

	c_naturalSize := (*C.gint)(unsafe.Pointer(naturalSize))

	C.gtk_cell_area_request_renderer(c_area, c_renderer, c_orientation, c_widget, c_forSize, c_minimumSize, c_naturalSize)
}

func Fn_gtk_cell_area_set_focus_cell(area unsafe.Pointer, renderer unsafe.Pointer) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_renderer := (*C.GtkCellRenderer)(unsafe.Pointer(renderer))

	C.gtk_cell_area_set_focus_cell(c_area, c_renderer)
}

func Fn_gtk_cell_area_stop_editing(area unsafe.Pointer, canceled bool) {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	c_canceled := toCBool(canceled)

	C.gtk_cell_area_stop_editing(c_area, c_canceled)
}
...
func Fn_gtk_cell_area_box_get_spacing(box unsafe.Pointer) int {
	c_box := (*C.GtkCellAreaBox)(unsafe.Pointer(box))

	ret := C.gtk_cell_area_box_get_spacing(c_box)

	return (int)(ret)
}

func Fn_gtk_cell_area_box_pack_end(box unsafe.Pointer, renderer unsafe.Pointer, expand bool, align bool, fixed bool) {
	c_box := (*C.GtkCellAreaBox)(unsafe.Pointer(box))
	...
	c_align := toCBool(align)

	c_fixed := toCBool(fixed)

	C.gtk_cell_area_box_pack_end(c_box, c_renderer, c_expand, c_align, c_fixed)
}

func Fn_gtk_cell_area_box_pack_start(box unsafe.Pointer, renderer unsafe.Pointer, expand bool, align bool, fixed bool) {
	c_box := (*C.GtkCellAreaBox)(unsafe.Pointer(box))
	...
	C.gtk_cell_area_box_pack_start(c_box, c_renderer, c_expand, c_align, c_fixed)
}

func Fn_gtk_cell_area_box_set_spacing(box unsafe.Pointer, spacing int) {
	c_box := (*C.GtkCellAreaBox)(unsafe.Pointer(box))

	c_spacing := (C.gint)(spacing)

	C.gtk_cell_area_box_set_spacing(c_box, c_spacing)
}
...
func Fn_gtk_cell_area_context_get_allocation(context unsafe.Pointer, width *int, height *int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))
	...
	C.gtk_cell_area_context_get_allocation(c_context, c_width, c_height)
}

func Fn_gtk_cell_area_context_get_area(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))

	ret := C.gtk_cell_area_context_get_area(c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_cell_area_context_get_preferred_height(context unsafe.Pointer, minimumHeight *int, naturalHeight *int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))
	...
	C.gtk_cell_area_context_get_preferred_height(c_context, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_area_context_get_preferred_height_for_width(context unsafe.Pointer, width int, minimumHeight *int, naturalHeight *int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))
	...
	C.gtk_cell_area_context_get_preferred_height_for_width(c_context, c_width, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_area_context_get_preferred_width(context unsafe.Pointer, minimumWidth *int, naturalWidth *int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))
	...
	C.gtk_cell_area_context_get_preferred_width(c_context, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_cell_area_context_get_preferred_width_for_height(context unsafe.Pointer, height int, minimumWidth *int, naturalWidth *int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))
	...
	C.gtk_cell_area_context_get_preferred_width_for_height(c_context, c_height, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_cell_area_context_push_preferred_height(context unsafe.Pointer, minimumHeight int, naturalHeight int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))

	c_minimumHeight := (C.gint)(minimumHeight)

	c_naturalHeight := (C.gint)(naturalHeight)

	C.gtk_cell_area_context_push_preferred_height(c_context, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_area_context_push_preferred_width(context unsafe.Pointer, minimumWidth int, naturalWidth int) {
	c_context := (*C.GtkCellAreaContext)(unsafe.Pointer(context))

	c_minimumWidth := (C.gint)(minimumWidth)

	c_naturalWidth := (C.gint)(naturalWidth)

	C.gtk_cell_area_context_push_preferred_width(c_context, c_minimumWidth, c_naturalWidth)
}
...
func Fn_gtk_cell_renderer_get_aligned_area(cell unsafe.Pointer, widget unsafe.Pointer, flags int, cellArea unsafe.Pointer, alignedArea unsafe.Pointer) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	c_alignedArea := (*C.GdkRectangle)(unsafe.Pointer(alignedArea))

	C.gtk_cell_renderer_get_aligned_area(c_cell, c_widget, c_flags, c_cellArea, c_alignedArea)
}

func Fn_gtk_cell_renderer_get_alignment(cell unsafe.Pointer, xalign *float32, yalign *float32) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_alignment(c_cell, c_xalign, c_yalign)
}
...
func Fn_gtk_cell_renderer_get_padding(cell unsafe.Pointer, xpad *int, ypad *int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_padding(c_cell, c_xpad, c_ypad)
}

func Fn_gtk_cell_renderer_get_preferred_height(cell unsafe.Pointer, widget unsafe.Pointer, minimumSize *int, naturalSize *int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_preferred_height(c_cell, c_widget, c_minimumSize, c_naturalSize)
}

func Fn_gtk_cell_renderer_get_preferred_height_for_width(cell unsafe.Pointer, widget unsafe.Pointer, width int, minimumHeight *int, naturalHeight *int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_preferred_height_for_width(c_cell, c_widget, c_width, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_cell_renderer_get_preferred_size(cell unsafe.Pointer, widget unsafe.Pointer, minimumSize unsafe.Pointer, naturalSize unsafe.Pointer) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_minimumSize := (*C.GtkRequisition)(unsafe.Pointer(minimumSize))

	c_naturalSize := (*C.GtkRequisition)(unsafe.Pointer(naturalSize))

	C.gtk_cell_renderer_get_preferred_size(c_cell, c_widget, c_minimumSize, c_naturalSize)
}

func Fn_gtk_cell_renderer_get_preferred_width(cell unsafe.Pointer, widget unsafe.Pointer, minimumSize *int, naturalSize *int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_preferred_width(c_cell, c_widget, c_minimumSize, c_naturalSize)
}

func Fn_gtk_cell_renderer_get_preferred_width_for_height(cell unsafe.Pointer, widget unsafe.Pointer, height int, minimumWidth *int, naturalWidth *int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_get_preferred_width_for_height(c_cell, c_widget, c_height, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_cell_renderer_get_request_mode(cell unsafe.Pointer) int {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	ret := C.gtk_cell_renderer_get_request_mode(c_cell)

	return (int)(ret)
}

func Fn_gtk_cell_renderer_get_sensitive(cell unsafe.Pointer) bool {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	ret := C.gtk_cell_renderer_get_sensitive(c_cell)
...
func Fn_gtk_cell_renderer_get_state(cell unsafe.Pointer, widget unsafe.Pointer, cellState int) int {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_cellState := (C.GtkCellRendererState)(cellState)

	ret := C.gtk_cell_renderer_get_state(c_cell, c_widget, c_cellState)

	return (int)(ret)
}

func Fn_gtk_cell_renderer_get_visible(cell unsafe.Pointer) bool {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	ret := C.gtk_cell_renderer_get_visible(c_cell)

	return toGoBool(ret)
}

func Fn_gtk_cell_renderer_is_activatable(cell unsafe.Pointer) bool {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	ret := C.gtk_cell_renderer_is_activatable(c_cell)
...
func Fn_gtk_cell_renderer_set_alignment(cell unsafe.Pointer, xalign float32, yalign float32) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_set_alignment(c_cell, c_xalign, c_yalign)
}
...
func Fn_gtk_cell_renderer_set_padding(cell unsafe.Pointer, xpad int, ypad int) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))
	...
	C.gtk_cell_renderer_set_padding(c_cell, c_xpad, c_ypad)
}

func Fn_gtk_cell_renderer_set_sensitive(cell unsafe.Pointer, sensitive bool) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	c_sensitive := toCBool(sensitive)

	C.gtk_cell_renderer_set_sensitive(c_cell, c_sensitive)
}

func Fn_gtk_cell_renderer_set_visible(cell unsafe.Pointer, visible bool) {
	c_cell := (*C.GtkCellRenderer)(unsafe.Pointer(cell))

	c_visible := toCBool(visible)

	C.gtk_cell_renderer_set_visible(c_cell, c_visible)
}
...
func Fn_gtk_cell_renderer_toggle_get_activatable(toggle unsafe.Pointer) bool {
	c_toggle := (*C.GtkCellRendererToggle)(unsafe.Pointer(toggle))

	ret := C.gtk_cell_renderer_toggle_get_activatable(c_toggle)
...
func Fn_gtk_cell_renderer_toggle_set_activatable(toggle unsafe.Pointer, setting bool) {
	c_toggle := (*C.GtkCellRendererToggle)(unsafe.Pointer(toggle))

	c_setting := toCBool(setting)

	C.gtk_cell_renderer_toggle_set_activatable(c_toggle, c_setting)
}
...
func Fn_gtk_cell_view_get_draw_sensitive(cellView unsafe.Pointer) bool {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	ret := C.gtk_cell_view_get_draw_sensitive(c_cellView)

	return toGoBool(ret)
}

func Fn_gtk_cell_view_get_fit_model(cellView unsafe.Pointer) bool {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	ret := C.gtk_cell_view_get_fit_model(c_cellView)

	return toGoBool(ret)
}

func Fn_gtk_cell_view_get_model(cellView unsafe.Pointer) unsafe.Pointer {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	ret := C.gtk_cell_view_get_model(c_cellView)
...
func Fn_gtk_cell_view_set_background_rgba(cellView unsafe.Pointer, rgba unsafe.Pointer) {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_cell_view_set_background_rgba(c_cellView, c_rgba)
}
...
func Fn_gtk_cell_view_set_draw_sensitive(cellView unsafe.Pointer, drawSensitive bool) {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	c_drawSensitive := toCBool(drawSensitive)

	C.gtk_cell_view_set_draw_sensitive(c_cellView, c_drawSensitive)
}

func Fn_gtk_cell_view_set_fit_model(cellView unsafe.Pointer, fitModel bool) {
	c_cellView := (*C.GtkCellView)(unsafe.Pointer(cellView))

	c_fitModel := toCBool(fitModel)

	C.gtk_cell_view_set_fit_model(c_cellView, c_fitModel)
}
...
func Fn_gtk_color_button_new_with_rgba(rgba unsafe.Pointer) unsafe.Pointer {
	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	ret := C.gtk_color_button_new_with_rgba(c_rgba)
...
func Fn_gtk_color_button_get_rgba(button unsafe.Pointer, rgba unsafe.Pointer) {
	c_button := (*C.GtkColorButton)(unsafe.Pointer(button))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_button_get_rgba(c_button, c_rgba)
}
...
func Fn_gtk_color_button_set_rgba(button unsafe.Pointer, rgba unsafe.Pointer) {
	c_button := (*C.GtkColorButton)(unsafe.Pointer(button))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_button_set_rgba(c_button, c_rgba)
}
...
func Fn_gtk_color_chooser_dialog_new(title *string, parent unsafe.Pointer) unsafe.Pointer {
	...
	ret := C.gtk_color_chooser_dialog_new(c_title, c_parent)
...
func Fn_gtk_color_selection_get_current_rgba(colorsel unsafe.Pointer, rgba unsafe.Pointer) {
	c_colorsel := (*C.GtkColorSelection)(unsafe.Pointer(colorsel))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_selection_get_current_rgba(c_colorsel, c_rgba)
}
...
func Fn_gtk_color_selection_get_previous_rgba(colorsel unsafe.Pointer, rgba unsafe.Pointer) {
	c_colorsel := (*C.GtkColorSelection)(unsafe.Pointer(colorsel))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_selection_get_previous_rgba(c_colorsel, c_rgba)
}
...
func Fn_gtk_color_selection_set_current_rgba(colorsel unsafe.Pointer, rgba unsafe.Pointer) {
	c_colorsel := (*C.GtkColorSelection)(unsafe.Pointer(colorsel))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_selection_set_current_rgba(c_colorsel, c_rgba)
}
...
func Fn_gtk_color_selection_set_previous_rgba(colorsel unsafe.Pointer, rgba unsafe.Pointer) {
	c_colorsel := (*C.GtkColorSelection)(unsafe.Pointer(colorsel))

	c_rgba := (*C.GdkRGBA)(unsafe.Pointer(rgba))

	C.gtk_color_selection_set_previous_rgba(c_colorsel, c_rgba)
}
...
func Fn_gtk_combo_box_new_with_model_and_entry(model unsafe.Pointer) unsafe.Pointer {
	c_model := (*C.GtkTreeModel)(unsafe.Pointer(model))

	ret := C.gtk_combo_box_new_with_model_and_entry(c_model)
...
func Fn_gtk_combo_box_get_active_id(comboBox unsafe.Pointer) string {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_get_active_id(c_comboBox)
...
func Fn_gtk_combo_box_get_entry_text_column(comboBox unsafe.Pointer) int {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_get_entry_text_column(c_comboBox)
...
func Fn_gtk_combo_box_get_has_entry(comboBox unsafe.Pointer) bool {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_get_has_entry(c_comboBox)

	return toGoBool(ret)
}

func Fn_gtk_combo_box_get_id_column(comboBox unsafe.Pointer) int {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_get_id_column(c_comboBox)
...
func Fn_gtk_combo_box_get_popup_fixed_width(comboBox unsafe.Pointer) bool {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_get_popup_fixed_width(c_comboBox)
...
func Fn_gtk_combo_box_popup_for_device(comboBox unsafe.Pointer, device unsafe.Pointer) {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	C.gtk_combo_box_popup_for_device(c_comboBox, c_device)
}
...
func Fn_gtk_combo_box_set_active_id(comboBox unsafe.Pointer, activeId *string) bool {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	var c_activeIdValue (*C.gchar)
	if activeId != nil {
		c_activeIdValue = (*C.gchar)(C.CString(*activeId))
		defer C.free(unsafe.Pointer(c_activeIdValue))
	}
	c_activeId := c_activeIdValue

	ret := C.gtk_combo_box_set_active_id(c_comboBox, c_activeId)
...
func Fn_gtk_combo_box_set_entry_text_column(comboBox unsafe.Pointer, textColumn int) {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	c_textColumn := (C.gint)(textColumn)

	C.gtk_combo_box_set_entry_text_column(c_comboBox, c_textColumn)
}
...
func Fn_gtk_combo_box_set_id_column(comboBox unsafe.Pointer, idColumn int) {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	c_idColumn := (C.gint)(idColumn)

	C.gtk_combo_box_set_id_column(c_comboBox, c_idColumn)
}
...
func Fn_gtk_combo_box_set_popup_fixed_width(comboBox unsafe.Pointer, fixed bool) {
	c_comboBox := (*C.GtkComboBox)(unsafe.Pointer(comboBox))

	c_fixed := toCBool(fixed)

	C.gtk_combo_box_set_popup_fixed_width(c_comboBox, c_fixed)
}
...
func Fn_gtk_combo_box_text_append(comboBox unsafe.Pointer, id *string, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))
	...
	C.gtk_combo_box_text_append(c_comboBox, c_id, c_text)
}

func Fn_gtk_combo_box_text_append_text(comboBox unsafe.Pointer, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))

	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	C.gtk_combo_box_text_append_text(c_comboBox, c_text)
}

func Fn_gtk_combo_box_text_get_active_text(comboBox unsafe.Pointer) string {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))

	ret := C.gtk_combo_box_text_get_active_text(c_comboBox)

	return C.GoString(ret)
}

func Fn_gtk_combo_box_text_insert(comboBox unsafe.Pointer, position int, id *string, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))
	...
	C.gtk_combo_box_text_insert(c_comboBox, c_position, c_id, c_text)
}

func Fn_gtk_combo_box_text_insert_text(comboBox unsafe.Pointer, position int, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))
	...
	C.gtk_combo_box_text_insert_text(c_comboBox, c_position, c_text)
}

func Fn_gtk_combo_box_text_prepend(comboBox unsafe.Pointer, id *string, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))
	...
	C.gtk_combo_box_text_prepend(c_comboBox, c_id, c_text)
}

func Fn_gtk_combo_box_text_prepend_text(comboBox unsafe.Pointer, text string) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))

	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	C.gtk_combo_box_text_prepend_text(c_comboBox, c_text)
}

func Fn_gtk_combo_box_text_remove(comboBox unsafe.Pointer, position int) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))

	c_position := (C.gint)(position)

	C.gtk_combo_box_text_remove(c_comboBox, c_position)
}

func Fn_gtk_combo_box_text_remove_all(comboBox unsafe.Pointer) {
	c_comboBox := (*C.GtkComboBoxText)(unsafe.Pointer(comboBox))

	C.gtk_combo_box_text_remove_all(c_comboBox)
}
...
func Fn_gtk_container_child_notify(container unsafe.Pointer, child unsafe.Pointer, childProperty string) {
	c_container := (*C.GtkContainer)(unsafe.Pointer(container))
	...
	C.gtk_container_child_notify(c_container, c_child, c_childProperty)
}
...
func Fn_gtk_css_provider_to_string(provider unsafe.Pointer) string {
	c_provider := (*C.GtkCssProvider)(unsafe.Pointer(provider))

	ret := C.gtk_css_provider_to_string(c_provider)
...
func Fn_gtk_dialog_get_header_bar(dialog unsafe.Pointer) unsafe.Pointer {
	c_dialog := (*C.GtkDialog)(unsafe.Pointer(dialog))

	ret := C.gtk_dialog_get_header_bar(c_dialog)
...
func Fn_gtk_dialog_get_widget_for_response(dialog unsafe.Pointer, responseId int) unsafe.Pointer {
	c_dialog := (*C.GtkDialog)(unsafe.Pointer(dialog))

	c_responseId := (C.gint)(responseId)

	ret := C.gtk_dialog_get_widget_for_response(c_dialog, c_responseId)
...
func Fn_gtk_entry_new_with_buffer(buffer unsafe.Pointer) unsafe.Pointer {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	ret := C.gtk_entry_new_with_buffer(c_buffer)
...
func Fn_gtk_entry_get_attributes(entry unsafe.Pointer) unsafe.Pointer {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_attributes(c_entry)

	return unsafe.Pointer(ret)
}

func Fn_gtk_entry_get_buffer(entry unsafe.Pointer) unsafe.Pointer {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_buffer(c_entry)
...
func Fn_gtk_entry_get_current_icon_drag_source(entry unsafe.Pointer) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_current_icon_drag_source(c_entry)
...
func Fn_gtk_entry_get_icon_activatable(entry unsafe.Pointer, iconPos int) bool {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_activatable(c_entry, c_iconPos)

	return toGoBool(ret)
}

func Fn_gtk_entry_get_icon_area(entry unsafe.Pointer, iconPos int, iconArea unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	c_iconArea := (*C.GdkRectangle)(unsafe.Pointer(iconArea))

	C.gtk_entry_get_icon_area(c_entry, c_iconPos, c_iconArea)
}

func Fn_gtk_entry_get_icon_at_pos(entry unsafe.Pointer, x int, y int) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	ret := C.gtk_entry_get_icon_at_pos(c_entry, c_x, c_y)

	return (int)(ret)
}

func Fn_gtk_entry_get_icon_gicon(entry unsafe.Pointer, iconPos int) unsafe.Pointer {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_gicon(c_entry, c_iconPos)

	return unsafe.Pointer(ret)
}

func Fn_gtk_entry_get_icon_name(entry unsafe.Pointer, iconPos int) string {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_name(c_entry, c_iconPos)

	return C.GoString(ret)
}

func Fn_gtk_entry_get_icon_pixbuf(entry unsafe.Pointer, iconPos int) unsafe.Pointer {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_pixbuf(c_entry, c_iconPos)

	return unsafe.Pointer(ret)
}

func Fn_gtk_entry_get_icon_sensitive(entry unsafe.Pointer, iconPos int) bool {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_sensitive(c_entry, c_iconPos)

	return toGoBool(ret)
}

func Fn_gtk_entry_get_icon_stock(entry unsafe.Pointer, iconPos int) string {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_stock(c_entry, c_iconPos)

	return C.GoString(ret)
}

func Fn_gtk_entry_get_icon_storage_type(entry unsafe.Pointer, iconPos int) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_storage_type(c_entry, c_iconPos)

	return (int)(ret)
}

func Fn_gtk_entry_get_icon_tooltip_markup(entry unsafe.Pointer, iconPos int) string {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_tooltip_markup(c_entry, c_iconPos)

	return C.GoString(ret)
}

func Fn_gtk_entry_get_icon_tooltip_text(entry unsafe.Pointer, iconPos int) string {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	ret := C.gtk_entry_get_icon_tooltip_text(c_entry, c_iconPos)
...
func Fn_gtk_entry_get_input_hints(entry unsafe.Pointer) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_input_hints(c_entry)

	return (int)(ret)
}

func Fn_gtk_entry_get_input_purpose(entry unsafe.Pointer) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_input_purpose(c_entry)
...
func Fn_gtk_entry_get_max_width_chars(entry unsafe.Pointer) int {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_max_width_chars(c_entry)
...
func Fn_gtk_entry_get_placeholder_text(entry unsafe.Pointer) string {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_placeholder_text(c_entry)

	return C.GoString(ret)
}

func Fn_gtk_entry_get_progress_fraction(entry unsafe.Pointer) float64 {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_progress_fraction(c_entry)

	return (float64)(ret)
}

func Fn_gtk_entry_get_progress_pulse_step(entry unsafe.Pointer) float64 {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_progress_pulse_step(c_entry)

	return (float64)(ret)
}

func Fn_gtk_entry_get_tabs(entry unsafe.Pointer) unsafe.Pointer {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	ret := C.gtk_entry_get_tabs(c_entry)
...
func Fn_gtk_entry_get_text_area(entry unsafe.Pointer, textArea unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_textArea := (*C.GdkRectangle)(unsafe.Pointer(textArea))

	C.gtk_entry_get_text_area(c_entry, c_textArea)
}
...
func Fn_gtk_entry_im_context_filter_keypress(entry unsafe.Pointer, event unsafe.Pointer) bool {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_event := (*C.GdkEventKey)(unsafe.Pointer(event))

	ret := C.gtk_entry_im_context_filter_keypress(c_entry, c_event)
...
func Fn_gtk_entry_progress_pulse(entry unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	C.gtk_entry_progress_pulse(c_entry)
}

func Fn_gtk_entry_reset_im_context(entry unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	C.gtk_entry_reset_im_context(c_entry)
}
...
func Fn_gtk_entry_set_attributes(entry unsafe.Pointer, attrs unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_attrs := (*C.PangoAttrList)(unsafe.Pointer(attrs))

	C.gtk_entry_set_attributes(c_entry, c_attrs)
}

func Fn_gtk_entry_set_buffer(entry unsafe.Pointer, buffer unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	C.gtk_entry_set_buffer(c_entry, c_buffer)
}
...
func Fn_gtk_entry_set_icon_activatable(entry unsafe.Pointer, iconPos int, activatable bool) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_iconPos := (C.GtkEntryIconPosition)(iconPos)

	c_activatable := toCBool(activatable)

	C.gtk_entry_set_icon_activatable(c_entry, c_iconPos, c_activatable)
}

func Fn_gtk_entry_set_icon_drag_source(entry unsafe.Pointer, iconPos int, targetList unsafe.Pointer, actions int) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_drag_source(c_entry, c_iconPos, c_targetList, c_actions)
}

func Fn_gtk_entry_set_icon_from_gicon(entry unsafe.Pointer, iconPos int, icon unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_from_gicon(c_entry, c_iconPos, c_icon)
}

func Fn_gtk_entry_set_icon_from_icon_name(entry unsafe.Pointer, iconPos int, iconName *string) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_from_icon_name(c_entry, c_iconPos, c_iconName)
}

func Fn_gtk_entry_set_icon_from_pixbuf(entry unsafe.Pointer, iconPos int, pixbuf unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_from_pixbuf(c_entry, c_iconPos, c_pixbuf)
}

func Fn_gtk_entry_set_icon_from_stock(entry unsafe.Pointer, iconPos int, stockId *string) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_from_stock(c_entry, c_iconPos, c_stockId)
}

func Fn_gtk_entry_set_icon_sensitive(entry unsafe.Pointer, iconPos int, sensitive bool) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_sensitive(c_entry, c_iconPos, c_sensitive)
}

func Fn_gtk_entry_set_icon_tooltip_markup(entry unsafe.Pointer, iconPos int, tooltip *string) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_tooltip_markup(c_entry, c_iconPos, c_tooltip)
}

func Fn_gtk_entry_set_icon_tooltip_text(entry unsafe.Pointer, iconPos int, tooltip *string) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_icon_tooltip_text(c_entry, c_iconPos, c_tooltip)
}
...
func Fn_gtk_entry_set_input_hints(entry unsafe.Pointer, hints int) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_hints := (C.GtkInputHints)(hints)

	C.gtk_entry_set_input_hints(c_entry, c_hints)
}

func Fn_gtk_entry_set_input_purpose(entry unsafe.Pointer, purpose int) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_purpose := (C.GtkInputPurpose)(purpose)

	C.gtk_entry_set_input_purpose(c_entry, c_purpose)
}
...
func Fn_gtk_entry_set_max_width_chars(entry unsafe.Pointer, nChars int) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_nChars := (C.gint)(nChars)

	C.gtk_entry_set_max_width_chars(c_entry, c_nChars)
}
...
func Fn_gtk_entry_set_placeholder_text(entry unsafe.Pointer, text *string) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))
	...
	C.gtk_entry_set_placeholder_text(c_entry, c_text)
}

func Fn_gtk_entry_set_progress_fraction(entry unsafe.Pointer, fraction float64) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_fraction := (C.gdouble)(fraction)

	C.gtk_entry_set_progress_fraction(c_entry, c_fraction)
}

func Fn_gtk_entry_set_progress_pulse_step(entry unsafe.Pointer, fraction float64) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_fraction := (C.gdouble)(fraction)

	C.gtk_entry_set_progress_pulse_step(c_entry, c_fraction)
}

func Fn_gtk_entry_set_tabs(entry unsafe.Pointer, tabs unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	c_tabs := (*C.PangoTabArray)(unsafe.Pointer(tabs))

	C.gtk_entry_set_tabs(c_entry, c_tabs)
}
...
func Fn_gtk_entry_unset_invisible_char(entry unsafe.Pointer) {
	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	C.gtk_entry_unset_invisible_char(c_entry)
}

func Fn_gtk_entry_buffer_new(initialChars *string, nInitialChars int) unsafe.Pointer {
	var c_initialCharsValue (*C.gchar)
	if initialChars != nil {
		c_initialCharsValue = (*C.gchar)(C.CString(*initialChars))
		defer C.free(unsafe.Pointer(c_initialCharsValue))
	}
	c_initialChars := c_initialCharsValue

	c_nInitialChars := (C.gint)(nInitialChars)

	ret := C.gtk_entry_buffer_new(c_initialChars, c_nInitialChars)

	return unsafe.Pointer(ret)
}

func Fn_gtk_entry_buffer_delete_text(buffer unsafe.Pointer, position uint, nChars int) uint {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))
	...
	ret := C.gtk_entry_buffer_delete_text(c_buffer, c_position, c_nChars)

	return (uint)(ret)
}

func Fn_gtk_entry_buffer_emit_deleted_text(buffer unsafe.Pointer, position uint, nChars uint) {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	c_position := (C.guint)(position)

	c_nChars := (C.guint)(nChars)

	C.gtk_entry_buffer_emit_deleted_text(c_buffer, c_position, c_nChars)
}

func Fn_gtk_entry_buffer_emit_inserted_text(buffer unsafe.Pointer, position uint, chars string, nChars uint) {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	c_position := (C.guint)(position)

	c_chars := (*C.gchar)(C.CString(chars))
	defer C.free(unsafe.Pointer(c_chars))

	c_nChars := (C.guint)(nChars)

	C.gtk_entry_buffer_emit_inserted_text(c_buffer, c_position, c_chars, c_nChars)
}

func Fn_gtk_entry_buffer_get_bytes(buffer unsafe.Pointer) uint64 {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	ret := C.gtk_entry_buffer_get_bytes(c_buffer)

	return (uint64)(ret)
}

func Fn_gtk_entry_buffer_get_length(buffer unsafe.Pointer) uint {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	ret := C.gtk_entry_buffer_get_length(c_buffer)

	return (uint)(ret)
}

func Fn_gtk_entry_buffer_get_max_length(buffer unsafe.Pointer) int {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	ret := C.gtk_entry_buffer_get_max_length(c_buffer)

	return (int)(ret)
}

func Fn_gtk_entry_buffer_get_text(buffer unsafe.Pointer) string {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	ret := C.gtk_entry_buffer_get_text(c_buffer)

	return C.GoString(ret)
}

func Fn_gtk_entry_buffer_insert_text(buffer unsafe.Pointer, position uint, chars string, nChars int) uint {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))
	...
	ret := C.gtk_entry_buffer_insert_text(c_buffer, c_position, c_chars, c_nChars)

	return (uint)(ret)
}

func Fn_gtk_entry_buffer_set_max_length(buffer unsafe.Pointer, maxLength int) {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))

	c_maxLength := (C.gint)(maxLength)

	C.gtk_entry_buffer_set_max_length(c_buffer, c_maxLength)
}

func Fn_gtk_entry_buffer_set_text(buffer unsafe.Pointer, chars string, nChars int) {
	c_buffer := (*C.GtkEntryBuffer)(unsafe.Pointer(buffer))
	...
	C.gtk_entry_buffer_set_text(c_buffer, c_chars, c_nChars)
}
...
func Fn_gtk_entry_completion_new_with_area(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_entry_completion_new_with_area(c_area)
...
func Fn_gtk_entry_completion_compute_prefix(completion unsafe.Pointer, key string) string {
	c_completion := (*C.GtkEntryCompletion)(unsafe.Pointer(completion))

	c_key := (*C.char)(C.CString(key))
	defer C.free(unsafe.Pointer(c_key))

	ret := C.gtk_entry_completion_compute_prefix(c_completion, c_key)
...
func Fn_gtk_expander_get_label_fill(expander unsafe.Pointer) bool {
	c_expander := (*C.GtkExpander)(unsafe.Pointer(expander))

	ret := C.gtk_expander_get_label_fill(c_expander)
...
func Fn_gtk_expander_get_resize_toplevel(expander unsafe.Pointer) bool {
	c_expander := (*C.GtkExpander)(unsafe.Pointer(expander))

	ret := C.gtk_expander_get_resize_toplevel(c_expander)
...
func Fn_gtk_expander_set_label_fill(expander unsafe.Pointer, labelFill bool) {
	c_expander := (*C.GtkExpander)(unsafe.Pointer(expander))

	c_labelFill := toCBool(labelFill)

	C.gtk_expander_set_label_fill(c_expander, c_labelFill)
}
...
func Fn_gtk_expander_set_resize_toplevel(expander unsafe.Pointer, resizeToplevel bool) {
	c_expander := (*C.GtkExpander)(unsafe.Pointer(expander))

	c_resizeToplevel := toCBool(resizeToplevel)

	C.gtk_expander_set_resize_toplevel(c_expander, c_resizeToplevel)
}
...
func Fn_gtk_flow_box_get_activate_on_single_click(box unsafe.Pointer) bool {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_activate_on_single_click(c_box)

	return toGoBool(ret)
}

func Fn_gtk_flow_box_get_child_at_index(box unsafe.Pointer, idx int) unsafe.Pointer {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_idx := (C.gint)(idx)

	ret := C.gtk_flow_box_get_child_at_index(c_box, c_idx)

	return unsafe.Pointer(ret)
}

func Fn_gtk_flow_box_get_column_spacing(box unsafe.Pointer) uint {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_column_spacing(c_box)

	return (uint)(ret)
}

func Fn_gtk_flow_box_get_homogeneous(box unsafe.Pointer) bool {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_homogeneous(c_box)

	return toGoBool(ret)
}

func Fn_gtk_flow_box_get_max_children_per_line(box unsafe.Pointer) uint {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_max_children_per_line(c_box)

	return (uint)(ret)
}

func Fn_gtk_flow_box_get_min_children_per_line(box unsafe.Pointer) uint {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_min_children_per_line(c_box)

	return (uint)(ret)
}

func Fn_gtk_flow_box_get_row_spacing(box unsafe.Pointer) uint {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_row_spacing(c_box)

	return (uint)(ret)
}

func Fn_gtk_flow_box_get_selected_children(box unsafe.Pointer) unsafe.Pointer {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_selected_children(c_box)

	return unsafe.Pointer(ret)
}

func Fn_gtk_flow_box_get_selection_mode(box unsafe.Pointer) int {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	ret := C.gtk_flow_box_get_selection_mode(c_box)

	return (int)(ret)
}

func Fn_gtk_flow_box_insert(box unsafe.Pointer, widget unsafe.Pointer, position int) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))
	...
	C.gtk_flow_box_insert(c_box, c_widget, c_position)
}

func Fn_gtk_flow_box_invalidate_filter(box unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	C.gtk_flow_box_invalidate_filter(c_box)
}

func Fn_gtk_flow_box_invalidate_sort(box unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	C.gtk_flow_box_invalidate_sort(c_box)
}

func Fn_gtk_flow_box_select_all(box unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	C.gtk_flow_box_select_all(c_box)
}

func Fn_gtk_flow_box_select_child(box unsafe.Pointer, child unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_child := (*C.GtkFlowBoxChild)(unsafe.Pointer(child))

	C.gtk_flow_box_select_child(c_box, c_child)
}

// UNSUPPORTED : gtk_flow_box_selected_foreach : parameter 'func' is callback

func Fn_gtk_flow_box_set_activate_on_single_click(box unsafe.Pointer, single bool) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_single := toCBool(single)

	C.gtk_flow_box_set_activate_on_single_click(c_box, c_single)
}

func Fn_gtk_flow_box_set_column_spacing(box unsafe.Pointer, spacing uint) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_spacing := (C.guint)(spacing)

	C.gtk_flow_box_set_column_spacing(c_box, c_spacing)
}

// UNSUPPORTED : gtk_flow_box_set_filter_func : parameter 'filter_func' is callback

func Fn_gtk_flow_box_set_hadjustment(box unsafe.Pointer, adjustment unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	C.gtk_flow_box_set_hadjustment(c_box, c_adjustment)
}

func Fn_gtk_flow_box_set_homogeneous(box unsafe.Pointer, homogeneous bool) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_homogeneous := toCBool(homogeneous)

	C.gtk_flow_box_set_homogeneous(c_box, c_homogeneous)
}

func Fn_gtk_flow_box_set_max_children_per_line(box unsafe.Pointer, nChildren uint) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_nChildren := (C.guint)(nChildren)

	C.gtk_flow_box_set_max_children_per_line(c_box, c_nChildren)
}

func Fn_gtk_flow_box_set_min_children_per_line(box unsafe.Pointer, nChildren uint) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_nChildren := (C.guint)(nChildren)

	C.gtk_flow_box_set_min_children_per_line(c_box, c_nChildren)
}

func Fn_gtk_flow_box_set_row_spacing(box unsafe.Pointer, spacing uint) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_spacing := (C.guint)(spacing)

	C.gtk_flow_box_set_row_spacing(c_box, c_spacing)
}

func Fn_gtk_flow_box_set_selection_mode(box unsafe.Pointer, mode int) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_mode := (C.GtkSelectionMode)(mode)

	C.gtk_flow_box_set_selection_mode(c_box, c_mode)
}

// UNSUPPORTED : gtk_flow_box_set_sort_func : parameter 'sort_func' is callback

func Fn_gtk_flow_box_set_vadjustment(box unsafe.Pointer, adjustment unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	C.gtk_flow_box_set_vadjustment(c_box, c_adjustment)
}

func Fn_gtk_flow_box_unselect_all(box unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	C.gtk_flow_box_unselect_all(c_box)
}

func Fn_gtk_flow_box_unselect_child(box unsafe.Pointer, child unsafe.Pointer) {
	c_box := (*C.GtkFlowBox)(unsafe.Pointer(box))

	c_child := (*C.GtkFlowBoxChild)(unsafe.Pointer(child))

	C.gtk_flow_box_unselect_child(c_box, c_child)
}
...
func Fn_gtk_flow_box_child_changed(child unsafe.Pointer) {
	c_child := (*C.GtkFlowBoxChild)(unsafe.Pointer(child))

	C.gtk_flow_box_child_changed(c_child)
}

func Fn_gtk_flow_box_child_get_index(child unsafe.Pointer) int {
	c_child := (*C.GtkFlowBoxChild)(unsafe.Pointer(child))

	ret := C.gtk_flow_box_child_get_index(c_child)

	return (int)(ret)
}

func Fn_gtk_flow_box_child_is_selected(child unsafe.Pointer) bool {
	c_child := (*C.GtkFlowBoxChild)(unsafe.Pointer(child))

	ret := C.gtk_flow_box_child_is_selected(c_child)
...
func Fn_gtk_font_chooser_dialog_new(title *string, parent unsafe.Pointer) unsafe.Pointer {
	var c_titleValue (*C.gchar)
	if title != nil {
		c_titleValue = (*C.gchar)(C.CString(*title))
		defer C.free(unsafe.Pointer(c_titleValue))
	...
	ret := C.gtk_font_chooser_dialog_new(c_title, c_parent)
...
func Fn_gtk_font_selection_dialog_get_font_selection(fsd unsafe.Pointer) unsafe.Pointer {
	c_fsd := (*C.GtkFontSelectionDialog)(unsafe.Pointer(fsd))

	ret := C.gtk_font_selection_dialog_get_font_selection(c_fsd)
...
func Fn_gtk_grid_get_baseline_row(grid unsafe.Pointer) int {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	ret := C.gtk_grid_get_baseline_row(c_grid)

	return (int)(ret)
}

func Fn_gtk_grid_get_child_at(grid unsafe.Pointer, left int, top int) unsafe.Pointer {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))
	...
	ret := C.gtk_grid_get_child_at(c_grid, c_left, c_top)
...
func Fn_gtk_grid_get_row_baseline_position(grid unsafe.Pointer, row int) int {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_row := (C.gint)(row)

	ret := C.gtk_grid_get_row_baseline_position(c_grid, c_row)
...
func Fn_gtk_grid_insert_column(grid unsafe.Pointer, position int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_position := (C.gint)(position)

	C.gtk_grid_insert_column(c_grid, c_position)
}

func Fn_gtk_grid_insert_next_to(grid unsafe.Pointer, sibling unsafe.Pointer, side int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))
	...
	C.gtk_grid_insert_next_to(c_grid, c_sibling, c_side)
}

func Fn_gtk_grid_insert_row(grid unsafe.Pointer, position int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_position := (C.gint)(position)

	C.gtk_grid_insert_row(c_grid, c_position)
}

func Fn_gtk_grid_remove_column(grid unsafe.Pointer, position int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_position := (C.gint)(position)

	C.gtk_grid_remove_column(c_grid, c_position)
}

func Fn_gtk_grid_remove_row(grid unsafe.Pointer, position int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_position := (C.gint)(position)

	C.gtk_grid_remove_row(c_grid, c_position)
}

func Fn_gtk_grid_set_baseline_row(grid unsafe.Pointer, row int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))

	c_row := (C.gint)(row)

	C.gtk_grid_set_baseline_row(c_grid, c_row)
}
...
func Fn_gtk_grid_set_row_baseline_position(grid unsafe.Pointer, row int, pos int) {
	c_grid := (*C.GtkGrid)(unsafe.Pointer(grid))
	...
	C.gtk_grid_set_row_baseline_position(c_grid, c_row, c_pos)
}
...
func Fn_gtk_header_bar_get_custom_title(bar unsafe.Pointer) unsafe.Pointer {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_custom_title(c_bar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_header_bar_get_decoration_layout(bar unsafe.Pointer) string {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_decoration_layout(c_bar)

	return C.GoString(ret)
}

func Fn_gtk_header_bar_get_has_subtitle(bar unsafe.Pointer) bool {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_has_subtitle(c_bar)

	return toGoBool(ret)
}

func Fn_gtk_header_bar_get_show_close_button(bar unsafe.Pointer) bool {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_show_close_button(c_bar)

	return toGoBool(ret)
}

func Fn_gtk_header_bar_get_subtitle(bar unsafe.Pointer) string {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_subtitle(c_bar)

	return C.GoString(ret)
}

func Fn_gtk_header_bar_get_title(bar unsafe.Pointer) string {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	ret := C.gtk_header_bar_get_title(c_bar)

	return C.GoString(ret)
}

func Fn_gtk_header_bar_pack_end(bar unsafe.Pointer, child unsafe.Pointer) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_header_bar_pack_end(c_bar, c_child)
}

func Fn_gtk_header_bar_pack_start(bar unsafe.Pointer, child unsafe.Pointer) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_header_bar_pack_start(c_bar, c_child)
}

func Fn_gtk_header_bar_set_custom_title(bar unsafe.Pointer, titleWidget unsafe.Pointer) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	c_titleWidget := (*C.GtkWidget)(unsafe.Pointer(titleWidget))

	C.gtk_header_bar_set_custom_title(c_bar, c_titleWidget)
}

func Fn_gtk_header_bar_set_decoration_layout(bar unsafe.Pointer, layout *string) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	var c_layoutValue (*C.gchar)
	if layout != nil {
		c_layoutValue = (*C.gchar)(C.CString(*layout))
		defer C.free(unsafe.Pointer(c_layoutValue))
	}
	c_layout := c_layoutValue

	C.gtk_header_bar_set_decoration_layout(c_bar, c_layout)
}

func Fn_gtk_header_bar_set_has_subtitle(bar unsafe.Pointer, setting bool) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	c_setting := toCBool(setting)

	C.gtk_header_bar_set_has_subtitle(c_bar, c_setting)
}

func Fn_gtk_header_bar_set_show_close_button(bar unsafe.Pointer, setting bool) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	c_setting := toCBool(setting)

	C.gtk_header_bar_set_show_close_button(c_bar, c_setting)
}

func Fn_gtk_header_bar_set_subtitle(bar unsafe.Pointer, subtitle *string) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))

	var c_subtitleValue (*C.gchar)
	if subtitle != nil {
		c_subtitleValue = (*C.gchar)(C.CString(*subtitle))
		defer C.free(unsafe.Pointer(c_subtitleValue))
	}
	c_subtitle := c_subtitleValue

	C.gtk_header_bar_set_subtitle(c_bar, c_subtitle)
}

func Fn_gtk_header_bar_set_title(bar unsafe.Pointer, title *string) {
	c_bar := (*C.GtkHeaderBar)(unsafe.Pointer(bar))
	...
	C.gtk_header_bar_set_title(c_bar, c_title)
}
...
func Fn_gtk_im_multicontext_get_context_id(context unsafe.Pointer) string {
	c_context := (*C.GtkIMMulticontext)(unsafe.Pointer(context))

	ret := C.gtk_im_multicontext_get_context_id(c_context)

	return C.GoString(ret)
}

func Fn_gtk_im_multicontext_set_context_id(context unsafe.Pointer, contextId string) {
	c_context := (*C.GtkIMMulticontext)(unsafe.Pointer(context))

	c_contextId := (*C.char)(C.CString(contextId))
	defer C.free(unsafe.Pointer(c_contextId))

	C.gtk_im_multicontext_set_context_id(c_context, c_contextId)
}
...
func Fn_gtk_icon_info_get_base_scale(iconInfo unsafe.Pointer) int {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))

	ret := C.gtk_icon_info_get_base_scale(c_iconInfo)
...
func Fn_gtk_icon_info_is_symbolic(iconInfo unsafe.Pointer) bool {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))

	ret := C.gtk_icon_info_is_symbolic(c_iconInfo)
...
func Fn_gtk_icon_info_load_icon_finish(iconInfo unsafe.Pointer, res unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_icon_finish(c_iconInfo, c_res, cError)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_info_load_surface(iconInfo unsafe.Pointer, forWindow unsafe.Pointer, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_surface(c_iconInfo, c_forWindow, cError)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_info_load_symbolic(iconInfo unsafe.Pointer, fg unsafe.Pointer, successColor unsafe.Pointer, warningColor unsafe.Pointer, errorColor unsafe.Pointer, wasSymbolic *bool, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))

	c_fg := (*C.GdkRGBA)(unsafe.Pointer(fg))

	c_successColor := (*C.GdkRGBA)(unsafe.Pointer(successColor))

	c_warningColor := (*C.GdkRGBA)(unsafe.Pointer(warningColor))

	c_errorColor := (*C.GdkRGBA)(unsafe.Pointer(errorColor))

	c_wasSymbolic := (*C.gboolean)(unsafe.Pointer(wasSymbolic))

	cError := (**C.GError)(error)

	ret := C.gtk_icon_info_load_symbolic(c_iconInfo, c_fg, c_successColor, c_warningColor, c_errorColor, c_wasSymbolic, cError)
...
func Fn_gtk_icon_info_load_symbolic_finish(iconInfo unsafe.Pointer, res unsafe.Pointer, wasSymbolic *bool, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_symbolic_finish(c_iconInfo, c_res, c_wasSymbolic, cError)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_info_load_symbolic_for_context(iconInfo unsafe.Pointer, context unsafe.Pointer, wasSymbolic *bool, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_symbolic_for_context(c_iconInfo, c_context, c_wasSymbolic, cError)
...
func Fn_gtk_icon_info_load_symbolic_for_context_finish(iconInfo unsafe.Pointer, res unsafe.Pointer, wasSymbolic *bool, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_symbolic_for_context_finish(c_iconInfo, c_res, c_wasSymbolic, cError)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_info_load_symbolic_for_style(iconInfo unsafe.Pointer, style unsafe.Pointer, state int, wasSymbolic *bool, error unsafe.Pointer) unsafe.Pointer {
	c_iconInfo := (*C.GtkIconInfo)(unsafe.Pointer(iconInfo))
	...
	ret := C.gtk_icon_info_load_symbolic_for_style(c_iconInfo, c_style, c_state, c_wasSymbolic, cError)
...
func Fn_gtk_icon_theme_choose_icon_for_scale(iconTheme unsafe.Pointer, iconNames []string, size int, scale int, flags int) unsafe.Pointer {
	c_iconTheme := (*C.GtkIconTheme)(unsafe.Pointer(iconTheme))
	...
	ret := C.gtk_icon_theme_choose_icon_for_scale(c_iconTheme, c_iconNames, c_size, c_scale, c_flags)
...
func Fn_gtk_icon_theme_load_icon_for_scale(iconTheme unsafe.Pointer, iconName string, size int, scale int, flags int, error unsafe.Pointer) unsafe.Pointer {
	c_iconTheme := (*C.GtkIconTheme)(unsafe.Pointer(iconTheme))
	...
	ret := C.gtk_icon_theme_load_icon_for_scale(c_iconTheme, c_iconName, c_size, c_scale, c_flags, cError)

	return unsafe.Pointer(ret)
}

func Fn_gtk_icon_theme_load_surface(iconTheme unsafe.Pointer, iconName string, size int, scale int, forWindow unsafe.Pointer, flags int, error unsafe.Pointer) unsafe.Pointer {
	c_iconTheme := (*C.GtkIconTheme)(unsafe.Pointer(iconTheme))
	...
	ret := C.gtk_icon_theme_load_surface(c_iconTheme, c_iconName, c_size, c_scale, c_forWindow, c_flags, cError)
...
func Fn_gtk_icon_theme_lookup_by_gicon_for_scale(iconTheme unsafe.Pointer, icon unsafe.Pointer, size int, scale int, flags int) unsafe.Pointer {
	c_iconTheme := (*C.GtkIconTheme)(unsafe.Pointer(iconTheme))
	...
	ret := C.gtk_icon_theme_lookup_by_gicon_for_scale(c_iconTheme, c_icon, c_size, c_scale, c_flags)
...
func Fn_gtk_icon_theme_lookup_icon_for_scale(iconTheme unsafe.Pointer, iconName string, size int, scale int, flags int) unsafe.Pointer {
	c_iconTheme := (*C.GtkIconTheme)(unsafe.Pointer(iconTheme))
	...
	ret := C.gtk_icon_theme_lookup_icon_for_scale(c_iconTheme, c_iconName, c_size, c_scale, c_flags)
...
func Fn_gtk_icon_view_new_with_area(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_icon_view_new_with_area(c_area)
...
func Fn_gtk_icon_view_get_activate_on_single_click(iconView unsafe.Pointer) bool {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	ret := C.gtk_icon_view_get_activate_on_single_click(c_iconView)

	return toGoBool(ret)
}

func Fn_gtk_icon_view_get_cell_rect(iconView unsafe.Pointer, path unsafe.Pointer, cell unsafe.Pointer, rect unsafe.Pointer) bool {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))
	...
	ret := C.gtk_icon_view_get_cell_rect(c_iconView, c_path, c_cell, c_rect)
...
func Fn_gtk_icon_view_get_item_column(iconView unsafe.Pointer, path unsafe.Pointer) int {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	c_path := (*C.GtkTreePath)(unsafe.Pointer(path))

	ret := C.gtk_icon_view_get_item_column(c_iconView, c_path)
...
func Fn_gtk_icon_view_get_item_padding(iconView unsafe.Pointer) int {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	ret := C.gtk_icon_view_get_item_padding(c_iconView)

	return (int)(ret)
}

func Fn_gtk_icon_view_get_item_row(iconView unsafe.Pointer, path unsafe.Pointer) int {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	c_path := (*C.GtkTreePath)(unsafe.Pointer(path))

	ret := C.gtk_icon_view_get_item_row(c_iconView, c_path)
...
func Fn_gtk_icon_view_set_activate_on_single_click(iconView unsafe.Pointer, single bool) {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	c_single := toCBool(single)

	C.gtk_icon_view_set_activate_on_single_click(c_iconView, c_single)
}
...
func Fn_gtk_icon_view_set_item_padding(iconView unsafe.Pointer, itemPadding int) {
	c_iconView := (*C.GtkIconView)(unsafe.Pointer(iconView))

	c_itemPadding := (C.gint)(itemPadding)

	C.gtk_icon_view_set_item_padding(c_iconView, c_itemPadding)
}
...
func Fn_gtk_image_new_from_resource(resourcePath string) unsafe.Pointer {
	c_resourcePath := (*C.gchar)(C.CString(resourcePath))
	defer C.free(unsafe.Pointer(c_resourcePath))

	ret := C.gtk_image_new_from_resource(c_resourcePath)
...
func Fn_gtk_image_new_from_surface(surface unsafe.Pointer) unsafe.Pointer {
	c_surface := (*C.cairo_surface_t)(unsafe.Pointer(surface))

	ret := C.gtk_image_new_from_surface(c_surface)
...
func Fn_gtk_image_set_from_surface(image unsafe.Pointer, surface unsafe.Pointer) {
	c_image := (*C.GtkImage)(unsafe.Pointer(image))

	c_surface := (*C.cairo_surface_t)(unsafe.Pointer(surface))

	C.gtk_image_set_from_surface(c_image, c_surface)
}
...
func Fn_gtk_image_menu_item_get_always_show_image(imageMenuItem unsafe.Pointer) bool {
	c_imageMenuItem := (*C.GtkImageMenuItem)(unsafe.Pointer(imageMenuItem))

	ret := C.gtk_image_menu_item_get_always_show_image(c_imageMenuItem)
...
func Fn_gtk_image_menu_item_get_use_stock(imageMenuItem unsafe.Pointer) bool {
	c_imageMenuItem := (*C.GtkImageMenuItem)(unsafe.Pointer(imageMenuItem))

	ret := C.gtk_image_menu_item_get_use_stock(c_imageMenuItem)

	return toGoBool(ret)
}

func Fn_gtk_image_menu_item_set_accel_group(imageMenuItem unsafe.Pointer, accelGroup unsafe.Pointer) {
	c_imageMenuItem := (*C.GtkImageMenuItem)(unsafe.Pointer(imageMenuItem))

	c_accelGroup := (*C.GtkAccelGroup)(unsafe.Pointer(accelGroup))

	C.gtk_image_menu_item_set_accel_group(c_imageMenuItem, c_accelGroup)
}

func Fn_gtk_image_menu_item_set_always_show_image(imageMenuItem unsafe.Pointer, alwaysShow bool) {
	c_imageMenuItem := (*C.GtkImageMenuItem)(unsafe.Pointer(imageMenuItem))

	c_alwaysShow := toCBool(alwaysShow)

	C.gtk_image_menu_item_set_always_show_image(c_imageMenuItem, c_alwaysShow)
}
...
func Fn_gtk_image_menu_item_set_use_stock(imageMenuItem unsafe.Pointer, useStock bool) {
	c_imageMenuItem := (*C.GtkImageMenuItem)(unsafe.Pointer(imageMenuItem))

	c_useStock := toCBool(useStock)

	C.gtk_image_menu_item_set_use_stock(c_imageMenuItem, c_useStock)
}
...
func Fn_gtk_info_bar_add_action_widget(infoBar unsafe.Pointer, child unsafe.Pointer, responseId int) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	c_responseId := (C.gint)(responseId)

	C.gtk_info_bar_add_action_widget(c_infoBar, c_child, c_responseId)
}

func Fn_gtk_info_bar_add_button(infoBar unsafe.Pointer, buttonText string, responseId int) unsafe.Pointer {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))
	...
	ret := C.gtk_info_bar_add_button(c_infoBar, c_buttonText, c_responseId)

	return unsafe.Pointer(ret)
}

func Fn_gtk_info_bar_add_buttons(infoBar unsafe.Pointer, firstButtonText string) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_firstButtonText := (*C.gchar)(C.CString(firstButtonText))
	defer C.free(unsafe.Pointer(c_firstButtonText))

	C.c_gtk_info_bar_add_buttons(c_infoBar, c_firstButtonText)
}

func Fn_gtk_info_bar_get_action_area(infoBar unsafe.Pointer) unsafe.Pointer {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	ret := C.gtk_info_bar_get_action_area(c_infoBar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_info_bar_get_content_area(infoBar unsafe.Pointer) unsafe.Pointer {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	ret := C.gtk_info_bar_get_content_area(c_infoBar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_info_bar_get_message_type(infoBar unsafe.Pointer) int {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	ret := C.gtk_info_bar_get_message_type(c_infoBar)

	return (int)(ret)
}

func Fn_gtk_info_bar_get_show_close_button(infoBar unsafe.Pointer) bool {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	ret := C.gtk_info_bar_get_show_close_button(c_infoBar)

	return toGoBool(ret)
}

func Fn_gtk_info_bar_response(infoBar unsafe.Pointer, responseId int) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_responseId := (C.gint)(responseId)

	C.gtk_info_bar_response(c_infoBar, c_responseId)
}

func Fn_gtk_info_bar_set_default_response(infoBar unsafe.Pointer, responseId int) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_responseId := (C.gint)(responseId)

	C.gtk_info_bar_set_default_response(c_infoBar, c_responseId)
}

func Fn_gtk_info_bar_set_message_type(infoBar unsafe.Pointer, messageType int) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_messageType := (C.GtkMessageType)(messageType)

	C.gtk_info_bar_set_message_type(c_infoBar, c_messageType)
}

func Fn_gtk_info_bar_set_response_sensitive(infoBar unsafe.Pointer, responseId int, setting bool) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))
	...
	C.gtk_info_bar_set_response_sensitive(c_infoBar, c_responseId, c_setting)
}

func Fn_gtk_info_bar_set_show_close_button(infoBar unsafe.Pointer, setting bool) {
	c_infoBar := (*C.GtkInfoBar)(unsafe.Pointer(infoBar))

	c_setting := toCBool(setting)

	C.gtk_info_bar_set_show_close_button(c_infoBar, c_setting)
}
...
func Fn_gtk_label_get_current_uri(label unsafe.Pointer) string {
	c_label := (*C.GtkLabel)(unsafe.Pointer(label))

	ret := C.gtk_label_get_current_uri(c_label)
...
func Fn_gtk_label_get_lines(label unsafe.Pointer) int {
	c_label := (*C.GtkLabel)(unsafe.Pointer(label))

	ret := C.gtk_label_get_lines(c_label)
...
func Fn_gtk_label_get_track_visited_links(label unsafe.Pointer) bool {
	c_label := (*C.GtkLabel)(unsafe.Pointer(label))

	ret := C.gtk_label_get_track_visited_links(c_label)
...
func Fn_gtk_label_set_lines(label unsafe.Pointer, lines int) {
	c_label := (*C.GtkLabel)(unsafe.Pointer(label))

	c_lines := (C.gint)(lines)

	C.gtk_label_set_lines(c_label, c_lines)
}
...
func Fn_gtk_label_set_track_visited_links(label unsafe.Pointer, trackLinks bool) {
	c_label := (*C.GtkLabel)(unsafe.Pointer(label))

	c_trackLinks := toCBool(trackLinks)

	C.gtk_label_set_track_visited_links(c_label, c_trackLinks)
}
...
func Fn_gtk_level_bar_new_for_interval(minValue float64, maxValue float64) unsafe.Pointer {
	c_minValue := (C.gdouble)(minValue)

	c_maxValue := (C.gdouble)(maxValue)

	ret := C.gtk_level_bar_new_for_interval(c_minValue, c_maxValue)

	return unsafe.Pointer(ret)
}

func Fn_gtk_level_bar_add_offset_value(self unsafe.Pointer, name string, value float64) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))
	...
	C.gtk_level_bar_add_offset_value(c_self, c_name, c_value)
}

func Fn_gtk_level_bar_get_inverted(self unsafe.Pointer) bool {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	ret := C.gtk_level_bar_get_inverted(c_self)

	return toGoBool(ret)
}

func Fn_gtk_level_bar_get_max_value(self unsafe.Pointer) float64 {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	ret := C.gtk_level_bar_get_max_value(c_self)

	return (float64)(ret)
}

func Fn_gtk_level_bar_get_min_value(self unsafe.Pointer) float64 {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	ret := C.gtk_level_bar_get_min_value(c_self)

	return (float64)(ret)
}

func Fn_gtk_level_bar_get_mode(self unsafe.Pointer) int {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	ret := C.gtk_level_bar_get_mode(c_self)

	return (int)(ret)
}

func Fn_gtk_level_bar_get_offset_value(self unsafe.Pointer, name *string, value *float64) bool {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))
	...
	ret := C.gtk_level_bar_get_offset_value(c_self, c_name, c_value)

	return toGoBool(ret)
}

func Fn_gtk_level_bar_get_value(self unsafe.Pointer) float64 {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	ret := C.gtk_level_bar_get_value(c_self)

	return (float64)(ret)
}

func Fn_gtk_level_bar_remove_offset_value(self unsafe.Pointer, name *string) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))
	...
	C.gtk_level_bar_remove_offset_value(c_self, c_name)
}

func Fn_gtk_level_bar_set_inverted(self unsafe.Pointer, inverted bool) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	c_inverted := toCBool(inverted)

	C.gtk_level_bar_set_inverted(c_self, c_inverted)
}

func Fn_gtk_level_bar_set_max_value(self unsafe.Pointer, value float64) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	c_value := (C.gdouble)(value)

	C.gtk_level_bar_set_max_value(c_self, c_value)
}

func Fn_gtk_level_bar_set_min_value(self unsafe.Pointer, value float64) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	c_value := (C.gdouble)(value)

	C.gtk_level_bar_set_min_value(c_self, c_value)
}

func Fn_gtk_level_bar_set_mode(self unsafe.Pointer, mode int) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	c_mode := (C.GtkLevelBarMode)(mode)

	C.gtk_level_bar_set_mode(c_self, c_mode)
}

func Fn_gtk_level_bar_set_value(self unsafe.Pointer, value float64) {
	c_self := (*C.GtkLevelBar)(unsafe.Pointer(self))

	c_value := (C.gdouble)(value)

	C.gtk_level_bar_set_value(c_self, c_value)
}
...
func Fn_gtk_list_box_drag_highlight_row(box unsafe.Pointer, row unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	C.gtk_list_box_drag_highlight_row(c_box, c_row)
}

func Fn_gtk_list_box_drag_unhighlight_row(box unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	C.gtk_list_box_drag_unhighlight_row(c_box)
}

func Fn_gtk_list_box_get_activate_on_single_click(box unsafe.Pointer) bool {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	ret := C.gtk_list_box_get_activate_on_single_click(c_box)

	return toGoBool(ret)
}

func Fn_gtk_list_box_get_adjustment(box unsafe.Pointer) unsafe.Pointer {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	ret := C.gtk_list_box_get_adjustment(c_box)

	return unsafe.Pointer(ret)
}

func Fn_gtk_list_box_get_row_at_index(box unsafe.Pointer, index int) unsafe.Pointer {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_index := (C.gint)(index)

	ret := C.gtk_list_box_get_row_at_index(c_box, c_index)

	return unsafe.Pointer(ret)
}

func Fn_gtk_list_box_get_row_at_y(box unsafe.Pointer, y int) unsafe.Pointer {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_y := (C.gint)(y)

	ret := C.gtk_list_box_get_row_at_y(c_box, c_y)

	return unsafe.Pointer(ret)
}

func Fn_gtk_list_box_get_selected_row(box unsafe.Pointer) unsafe.Pointer {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	ret := C.gtk_list_box_get_selected_row(c_box)

	return unsafe.Pointer(ret)
}

func Fn_gtk_list_box_get_selection_mode(box unsafe.Pointer) int {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	ret := C.gtk_list_box_get_selection_mode(c_box)

	return (int)(ret)
}

func Fn_gtk_list_box_insert(box unsafe.Pointer, child unsafe.Pointer, position int) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))
	...
	C.gtk_list_box_insert(c_box, c_child, c_position)
}

func Fn_gtk_list_box_invalidate_filter(box unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	C.gtk_list_box_invalidate_filter(c_box)
}

func Fn_gtk_list_box_invalidate_headers(box unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	C.gtk_list_box_invalidate_headers(c_box)
}

func Fn_gtk_list_box_invalidate_sort(box unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	C.gtk_list_box_invalidate_sort(c_box)
}

func Fn_gtk_list_box_prepend(box unsafe.Pointer, child unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_list_box_prepend(c_box, c_child)
}

func Fn_gtk_list_box_select_row(box unsafe.Pointer, row unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	C.gtk_list_box_select_row(c_box, c_row)
}

// UNSUPPORTED : gtk_list_box_selected_foreach : parameter 'func' is callback

func Fn_gtk_list_box_set_activate_on_single_click(box unsafe.Pointer, single bool) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_single := toCBool(single)

	C.gtk_list_box_set_activate_on_single_click(c_box, c_single)
}

func Fn_gtk_list_box_set_adjustment(box unsafe.Pointer, adjustment unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	C.gtk_list_box_set_adjustment(c_box, c_adjustment)
}
...
func Fn_gtk_list_box_set_placeholder(box unsafe.Pointer, placeholder unsafe.Pointer) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_placeholder := (*C.GtkWidget)(unsafe.Pointer(placeholder))

	C.gtk_list_box_set_placeholder(c_box, c_placeholder)
}

func Fn_gtk_list_box_set_selection_mode(box unsafe.Pointer, mode int) {
	c_box := (*C.GtkListBox)(unsafe.Pointer(box))

	c_mode := (C.GtkSelectionMode)(mode)

	C.gtk_list_box_set_selection_mode(c_box, c_mode)
}
...
func Fn_gtk_list_box_row_changed(row unsafe.Pointer) {
	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	C.gtk_list_box_row_changed(c_row)
}

func Fn_gtk_list_box_row_get_header(row unsafe.Pointer) unsafe.Pointer {
	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	ret := C.gtk_list_box_row_get_header(c_row)

	return unsafe.Pointer(ret)
}

func Fn_gtk_list_box_row_get_index(row unsafe.Pointer) int {
	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	ret := C.gtk_list_box_row_get_index(c_row)

	return (int)(ret)
}

func Fn_gtk_list_box_row_set_header(row unsafe.Pointer, header unsafe.Pointer) {
	c_row := (*C.GtkListBoxRow)(unsafe.Pointer(row))

	c_header := (*C.GtkWidget)(unsafe.Pointer(header))

	C.gtk_list_box_row_set_header(c_row, c_header)
}
...
func Fn_gtk_lock_button_new(permission unsafe.Pointer) unsafe.Pointer {
	c_permission := (*C.GPermission)(unsafe.Pointer(permission))

	ret := C.gtk_lock_button_new(c_permission)

	return unsafe.Pointer(ret)
}

func Fn_gtk_lock_button_get_permission(button unsafe.Pointer) unsafe.Pointer {
	c_button := (*C.GtkLockButton)(unsafe.Pointer(button))

	ret := C.gtk_lock_button_get_permission(c_button)

	return unsafe.Pointer(ret)
}

func Fn_gtk_lock_button_set_permission(button unsafe.Pointer, permission unsafe.Pointer) {
	c_button := (*C.GtkLockButton)(unsafe.Pointer(button))

	c_permission := (*C.GPermission)(unsafe.Pointer(permission))

	C.gtk_lock_button_set_permission(c_button, c_permission)
}
...
func Fn_gtk_menu_new_from_model(model unsafe.Pointer) unsafe.Pointer {
	c_model := (*C.GMenuModel)(unsafe.Pointer(model))

	ret := C.gtk_menu_new_from_model(c_model)
...
func Fn_gtk_menu_get_reserve_toggle_size(menu unsafe.Pointer) bool {
	c_menu := (*C.GtkMenu)(unsafe.Pointer(menu))

	ret := C.gtk_menu_get_reserve_toggle_size(c_menu)
...
func Fn_gtk_menu_set_reserve_toggle_size(menu unsafe.Pointer, reserveToggleSize bool) {
	c_menu := (*C.GtkMenu)(unsafe.Pointer(menu))

	c_reserveToggleSize := toCBool(reserveToggleSize)

	C.gtk_menu_set_reserve_toggle_size(c_menu, c_reserveToggleSize)
}
...
func Fn_gtk_menu_bar_new_from_model(model unsafe.Pointer) unsafe.Pointer {
	c_model := (*C.GMenuModel)(unsafe.Pointer(model))

	ret := C.gtk_menu_bar_new_from_model(c_model)
...
func Fn_gtk_menu_button_get_align_widget(menuButton unsafe.Pointer) unsafe.Pointer {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_align_widget(c_menuButton)

	return unsafe.Pointer(ret)
}

func Fn_gtk_menu_button_get_direction(menuButton unsafe.Pointer) int {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_direction(c_menuButton)

	return (int)(ret)
}

func Fn_gtk_menu_button_get_menu_model(menuButton unsafe.Pointer) unsafe.Pointer {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_menu_model(c_menuButton)

	return unsafe.Pointer(ret)
}

func Fn_gtk_menu_button_get_popover(menuButton unsafe.Pointer) unsafe.Pointer {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_popover(c_menuButton)

	return unsafe.Pointer(ret)
}

func Fn_gtk_menu_button_get_popup(menuButton unsafe.Pointer) unsafe.Pointer {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_popup(c_menuButton)

	return unsafe.Pointer(ret)
}

func Fn_gtk_menu_button_get_use_popover(menuButton unsafe.Pointer) bool {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	ret := C.gtk_menu_button_get_use_popover(c_menuButton)

	return toGoBool(ret)
}

func Fn_gtk_menu_button_set_align_widget(menuButton unsafe.Pointer, alignWidget unsafe.Pointer) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_alignWidget := (*C.GtkWidget)(unsafe.Pointer(alignWidget))

	C.gtk_menu_button_set_align_widget(c_menuButton, c_alignWidget)
}

func Fn_gtk_menu_button_set_direction(menuButton unsafe.Pointer, direction int) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_direction := (C.GtkArrowType)(direction)

	C.gtk_menu_button_set_direction(c_menuButton, c_direction)
}

func Fn_gtk_menu_button_set_menu_model(menuButton unsafe.Pointer, menuModel unsafe.Pointer) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_menuModel := (*C.GMenuModel)(unsafe.Pointer(menuModel))

	C.gtk_menu_button_set_menu_model(c_menuButton, c_menuModel)
}

func Fn_gtk_menu_button_set_popover(menuButton unsafe.Pointer, popover unsafe.Pointer) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_popover := (*C.GtkWidget)(unsafe.Pointer(popover))

	C.gtk_menu_button_set_popover(c_menuButton, c_popover)
}

func Fn_gtk_menu_button_set_popup(menuButton unsafe.Pointer, menu unsafe.Pointer) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_menu := (*C.GtkWidget)(unsafe.Pointer(menu))

	C.gtk_menu_button_set_popup(c_menuButton, c_menu)
}

func Fn_gtk_menu_button_set_use_popover(menuButton unsafe.Pointer, usePopover bool) {
	c_menuButton := (*C.GtkMenuButton)(unsafe.Pointer(menuButton))

	c_usePopover := toCBool(usePopover)

	C.gtk_menu_button_set_use_popover(c_menuButton, c_usePopover)
}
...
func Fn_gtk_menu_item_get_label(menuItem unsafe.Pointer) string {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	ret := C.gtk_menu_item_get_label(c_menuItem)

	return C.GoString(ret)
}

func Fn_gtk_menu_item_get_reserve_indicator(menuItem unsafe.Pointer) bool {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	ret := C.gtk_menu_item_get_reserve_indicator(c_menuItem)
...
func Fn_gtk_menu_item_get_use_underline(menuItem unsafe.Pointer) bool {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	ret := C.gtk_menu_item_get_use_underline(c_menuItem)
...
func Fn_gtk_menu_item_set_label(menuItem unsafe.Pointer, label string) {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	c_label := (*C.gchar)(C.CString(label))
	defer C.free(unsafe.Pointer(c_label))

	C.gtk_menu_item_set_label(c_menuItem, c_label)
}

func Fn_gtk_menu_item_set_reserve_indicator(menuItem unsafe.Pointer, reserve bool) {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	c_reserve := toCBool(reserve)

	C.gtk_menu_item_set_reserve_indicator(c_menuItem, c_reserve)
}
...
func Fn_gtk_menu_item_set_use_underline(menuItem unsafe.Pointer, setting bool) {
	c_menuItem := (*C.GtkMenuItem)(unsafe.Pointer(menuItem))

	c_setting := toCBool(setting)

	C.gtk_menu_item_set_use_underline(c_menuItem, c_setting)
}
...
func Fn_gtk_menu_shell_bind_model(menuShell unsafe.Pointer, model unsafe.Pointer, actionNamespace *string, withSeparators bool) {
	c_menuShell := (*C.GtkMenuShell)(unsafe.Pointer(menuShell))

	c_model := (*C.GMenuModel)(unsafe.Pointer(model))

	var c_actionNamespaceValue (*C.gchar)
	if actionNamespace != nil {
		c_actionNamespaceValue = (*C.gchar)(C.CString(*actionNamespace))
		defer C.free(unsafe.Pointer(c_actionNamespaceValue))
	}
	c_actionNamespace := c_actionNamespaceValue

	c_withSeparators := toCBool(withSeparators)

	C.gtk_menu_shell_bind_model(c_menuShell, c_model, c_actionNamespace, c_withSeparators)
}
...
func Fn_gtk_menu_shell_get_parent_shell(menuShell unsafe.Pointer) unsafe.Pointer {
	c_menuShell := (*C.GtkMenuShell)(unsafe.Pointer(menuShell))

	ret := C.gtk_menu_shell_get_parent_shell(c_menuShell)

	return unsafe.Pointer(ret)
}

func Fn_gtk_menu_shell_get_selected_item(menuShell unsafe.Pointer) unsafe.Pointer {
	c_menuShell := (*C.GtkMenuShell)(unsafe.Pointer(menuShell))

	ret := C.gtk_menu_shell_get_selected_item(c_menuShell)
...
func Fn_gtk_message_dialog_get_message_area(messageDialog unsafe.Pointer) unsafe.Pointer {
	c_messageDialog := (*C.GtkMessageDialog)(unsafe.Pointer(messageDialog))

	ret := C.gtk_message_dialog_get_message_area(c_messageDialog)
...
func Fn_gtk_notebook_get_action_widget(notebook unsafe.Pointer, packType int) unsafe.Pointer {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))

	c_packType := (C.GtkPackType)(packType)

	ret := C.gtk_notebook_get_action_widget(c_notebook, c_packType)
...
func Fn_gtk_notebook_get_group_name(notebook unsafe.Pointer) string {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))

	ret := C.gtk_notebook_get_group_name(c_notebook)
...
func Fn_gtk_notebook_get_tab_hborder(notebook unsafe.Pointer) uint16 {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))

	ret := C.gtk_notebook_get_tab_hborder(c_notebook)
...
func Fn_gtk_notebook_get_tab_vborder(notebook unsafe.Pointer) uint16 {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))

	ret := C.gtk_notebook_get_tab_vborder(c_notebook)
...
func Fn_gtk_notebook_set_action_widget(notebook unsafe.Pointer, widget unsafe.Pointer, packType int) {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))
	...
	C.gtk_notebook_set_action_widget(c_notebook, c_widget, c_packType)
}
...
func Fn_gtk_notebook_set_group_name(notebook unsafe.Pointer, groupName *string) {
	c_notebook := (*C.GtkNotebook)(unsafe.Pointer(notebook))
	...
	C.gtk_notebook_set_group_name(c_notebook, c_groupName)
}
...
func Fn_gtk_numerable_icon_get_background_gicon(self unsafe.Pointer) unsafe.Pointer {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	ret := C.gtk_numerable_icon_get_background_gicon(c_self)

	return unsafe.Pointer(ret)
}

func Fn_gtk_numerable_icon_get_background_icon_name(self unsafe.Pointer) string {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	ret := C.gtk_numerable_icon_get_background_icon_name(c_self)

	return C.GoString(ret)
}

func Fn_gtk_numerable_icon_get_count(self unsafe.Pointer) int {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	ret := C.gtk_numerable_icon_get_count(c_self)

	return (int)(ret)
}

func Fn_gtk_numerable_icon_get_label(self unsafe.Pointer) string {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	ret := C.gtk_numerable_icon_get_label(c_self)

	return C.GoString(ret)
}

func Fn_gtk_numerable_icon_get_style_context(self unsafe.Pointer) unsafe.Pointer {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	ret := C.gtk_numerable_icon_get_style_context(c_self)

	return unsafe.Pointer(ret)
}

func Fn_gtk_numerable_icon_set_background_gicon(self unsafe.Pointer, icon unsafe.Pointer) {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	c_icon := (*C.GIcon)(unsafe.Pointer(icon))

	C.gtk_numerable_icon_set_background_gicon(c_self, c_icon)
}

func Fn_gtk_numerable_icon_set_background_icon_name(self unsafe.Pointer, iconName *string) {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))
	...
	C.gtk_numerable_icon_set_background_icon_name(c_self, c_iconName)
}

func Fn_gtk_numerable_icon_set_count(self unsafe.Pointer, count int) {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	c_count := (C.gint)(count)

	C.gtk_numerable_icon_set_count(c_self, c_count)
}

func Fn_gtk_numerable_icon_set_label(self unsafe.Pointer, label *string) {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))
	...
	C.gtk_numerable_icon_set_label(c_self, c_label)
}

func Fn_gtk_numerable_icon_set_style_context(self unsafe.Pointer, style unsafe.Pointer) {
	c_self := (*C.GtkNumerableIcon)(unsafe.Pointer(self))

	c_style := (*C.GtkStyleContext)(unsafe.Pointer(style))

	C.gtk_numerable_icon_set_style_context(c_self, c_style)
}

func Fn_gtk_numerable_icon_new(baseIcon unsafe.Pointer) unsafe.Pointer {
	c_baseIcon := (*C.GIcon)(unsafe.Pointer(baseIcon))

	ret := C.gtk_numerable_icon_new(c_baseIcon)

	return unsafe.Pointer(ret)
}

func Fn_gtk_numerable_icon_new_with_style_context(baseIcon unsafe.Pointer, context unsafe.Pointer) unsafe.Pointer {
	c_baseIcon := (*C.GIcon)(unsafe.Pointer(baseIcon))

	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_numerable_icon_new_with_style_context(c_baseIcon, c_context)
...
func Fn_gtk_offscreen_window_get_pixbuf(offscreen unsafe.Pointer) unsafe.Pointer {
	c_offscreen := (*C.GtkOffscreenWindow)(unsafe.Pointer(offscreen))

	ret := C.gtk_offscreen_window_get_pixbuf(c_offscreen)

	return unsafe.Pointer(ret)
}

func Fn_gtk_offscreen_window_get_surface(offscreen unsafe.Pointer) unsafe.Pointer {
	c_offscreen := (*C.GtkOffscreenWindow)(unsafe.Pointer(offscreen))

	ret := C.gtk_offscreen_window_get_surface(c_offscreen)
...
func Fn_gtk_overlay_add_overlay(overlay unsafe.Pointer, widget unsafe.Pointer) {
	c_overlay := (*C.GtkOverlay)(unsafe.Pointer(overlay))

	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_overlay_add_overlay(c_overlay, c_widget)
}
...
func Fn_gtk_paned_new(orientation int) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	ret := C.gtk_paned_new(c_orientation)
...
func Fn_gtk_paned_get_handle_window(paned unsafe.Pointer) unsafe.Pointer {
	c_paned := (*C.GtkPaned)(unsafe.Pointer(paned))

	ret := C.gtk_paned_get_handle_window(c_paned)
...
func Fn_gtk_places_sidebar_add_shortcut(sidebar unsafe.Pointer, location unsafe.Pointer) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_location := (*C.GFile)(unsafe.Pointer(location))

	C.gtk_places_sidebar_add_shortcut(c_sidebar, c_location)
}

func Fn_gtk_places_sidebar_get_local_only(sidebar unsafe.Pointer) bool {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	ret := C.gtk_places_sidebar_get_local_only(c_sidebar)

	return toGoBool(ret)
}

func Fn_gtk_places_sidebar_get_location(sidebar unsafe.Pointer) unsafe.Pointer {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	ret := C.gtk_places_sidebar_get_location(c_sidebar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_places_sidebar_get_nth_bookmark(sidebar unsafe.Pointer, n int) unsafe.Pointer {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_n := (C.gint)(n)

	ret := C.gtk_places_sidebar_get_nth_bookmark(c_sidebar, c_n)

	return unsafe.Pointer(ret)
}

func Fn_gtk_places_sidebar_get_open_flags(sidebar unsafe.Pointer) int {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	ret := C.gtk_places_sidebar_get_open_flags(c_sidebar)
...
func Fn_gtk_places_sidebar_get_show_desktop(sidebar unsafe.Pointer) bool {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	ret := C.gtk_places_sidebar_get_show_desktop(c_sidebar)

	return toGoBool(ret)
}

func Fn_gtk_places_sidebar_list_shortcuts(sidebar unsafe.Pointer) unsafe.Pointer {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	ret := C.gtk_places_sidebar_list_shortcuts(c_sidebar)

	return unsafe.Pointer(ret)
}

func Fn_gtk_places_sidebar_remove_shortcut(sidebar unsafe.Pointer, location unsafe.Pointer) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_location := (*C.GFile)(unsafe.Pointer(location))

	C.gtk_places_sidebar_remove_shortcut(c_sidebar, c_location)
}

func Fn_gtk_places_sidebar_set_local_only(sidebar unsafe.Pointer, localOnly bool) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_localOnly := toCBool(localOnly)

	C.gtk_places_sidebar_set_local_only(c_sidebar, c_localOnly)
}

func Fn_gtk_places_sidebar_set_location(sidebar unsafe.Pointer, location unsafe.Pointer) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_location := (*C.GFile)(unsafe.Pointer(location))

	C.gtk_places_sidebar_set_location(c_sidebar, c_location)
}

func Fn_gtk_places_sidebar_set_open_flags(sidebar unsafe.Pointer, flags int) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_flags := (C.GtkPlacesOpenFlags)(flags)

	C.gtk_places_sidebar_set_open_flags(c_sidebar, c_flags)
}

func Fn_gtk_places_sidebar_set_show_connect_to_server(sidebar unsafe.Pointer, showConnectToServer bool) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_showConnectToServer := toCBool(showConnectToServer)

	C.gtk_places_sidebar_set_show_connect_to_server(c_sidebar, c_showConnectToServer)
}

func Fn_gtk_places_sidebar_set_show_desktop(sidebar unsafe.Pointer, showDesktop bool) {
	c_sidebar := (*C.GtkPlacesSidebar)(unsafe.Pointer(sidebar))

	c_showDesktop := toCBool(showDesktop)

	C.gtk_places_sidebar_set_show_desktop(c_sidebar, c_showDesktop)
}
...
func Fn_gtk_popover_new(relativeTo unsafe.Pointer) unsafe.Pointer {
	c_relativeTo := (*C.GtkWidget)(unsafe.Pointer(relativeTo))

	ret := C.gtk_popover_new(c_relativeTo)

	return unsafe.Pointer(ret)
}

func Fn_gtk_popover_new_from_model(relativeTo unsafe.Pointer, model unsafe.Pointer) unsafe.Pointer {
	c_relativeTo := (*C.GtkWidget)(unsafe.Pointer(relativeTo))

	c_model := (*C.GMenuModel)(unsafe.Pointer(model))

	ret := C.gtk_popover_new_from_model(c_relativeTo, c_model)

	return unsafe.Pointer(ret)
}

func Fn_gtk_popover_bind_model(popover unsafe.Pointer, model unsafe.Pointer, actionNamespace *string) {
	...
	C.gtk_popover_bind_model(c_popover, c_model, c_actionNamespace)
}

func Fn_gtk_popover_get_modal(popover unsafe.Pointer) bool {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	ret := C.gtk_popover_get_modal(c_popover)
...
func Fn_gtk_popover_get_relative_to(popover unsafe.Pointer) unsafe.Pointer {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	ret := C.gtk_popover_get_relative_to(c_popover)

	return unsafe.Pointer(ret)
}

func Fn_gtk_popover_set_modal(popover unsafe.Pointer, modal bool) {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	c_modal := toCBool(modal)

	C.gtk_popover_set_modal(c_popover, c_modal)
}

func Fn_gtk_popover_set_pointing_to(popover unsafe.Pointer, rect unsafe.Pointer) {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	c_rect := (*C.GdkRectangle)(unsafe.Pointer(rect))

	C.gtk_popover_set_pointing_to(c_popover, c_rect)
}

func Fn_gtk_popover_set_position(popover unsafe.Pointer, position int) {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	c_position := (C.GtkPositionType)(position)

	C.gtk_popover_set_position(c_popover, c_position)
}

func Fn_gtk_popover_set_relative_to(popover unsafe.Pointer, relativeTo unsafe.Pointer) {
	c_popover := (*C.GtkPopover)(unsafe.Pointer(popover))

	c_relativeTo := (*C.GtkWidget)(unsafe.Pointer(relativeTo))

	C.gtk_popover_set_relative_to(c_popover, c_relativeTo)
}
...
func Fn_gtk_print_context_get_hard_margins(context unsafe.Pointer, top *float64, bottom *float64, left *float64, right *float64) bool {
	c_context := (*C.GtkPrintContext)(unsafe.Pointer(context))

	c_top := (*C.gdouble)(unsafe.Pointer(top))

	c_bottom := (*C.gdouble)(unsafe.Pointer(bottom))

	c_left := (*C.gdouble)(unsafe.Pointer(left))

	c_right := (*C.gdouble)(unsafe.Pointer(right))

	ret := C.gtk_print_context_get_hard_margins(c_context, c_top, c_bottom, c_left, c_right)
...
func Fn_gtk_print_operation_draw_page_finish(op unsafe.Pointer) {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	C.gtk_print_operation_draw_page_finish(c_op)
}
...
func Fn_gtk_print_operation_get_embed_page_setup(op unsafe.Pointer) bool {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	ret := C.gtk_print_operation_get_embed_page_setup(c_op)
...
func Fn_gtk_print_operation_get_has_selection(op unsafe.Pointer) bool {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	ret := C.gtk_print_operation_get_has_selection(c_op)

	return toGoBool(ret)
}

func Fn_gtk_print_operation_get_n_pages_to_print(op unsafe.Pointer) int {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	ret := C.gtk_print_operation_get_n_pages_to_print(c_op)
...
func Fn_gtk_print_operation_get_support_selection(op unsafe.Pointer) bool {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	ret := C.gtk_print_operation_get_support_selection(c_op)
...
func Fn_gtk_print_operation_set_defer_drawing(op unsafe.Pointer) {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	C.gtk_print_operation_set_defer_drawing(c_op)
}

func Fn_gtk_print_operation_set_embed_page_setup(op unsafe.Pointer, embed bool) {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	c_embed := toCBool(embed)

	C.gtk_print_operation_set_embed_page_setup(c_op, c_embed)
}
...
func Fn_gtk_print_operation_set_has_selection(op unsafe.Pointer, hasSelection bool) {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	c_hasSelection := toCBool(hasSelection)

	C.gtk_print_operation_set_has_selection(c_op, c_hasSelection)
}
...
func Fn_gtk_print_operation_set_support_selection(op unsafe.Pointer, supportSelection bool) {
	c_op := (*C.GtkPrintOperation)(unsafe.Pointer(op))

	c_supportSelection := toCBool(supportSelection)

	C.gtk_print_operation_set_support_selection(c_op, c_supportSelection)
}
...
func Fn_gtk_print_settings_get_printer_lpi(settings unsafe.Pointer) float64 {
	c_settings := (*C.GtkPrintSettings)(unsafe.Pointer(settings))

	ret := C.gtk_print_settings_get_printer_lpi(c_settings)
...
func Fn_gtk_print_settings_get_resolution_x(settings unsafe.Pointer) int {
	c_settings := (*C.GtkPrintSettings)(unsafe.Pointer(settings))

	ret := C.gtk_print_settings_get_resolution_x(c_settings)

	return (int)(ret)
}

func Fn_gtk_print_settings_get_resolution_y(settings unsafe.Pointer) int {
	c_settings := (*C.GtkPrintSettings)(unsafe.Pointer(settings))

	ret := C.gtk_print_settings_get_resolution_y(c_settings)
...
func Fn_gtk_print_settings_set_printer_lpi(settings unsafe.Pointer, lpi float64) {
	c_settings := (*C.GtkPrintSettings)(unsafe.Pointer(settings))

	c_lpi := (C.gdouble)(lpi)

	C.gtk_print_settings_set_printer_lpi(c_settings, c_lpi)
}
...
func Fn_gtk_print_settings_set_resolution_xy(settings unsafe.Pointer, resolutionX int, resolutionY int) {
	c_settings := (*C.GtkPrintSettings)(unsafe.Pointer(settings))

	c_resolutionX := (C.gint)(resolutionX)

	c_resolutionY := (C.gint)(resolutionY)

	C.gtk_print_settings_set_resolution_xy(c_settings, c_resolutionX, c_resolutionY)
}
...
func Fn_gtk_progress_bar_get_show_text(pbar unsafe.Pointer) bool {
	c_pbar := (*C.GtkProgressBar)(unsafe.Pointer(pbar))

	ret := C.gtk_progress_bar_get_show_text(c_pbar)
...
func Fn_gtk_progress_bar_set_show_text(pbar unsafe.Pointer, showText bool) {
	c_pbar := (*C.GtkProgressBar)(unsafe.Pointer(pbar))

	c_showText := toCBool(showText)

	C.gtk_progress_bar_set_show_text(c_pbar, c_showText)
}
...
func Fn_gtk_radio_action_join_group(action unsafe.Pointer, groupSource unsafe.Pointer) {
	c_action := (*C.GtkRadioAction)(unsafe.Pointer(action))

	c_groupSource := (*C.GtkRadioAction)(unsafe.Pointer(groupSource))

	C.gtk_radio_action_join_group(c_action, c_groupSource)
}
...
func Fn_gtk_radio_button_join_group(radioButton unsafe.Pointer, groupSource unsafe.Pointer) {
	c_radioButton := (*C.GtkRadioButton)(unsafe.Pointer(radioButton))

	c_groupSource := (*C.GtkRadioButton)(unsafe.Pointer(groupSource))

	C.gtk_radio_button_join_group(c_radioButton, c_groupSource)
}
...
func Fn_gtk_range_get_flippable(range_ unsafe.Pointer) bool {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	ret := C.gtk_range_get_flippable(c_range_)
...
func Fn_gtk_range_get_min_slider_size(range_ unsafe.Pointer) int {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	ret := C.gtk_range_get_min_slider_size(c_range_)

	return (int)(ret)
}

func Fn_gtk_range_get_range_rect(range_ unsafe.Pointer, rangeRect unsafe.Pointer) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_rangeRect := (*C.GdkRectangle)(unsafe.Pointer(rangeRect))

	C.gtk_range_get_range_rect(c_range_, c_rangeRect)
}
...
func Fn_gtk_range_get_round_digits(range_ unsafe.Pointer) int {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	ret := C.gtk_range_get_round_digits(c_range_)
...
func Fn_gtk_range_get_slider_range(range_ unsafe.Pointer, sliderStart *int, sliderEnd *int) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_sliderStart := (*C.gint)(unsafe.Pointer(sliderStart))

	c_sliderEnd := (*C.gint)(unsafe.Pointer(sliderEnd))

	C.gtk_range_get_slider_range(c_range_, c_sliderStart, c_sliderEnd)
}

func Fn_gtk_range_get_slider_size_fixed(range_ unsafe.Pointer) bool {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	ret := C.gtk_range_get_slider_size_fixed(c_range_)
...
func Fn_gtk_range_set_flippable(range_ unsafe.Pointer, flippable bool) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_flippable := toCBool(flippable)

	C.gtk_range_set_flippable(c_range_, c_flippable)
}
...
func Fn_gtk_range_set_min_slider_size(range_ unsafe.Pointer, minSize int) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_minSize := (C.gint)(minSize)

	C.gtk_range_set_min_slider_size(c_range_, c_minSize)
}
...
func Fn_gtk_range_set_round_digits(range_ unsafe.Pointer, roundDigits int) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_roundDigits := (C.gint)(roundDigits)

	C.gtk_range_set_round_digits(c_range_, c_roundDigits)
}
...
func Fn_gtk_range_set_slider_size_fixed(range_ unsafe.Pointer, sizeFixed bool) {
	c_range_ := (*C.GtkRange)(unsafe.Pointer(range_))

	c_sizeFixed := toCBool(sizeFixed)

	C.gtk_range_set_slider_size_fixed(c_range_, c_sizeFixed)
}
...
func Fn_gtk_revealer_get_child_revealed(revealer unsafe.Pointer) bool {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	ret := C.gtk_revealer_get_child_revealed(c_revealer)

	return toGoBool(ret)
}

func Fn_gtk_revealer_get_reveal_child(revealer unsafe.Pointer) bool {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	ret := C.gtk_revealer_get_reveal_child(c_revealer)

	return toGoBool(ret)
}

func Fn_gtk_revealer_get_transition_duration(revealer unsafe.Pointer) uint {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	ret := C.gtk_revealer_get_transition_duration(c_revealer)

	return (uint)(ret)
}

func Fn_gtk_revealer_get_transition_type(revealer unsafe.Pointer) int {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	ret := C.gtk_revealer_get_transition_type(c_revealer)

	return (int)(ret)
}

func Fn_gtk_revealer_set_reveal_child(revealer unsafe.Pointer, revealChild bool) {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	c_revealChild := toCBool(revealChild)

	C.gtk_revealer_set_reveal_child(c_revealer, c_revealChild)
}

func Fn_gtk_revealer_set_transition_duration(revealer unsafe.Pointer, duration uint) {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	c_duration := (C.guint)(duration)

	C.gtk_revealer_set_transition_duration(c_revealer, c_duration)
}

func Fn_gtk_revealer_set_transition_type(revealer unsafe.Pointer, transition int) {
	c_revealer := (*C.GtkRevealer)(unsafe.Pointer(revealer))

	c_transition := (C.GtkRevealerTransitionType)(transition)

	C.gtk_revealer_set_transition_type(c_revealer, c_transition)
}

func Fn_gtk_scale_new(orientation int, adjustment unsafe.Pointer) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	ret := C.gtk_scale_new(c_orientation, c_adjustment)

	return unsafe.Pointer(ret)
}

func Fn_gtk_scale_new_with_range(orientation int, min float64, max float64, step float64) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)
	...
	ret := C.gtk_scale_new_with_range(c_orientation, c_min, c_max, c_step)

	return unsafe.Pointer(ret)
}

func Fn_gtk_scale_add_mark(scale unsafe.Pointer, value float64, position int, markup *string) {
	...
	C.gtk_scale_add_mark(c_scale, c_value, c_position, c_markup)
}

func Fn_gtk_scale_clear_marks(scale unsafe.Pointer) {
	c_scale := (*C.GtkScale)(unsafe.Pointer(scale))

	C.gtk_scale_clear_marks(c_scale)
}
...
func Fn_gtk_scale_get_has_origin(scale unsafe.Pointer) bool {
	c_scale := (*C.GtkScale)(unsafe.Pointer(scale))

	ret := C.gtk_scale_get_has_origin(c_scale)
...
func Fn_gtk_scale_set_has_origin(scale unsafe.Pointer, hasOrigin bool) {
	c_scale := (*C.GtkScale)(unsafe.Pointer(scale))

	c_hasOrigin := toCBool(hasOrigin)

	C.gtk_scale_set_has_origin(c_scale, c_hasOrigin)
}
...
func Fn_gtk_scrollbar_new(orientation int, adjustment unsafe.Pointer) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	c_adjustment := (*C.GtkAdjustment)(unsafe.Pointer(adjustment))

	ret := C.gtk_scrollbar_new(c_orientation, c_adjustment)
...
func Fn_gtk_scrolled_window_get_capture_button_press(scrolledWindow unsafe.Pointer) bool {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	ret := C.gtk_scrolled_window_get_capture_button_press(c_scrolledWindow)
...
func Fn_gtk_scrolled_window_get_kinetic_scrolling(scrolledWindow unsafe.Pointer) bool {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	ret := C.gtk_scrolled_window_get_kinetic_scrolling(c_scrolledWindow)

	return toGoBool(ret)
}

func Fn_gtk_scrolled_window_get_min_content_height(scrolledWindow unsafe.Pointer) int {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	ret := C.gtk_scrolled_window_get_min_content_height(c_scrolledWindow)

	return (int)(ret)
}

func Fn_gtk_scrolled_window_get_min_content_width(scrolledWindow unsafe.Pointer) int {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	ret := C.gtk_scrolled_window_get_min_content_width(c_scrolledWindow)
...
func Fn_gtk_scrolled_window_set_capture_button_press(scrolledWindow unsafe.Pointer, captureButtonPress bool) {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	c_captureButtonPress := toCBool(captureButtonPress)

	C.gtk_scrolled_window_set_capture_button_press(c_scrolledWindow, c_captureButtonPress)
}
...
func Fn_gtk_scrolled_window_set_kinetic_scrolling(scrolledWindow unsafe.Pointer, kineticScrolling bool) {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	c_kineticScrolling := toCBool(kineticScrolling)

	C.gtk_scrolled_window_set_kinetic_scrolling(c_scrolledWindow, c_kineticScrolling)
}

func Fn_gtk_scrolled_window_set_min_content_height(scrolledWindow unsafe.Pointer, height int) {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	c_height := (C.gint)(height)

	C.gtk_scrolled_window_set_min_content_height(c_scrolledWindow, c_height)
}

func Fn_gtk_scrolled_window_set_min_content_width(scrolledWindow unsafe.Pointer, width int) {
	c_scrolledWindow := (*C.GtkScrolledWindow)(unsafe.Pointer(scrolledWindow))

	c_width := (C.gint)(width)

	C.gtk_scrolled_window_set_min_content_width(c_scrolledWindow, c_width)
}
...
func Fn_gtk_search_bar_connect_entry(bar unsafe.Pointer, entry unsafe.Pointer) {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	c_entry := (*C.GtkEntry)(unsafe.Pointer(entry))

	C.gtk_search_bar_connect_entry(c_bar, c_entry)
}

func Fn_gtk_search_bar_get_search_mode(bar unsafe.Pointer) bool {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	ret := C.gtk_search_bar_get_search_mode(c_bar)

	return toGoBool(ret)
}

func Fn_gtk_search_bar_get_show_close_button(bar unsafe.Pointer) bool {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	ret := C.gtk_search_bar_get_show_close_button(c_bar)

	return toGoBool(ret)
}

func Fn_gtk_search_bar_handle_event(bar unsafe.Pointer, event unsafe.Pointer) bool {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	c_event := (*C.GdkEvent)(unsafe.Pointer(event))

	ret := C.gtk_search_bar_handle_event(c_bar, c_event)

	return toGoBool(ret)
}

func Fn_gtk_search_bar_set_search_mode(bar unsafe.Pointer, searchMode bool) {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	c_searchMode := toCBool(searchMode)

	C.gtk_search_bar_set_search_mode(c_bar, c_searchMode)
}

func Fn_gtk_search_bar_set_show_close_button(bar unsafe.Pointer, visible bool) {
	c_bar := (*C.GtkSearchBar)(unsafe.Pointer(bar))

	c_visible := toCBool(visible)

	C.gtk_search_bar_set_show_close_button(c_bar, c_visible)
}
...
func Fn_gtk_separator_new(orientation int) unsafe.Pointer {
	c_orientation := (C.GtkOrientation)(orientation)

	ret := C.gtk_separator_new(c_orientation)
...
func Fn_gtk_spinner_start(spinner unsafe.Pointer) {
	c_spinner := (*C.GtkSpinner)(unsafe.Pointer(spinner))

	C.gtk_spinner_start(c_spinner)
}

func Fn_gtk_spinner_stop(spinner unsafe.Pointer) {
	c_spinner := (*C.GtkSpinner)(unsafe.Pointer(spinner))

	C.gtk_spinner_stop(c_spinner)
}
...
func Fn_gtk_stack_add_named(stack unsafe.Pointer, child unsafe.Pointer, name string) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))
	...
	C.gtk_stack_add_named(c_stack, c_child, c_name)
}

func Fn_gtk_stack_add_titled(stack unsafe.Pointer, child unsafe.Pointer, name string, title string) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))
	...
	C.gtk_stack_add_titled(c_stack, c_child, c_name, c_title)
}

func Fn_gtk_stack_get_child_by_name(stack unsafe.Pointer, name string) unsafe.Pointer {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	ret := C.gtk_stack_get_child_by_name(c_stack, c_name)

	return unsafe.Pointer(ret)
}

func Fn_gtk_stack_get_homogeneous(stack unsafe.Pointer) bool {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_homogeneous(c_stack)

	return toGoBool(ret)
}

func Fn_gtk_stack_get_transition_duration(stack unsafe.Pointer) uint {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_transition_duration(c_stack)

	return (uint)(ret)
}

func Fn_gtk_stack_get_transition_running(stack unsafe.Pointer) bool {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_transition_running(c_stack)

	return toGoBool(ret)
}

func Fn_gtk_stack_get_transition_type(stack unsafe.Pointer) int {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_transition_type(c_stack)

	return (int)(ret)
}

func Fn_gtk_stack_get_visible_child(stack unsafe.Pointer) unsafe.Pointer {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_visible_child(c_stack)

	return unsafe.Pointer(ret)
}

func Fn_gtk_stack_get_visible_child_name(stack unsafe.Pointer) string {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	ret := C.gtk_stack_get_visible_child_name(c_stack)

	return C.GoString(ret)
}

func Fn_gtk_stack_set_homogeneous(stack unsafe.Pointer, homogeneous bool) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_homogeneous := toCBool(homogeneous)

	C.gtk_stack_set_homogeneous(c_stack, c_homogeneous)
}

func Fn_gtk_stack_set_transition_duration(stack unsafe.Pointer, duration uint) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_duration := (C.guint)(duration)

	C.gtk_stack_set_transition_duration(c_stack, c_duration)
}

func Fn_gtk_stack_set_transition_type(stack unsafe.Pointer, transition int) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_transition := (C.GtkStackTransitionType)(transition)

	C.gtk_stack_set_transition_type(c_stack, c_transition)
}

func Fn_gtk_stack_set_visible_child(stack unsafe.Pointer, child unsafe.Pointer) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_child := (*C.GtkWidget)(unsafe.Pointer(child))

	C.gtk_stack_set_visible_child(c_stack, c_child)
}

func Fn_gtk_stack_set_visible_child_full(stack unsafe.Pointer, name string, transition int) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))
	...
	C.gtk_stack_set_visible_child_full(c_stack, c_name, c_transition)
}

func Fn_gtk_stack_set_visible_child_name(stack unsafe.Pointer, name string) {
	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	C.gtk_stack_set_visible_child_name(c_stack, c_name)
}
...
func Fn_gtk_stack_switcher_get_stack(switcher unsafe.Pointer) unsafe.Pointer {
	c_switcher := (*C.GtkStackSwitcher)(unsafe.Pointer(switcher))

	ret := C.gtk_stack_switcher_get_stack(c_switcher)

	return unsafe.Pointer(ret)
}

func Fn_gtk_stack_switcher_set_stack(switcher unsafe.Pointer, stack unsafe.Pointer) {
	c_switcher := (*C.GtkStackSwitcher)(unsafe.Pointer(switcher))

	c_stack := (*C.GtkStack)(unsafe.Pointer(stack))

	C.gtk_stack_switcher_set_stack(c_switcher, c_stack)
}
...
func Fn_gtk_status_icon_get_has_tooltip(statusIcon unsafe.Pointer) bool {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	ret := C.gtk_status_icon_get_has_tooltip(c_statusIcon)
...
func Fn_gtk_status_icon_get_title(statusIcon unsafe.Pointer) string {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	ret := C.gtk_status_icon_get_title(c_statusIcon)

	return C.GoString(ret)
}

func Fn_gtk_status_icon_get_tooltip_markup(statusIcon unsafe.Pointer) string {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	ret := C.gtk_status_icon_get_tooltip_markup(c_statusIcon)

	return C.GoString(ret)
}

func Fn_gtk_status_icon_get_tooltip_text(statusIcon unsafe.Pointer) string {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	ret := C.gtk_status_icon_get_tooltip_text(c_statusIcon)
...
func Fn_gtk_status_icon_set_has_tooltip(statusIcon unsafe.Pointer, hasTooltip bool) {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	c_hasTooltip := toCBool(hasTooltip)

	C.gtk_status_icon_set_has_tooltip(c_statusIcon, c_hasTooltip)
}

func Fn_gtk_status_icon_set_name(statusIcon unsafe.Pointer, name string) {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	C.gtk_status_icon_set_name(c_statusIcon, c_name)
}
...
func Fn_gtk_status_icon_set_title(statusIcon unsafe.Pointer, title string) {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	c_title := (*C.gchar)(C.CString(title))
	defer C.free(unsafe.Pointer(c_title))

	C.gtk_status_icon_set_title(c_statusIcon, c_title)
}

func Fn_gtk_status_icon_set_tooltip_markup(statusIcon unsafe.Pointer, markup *string) {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))
	...
	C.gtk_status_icon_set_tooltip_markup(c_statusIcon, c_markup)
}

func Fn_gtk_status_icon_set_tooltip_text(statusIcon unsafe.Pointer, text string) {
	c_statusIcon := (*C.GtkStatusIcon)(unsafe.Pointer(statusIcon))

	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	C.gtk_status_icon_set_tooltip_text(c_statusIcon, c_text)
}
...
func Fn_gtk_statusbar_get_message_area(statusbar unsafe.Pointer) unsafe.Pointer {
	c_statusbar := (*C.GtkStatusbar)(unsafe.Pointer(statusbar))

	ret := C.gtk_statusbar_get_message_area(c_statusbar)
...
func Fn_gtk_statusbar_remove_all(statusbar unsafe.Pointer, contextId uint) {
	c_statusbar := (*C.GtkStatusbar)(unsafe.Pointer(statusbar))

	c_contextId := (C.guint)(contextId)

	C.gtk_statusbar_remove_all(c_statusbar, c_contextId)
}
...
func Fn_gtk_style_get(style unsafe.Pointer, widgetType uint64, firstPropertyName string) {
	c_style := (*C.GtkStyle)(unsafe.Pointer(style))
	...
	C.c_gtk_style_get(c_style, c_widgetType, c_firstPropertyName)
}

func Fn_gtk_style_get_style_property(style unsafe.Pointer, widgetType uint64, propertyName string, value unsafe.Pointer) {
	c_style := (*C.GtkStyle)(unsafe.Pointer(style))
	...
	C.gtk_style_get_style_property(c_style, c_widgetType, c_propertyName, c_value)
}

func Fn_gtk_style_get_valist(style unsafe.Pointer, widgetType uint64, firstPropertyName string) {
	c_style := (*C.GtkStyle)(unsafe.Pointer(style))
	...
	C.c_gtk_style_get_valist(c_style, c_widgetType, c_firstPropertyName)
}

func Fn_gtk_style_has_context(style unsafe.Pointer) bool {
	c_style := (*C.GtkStyle)(unsafe.Pointer(style))

	ret := C.gtk_style_has_context(c_style)
...
func Fn_gtk_style_context_add_class(context unsafe.Pointer, className string) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_className := (*C.gchar)(C.CString(className))
	defer C.free(unsafe.Pointer(c_className))

	C.gtk_style_context_add_class(c_context, c_className)
}

func Fn_gtk_style_context_add_provider(context unsafe.Pointer, provider unsafe.Pointer, priority uint) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_provider := (*C.GtkStyleProvider)(unsafe.Pointer(provider))

	c_priority := (C.guint)(priority)

	C.gtk_style_context_add_provider(c_context, c_provider, c_priority)
}

func Fn_gtk_style_context_add_region(context unsafe.Pointer, regionName string, flags int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_regionName := (*C.gchar)(C.CString(regionName))
	defer C.free(unsafe.Pointer(c_regionName))

	c_flags := (C.GtkRegionFlags)(flags)

	C.gtk_style_context_add_region(c_context, c_regionName, c_flags)
}

func Fn_gtk_style_context_cancel_animations(context unsafe.Pointer, regionId unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_regionId := (C.gpointer)(regionId)

	C.gtk_style_context_cancel_animations(c_context, c_regionId)
}

func Fn_gtk_style_context_get(context unsafe.Pointer, state int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_context_get(c_context, c_state)
}

func Fn_gtk_style_context_get_background_color(context unsafe.Pointer, state int, color unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_get_background_color(c_context, c_state, c_color)
}

func Fn_gtk_style_context_get_border(context unsafe.Pointer, state int, border unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_get_border(c_context, c_state, c_border)
}

func Fn_gtk_style_context_get_border_color(context unsafe.Pointer, state int, color unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_get_border_color(c_context, c_state, c_color)
}

func Fn_gtk_style_context_get_color(context unsafe.Pointer, state int, color unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_get_color(c_context, c_state, c_color)
}

func Fn_gtk_style_context_get_direction(context unsafe.Pointer) int {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_direction(c_context)

	return (int)(ret)
}

func Fn_gtk_style_context_get_font(context unsafe.Pointer, state int) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateFlags)(state)

	ret := C.gtk_style_context_get_font(c_context, c_state)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_context_get_frame_clock(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_frame_clock(c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_context_get_junction_sides(context unsafe.Pointer) int {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_junction_sides(c_context)

	return (int)(ret)
}

func Fn_gtk_style_context_get_margin(context unsafe.Pointer, state int, margin unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateFlags)(state)

	c_margin := (*C.GtkBorder)(unsafe.Pointer(margin))

	C.gtk_style_context_get_margin(c_context, c_state, c_margin)
}

func Fn_gtk_style_context_get_padding(context unsafe.Pointer, state int, padding unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateFlags)(state)

	c_padding := (*C.GtkBorder)(unsafe.Pointer(padding))

	C.gtk_style_context_get_padding(c_context, c_state, c_padding)
}

func Fn_gtk_style_context_get_parent(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_parent(c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_context_get_path(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_path(c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_context_get_property(context unsafe.Pointer, property string, state int, value unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_get_property(c_context, c_property, c_state, c_value)
}

func Fn_gtk_style_context_get_scale(context unsafe.Pointer) int {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_scale(c_context)
...
func Fn_gtk_style_context_get_state(context unsafe.Pointer) int {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_get_state(c_context)

	return (int)(ret)
}

func Fn_gtk_style_context_get_style(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.c_gtk_style_context_get_style(c_context)
}
...
func Fn_gtk_style_context_get_style_valist(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.c_gtk_style_context_get_style_valist(c_context)
}

func Fn_gtk_style_context_get_valist(context unsafe.Pointer, state int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_context_get_valist(c_context, c_state)
}

func Fn_gtk_style_context_has_class(context unsafe.Pointer, className string) bool {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_className := (*C.gchar)(C.CString(className))
	defer C.free(unsafe.Pointer(c_className))

	ret := C.gtk_style_context_has_class(c_context, c_className)

	return toGoBool(ret)
}

func Fn_gtk_style_context_has_region(context unsafe.Pointer, regionName string, flagsReturn *int) bool {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_regionName := (*C.gchar)(C.CString(regionName))
	defer C.free(unsafe.Pointer(c_regionName))

	c_flagsReturn := (*C.GtkRegionFlags)(unsafe.Pointer(flagsReturn))

	ret := C.gtk_style_context_has_region(c_context, c_regionName, c_flagsReturn)

	return toGoBool(ret)
}

func Fn_gtk_style_context_invalidate(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.gtk_style_context_invalidate(c_context)
}

func Fn_gtk_style_context_list_classes(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_list_classes(c_context)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_context_list_regions(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	ret := C.gtk_style_context_list_regions(c_context)
...
func Fn_gtk_style_context_notify_state_change(context unsafe.Pointer, window unsafe.Pointer, regionId unsafe.Pointer, state int, stateValue bool) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	c_stateValue := toCBool(stateValue)

	C.gtk_style_context_notify_state_change(c_context, c_window, c_regionId, c_state, c_stateValue)
}

func Fn_gtk_style_context_pop_animatable_region(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.gtk_style_context_pop_animatable_region(c_context)
}

func Fn_gtk_style_context_push_animatable_region(context unsafe.Pointer, regionId unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_regionId := (C.gpointer)(regionId)

	C.gtk_style_context_push_animatable_region(c_context, c_regionId)
}

func Fn_gtk_style_context_remove_class(context unsafe.Pointer, className string) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_className := (*C.gchar)(C.CString(className))
	defer C.free(unsafe.Pointer(c_className))

	C.gtk_style_context_remove_class(c_context, c_className)
}

func Fn_gtk_style_context_remove_provider(context unsafe.Pointer, provider unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_provider := (*C.GtkStyleProvider)(unsafe.Pointer(provider))

	C.gtk_style_context_remove_provider(c_context, c_provider)
}

func Fn_gtk_style_context_remove_region(context unsafe.Pointer, regionName string) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_regionName := (*C.gchar)(C.CString(regionName))
	defer C.free(unsafe.Pointer(c_regionName))

	C.gtk_style_context_remove_region(c_context, c_regionName)
}

func Fn_gtk_style_context_restore(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.gtk_style_context_restore(c_context)
}

func Fn_gtk_style_context_save(context unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	C.gtk_style_context_save(c_context)
}

func Fn_gtk_style_context_scroll_animations(context unsafe.Pointer, window unsafe.Pointer, dx int, dy int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))
	...
	C.gtk_style_context_scroll_animations(c_context, c_window, c_dx, c_dy)
}

func Fn_gtk_style_context_set_background(context unsafe.Pointer, window unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_window := (*C.GdkWindow)(unsafe.Pointer(window))

	C.gtk_style_context_set_background(c_context, c_window)
}

func Fn_gtk_style_context_set_direction(context unsafe.Pointer, direction int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_direction := (C.GtkTextDirection)(direction)

	C.gtk_style_context_set_direction(c_context, c_direction)
}

func Fn_gtk_style_context_set_frame_clock(context unsafe.Pointer, frameClock unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_frameClock := (*C.GdkFrameClock)(unsafe.Pointer(frameClock))

	C.gtk_style_context_set_frame_clock(c_context, c_frameClock)
}

func Fn_gtk_style_context_set_junction_sides(context unsafe.Pointer, sides int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_sides := (C.GtkJunctionSides)(sides)

	C.gtk_style_context_set_junction_sides(c_context, c_sides)
}

func Fn_gtk_style_context_set_parent(context unsafe.Pointer, parent unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_parent := (*C.GtkStyleContext)(unsafe.Pointer(parent))

	C.gtk_style_context_set_parent(c_context, c_parent)
}

func Fn_gtk_style_context_set_path(context unsafe.Pointer, path unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	C.gtk_style_context_set_path(c_context, c_path)
}

func Fn_gtk_style_context_set_scale(context unsafe.Pointer, scale int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_scale := (C.gint)(scale)

	C.gtk_style_context_set_scale(c_context, c_scale)
}

func Fn_gtk_style_context_set_screen(context unsafe.Pointer, screen unsafe.Pointer) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_screen := (*C.GdkScreen)(unsafe.Pointer(screen))

	C.gtk_style_context_set_screen(c_context, c_screen)
}

func Fn_gtk_style_context_set_state(context unsafe.Pointer, flags int) {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_flags := (C.GtkStateFlags)(flags)

	C.gtk_style_context_set_state(c_context, c_flags)
}

func Fn_gtk_style_context_state_is_running(context unsafe.Pointer, state int, progress *float64) bool {
	c_context := (*C.GtkStyleContext)(unsafe.Pointer(context))

	c_state := (C.GtkStateType)(state)

	c_progress := (*C.gdouble)(unsafe.Pointer(progress))

	ret := C.gtk_style_context_state_is_running(c_context, c_state, c_progress)

	return toGoBool(ret)
}

func Fn_gtk_style_context_add_provider_for_screen(screen unsafe.Pointer, provider unsafe.Pointer, priority uint) {
	c_screen := (*C.GdkScreen)(unsafe.Pointer(screen))
...
func Fn_gtk_style_context_remove_provider_for_screen(screen unsafe.Pointer, provider unsafe.Pointer) {
	c_screen := (*C.GdkScreen)(unsafe.Pointer(screen))
...
func Fn_gtk_style_context_reset_widgets(screen unsafe.Pointer) {
	c_screen := (*C.GdkScreen)(unsafe.Pointer(screen))
...
func Fn_gtk_style_properties_get(props unsafe.Pointer, state int) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_properties_get(c_props, c_state)
}

func Fn_gtk_style_properties_get_property(props unsafe.Pointer, property string, state int, value unsafe.Pointer) bool {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))
	...
	ret := C.gtk_style_properties_get_property(c_props, c_property, c_state, c_value)

	return toGoBool(ret)
}

func Fn_gtk_style_properties_get_valist(props unsafe.Pointer, state int) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_properties_get_valist(c_props, c_state)
}

func Fn_gtk_style_properties_lookup_color(props unsafe.Pointer, name string) unsafe.Pointer {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	ret := C.gtk_style_properties_lookup_color(c_props, c_name)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_properties_map_color(props unsafe.Pointer, name string, color unsafe.Pointer) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))
	...
	C.gtk_style_properties_map_color(c_props, c_name, c_color)
}

func Fn_gtk_style_properties_merge(props unsafe.Pointer, propsToMerge unsafe.Pointer, replace bool) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_propsToMerge := (*C.GtkStyleProperties)(unsafe.Pointer(propsToMerge))

	c_replace := toCBool(replace)

	C.gtk_style_properties_merge(c_props, c_propsToMerge, c_replace)
}

func Fn_gtk_style_properties_set(props unsafe.Pointer, state int) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_properties_set(c_props, c_state)
}

func Fn_gtk_style_properties_set_property(props unsafe.Pointer, property string, state int, value unsafe.Pointer) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))
	...
	C.gtk_style_properties_set_property(c_props, c_property, c_state, c_value)
}

func Fn_gtk_style_properties_set_valist(props unsafe.Pointer, state int) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_style_properties_set_valist(c_props, c_state)
}

func Fn_gtk_style_properties_unset_property(props unsafe.Pointer, property string, state int) {
	c_props := (*C.GtkStyleProperties)(unsafe.Pointer(props))
	...
	C.gtk_style_properties_unset_property(c_props, c_property, c_state)
}
...
func Fn_gtk_switch_get_active(sw unsafe.Pointer) bool {
	c_sw := (*C.GtkSwitch)(unsafe.Pointer(sw))

	ret := C.gtk_switch_get_active(c_sw)

	return toGoBool(ret)
}

func Fn_gtk_switch_set_active(sw unsafe.Pointer, isActive bool) {
	c_sw := (*C.GtkSwitch)(unsafe.Pointer(sw))

	c_isActive := toCBool(isActive)

	C.gtk_switch_set_active(c_sw, c_isActive)
}
...
func Fn_gtk_table_get_size(table unsafe.Pointer, rows *uint, columns *uint) {
	c_table := (*C.GtkTable)(unsafe.Pointer(table))

	c_rows := (*C.guint)(unsafe.Pointer(rows))

	c_columns := (*C.guint)(unsafe.Pointer(columns))

	C.gtk_table_get_size(c_table, c_rows, c_columns)
}
...
func Fn_gtk_text_view_get_cursor_locations(textView unsafe.Pointer, iter unsafe.Pointer, strong unsafe.Pointer, weak unsafe.Pointer) {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	c_iter := (*C.GtkTextIter)(unsafe.Pointer(iter))

	c_strong := (*C.GdkRectangle)(unsafe.Pointer(strong))

	c_weak := (*C.GdkRectangle)(unsafe.Pointer(weak))

	C.gtk_text_view_get_cursor_locations(c_textView, c_iter, c_strong, c_weak)
}
...
func Fn_gtk_text_view_get_hadjustment(textView unsafe.Pointer) unsafe.Pointer {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	ret := C.gtk_text_view_get_hadjustment(c_textView)
...
func Fn_gtk_text_view_get_input_hints(textView unsafe.Pointer) int {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	ret := C.gtk_text_view_get_input_hints(c_textView)

	return (int)(ret)
}

func Fn_gtk_text_view_get_input_purpose(textView unsafe.Pointer) int {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	ret := C.gtk_text_view_get_input_purpose(c_textView)
...
func Fn_gtk_text_view_get_vadjustment(textView unsafe.Pointer) unsafe.Pointer {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	ret := C.gtk_text_view_get_vadjustment(c_textView)
...
func Fn_gtk_text_view_im_context_filter_keypress(textView unsafe.Pointer, event unsafe.Pointer) bool {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	c_event := (*C.GdkEventKey)(unsafe.Pointer(event))

	ret := C.gtk_text_view_im_context_filter_keypress(c_textView, c_event)
...
func Fn_gtk_text_view_reset_im_context(textView unsafe.Pointer) {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	C.gtk_text_view_reset_im_context(c_textView)
}
...
func Fn_gtk_text_view_set_input_hints(textView unsafe.Pointer, hints int) {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	c_hints := (C.GtkInputHints)(hints)

	C.gtk_text_view_set_input_hints(c_textView, c_hints)
}

func Fn_gtk_text_view_set_input_purpose(textView unsafe.Pointer, purpose int) {
	c_textView := (*C.GtkTextView)(unsafe.Pointer(textView))

	c_purpose := (C.GtkInputPurpose)(purpose)

	C.gtk_text_view_set_input_purpose(c_textView, c_purpose)
}
...
func Fn_gtk_theming_engine_get(engine unsafe.Pointer, state int) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_theming_engine_get(c_engine, c_state)
}

func Fn_gtk_theming_engine_get_background_color(engine unsafe.Pointer, state int, color unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_background_color(c_engine, c_state, c_color)
}

func Fn_gtk_theming_engine_get_border(engine unsafe.Pointer, state int, border unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_border(c_engine, c_state, c_border)
}

func Fn_gtk_theming_engine_get_border_color(engine unsafe.Pointer, state int, color unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_border_color(c_engine, c_state, c_color)
}

func Fn_gtk_theming_engine_get_color(engine unsafe.Pointer, state int, color unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_color(c_engine, c_state, c_color)
}

func Fn_gtk_theming_engine_get_direction(engine unsafe.Pointer) int {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	ret := C.gtk_theming_engine_get_direction(c_engine)

	return (int)(ret)
}

func Fn_gtk_theming_engine_get_font(engine unsafe.Pointer, state int) unsafe.Pointer {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	c_state := (C.GtkStateFlags)(state)

	ret := C.gtk_theming_engine_get_font(c_engine, c_state)

	return unsafe.Pointer(ret)
}

func Fn_gtk_theming_engine_get_junction_sides(engine unsafe.Pointer) int {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	ret := C.gtk_theming_engine_get_junction_sides(c_engine)

	return (int)(ret)
}

func Fn_gtk_theming_engine_get_margin(engine unsafe.Pointer, state int, margin unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_margin(c_engine, c_state, c_margin)
}

func Fn_gtk_theming_engine_get_padding(engine unsafe.Pointer, state int, padding unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_padding(c_engine, c_state, c_padding)
}

func Fn_gtk_theming_engine_get_path(engine unsafe.Pointer) unsafe.Pointer {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	ret := C.gtk_theming_engine_get_path(c_engine)

	return unsafe.Pointer(ret)
}

func Fn_gtk_theming_engine_get_property(engine unsafe.Pointer, property string, state int, value unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_property(c_engine, c_property, c_state, c_value)
}
...
func Fn_gtk_theming_engine_get_state(engine unsafe.Pointer) int {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	ret := C.gtk_theming_engine_get_state(c_engine)

	return (int)(ret)
}

func Fn_gtk_theming_engine_get_style(engine unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	C.c_gtk_theming_engine_get_style(c_engine)
}

func Fn_gtk_theming_engine_get_style_property(engine unsafe.Pointer, propertyName string, value unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	C.gtk_theming_engine_get_style_property(c_engine, c_propertyName, c_value)
}

func Fn_gtk_theming_engine_get_style_valist(engine unsafe.Pointer) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	C.c_gtk_theming_engine_get_style_valist(c_engine)
}

func Fn_gtk_theming_engine_get_valist(engine unsafe.Pointer, state int) {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	c_state := (C.GtkStateFlags)(state)

	C.c_gtk_theming_engine_get_valist(c_engine, c_state)
}

func Fn_gtk_theming_engine_has_class(engine unsafe.Pointer, styleClass string) bool {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	c_styleClass := (*C.gchar)(C.CString(styleClass))
	defer C.free(unsafe.Pointer(c_styleClass))

	ret := C.gtk_theming_engine_has_class(c_engine, c_styleClass)

	return toGoBool(ret)
}

func Fn_gtk_theming_engine_has_region(engine unsafe.Pointer, styleRegion string, flags *int) bool {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))

	c_styleRegion := (*C.gchar)(C.CString(styleRegion))
	defer C.free(unsafe.Pointer(c_styleRegion))

	c_flags := (*C.GtkRegionFlags)(unsafe.Pointer(flags))

	ret := C.gtk_theming_engine_has_region(c_engine, c_styleRegion, c_flags)

	return toGoBool(ret)
}

func Fn_gtk_theming_engine_lookup_color(engine unsafe.Pointer, colorName string, color unsafe.Pointer) bool {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	ret := C.gtk_theming_engine_lookup_color(c_engine, c_colorName, c_color)

	return toGoBool(ret)
}

func Fn_gtk_theming_engine_state_is_running(engine unsafe.Pointer, state int, progress *float64) bool {
	c_engine := (*C.GtkThemingEngine)(unsafe.Pointer(engine))
	...
	ret := C.gtk_theming_engine_state_is_running(c_engine, c_state, c_progress)
...
func Fn_gtk_tool_item_get_ellipsize_mode(toolItem unsafe.Pointer) int {
	c_toolItem := (*C.GtkToolItem)(unsafe.Pointer(toolItem))

	ret := C.gtk_tool_item_get_ellipsize_mode(c_toolItem)
...
func Fn_gtk_tool_item_get_text_alignment(toolItem unsafe.Pointer) float32 {
	c_toolItem := (*C.GtkToolItem)(unsafe.Pointer(toolItem))

	ret := C.gtk_tool_item_get_text_alignment(c_toolItem)

	return (float32)(ret)
}

func Fn_gtk_tool_item_get_text_orientation(toolItem unsafe.Pointer) int {
	c_toolItem := (*C.GtkToolItem)(unsafe.Pointer(toolItem))

	ret := C.gtk_tool_item_get_text_orientation(c_toolItem)

	return (int)(ret)
}

func Fn_gtk_tool_item_get_text_size_group(toolItem unsafe.Pointer) unsafe.Pointer {
	c_toolItem := (*C.GtkToolItem)(unsafe.Pointer(toolItem))

	ret := C.gtk_tool_item_get_text_size_group(c_toolItem)
...
func Fn_gtk_tool_item_group_new(label string) unsafe.Pointer {
	c_label := (*C.gchar)(C.CString(label))
	defer C.free(unsafe.Pointer(c_label))

	ret := C.gtk_tool_item_group_new(c_label)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_item_group_get_collapsed(group unsafe.Pointer) bool {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_collapsed(c_group)

	return toGoBool(ret)
}

func Fn_gtk_tool_item_group_get_drop_item(group unsafe.Pointer, x int, y int) unsafe.Pointer {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))
	...
	ret := C.gtk_tool_item_group_get_drop_item(c_group, c_x, c_y)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_item_group_get_ellipsize(group unsafe.Pointer) int {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_ellipsize(c_group)

	return (int)(ret)
}

func Fn_gtk_tool_item_group_get_header_relief(group unsafe.Pointer) int {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_header_relief(c_group)

	return (int)(ret)
}

func Fn_gtk_tool_item_group_get_item_position(group unsafe.Pointer, item unsafe.Pointer) int {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_item := (*C.GtkToolItem)(unsafe.Pointer(item))

	ret := C.gtk_tool_item_group_get_item_position(c_group, c_item)

	return (int)(ret)
}

func Fn_gtk_tool_item_group_get_label(group unsafe.Pointer) string {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_label(c_group)

	return C.GoString(ret)
}

func Fn_gtk_tool_item_group_get_label_widget(group unsafe.Pointer) unsafe.Pointer {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_label_widget(c_group)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_item_group_get_n_items(group unsafe.Pointer) uint {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_item_group_get_n_items(c_group)

	return (uint)(ret)
}

func Fn_gtk_tool_item_group_get_nth_item(group unsafe.Pointer, index uint) unsafe.Pointer {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_index := (C.guint)(index)

	ret := C.gtk_tool_item_group_get_nth_item(c_group, c_index)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_item_group_insert(group unsafe.Pointer, item unsafe.Pointer, position int) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))
	...
	C.gtk_tool_item_group_insert(c_group, c_item, c_position)
}

func Fn_gtk_tool_item_group_set_collapsed(group unsafe.Pointer, collapsed bool) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_collapsed := toCBool(collapsed)

	C.gtk_tool_item_group_set_collapsed(c_group, c_collapsed)
}

func Fn_gtk_tool_item_group_set_ellipsize(group unsafe.Pointer, ellipsize int) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_ellipsize := (C.PangoEllipsizeMode)(ellipsize)

	C.gtk_tool_item_group_set_ellipsize(c_group, c_ellipsize)
}

func Fn_gtk_tool_item_group_set_header_relief(group unsafe.Pointer, style int) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_style := (C.GtkReliefStyle)(style)

	C.gtk_tool_item_group_set_header_relief(c_group, c_style)
}

func Fn_gtk_tool_item_group_set_item_position(group unsafe.Pointer, item unsafe.Pointer, position int) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))
	...
	C.gtk_tool_item_group_set_item_position(c_group, c_item, c_position)
}

func Fn_gtk_tool_item_group_set_label(group unsafe.Pointer, label string) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_label := (*C.gchar)(C.CString(label))
	defer C.free(unsafe.Pointer(c_label))

	C.gtk_tool_item_group_set_label(c_group, c_label)
}

func Fn_gtk_tool_item_group_set_label_widget(group unsafe.Pointer, labelWidget unsafe.Pointer) {
	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_labelWidget := (*C.GtkWidget)(unsafe.Pointer(labelWidget))

	C.gtk_tool_item_group_set_label_widget(c_group, c_labelWidget)
}
...
func Fn_gtk_tool_palette_add_drag_dest(palette unsafe.Pointer, widget unsafe.Pointer, flags int, targets int, actions int) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))
	...
	C.gtk_tool_palette_add_drag_dest(c_palette, c_widget, c_flags, c_targets, c_actions)
}

func Fn_gtk_tool_palette_get_drag_item(palette unsafe.Pointer, selection unsafe.Pointer) unsafe.Pointer {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_selection := (*C.GtkSelectionData)(unsafe.Pointer(selection))

	ret := C.gtk_tool_palette_get_drag_item(c_palette, c_selection)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_palette_get_drop_group(palette unsafe.Pointer, x int, y int) unsafe.Pointer {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))
	...
	ret := C.gtk_tool_palette_get_drop_group(c_palette, c_x, c_y)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_palette_get_drop_item(palette unsafe.Pointer, x int, y int) unsafe.Pointer {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))
	...
	ret := C.gtk_tool_palette_get_drop_item(c_palette, c_x, c_y)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_palette_get_exclusive(palette unsafe.Pointer, group unsafe.Pointer) bool {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_palette_get_exclusive(c_palette, c_group)

	return toGoBool(ret)
}

func Fn_gtk_tool_palette_get_expand(palette unsafe.Pointer, group unsafe.Pointer) bool {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_palette_get_expand(c_palette, c_group)

	return toGoBool(ret)
}

func Fn_gtk_tool_palette_get_group_position(palette unsafe.Pointer, group unsafe.Pointer) int {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	ret := C.gtk_tool_palette_get_group_position(c_palette, c_group)

	return (int)(ret)
}

func Fn_gtk_tool_palette_get_hadjustment(palette unsafe.Pointer) unsafe.Pointer {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	ret := C.gtk_tool_palette_get_hadjustment(c_palette)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_palette_get_icon_size(palette unsafe.Pointer) int {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	ret := C.gtk_tool_palette_get_icon_size(c_palette)

	return (int)(ret)
}

func Fn_gtk_tool_palette_get_style(palette unsafe.Pointer) int {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	ret := C.gtk_tool_palette_get_style(c_palette)

	return (int)(ret)
}

func Fn_gtk_tool_palette_get_vadjustment(palette unsafe.Pointer) unsafe.Pointer {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	ret := C.gtk_tool_palette_get_vadjustment(c_palette)

	return unsafe.Pointer(ret)
}

func Fn_gtk_tool_palette_set_drag_source(palette unsafe.Pointer, targets int) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_targets := (C.GtkToolPaletteDragTargets)(targets)

	C.gtk_tool_palette_set_drag_source(c_palette, c_targets)
}

func Fn_gtk_tool_palette_set_exclusive(palette unsafe.Pointer, group unsafe.Pointer, exclusive bool) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_group := (*C.GtkToolItemGroup)(unsafe.Pointer(group))

	c_exclusive := toCBool(exclusive)

	C.gtk_tool_palette_set_exclusive(c_palette, c_group, c_exclusive)
}

func Fn_gtk_tool_palette_set_expand(palette unsafe.Pointer, group unsafe.Pointer, expand bool) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))
	...
	C.gtk_tool_palette_set_expand(c_palette, c_group, c_expand)
}

func Fn_gtk_tool_palette_set_group_position(palette unsafe.Pointer, group unsafe.Pointer, position int) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))
	...
	C.gtk_tool_palette_set_group_position(c_palette, c_group, c_position)
}

func Fn_gtk_tool_palette_set_icon_size(palette unsafe.Pointer, iconSize int) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_iconSize := (C.GtkIconSize)(iconSize)

	C.gtk_tool_palette_set_icon_size(c_palette, c_iconSize)
}

func Fn_gtk_tool_palette_set_style(palette unsafe.Pointer, style int) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	c_style := (C.GtkToolbarStyle)(style)

	C.gtk_tool_palette_set_style(c_palette, c_style)
}

func Fn_gtk_tool_palette_unset_icon_size(palette unsafe.Pointer) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	C.gtk_tool_palette_unset_icon_size(c_palette)
}

func Fn_gtk_tool_palette_unset_style(palette unsafe.Pointer) {
	c_palette := (*C.GtkToolPalette)(unsafe.Pointer(palette))

	C.gtk_tool_palette_unset_style(c_palette)
}
...
func Fn_gtk_tooltip_set_icon_from_gicon(tooltip unsafe.Pointer, gicon unsafe.Pointer, size int) {
	c_tooltip := (*C.GtkTooltip)(unsafe.Pointer(tooltip))

	c_gicon := (*C.GIcon)(unsafe.Pointer(gicon))

	c_size := (C.GtkIconSize)(size)

	C.gtk_tooltip_set_icon_from_gicon(c_tooltip, c_gicon, c_size)
}
...
func Fn_gtk_tree_view_get_activate_on_single_click(treeView unsafe.Pointer) bool {
	c_treeView := (*C.GtkTreeView)(unsafe.Pointer(treeView))

	ret := C.gtk_tree_view_get_activate_on_single_click(c_treeView)
...
func Fn_gtk_tree_view_get_n_columns(treeView unsafe.Pointer) uint {
	c_treeView := (*C.GtkTreeView)(unsafe.Pointer(treeView))

	ret := C.gtk_tree_view_get_n_columns(c_treeView)
...
func Fn_gtk_tree_view_set_activate_on_single_click(treeView unsafe.Pointer, single bool) {
	c_treeView := (*C.GtkTreeView)(unsafe.Pointer(treeView))

	c_single := toCBool(single)

	C.gtk_tree_view_set_activate_on_single_click(c_treeView, c_single)
}
...
func Fn_gtk_tree_view_column_new_with_area(area unsafe.Pointer) unsafe.Pointer {
	c_area := (*C.GtkCellArea)(unsafe.Pointer(area))

	ret := C.gtk_tree_view_column_new_with_area(c_area)
...
func Fn_gtk_tree_view_column_get_button(treeColumn unsafe.Pointer) unsafe.Pointer {
	c_treeColumn := (*C.GtkTreeViewColumn)(unsafe.Pointer(treeColumn))

	ret := C.gtk_tree_view_column_get_button(c_treeColumn)
...
func Fn_gtk_tree_view_column_get_x_offset(treeColumn unsafe.Pointer) int {
	c_treeColumn := (*C.GtkTreeViewColumn)(unsafe.Pointer(treeColumn))

	ret := C.gtk_tree_view_column_get_x_offset(c_treeColumn)
...
func Fn_gtk_ui_manager_add_ui_from_resource(manager unsafe.Pointer, resourcePath string, error unsafe.Pointer) uint {
	c_manager := (*C.GtkUIManager)(unsafe.Pointer(manager))
	...
	ret := C.gtk_ui_manager_add_ui_from_resource(c_manager, c_resourcePath, cError)
...
func Fn_gtk_viewport_get_bin_window(viewport unsafe.Pointer) unsafe.Pointer {
	c_viewport := (*C.GtkViewport)(unsafe.Pointer(viewport))

	ret := C.gtk_viewport_get_bin_window(c_viewport)
...
func Fn_gtk_viewport_get_view_window(viewport unsafe.Pointer) unsafe.Pointer {
	c_viewport := (*C.GtkViewport)(unsafe.Pointer(viewport))

	ret := C.gtk_viewport_get_view_window(c_viewport)
...
func Fn_gtk_widget_add_device_events(widget unsafe.Pointer, device unsafe.Pointer, events int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_add_device_events(c_widget, c_device, c_events)
}
...
func Fn_gtk_widget_device_is_shadowed(widget unsafe.Pointer, device unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	ret := C.gtk_widget_device_is_shadowed(c_widget, c_device)
...
func Fn_gtk_drag_begin_with_coordinates(widget unsafe.Pointer, targets unsafe.Pointer, actions int, button int, event unsafe.Pointer, x int, y int) unsafe.Pointer {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	ret := C.gtk_drag_begin_with_coordinates(c_widget, c_targets, c_actions, c_button, c_event, c_x, c_y)
...
func Fn_gtk_drag_source_set_icon_gicon(widget unsafe.Pointer, icon unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_icon := (*C.GIcon)(unsafe.Pointer(icon))

	C.gtk_drag_source_set_icon_gicon(c_widget, c_icon)
}
...
func Fn_gtk_widget_draw(widget unsafe.Pointer, cr unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_cr := (*C.cairo_t)(unsafe.Pointer(cr))

	C.gtk_widget_draw(c_widget, c_cr)
}
...
func Fn_gtk_widget_get_allocated_baseline(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_allocated_baseline(c_widget)
...
func Fn_gtk_widget_get_allocation(widget unsafe.Pointer, allocation *gdk.Rectangle) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_allocation := (*C.GtkAllocation)(unsafe.Pointer(allocation))

	C.gtk_widget_get_allocation(c_widget, c_allocation)
}
...
func Fn_gtk_widget_get_app_paintable(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_app_paintable(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_can_default(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_can_default(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_can_focus(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_can_focus(c_widget)
...
func Fn_gtk_widget_get_device_enabled(widget unsafe.Pointer, device unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	ret := C.gtk_widget_get_device_enabled(c_widget, c_device)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_device_events(widget unsafe.Pointer, device unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	ret := C.gtk_widget_get_device_events(c_widget, c_device)
...
func Fn_gtk_widget_get_double_buffered(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_double_buffered(c_widget)
...
func Fn_gtk_widget_get_frame_clock(widget unsafe.Pointer) unsafe.Pointer {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_frame_clock(c_widget)
...
func Fn_gtk_widget_get_has_window(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_has_window(c_widget)
...
func Fn_gtk_widget_get_mapped(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_mapped(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_margin_bottom(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_bottom(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_margin_end(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_end(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_margin_left(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_left(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_margin_right(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_right(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_margin_start(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_start(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_margin_top(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_margin_top(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_modifier_mask(widget unsafe.Pointer, intent int) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_intent := (C.GdkModifierIntent)(intent)

	ret := C.gtk_widget_get_modifier_mask(c_widget, c_intent)
...
func Fn_gtk_widget_get_opacity(widget unsafe.Pointer) float64 {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_opacity(c_widget)
...
func Fn_gtk_widget_get_preferred_height(widget unsafe.Pointer, minimumHeight *int, naturalHeight *int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_get_preferred_height(c_widget, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_widget_get_preferred_height_and_baseline_for_width(widget unsafe.Pointer, width int, minimumHeight *int, naturalHeight *int, minimumBaseline *int, naturalBaseline *int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	c_minimumBaseline := (*C.gint)(unsafe.Pointer(minimumBaseline))

	c_naturalBaseline := (*C.gint)(unsafe.Pointer(naturalBaseline))

	C.gtk_widget_get_preferred_height_and_baseline_for_width(c_widget, c_width, c_minimumHeight, c_naturalHeight, c_minimumBaseline, c_naturalBaseline)
}

func Fn_gtk_widget_get_preferred_height_for_width(widget unsafe.Pointer, width int, minimumHeight *int, naturalHeight *int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_get_preferred_height_for_width(c_widget, c_width, c_minimumHeight, c_naturalHeight)
}

func Fn_gtk_widget_get_preferred_size(widget unsafe.Pointer, minimumSize unsafe.Pointer, naturalSize unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_get_preferred_size(c_widget, c_minimumSize, c_naturalSize)
}

func Fn_gtk_widget_get_preferred_width(widget unsafe.Pointer, minimumWidth *int, naturalWidth *int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_get_preferred_width(c_widget, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_widget_get_preferred_width_for_height(widget unsafe.Pointer, height int, minimumWidth *int, naturalWidth *int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_get_preferred_width_for_height(c_widget, c_height, c_minimumWidth, c_naturalWidth)
}

func Fn_gtk_widget_get_realized(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_realized(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_receives_default(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_receives_default(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_get_request_mode(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_request_mode(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_requisition(widget unsafe.Pointer, requisition unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_requisition := (*C.GtkRequisition)(unsafe.Pointer(requisition))

	C.gtk_widget_get_requisition(c_widget, c_requisition)
}
...
func Fn_gtk_widget_get_scale_factor(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_scale_factor(c_widget)
...
func Fn_gtk_widget_get_sensitive(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_sensitive(c_widget)
...
func Fn_gtk_widget_get_state(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_state(c_widget)

	return (int)(ret)
}

func Fn_gtk_widget_get_state_flags(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_state_flags(c_widget)
...
func Fn_gtk_widget_get_valign_with_baseline(widget unsafe.Pointer) int {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_valign_with_baseline(c_widget)
...
func Fn_gtk_widget_get_visible(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_get_visible(c_widget)
...
func Fn_gtk_widget_has_default(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_has_default(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_has_focus(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_has_focus(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_has_grab(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_has_grab(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_has_rc_style(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_has_rc_style(c_widget)
...
func Fn_gtk_widget_has_visible_focus(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_has_visible_focus(c_widget)
...
func Fn_gtk_widget_init_template(widget unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_widget_init_template(c_widget)
}

func Fn_gtk_widget_input_shape_combine_region(widget unsafe.Pointer, region unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_region := (*C.cairo_region_t)(unsafe.Pointer(region))

	C.gtk_widget_input_shape_combine_region(c_widget, c_region)
}

func Fn_gtk_widget_insert_action_group(widget unsafe.Pointer, name string, group unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_name := (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(c_name))

	c_group := (*C.GActionGroup)(unsafe.Pointer(group))

	C.gtk_widget_insert_action_group(c_widget, c_name, c_group)
}
...
func Fn_gtk_widget_is_drawable(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_is_drawable(c_widget)
...
func Fn_gtk_widget_is_sensitive(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_is_sensitive(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_is_toplevel(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_is_toplevel(c_widget)

	return toGoBool(ret)
}

func Fn_gtk_widget_is_visible(widget unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	ret := C.gtk_widget_is_visible(c_widget)
...
func Fn_gtk_widget_override_background_color(widget unsafe.Pointer, state int, color unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_override_background_color(c_widget, c_state, c_color)
}

func Fn_gtk_widget_override_color(widget unsafe.Pointer, state int, color unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_override_color(c_widget, c_state, c_color)
}

func Fn_gtk_widget_override_cursor(widget unsafe.Pointer, cursor unsafe.Pointer, secondaryCursor unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_cursor := (*C.GdkRGBA)(unsafe.Pointer(cursor))

	c_secondaryCursor := (*C.GdkRGBA)(unsafe.Pointer(secondaryCursor))

	C.gtk_widget_override_cursor(c_widget, c_cursor, c_secondaryCursor)
}

func Fn_gtk_widget_override_font(widget unsafe.Pointer, fontDesc unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_fontDesc := (*C.PangoFontDescription)(unsafe.Pointer(fontDesc))

	C.gtk_widget_override_font(c_widget, c_fontDesc)
}

func Fn_gtk_widget_override_symbolic_color(widget unsafe.Pointer, name string, color unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_override_symbolic_color(c_widget, c_name, c_color)
}
...
func Fn_gtk_widget_queue_draw_region(widget unsafe.Pointer, region unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_region := (*C.cairo_region_t)(unsafe.Pointer(region))

	C.gtk_widget_queue_draw_region(c_widget, c_region)
}
...
func Fn_gtk_widget_register_window(widget unsafe.Pointer, window unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_window := (*C.GdkWindow)(unsafe.Pointer(window))

	C.gtk_widget_register_window(c_widget, c_window)
}
...
func Fn_gtk_widget_remove_tick_callback(widget unsafe.Pointer, id uint) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_id := (C.guint)(id)

	C.gtk_widget_remove_tick_callback(c_widget, c_id)
}
...
func Fn_gtk_widget_render_icon_pixbuf(widget unsafe.Pointer, stockId string, size int) unsafe.Pointer {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	ret := C.gtk_widget_render_icon_pixbuf(c_widget, c_stockId, c_size)
...
func Fn_gtk_widget_reset_style(widget unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_widget_reset_style(c_widget)
}
...
func Fn_gtk_widget_send_focus_change(widget unsafe.Pointer, event unsafe.Pointer) bool {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_event := (*C.GdkEvent)(unsafe.Pointer(event))

	ret := C.gtk_widget_send_focus_change(c_widget, c_event)
...
func Fn_gtk_widget_set_allocation(widget unsafe.Pointer, allocation *gdk.Rectangle) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_allocation := (*C.GtkAllocation)(unsafe.Pointer(allocation))

	C.gtk_widget_set_allocation(c_widget, c_allocation)
}
...
func Fn_gtk_widget_set_can_default(widget unsafe.Pointer, canDefault bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_canDefault := toCBool(canDefault)

	C.gtk_widget_set_can_default(c_widget, c_canDefault)
}

func Fn_gtk_widget_set_can_focus(widget unsafe.Pointer, canFocus bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_canFocus := toCBool(canFocus)

	C.gtk_widget_set_can_focus(c_widget, c_canFocus)
}
...
func Fn_gtk_widget_set_device_enabled(widget unsafe.Pointer, device unsafe.Pointer, enabled bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_set_device_enabled(c_widget, c_device, c_enabled)
}

func Fn_gtk_widget_set_device_events(widget unsafe.Pointer, device unsafe.Pointer, events int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_set_device_events(c_widget, c_device, c_events)
}
...
func Fn_gtk_widget_set_has_window(widget unsafe.Pointer, hasWindow bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_hasWindow := toCBool(hasWindow)

	C.gtk_widget_set_has_window(c_widget, c_hasWindow)
}
...
func Fn_gtk_widget_set_mapped(widget unsafe.Pointer, mapped bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_mapped := toCBool(mapped)

	C.gtk_widget_set_mapped(c_widget, c_mapped)
}

func Fn_gtk_widget_set_margin_bottom(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_bottom(c_widget, c_margin)
}

func Fn_gtk_widget_set_margin_end(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_end(c_widget, c_margin)
}

func Fn_gtk_widget_set_margin_left(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_left(c_widget, c_margin)
}

func Fn_gtk_widget_set_margin_right(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_right(c_widget, c_margin)
}

func Fn_gtk_widget_set_margin_start(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_start(c_widget, c_margin)
}

func Fn_gtk_widget_set_margin_top(widget unsafe.Pointer, margin int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_margin := (C.gint)(margin)

	C.gtk_widget_set_margin_top(c_widget, c_margin)
}
...
func Fn_gtk_widget_set_opacity(widget unsafe.Pointer, opacity float64) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_opacity := (C.double)(opacity)

	C.gtk_widget_set_opacity(c_widget, c_opacity)
}
...
func Fn_gtk_widget_set_realized(widget unsafe.Pointer, realized bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_realized := toCBool(realized)

	C.gtk_widget_set_realized(c_widget, c_realized)
}

func Fn_gtk_widget_set_receives_default(widget unsafe.Pointer, receivesDefault bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_receivesDefault := toCBool(receivesDefault)

	C.gtk_widget_set_receives_default(c_widget, c_receivesDefault)
}
...
func Fn_gtk_widget_set_state_flags(widget unsafe.Pointer, flags int, clear bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_flags := (C.GtkStateFlags)(flags)

	c_clear := toCBool(clear)

	C.gtk_widget_set_state_flags(c_widget, c_flags, c_clear)
}
...
func Fn_gtk_widget_set_support_multidevice(widget unsafe.Pointer, supportMultidevice bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_supportMultidevice := toCBool(supportMultidevice)

	C.gtk_widget_set_support_multidevice(c_widget, c_supportMultidevice)
}
...
func Fn_gtk_widget_set_visible(widget unsafe.Pointer, visible bool) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_visible := toCBool(visible)

	C.gtk_widget_set_visible(c_widget, c_visible)
}
...
func Fn_gtk_widget_set_window(widget unsafe.Pointer, window unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_window := (*C.GdkWindow)(unsafe.Pointer(window))

	C.gtk_widget_set_window(c_widget, c_window)
}

func Fn_gtk_widget_shape_combine_region(widget unsafe.Pointer, region unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_region := (*C.cairo_region_t)(unsafe.Pointer(region))

	C.gtk_widget_shape_combine_region(c_widget, c_region)
}
...
func Fn_gtk_widget_size_allocate_with_baseline(widget unsafe.Pointer, allocation *gdk.Rectangle, baseline int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))
	...
	C.gtk_widget_size_allocate_with_baseline(c_widget, c_allocation, c_baseline)
}
...
func Fn_gtk_widget_style_attach(widget unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	C.gtk_widget_style_attach(c_widget)
}
...
func Fn_gtk_widget_unregister_window(widget unsafe.Pointer, window unsafe.Pointer) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_window := (*C.GdkWindow)(unsafe.Pointer(window))

	C.gtk_widget_unregister_window(c_widget, c_window)
}

func Fn_gtk_widget_unset_state_flags(widget unsafe.Pointer, flags int) {
	c_widget := (*C.GtkWidget)(unsafe.Pointer(widget))

	c_flags := (C.GtkStateFlags)(flags)

	C.gtk_widget_unset_state_flags(c_widget, c_flags)
}
...
func Fn_gtk_window_close(window unsafe.Pointer) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	C.gtk_window_close(c_window)
}
...
func Fn_gtk_window_get_application(window unsafe.Pointer) unsafe.Pointer {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_application(c_window)

	return unsafe.Pointer(ret)
}

func Fn_gtk_window_get_attached_to(window unsafe.Pointer) unsafe.Pointer {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_attached_to(c_window)
...
func Fn_gtk_window_get_focus_visible(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_focus_visible(c_window)
...
func Fn_gtk_window_get_has_resize_grip(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_has_resize_grip(c_window)

	return toGoBool(ret)
}

func Fn_gtk_window_get_hide_titlebar_when_maximized(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_hide_titlebar_when_maximized(c_window)
...
func Fn_gtk_window_get_mnemonics_visible(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_mnemonics_visible(c_window)
...
func Fn_gtk_window_get_resize_grip_area(window unsafe.Pointer, rect unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_rect := (*C.GdkRectangle)(unsafe.Pointer(rect))

	ret := C.gtk_window_get_resize_grip_area(c_window, c_rect)
...
func Fn_gtk_window_get_window_type(window unsafe.Pointer) int {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_get_window_type(c_window)
...
func Fn_gtk_window_is_maximized(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_is_maximized(c_window)
...
func Fn_gtk_window_resize_grip_is_visible(window unsafe.Pointer) bool {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	ret := C.gtk_window_resize_grip_is_visible(c_window)

	return toGoBool(ret)
}

func Fn_gtk_window_resize_to_geometry(window unsafe.Pointer, width int, height int) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))
	...
	C.gtk_window_resize_to_geometry(c_window, c_width, c_height)
}
...
func Fn_gtk_window_set_application(window unsafe.Pointer, application unsafe.Pointer) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_application := (*C.GtkApplication)(unsafe.Pointer(application))

	C.gtk_window_set_application(c_window, c_application)
}

func Fn_gtk_window_set_attached_to(window unsafe.Pointer, attachWidget unsafe.Pointer) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_attachWidget := (*C.GtkWidget)(unsafe.Pointer(attachWidget))

	C.gtk_window_set_attached_to(c_window, c_attachWidget)
}
...
func Fn_gtk_window_set_default_geometry(window unsafe.Pointer, width int, height int) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))
	...
	C.gtk_window_set_default_geometry(c_window, c_width, c_height)
}
...
func Fn_gtk_window_set_focus_visible(window unsafe.Pointer, setting bool) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_setting := toCBool(setting)

	C.gtk_window_set_focus_visible(c_window, c_setting)
}
...
func Fn_gtk_window_set_has_resize_grip(window unsafe.Pointer, value bool) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_value := toCBool(value)

	C.gtk_window_set_has_resize_grip(c_window, c_value)
}

func Fn_gtk_window_set_has_user_ref_count(window unsafe.Pointer, setting bool) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_setting := toCBool(setting)

	C.gtk_window_set_has_user_ref_count(c_window, c_setting)
}

func Fn_gtk_window_set_hide_titlebar_when_maximized(window unsafe.Pointer, setting bool) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_setting := toCBool(setting)

	C.gtk_window_set_hide_titlebar_when_maximized(c_window, c_setting)
}
...
func Fn_gtk_window_set_mnemonics_visible(window unsafe.Pointer, setting bool) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_setting := toCBool(setting)

	C.gtk_window_set_mnemonics_visible(c_window, c_setting)
}
...
func Fn_gtk_window_set_titlebar(window unsafe.Pointer, titlebar unsafe.Pointer) {
	c_window := (*C.GtkWindow)(unsafe.Pointer(window))

	c_titlebar := (*C.GtkWidget)(unsafe.Pointer(titlebar))

	C.gtk_window_set_titlebar(c_window, c_titlebar)
}
...
func Fn_gtk_window_group_get_current_device_grab(windowGroup unsafe.Pointer, device unsafe.Pointer) unsafe.Pointer {
	c_windowGroup := (*C.GtkWindowGroup)(unsafe.Pointer(windowGroup))

	c_device := (*C.GdkDevice)(unsafe.Pointer(device))

	ret := C.gtk_window_group_get_current_device_grab(c_windowGroup, c_device)

	return unsafe.Pointer(ret)
}

func Fn_gtk_window_group_get_current_grab(windowGroup unsafe.Pointer) unsafe.Pointer {
	c_windowGroup := (*C.GtkWindowGroup)(unsafe.Pointer(windowGroup))

	ret := C.gtk_window_group_get_current_grab(c_windowGroup)
...
func Fn_gtk_actionable_get_action_name(actionable unsafe.Pointer) string {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	ret := C.gtk_actionable_get_action_name(c_actionable)

	return C.GoString(ret)
}

func Fn_gtk_actionable_get_action_target_value(actionable unsafe.Pointer) unsafe.Pointer {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	ret := C.gtk_actionable_get_action_target_value(c_actionable)

	return unsafe.Pointer(ret)
}

func Fn_gtk_actionable_set_action_name(actionable unsafe.Pointer, actionName *string) {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	var c_actionNameValue (*C.gchar)
	if actionName != nil {
		c_actionNameValue = (*C.gchar)(C.CString(*actionName))
		defer C.free(unsafe.Pointer(c_actionNameValue))
	}
	c_actionName := c_actionNameValue

	C.gtk_actionable_set_action_name(c_actionable, c_actionName)
}

func Fn_gtk_actionable_set_action_target(actionable unsafe.Pointer, formatString string) {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	c_formatString := (*C.gchar)(C.CString(formatString))
	defer C.free(unsafe.Pointer(c_formatString))

	C.c_gtk_actionable_set_action_target(c_actionable, c_formatString)
}

func Fn_gtk_actionable_set_action_target_value(actionable unsafe.Pointer, targetValue unsafe.Pointer) {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	c_targetValue := (*C.GVariant)(unsafe.Pointer(targetValue))

	C.gtk_actionable_set_action_target_value(c_actionable, c_targetValue)
}

func Fn_gtk_actionable_set_detailed_action_name(actionable unsafe.Pointer, detailedActionName string) {
	c_actionable := (*C.GtkActionable)(unsafe.Pointer(actionable))

	c_detailedActionName := (*C.gchar)(C.CString(detailedActionName))
	defer C.free(unsafe.Pointer(c_detailedActionName))

	C.gtk_actionable_set_detailed_action_name(c_actionable, c_detailedActionName)
}

func Fn_gtk_activatable_do_set_related_action(activatable unsafe.Pointer, action unsafe.Pointer) {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	C.gtk_activatable_do_set_related_action(c_activatable, c_action)
}

func Fn_gtk_activatable_get_related_action(activatable unsafe.Pointer) unsafe.Pointer {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	ret := C.gtk_activatable_get_related_action(c_activatable)

	return unsafe.Pointer(ret)
}

func Fn_gtk_activatable_get_use_action_appearance(activatable unsafe.Pointer) bool {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	ret := C.gtk_activatable_get_use_action_appearance(c_activatable)

	return toGoBool(ret)
}

func Fn_gtk_activatable_set_related_action(activatable unsafe.Pointer, action unsafe.Pointer) {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	C.gtk_activatable_set_related_action(c_activatable, c_action)
}

func Fn_gtk_activatable_set_use_action_appearance(activatable unsafe.Pointer, useAppearance bool) {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	c_useAppearance := toCBool(useAppearance)

	C.gtk_activatable_set_use_action_appearance(c_activatable, c_useAppearance)
}

func Fn_gtk_activatable_sync_action_properties(activatable unsafe.Pointer, action unsafe.Pointer) {
	c_activatable := (*C.GtkActivatable)(unsafe.Pointer(activatable))

	c_action := (*C.GtkAction)(unsafe.Pointer(action))

	C.gtk_activatable_sync_action_properties(c_activatable, c_action)
}

func Fn_gtk_app_chooser_get_app_info(self unsafe.Pointer) unsafe.Pointer {
	c_self := (*C.GtkAppChooser)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_get_app_info(c_self)

	return unsafe.Pointer(ret)
}

func Fn_gtk_app_chooser_get_content_type(self unsafe.Pointer) string {
	c_self := (*C.GtkAppChooser)(unsafe.Pointer(self))

	ret := C.gtk_app_chooser_get_content_type(c_self)

	return C.GoString(ret)
}

func Fn_gtk_app_chooser_refresh(self unsafe.Pointer) {
	c_self := (*C.GtkAppChooser)(unsafe.Pointer(self))

	C.gtk_app_chooser_refresh(c_self)
}
...
func Fn_gtk_cell_layout_get_area(cellLayout unsafe.Pointer) unsafe.Pointer {
	c_cellLayout := (*C.GtkCellLayout)(unsafe.Pointer(cellLayout))

	ret := C.gtk_cell_layout_get_area(c_cellLayout)
...
func Fn_gtk_color_chooser_add_palette(chooser unsafe.Pointer, orientation int, colorsPerLine int, nColors int, colors []gdk.RGBA) {
	c_chooser := (*C.GtkColorChooser)(unsafe.Pointer(chooser))

	c_orientation := (C.GtkOrientation)(orientation)

	c_colorsPerLine := (C.gint)(colorsPerLine)

	c_nColors := (C.gint)(nColors)

	c_colors := (*C.GdkRGBA)(unsafe.Pointer(&colors[0]))

	C.gtk_color_chooser_add_palette(c_chooser, c_orientation, c_colorsPerLine, c_nColors, c_colors)
}

func Fn_gtk_color_chooser_get_rgba(chooser unsafe.Pointer, color unsafe.Pointer) {
	c_chooser := (*C.GtkColorChooser)(unsafe.Pointer(chooser))

	c_color := (*C.GdkRGBA)(unsafe.Pointer(color))

	C.gtk_color_chooser_get_rgba(c_chooser, c_color)
}

func Fn_gtk_color_chooser_get_use_alpha(chooser unsafe.Pointer) bool {
	c_chooser := (*C.GtkColorChooser)(unsafe.Pointer(chooser))

	ret := C.gtk_color_chooser_get_use_alpha(c_chooser)

	return toGoBool(ret)
}

func Fn_gtk_color_chooser_set_rgba(chooser unsafe.Pointer, color unsafe.Pointer) {
	c_chooser := (*C.GtkColorChooser)(unsafe.Pointer(chooser))

	c_color := (*C.GdkRGBA)(unsafe.Pointer(color))

	C.gtk_color_chooser_set_rgba(c_chooser, c_color)
}

func Fn_gtk_color_chooser_set_use_alpha(chooser unsafe.Pointer, useAlpha bool) {
	c_chooser := (*C.GtkColorChooser)(unsafe.Pointer(chooser))

	c_useAlpha := toCBool(useAlpha)

	C.gtk_color_chooser_set_use_alpha(c_chooser, c_useAlpha)
}
...
func Fn_gtk_file_chooser_get_create_folders(chooser unsafe.Pointer) bool {
	c_chooser := (*C.GtkFileChooser)(unsafe.Pointer(chooser))

	ret := C.gtk_file_chooser_get_create_folders(c_chooser)
...
func Fn_gtk_file_chooser_get_current_name(chooser unsafe.Pointer) string {
	c_chooser := (*C.GtkFileChooser)(unsafe.Pointer(chooser))

	ret := C.gtk_file_chooser_get_current_name(c_chooser)
...
func Fn_gtk_file_chooser_set_create_folders(chooser unsafe.Pointer, createFolders bool) {
	c_chooser := (*C.GtkFileChooser)(unsafe.Pointer(chooser))

	c_createFolders := toCBool(createFolders)

	C.gtk_file_chooser_set_create_folders(c_chooser, c_createFolders)
}
...
func Fn_gtk_font_chooser_get_font(fontchooser unsafe.Pointer) string {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_font(c_fontchooser)

	return C.GoString(ret)
}

func Fn_gtk_font_chooser_get_font_desc(fontchooser unsafe.Pointer) unsafe.Pointer {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_font_desc(c_fontchooser)

	return unsafe.Pointer(ret)
}

func Fn_gtk_font_chooser_get_font_face(fontchooser unsafe.Pointer) unsafe.Pointer {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_font_face(c_fontchooser)

	return unsafe.Pointer(ret)
}

func Fn_gtk_font_chooser_get_font_family(fontchooser unsafe.Pointer) unsafe.Pointer {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_font_family(c_fontchooser)

	return unsafe.Pointer(ret)
}

func Fn_gtk_font_chooser_get_font_size(fontchooser unsafe.Pointer) int {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_font_size(c_fontchooser)

	return (int)(ret)
}

func Fn_gtk_font_chooser_get_preview_text(fontchooser unsafe.Pointer) string {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_preview_text(c_fontchooser)

	return C.GoString(ret)
}

func Fn_gtk_font_chooser_get_show_preview_entry(fontchooser unsafe.Pointer) bool {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	ret := C.gtk_font_chooser_get_show_preview_entry(c_fontchooser)
...
func Fn_gtk_font_chooser_set_font(fontchooser unsafe.Pointer, fontname string) {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	c_fontname := (*C.gchar)(C.CString(fontname))
	defer C.free(unsafe.Pointer(c_fontname))

	C.gtk_font_chooser_set_font(c_fontchooser, c_fontname)
}

func Fn_gtk_font_chooser_set_font_desc(fontchooser unsafe.Pointer, fontDesc unsafe.Pointer) {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	c_fontDesc := (*C.PangoFontDescription)(unsafe.Pointer(fontDesc))

	C.gtk_font_chooser_set_font_desc(c_fontchooser, c_fontDesc)
}

func Fn_gtk_font_chooser_set_preview_text(fontchooser unsafe.Pointer, text string) {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	C.gtk_font_chooser_set_preview_text(c_fontchooser, c_text)
}

func Fn_gtk_font_chooser_set_show_preview_entry(fontchooser unsafe.Pointer, showPreviewEntry bool) {
	c_fontchooser := (*C.GtkFontChooser)(unsafe.Pointer(fontchooser))

	c_showPreviewEntry := toCBool(showPreviewEntry)

	C.gtk_font_chooser_set_show_preview_entry(c_fontchooser, c_showPreviewEntry)
}

func Fn_gtk_orientable_get_orientation(orientable unsafe.Pointer) int {
	c_orientable := (*C.GtkOrientable)(unsafe.Pointer(orientable))

	ret := C.gtk_orientable_get_orientation(c_orientable)

	return (int)(ret)
}

func Fn_gtk_orientable_set_orientation(orientable unsafe.Pointer, orientation int) {
	c_orientable := (*C.GtkOrientable)(unsafe.Pointer(orientable))

	c_orientation := (C.GtkOrientation)(orientation)

	C.gtk_orientable_set_orientation(c_orientable, c_orientation)
}
...
func Fn_gtk_scrollable_get_hadjustment(scrollable unsafe.Pointer) unsafe.Pointer {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	ret := C.gtk_scrollable_get_hadjustment(c_scrollable)

	return unsafe.Pointer(ret)
}

func Fn_gtk_scrollable_get_hscroll_policy(scrollable unsafe.Pointer) int {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	ret := C.gtk_scrollable_get_hscroll_policy(c_scrollable)

	return (int)(ret)
}

func Fn_gtk_scrollable_get_vadjustment(scrollable unsafe.Pointer) unsafe.Pointer {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	ret := C.gtk_scrollable_get_vadjustment(c_scrollable)

	return unsafe.Pointer(ret)
}

func Fn_gtk_scrollable_get_vscroll_policy(scrollable unsafe.Pointer) int {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	ret := C.gtk_scrollable_get_vscroll_policy(c_scrollable)

	return (int)(ret)
}

func Fn_gtk_scrollable_set_hadjustment(scrollable unsafe.Pointer, hadjustment unsafe.Pointer) {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	c_hadjustment := (*C.GtkAdjustment)(unsafe.Pointer(hadjustment))

	C.gtk_scrollable_set_hadjustment(c_scrollable, c_hadjustment)
}

func Fn_gtk_scrollable_set_hscroll_policy(scrollable unsafe.Pointer, policy int) {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	c_policy := (C.GtkScrollablePolicy)(policy)

	C.gtk_scrollable_set_hscroll_policy(c_scrollable, c_policy)
}

func Fn_gtk_scrollable_set_vadjustment(scrollable unsafe.Pointer, vadjustment unsafe.Pointer) {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	c_vadjustment := (*C.GtkAdjustment)(unsafe.Pointer(vadjustment))

	C.gtk_scrollable_set_vadjustment(c_scrollable, c_vadjustment)
}

func Fn_gtk_scrollable_set_vscroll_policy(scrollable unsafe.Pointer, policy int) {
	c_scrollable := (*C.GtkScrollable)(unsafe.Pointer(scrollable))

	c_policy := (C.GtkScrollablePolicy)(policy)

	C.gtk_scrollable_set_vscroll_policy(c_scrollable, c_policy)
}

func Fn_gtk_style_provider_get_icon_factory(provider unsafe.Pointer, path unsafe.Pointer) unsafe.Pointer {
	c_provider := (*C.GtkStyleProvider)(unsafe.Pointer(provider))

	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_style_provider_get_icon_factory(c_provider, c_path)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_provider_get_style(provider unsafe.Pointer, path unsafe.Pointer) unsafe.Pointer {
	c_provider := (*C.GtkStyleProvider)(unsafe.Pointer(provider))

	c_path := (*C.GtkWidgetPath)(unsafe.Pointer(path))

	ret := C.gtk_style_provider_get_style(c_provider, c_path)

	return unsafe.Pointer(ret)
}

func Fn_gtk_style_provider_get_style_property(provider unsafe.Pointer, path unsafe.Pointer, state int, pspec unsafe.Pointer, value unsafe.Pointer) bool {
	c_provider := (*C.GtkStyleProvider)(unsafe.Pointer(provider))
	...
	ret := C.gtk_style_provider_get_style_property(c_provider, c_path, c_state, c_pspec, c_value)

	return toGoBool(ret)
}

func Fn_gtk_tool_shell_get_ellipsize_mode(shell unsafe.Pointer) int {
	c_shell := (*C.GtkToolShell)(unsafe.Pointer(shell))

	ret := C.gtk_tool_shell_get_ellipsize_mode(c_shell)
...
func Fn_gtk_tool_shell_get_text_alignment(shell unsafe.Pointer) float32 {
	c_shell := (*C.GtkToolShell)(unsafe.Pointer(shell))

	ret := C.gtk_tool_shell_get_text_alignment(c_shell)

	return (float32)(ret)
}

func Fn_gtk_tool_shell_get_text_orientation(shell unsafe.Pointer) int {
	c_shell := (*C.GtkToolShell)(unsafe.Pointer(shell))

	ret := C.gtk_tool_shell_get_text_orientation(c_shell)

	return (int)(ret)
}

func Fn_gtk_tool_shell_get_text_size_group(shell unsafe.Pointer) unsafe.Pointer {
	c_shell := (*C.GtkToolShell)(unsafe.Pointer(shell))

	ret := C.gtk_tool_shell_get_text_size_group(c_shell)
...
func Fn_gtk_tree_model_iter_previous(treeModel unsafe.Pointer, iter unsafe.Pointer) bool {
	c_treeModel := (*C.GtkTreeModel)(unsafe.Pointer(treeModel))

	c_iter := (*C.GtkTreeIter)(unsafe.Pointer(iter))

	ret := C.gtk_tree_model_iter_previous(c_treeModel, c_iter)
...
func Fn_gtk_tree_model_rows_reordered_with_length(treeModel unsafe.Pointer, path unsafe.Pointer, iter unsafe.Pointer, newOrder []int, length int) {
	c_treeModel := (*C.GtkTreeModel)(unsafe.Pointer(treeModel))
	...
	C.gtk_tree_model_rows_reordered_with_length(c_treeModel, c_path, c_iter, c_newOrder, c_length)
}
