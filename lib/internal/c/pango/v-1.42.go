...
func Fn_pango_font_description_get_variations(paramInstance unsafe.Pointer) string {
	cValueInstance := (*C.PangoFontDescription)(unsafe.Pointer(paramInstance))

	ret := C.pango_font_description_get_variations(cValueInstance)
...
func Fn_pango_font_description_set_variations(paramInstance unsafe.Pointer, param0 string) {
	cValueInstance := (*C.PangoFontDescription)(unsafe.Pointer(paramInstance))

	cValue0 := (*C.char)(C.CString(param0))
	defer C.free(unsafe.Pointer(cValue0))

	C.pango_font_description_set_variations(cValueInstance, cValue0)
}

func Fn_pango_font_description_set_variations_static(paramInstance unsafe.Pointer, param0 string) {
	cValueInstance := (*C.PangoFontDescription)(unsafe.Pointer(paramInstance))

	cValue0 := (*C.char)(C.CString(param0))
	defer C.free(unsafe.Pointer(cValue0))

	C.pango_font_description_set_variations_static(cValueInstance, cValue0)
}
...
func Fn_pango_glyph_item_get_logical_widths(paramInstance unsafe.Pointer, param0 string, param1 []int) {
	cValueInstance := (*C.PangoGlyphItem)(unsafe.Pointer(paramInstance))

	cValue0 := (*C.char)(C.CString(param0))
	defer C.free(unsafe.Pointer(cValue0))

	cValue1 := (*C.int)(unsafe.Pointer(&param1[0]))

	C.pango_glyph_item_get_logical_widths(cValueInstance, cValue0, cValue1)
}
