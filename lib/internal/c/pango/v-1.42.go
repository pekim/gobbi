...
func Fn_attr_background_alpha_new(alpha uint16) {}
...
func Fn_attr_foreground_alpha_new(alpha uint16) {}
...
func Fn_gravity_get_for_script_and_width(script int, wide bool, baseGravity int, hint int) {}
...
func Fn_shape_full(itemText string, itemLength int, paragraphText string, paragraphLength int, analysis unsafe.Pointer, glyphs unsafe.Pointer) {
}
