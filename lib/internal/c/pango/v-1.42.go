...
func Fn_attr_background_alpha_new(param0 uint16) {}
...
func Fn_attr_foreground_alpha_new(param0 uint16) {}
...
func Fn_attr_type_get_name(param0 int) {}
...
func Fn_bidi_type_for_unichar(param0 rune) {}
...
func Fn_gravity_get_for_script_and_width(param0 int, param1 bool, param2 int, param3 int) {}
...
func Fn_markup_parser_finish(param0 unsafe.Pointer, param1 *unsafe.Pointer, param2 string, param3 *rune) {
}

func Fn_markup_parser_new(param0 rune) {}
...
func Fn_shape_full(param0 string, param1 int, param2 string, param3 int, param4 unsafe.Pointer, param5 unsafe.Pointer) {
}
