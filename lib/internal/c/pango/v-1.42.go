...
func Fn_pango_attr_font_features_new(features string) unsafe.Pointer {
	c_features := (*C.gchar)(C.CString(features))
	defer C.free(unsafe.Pointer(c_features))

	ret := C.pango_attr_font_features_new(c_features)
...
func Fn_pango_attr_list_ref(list unsafe.Pointer) unsafe.Pointer {
	c_list := (*C.PangoAttrList)(unsafe.Pointer(list))

	ret := C.pango_attr_list_ref(c_list)
...
func Fn_pango_attr_size_new_absolute(size int) unsafe.Pointer {
	c_size := (C.int)(size)

	ret := C.pango_attr_size_new_absolute(c_size)
...
func Fn_pango_attribute_init(attr unsafe.Pointer, klass unsafe.Pointer) {
	c_attr := (*C.PangoAttribute)(unsafe.Pointer(attr))

	c_klass := (*C.PangoAttrClass)(unsafe.Pointer(klass))

	C.pango_attribute_init(c_attr, c_klass)
}
...
func Fn_pango_color_to_string(color unsafe.Pointer) string {
	c_color := (*C.PangoColor)(unsafe.Pointer(color))

	ret := C.pango_color_to_string(c_color)
...
func Fn_pango_font_description_get_gravity(desc unsafe.Pointer) int {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	ret := C.pango_font_description_get_gravity(c_desc)
...
func Fn_pango_font_description_get_size_is_absolute(desc unsafe.Pointer) bool {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	ret := C.pango_font_description_get_size_is_absolute(c_desc)
...
func Fn_pango_font_description_get_variations(desc unsafe.Pointer) string {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	ret := C.pango_font_description_get_variations(c_desc)
...
func Fn_pango_font_description_set_absolute_size(desc unsafe.Pointer, size float64) {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	c_size := (C.double)(size)

	C.pango_font_description_set_absolute_size(c_desc, c_size)
}
...
func Fn_pango_font_description_set_gravity(desc unsafe.Pointer, gravity int) {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	c_gravity := (C.PangoGravity)(gravity)

	C.pango_font_description_set_gravity(c_desc, c_gravity)
}
...
func Fn_pango_font_description_set_variations(desc unsafe.Pointer, settings string) {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	c_settings := (*C.char)(C.CString(settings))
	defer C.free(unsafe.Pointer(c_settings))

	C.pango_font_description_set_variations(c_desc, c_settings)
}

func Fn_pango_font_description_set_variations_static(desc unsafe.Pointer, settings string) {
	c_desc := (*C.PangoFontDescription)(unsafe.Pointer(desc))

	c_settings := (*C.char)(C.CString(settings))
	defer C.free(unsafe.Pointer(c_settings))

	C.pango_font_description_set_variations_static(c_desc, c_settings)
}
...
func Fn_pango_font_metrics_get_strikethrough_position(metrics unsafe.Pointer) int {
	c_metrics := (*C.PangoFontMetrics)(unsafe.Pointer(metrics))

	ret := C.pango_font_metrics_get_strikethrough_position(c_metrics)

	return (int)(ret)
}

func Fn_pango_font_metrics_get_strikethrough_thickness(metrics unsafe.Pointer) int {
	c_metrics := (*C.PangoFontMetrics)(unsafe.Pointer(metrics))

	ret := C.pango_font_metrics_get_strikethrough_thickness(c_metrics)

	return (int)(ret)
}

func Fn_pango_font_metrics_get_underline_position(metrics unsafe.Pointer) int {
	c_metrics := (*C.PangoFontMetrics)(unsafe.Pointer(metrics))

	ret := C.pango_font_metrics_get_underline_position(c_metrics)

	return (int)(ret)
}

func Fn_pango_font_metrics_get_underline_thickness(metrics unsafe.Pointer) int {
	c_metrics := (*C.PangoFontMetrics)(unsafe.Pointer(metrics))

	ret := C.pango_font_metrics_get_underline_thickness(c_metrics)
...
func Fn_pango_glyph_item_copy(orig unsafe.Pointer) unsafe.Pointer {
	c_orig := (*C.PangoGlyphItem)(unsafe.Pointer(orig))

	ret := C.pango_glyph_item_copy(c_orig)

	return unsafe.Pointer(ret)
}

func Fn_pango_glyph_item_free(glyphItem unsafe.Pointer) {
	c_glyphItem := (*C.PangoGlyphItem)(unsafe.Pointer(glyphItem))

	C.pango_glyph_item_free(c_glyphItem)
}

func Fn_pango_glyph_item_get_logical_widths(glyphItem unsafe.Pointer, text string, logicalWidths []int) {
	c_glyphItem := (*C.PangoGlyphItem)(unsafe.Pointer(glyphItem))
	...
	C.pango_glyph_item_get_logical_widths(c_glyphItem, c_text, c_logicalWidths)
}

func Fn_pango_glyph_item_letter_space(glyphItem unsafe.Pointer, text string, logAttrs []LogAttr, letterSpacing int) {
	c_glyphItem := (*C.PangoGlyphItem)(unsafe.Pointer(glyphItem))
	...
	c_letterSpacing := (C.int)(letterSpacing)

	C.pango_glyph_item_letter_space(c_glyphItem, c_text, c_logAttrs, c_letterSpacing)
}
...
func Fn_pango_glyph_item_iter_copy(orig unsafe.Pointer) unsafe.Pointer {
	c_orig := (*C.PangoGlyphItemIter)(unsafe.Pointer(orig))

	ret := C.pango_glyph_item_iter_copy(c_orig)

	return unsafe.Pointer(ret)
}

func Fn_pango_glyph_item_iter_free(iter unsafe.Pointer) {
	c_iter := (*C.PangoGlyphItemIter)(unsafe.Pointer(iter))

	C.pango_glyph_item_iter_free(c_iter)
}

func Fn_pango_glyph_item_iter_init_end(iter unsafe.Pointer, glyphItem unsafe.Pointer, text string) bool {
	c_iter := (*C.PangoGlyphItemIter)(unsafe.Pointer(iter))
	...
	ret := C.pango_glyph_item_iter_init_end(c_iter, c_glyphItem, c_text)

	return toGoBool(ret)
}

func Fn_pango_glyph_item_iter_init_start(iter unsafe.Pointer, glyphItem unsafe.Pointer, text string) bool {
	c_iter := (*C.PangoGlyphItemIter)(unsafe.Pointer(iter))
	...
	ret := C.pango_glyph_item_iter_init_start(c_iter, c_glyphItem, c_text)

	return toGoBool(ret)
}

func Fn_pango_glyph_item_iter_next_cluster(iter unsafe.Pointer) bool {
	c_iter := (*C.PangoGlyphItemIter)(unsafe.Pointer(iter))

	ret := C.pango_glyph_item_iter_next_cluster(c_iter)

	return toGoBool(ret)
}

func Fn_pango_glyph_item_iter_prev_cluster(iter unsafe.Pointer) bool {
	c_iter := (*C.PangoGlyphItemIter)(unsafe.Pointer(iter))

	ret := C.pango_glyph_item_iter_prev_cluster(c_iter)
...
func Fn_pango_glyph_string_get_width(glyphs unsafe.Pointer) int {
	c_glyphs := (*C.PangoGlyphString)(unsafe.Pointer(glyphs))

	ret := C.pango_glyph_string_get_width(c_glyphs)
...
func Fn_pango_language_get_scripts(language unsafe.Pointer, numScripts *int) []int {
	c_language := (*C.PangoLanguage)(unsafe.Pointer(language))

	c_numScripts := (*C.int)(unsafe.Pointer(numScripts))

	ret := C.pango_language_get_scripts(c_language, c_numScripts)

	retLen := int(*c_numScripts)
...
func Fn_pango_language_includes_script(language unsafe.Pointer, script int) bool {
	c_language := (*C.PangoLanguage)(unsafe.Pointer(language))

	c_script := (C.PangoScript)(script)

	ret := C.pango_language_includes_script(c_language, c_script)
...
func Fn_pango_layout_iter_copy(iter unsafe.Pointer) unsafe.Pointer {
	c_iter := (*C.PangoLayoutIter)(unsafe.Pointer(iter))

	ret := C.pango_layout_iter_copy(c_iter)
...
func Fn_pango_layout_iter_get_layout(iter unsafe.Pointer) unsafe.Pointer {
	c_iter := (*C.PangoLayoutIter)(unsafe.Pointer(iter))

	ret := C.pango_layout_iter_get_layout(c_iter)
...
func Fn_pango_layout_iter_get_line_readonly(iter unsafe.Pointer) unsafe.Pointer {
	c_iter := (*C.PangoLayoutIter)(unsafe.Pointer(iter))

	ret := C.pango_layout_iter_get_line_readonly(c_iter)
...
func Fn_pango_layout_iter_get_run_readonly(iter unsafe.Pointer) *GlyphItem {
	c_iter := (*C.PangoLayoutIter)(unsafe.Pointer(iter))

	ret := C.pango_layout_iter_get_run_readonly(c_iter)
...
func Fn_pango_layout_line_ref(line unsafe.Pointer) unsafe.Pointer {
	c_line := (*C.PangoLayoutLine)(unsafe.Pointer(line))

	ret := C.pango_layout_line_ref(c_line)
...
func Fn_pango_matrix_concat(matrix unsafe.Pointer, newMatrix unsafe.Pointer) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_newMatrix := (*C.PangoMatrix)(unsafe.Pointer(newMatrix))

	C.pango_matrix_concat(c_matrix, c_newMatrix)
}

func Fn_pango_matrix_copy(matrix unsafe.Pointer) unsafe.Pointer {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	ret := C.pango_matrix_copy(c_matrix)

	return unsafe.Pointer(ret)
}

func Fn_pango_matrix_free(matrix unsafe.Pointer) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	C.pango_matrix_free(c_matrix)
}

func Fn_pango_matrix_get_font_scale_factor(matrix unsafe.Pointer) float64 {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	ret := C.pango_matrix_get_font_scale_factor(c_matrix)

	return (float64)(ret)
}

func Fn_pango_matrix_get_font_scale_factors(matrix unsafe.Pointer, xscale *float64, yscale *float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_xscale := (*C.double)(unsafe.Pointer(xscale))

	c_yscale := (*C.double)(unsafe.Pointer(yscale))

	C.pango_matrix_get_font_scale_factors(c_matrix, c_xscale, c_yscale)
}

func Fn_pango_matrix_rotate(matrix unsafe.Pointer, degrees float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_degrees := (C.double)(degrees)

	C.pango_matrix_rotate(c_matrix, c_degrees)
}

func Fn_pango_matrix_scale(matrix unsafe.Pointer, scaleX float64, scaleY float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))
	...
	C.pango_matrix_scale(c_matrix, c_scaleX, c_scaleY)
}

func Fn_pango_matrix_transform_distance(matrix unsafe.Pointer, dx *float64, dy *float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_dx := (*C.double)(unsafe.Pointer(dx))

	c_dy := (*C.double)(unsafe.Pointer(dy))

	C.pango_matrix_transform_distance(c_matrix, c_dx, c_dy)
}

func Fn_pango_matrix_transform_pixel_rectangle(matrix unsafe.Pointer, rect unsafe.Pointer) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_rect := (*C.PangoRectangle)(unsafe.Pointer(rect))

	C.pango_matrix_transform_pixel_rectangle(c_matrix, c_rect)
}

func Fn_pango_matrix_transform_point(matrix unsafe.Pointer, x *float64, y *float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_x := (*C.double)(unsafe.Pointer(x))

	c_y := (*C.double)(unsafe.Pointer(y))

	C.pango_matrix_transform_point(c_matrix, c_x, c_y)
}

func Fn_pango_matrix_transform_rectangle(matrix unsafe.Pointer, rect unsafe.Pointer) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	c_rect := (*C.PangoRectangle)(unsafe.Pointer(rect))

	C.pango_matrix_transform_rectangle(c_matrix, c_rect)
}

func Fn_pango_matrix_translate(matrix unsafe.Pointer, tx float64, ty float64) {
	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))
	...
	C.pango_matrix_translate(c_matrix, c_tx, c_ty)
}

func Fn_pango_script_iter_free(iter unsafe.Pointer) {
	c_iter := (*C.PangoScriptIter)(unsafe.Pointer(iter))

	C.pango_script_iter_free(c_iter)
}

// UNSUPPORTED : pango_script_iter_get_range : parameter 'start' is non array with indirect count > 1

func Fn_pango_script_iter_next(iter unsafe.Pointer) bool {
	c_iter := (*C.PangoScriptIter)(unsafe.Pointer(iter))

	ret := C.pango_script_iter_next(c_iter)

	return toGoBool(ret)
}

func Fn_pango_script_iter_new(text string, length int) unsafe.Pointer {
	c_text := (*C.char)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	c_length := (C.int)(length)

	ret := C.pango_script_iter_new(c_text, c_length)
...
func Fn_pango_attr_background_alpha_new(alpha uint16) unsafe.Pointer {
	c_alpha := (C.guint16)(alpha)

	ret := C.pango_attr_background_alpha_new(c_alpha)
...
func Fn_pango_attr_fallback_new(enableFallback bool) unsafe.Pointer {
	c_enableFallback := toCBool(enableFallback)

	ret := C.pango_attr_fallback_new(c_enableFallback)
...
func Fn_pango_attr_foreground_alpha_new(alpha uint16) unsafe.Pointer {
	c_alpha := (C.guint16)(alpha)

	ret := C.pango_attr_foreground_alpha_new(c_alpha)
...
func Fn_pango_attr_gravity_hint_new(hint int) unsafe.Pointer {
	c_hint := (C.PangoGravityHint)(hint)

	ret := C.pango_attr_gravity_hint_new(c_hint)

	return unsafe.Pointer(ret)
}

func Fn_pango_attr_gravity_new(gravity int) unsafe.Pointer {
	c_gravity := (C.PangoGravity)(gravity)

	ret := C.pango_attr_gravity_new(c_gravity)

	return unsafe.Pointer(ret)
}

func Fn_pango_attr_letter_spacing_new(letterSpacing int) unsafe.Pointer {
	c_letterSpacing := (C.int)(letterSpacing)

	ret := C.pango_attr_letter_spacing_new(c_letterSpacing)
...
func Fn_pango_attr_strikethrough_color_new(red uint16, green uint16, blue uint16) unsafe.Pointer {
	c_red := (C.guint16)(red)
	...
	ret := C.pango_attr_strikethrough_color_new(c_red, c_green, c_blue)
...
func Fn_pango_attr_underline_color_new(red uint16, green uint16, blue uint16) unsafe.Pointer {
	c_red := (C.guint16)(red)
	...
	ret := C.pango_attr_underline_color_new(c_red, c_green, c_blue)
...
func Fn_pango_extents_to_pixels(inclusive unsafe.Pointer, nearest unsafe.Pointer) {
	c_inclusive := (*C.PangoRectangle)(unsafe.Pointer(inclusive))

	c_nearest := (*C.PangoRectangle)(unsafe.Pointer(nearest))

	C.pango_extents_to_pixels(c_inclusive, c_nearest)
}

func Fn_pango_find_base_dir(text string, length int) int {
	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	c_length := (C.gint)(length)

	ret := C.pango_find_base_dir(c_text, c_length)
...
func Fn_pango_is_zero_width(ch rune) bool {
	c_ch := (C.gunichar)(ch)

	ret := C.pango_is_zero_width(c_ch)
...
func Fn_pango_itemize_with_base_dir(context unsafe.Pointer, baseDir int, text string, startIndex int, length int, attrs unsafe.Pointer, cachedIter unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	c_baseDir := (C.PangoDirection)(baseDir)
	...
	ret := C.pango_itemize_with_base_dir(c_context, c_baseDir, c_text, c_startIndex, c_length, c_attrs, c_cachedIter)

	return unsafe.Pointer(ret)
}

func Fn_pango_log2vis_get_embedding_levels(text string, length int, pbaseDir *int) *uint8 {
	c_text := (*C.gchar)(C.CString(text))
	defer C.free(unsafe.Pointer(c_text))

	c_length := (C.int)(length)

	c_pbaseDir := (*C.PangoDirection)(unsafe.Pointer(pbaseDir))

	ret := C.pango_log2vis_get_embedding_levels(c_text, c_length, c_pbaseDir)
...
func Fn_pango_markup_parser_new(accelMarker rune) unsafe.Pointer {
	c_accelMarker := (C.gunichar)(accelMarker)

	ret := C.pango_markup_parser_new(c_accelMarker)
...
func Fn_pango_quantize_line_geometry(thickness *int, position *int) {
	c_thickness := (*C.int)(unsafe.Pointer(thickness))

	c_position := (*C.int)(unsafe.Pointer(position))
...
func Fn_pango_shape_full(itemText string, itemLength int, paragraphText *string, paragraphLength int, analysis unsafe.Pointer, glyphs unsafe.Pointer) {
	c_itemText := (*C.gchar)(C.CString(itemText))
	defer C.free(unsafe.Pointer(c_itemText))

	c_itemLength := (C.gint)(itemLength)

	var c_paragraphTextValue (*C.gchar)
	if paragraphText != nil {
		c_paragraphTextValue = (*C.gchar)(C.CString(*paragraphText))
		defer C.free(unsafe.Pointer(c_paragraphTextValue))
	}
	c_paragraphText := c_paragraphTextValue

	c_paragraphLength := (C.gint)(paragraphLength)

	c_analysis := (*C.PangoAnalysis)(unsafe.Pointer(analysis))

	c_glyphs := (*C.PangoGlyphString)(unsafe.Pointer(glyphs))

	C.pango_shape_full(c_itemText, c_itemLength, c_paragraphText, c_paragraphLength, c_analysis, c_glyphs)
}
...
func Fn_pango_units_from_double(d float64) int {
	c_d := (C.double)(d)

	ret := C.pango_units_from_double(c_d)

	return (int)(ret)
}

func Fn_pango_units_to_double(i int) float64 {
	c_i := (C.int)(i)

	ret := C.pango_units_to_double(c_i)
...
func Fn_pango_version_check(requiredMajor int, requiredMinor int, requiredMicro int) string {
	c_requiredMajor := (C.int)(requiredMajor)

	c_requiredMinor := (C.int)(requiredMinor)

	c_requiredMicro := (C.int)(requiredMicro)

	ret := C.pango_version_check(c_requiredMajor, c_requiredMinor, c_requiredMicro)
...
func Fn_pango_context_changed(context unsafe.Pointer) {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	C.pango_context_changed(c_context)
}
...
func Fn_pango_context_get_base_gravity(context unsafe.Pointer) int {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_base_gravity(c_context)
...
func Fn_pango_context_get_font_map(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_font_map(c_context)

	return unsafe.Pointer(ret)
}

func Fn_pango_context_get_gravity(context unsafe.Pointer) int {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_gravity(c_context)

	return (int)(ret)
}

func Fn_pango_context_get_gravity_hint(context unsafe.Pointer) int {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_gravity_hint(c_context)
...
func Fn_pango_context_get_matrix(context unsafe.Pointer) unsafe.Pointer {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_matrix(c_context)
...
func Fn_pango_context_get_serial(context unsafe.Pointer) uint {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	ret := C.pango_context_get_serial(c_context)
...
func Fn_pango_context_set_base_gravity(context unsafe.Pointer, gravity int) {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	c_gravity := (C.PangoGravity)(gravity)

	C.pango_context_set_base_gravity(c_context, c_gravity)
}
...
func Fn_pango_context_set_gravity_hint(context unsafe.Pointer, hint int) {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	c_hint := (C.PangoGravityHint)(hint)

	C.pango_context_set_gravity_hint(c_context, c_hint)
}
...
func Fn_pango_context_set_matrix(context unsafe.Pointer, matrix unsafe.Pointer) {
	c_context := (*C.PangoContext)(unsafe.Pointer(context))

	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	C.pango_context_set_matrix(c_context, c_matrix)
}
...
func Fn_pango_font_describe_with_absolute_size(font unsafe.Pointer) unsafe.Pointer {
	c_font := (*C.PangoFont)(unsafe.Pointer(font))

	ret := C.pango_font_describe_with_absolute_size(c_font)
...
func Fn_pango_font_get_font_map(font unsafe.Pointer) unsafe.Pointer {
	c_font := (*C.PangoFont)(unsafe.Pointer(font))

	ret := C.pango_font_get_font_map(c_font)
...
func Fn_pango_font_face_is_synthesized(face unsafe.Pointer) bool {
	c_face := (*C.PangoFontFace)(unsafe.Pointer(face))

	ret := C.pango_font_face_is_synthesized(c_face)

	return toGoBool(ret)
}

func Fn_pango_font_face_list_sizes(face unsafe.Pointer, sizes *[]int, nSizes *int) {
	c_face := (*C.PangoFontFace)(unsafe.Pointer(face))

	var c_sizesArrayPointer (*C.int)
	c_sizes := &c_sizesArrayPointer

	c_nSizes := (*C.int)(unsafe.Pointer(nSizes))

	C.pango_font_face_list_sizes(c_face, c_sizes, c_nSizes)
...
func Fn_pango_font_family_is_monospace(family unsafe.Pointer) bool {
	c_family := (*C.PangoFontFamily)(unsafe.Pointer(family))

	ret := C.pango_font_family_is_monospace(c_family)
...
func Fn_pango_font_map_changed(fontmap unsafe.Pointer) {
	c_fontmap := (*C.PangoFontMap)(unsafe.Pointer(fontmap))

	C.pango_font_map_changed(c_fontmap)
}

func Fn_pango_font_map_create_context(fontmap unsafe.Pointer) unsafe.Pointer {
	c_fontmap := (*C.PangoFontMap)(unsafe.Pointer(fontmap))

	ret := C.pango_font_map_create_context(c_fontmap)

	return unsafe.Pointer(ret)
}

func Fn_pango_font_map_get_serial(fontmap unsafe.Pointer) uint {
	c_fontmap := (*C.PangoFontMap)(unsafe.Pointer(fontmap))

	ret := C.pango_font_map_get_serial(c_fontmap)
...
func Fn_pango_layout_get_auto_dir(layout unsafe.Pointer) bool {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_auto_dir(c_layout)

	return toGoBool(ret)
}

func Fn_pango_layout_get_baseline(layout unsafe.Pointer) int {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_baseline(c_layout)

	return (int)(ret)
}

func Fn_pango_layout_get_character_count(layout unsafe.Pointer) int {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_character_count(c_layout)
...
func Fn_pango_layout_get_ellipsize(layout unsafe.Pointer) int {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_ellipsize(c_layout)
...
func Fn_pango_layout_get_font_description(layout unsafe.Pointer) unsafe.Pointer {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_font_description(c_layout)

	return unsafe.Pointer(ret)
}

func Fn_pango_layout_get_height(layout unsafe.Pointer) int {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_height(c_layout)
...
func Fn_pango_layout_get_line_readonly(layout unsafe.Pointer, line int) unsafe.Pointer {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	c_line := (C.int)(line)

	ret := C.pango_layout_get_line_readonly(c_layout, c_line)
...
func Fn_pango_layout_get_lines_readonly(layout unsafe.Pointer) unsafe.Pointer {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_lines_readonly(c_layout)
...
func Fn_pango_layout_get_log_attrs_readonly(layout unsafe.Pointer, nAttrs *int) []LogAttr {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	c_nAttrs := (*C.gint)(unsafe.Pointer(nAttrs))

	ret := C.pango_layout_get_log_attrs_readonly(c_layout, c_nAttrs)
...
func Fn_pango_layout_get_serial(layout unsafe.Pointer) uint {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_serial(c_layout)
...
func Fn_pango_layout_get_unknown_glyphs_count(layout unsafe.Pointer) int {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_get_unknown_glyphs_count(c_layout)
...
func Fn_pango_layout_is_ellipsized(layout unsafe.Pointer) bool {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_is_ellipsized(c_layout)

	return toGoBool(ret)
}

func Fn_pango_layout_is_wrapped(layout unsafe.Pointer) bool {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	ret := C.pango_layout_is_wrapped(c_layout)
...
func Fn_pango_layout_set_auto_dir(layout unsafe.Pointer, autoDir bool) {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	c_autoDir := toCBool(autoDir)

	C.pango_layout_set_auto_dir(c_layout, c_autoDir)
}

func Fn_pango_layout_set_ellipsize(layout unsafe.Pointer, ellipsize int) {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	c_ellipsize := (C.PangoEllipsizeMode)(ellipsize)

	C.pango_layout_set_ellipsize(c_layout, c_ellipsize)
}
...
func Fn_pango_layout_set_height(layout unsafe.Pointer, height int) {
	c_layout := (*C.PangoLayout)(unsafe.Pointer(layout))

	c_height := (C.int)(height)

	C.pango_layout_set_height(c_layout, c_height)
}
...
func Fn_pango_renderer_activate(renderer unsafe.Pointer) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	C.pango_renderer_activate(c_renderer)
}

func Fn_pango_renderer_deactivate(renderer unsafe.Pointer) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	C.pango_renderer_deactivate(c_renderer)
}

func Fn_pango_renderer_draw_error_underline(renderer unsafe.Pointer, x int, y int, width int, height int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_error_underline(c_renderer, c_x, c_y, c_width, c_height)
}

func Fn_pango_renderer_draw_glyph(renderer unsafe.Pointer, font unsafe.Pointer, glyph uint32, x float64, y float64) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_glyph(c_renderer, c_font, c_glyph, c_x, c_y)
}

func Fn_pango_renderer_draw_glyph_item(renderer unsafe.Pointer, text *string, glyphItem unsafe.Pointer, x int, y int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	var c_textValue (*C.char)
	if text != nil {
		c_textValue = (*C.char)(C.CString(*text))
	...
	C.pango_renderer_draw_glyph_item(c_renderer, c_text, c_glyphItem, c_x, c_y)
}

func Fn_pango_renderer_draw_glyphs(renderer unsafe.Pointer, font unsafe.Pointer, glyphs unsafe.Pointer, x int, y int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_glyphs(c_renderer, c_font, c_glyphs, c_x, c_y)
}

func Fn_pango_renderer_draw_layout(renderer unsafe.Pointer, layout unsafe.Pointer, x int, y int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_layout(c_renderer, c_layout, c_x, c_y)
}

func Fn_pango_renderer_draw_layout_line(renderer unsafe.Pointer, line unsafe.Pointer, x int, y int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_layout_line(c_renderer, c_line, c_x, c_y)
}

func Fn_pango_renderer_draw_rectangle(renderer unsafe.Pointer, part int, x int, y int, width int, height int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_rectangle(c_renderer, c_part, c_x, c_y, c_width, c_height)
}

func Fn_pango_renderer_draw_trapezoid(renderer unsafe.Pointer, part int, y1 float64, x11 float64, x21 float64, y2 float64, x12 float64, x22 float64) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_draw_trapezoid(c_renderer, c_part, c_y1, c_x11, c_x21, c_y2, c_x12, c_x22)
}

func Fn_pango_renderer_get_alpha(renderer unsafe.Pointer, part int) uint16 {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	c_part := (C.PangoRenderPart)(part)

	ret := C.pango_renderer_get_alpha(c_renderer, c_part)

	return (uint16)(ret)
}

func Fn_pango_renderer_get_color(renderer unsafe.Pointer, part int) unsafe.Pointer {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	c_part := (C.PangoRenderPart)(part)

	ret := C.pango_renderer_get_color(c_renderer, c_part)

	return unsafe.Pointer(ret)
}

func Fn_pango_renderer_get_layout(renderer unsafe.Pointer) unsafe.Pointer {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	ret := C.pango_renderer_get_layout(c_renderer)

	return unsafe.Pointer(ret)
}

func Fn_pango_renderer_get_layout_line(renderer unsafe.Pointer) unsafe.Pointer {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	ret := C.pango_renderer_get_layout_line(c_renderer)

	return unsafe.Pointer(ret)
}

func Fn_pango_renderer_get_matrix(renderer unsafe.Pointer) unsafe.Pointer {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	ret := C.pango_renderer_get_matrix(c_renderer)

	return unsafe.Pointer(ret)
}

func Fn_pango_renderer_part_changed(renderer unsafe.Pointer, part int) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	c_part := (C.PangoRenderPart)(part)

	C.pango_renderer_part_changed(c_renderer, c_part)
}

func Fn_pango_renderer_set_alpha(renderer unsafe.Pointer, part int, alpha uint16) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_set_alpha(c_renderer, c_part, c_alpha)
}

func Fn_pango_renderer_set_color(renderer unsafe.Pointer, part int, color unsafe.Pointer) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))
	...
	C.pango_renderer_set_color(c_renderer, c_part, c_color)
}

func Fn_pango_renderer_set_matrix(renderer unsafe.Pointer, matrix unsafe.Pointer) {
	c_renderer := (*C.PangoRenderer)(unsafe.Pointer(renderer))

	c_matrix := (*C.PangoMatrix)(unsafe.Pointer(matrix))

	C.pango_renderer_set_matrix(c_renderer, c_matrix)
}
