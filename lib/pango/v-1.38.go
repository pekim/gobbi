...
func AttrBackgroundAlphaNew(alpha uint16) unsafe.Pointer {
	sys_alpha := alpha
	ret := pango.Fn_pango_attr_background_alpha_new(sys_alpha)
...
func AttrForegroundAlphaNew(alpha uint16) unsafe.Pointer {
	sys_alpha := alpha
	ret := pango.Fn_pango_attr_foreground_alpha_new(sys_alpha)
