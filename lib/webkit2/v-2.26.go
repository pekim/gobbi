...
/*
	...
	void authenticationrequest_cancelledHandler(GObject *, gpointer);

	static gulong AuthenticationRequest_signal_connect_cancelled(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "cancelled", G_CALLBACK(authenticationrequest_cancelledHandler), data);
	}

*/
/*

	WebKitWebView * automationsession_createWebViewHandler(GObject *, gpointer);

	static gulong AutomationSession_signal_connect_create_web_view(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "create-web-view", G_CALLBACK(automationsession_createWebViewHandler), data);
	}

*/
/*

	void colorchooserrequest_finishedHandler(GObject *, gpointer);

	static gulong ColorChooserRequest_signal_connect_finished(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "finished", G_CALLBACK(colorchooserrequest_finishedHandler), data);
	}
...
/*
	...
	gboolean geolocationmanager_startHandler(GObject *, gpointer);

	static gulong GeolocationManager_signal_connect_start(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "start", G_CALLBACK(geolocationmanager_startHandler), data);
	}

*/
/*

	void geolocationmanager_stopHandler(GObject *, gpointer);

	static gulong GeolocationManager_signal_connect_stop(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "stop", G_CALLBACK(geolocationmanager_stopHandler), data);
	}

*/
/*

	void notification_clickedHandler(GObject *, gpointer);

	static gulong Notification_signal_connect_clicked(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "clicked", G_CALLBACK(notification_clickedHandler), data);
	}

*/
/*

	void notification_closedHandler(GObject *, gpointer);

	static gulong Notification_signal_connect_closed(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "closed", G_CALLBACK(notification_closedHandler), data);
	}

*/
/*

	void optionmenu_closeHandler(GObject *, gpointer);

	static gulong OptionMenu_signal_connect_close(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "close", G_CALLBACK(optionmenu_closeHandler), data);
	}

*/
/*

	void printcustomwidget_applyHandler(GObject *, gpointer);

	static gulong PrintCustomWidget_signal_connect_apply(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "apply", G_CALLBACK(printcustomwidget_applyHandler), data);
	}

*/
/*

	void printcustomwidget_updateHandler(GObject *, GtkPageSetup *, GtkPrintSettings *, gpointer);

	static gulong PrintCustomWidget_signal_connect_update(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "update", G_CALLBACK(printcustomwidget_updateHandler), data);
	}
...
/*
	...
	void usercontentmanager_scriptMessageReceivedHandler(GObject *, WebKitJavascriptResult *, gpointer);

	static gulong UserContentManager_signal_connect_script_message_received(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "script-message-received", G_CALLBACK(usercontentmanager_scriptMessageReceivedHandler), data);
	}

*/
/*

	void webcontext_automationStartedHandler(GObject *, WebKitAutomationSession *, gpointer);

	static gulong WebContext_signal_connect_automation_started(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "automation-started", G_CALLBACK(webcontext_automationStartedHandler), data);
	}
...
/*
	...
	void webcontext_initializeNotificationPermissionsHandler(GObject *, gpointer);

	static gulong WebContext_signal_connect_initialize_notification_permissions(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "initialize-notification-permissions", G_CALLBACK(webcontext_initializeNotificationPermissionsHandler), data);
	}

*/
/*

	void webcontext_initializeWebExtensionsHandler(GObject *, gpointer);

	static gulong WebContext_signal_connect_initialize_web_extensions(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "initialize-web-extensions", G_CALLBACK(webcontext_initializeWebExtensionsHandler), data);
	}
...
/*
	...
	void webresource_failedWithTlsErrorsHandler(GObject *, GTlsCertificate *, GTlsCertificateFlags, gpointer);

	static gulong WebResource_signal_connect_failed_with_tls_errors(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "failed-with-tls-errors", G_CALLBACK(webresource_failedWithTlsErrorsHandler), data);
	}
...
/*
	...
	gboolean webview_authenticateHandler(GObject *, WebKitAuthenticationRequest *, gpointer);

	static gulong WebView_signal_connect_authenticate(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "authenticate", G_CALLBACK(webview_authenticateHandler), data);
	}
...
/*
	...
	gboolean webview_loadFailedWithTlsErrorsHandler(GObject *, gchar*, GTlsCertificate *, GTlsCertificateFlags, gpointer);

	static gulong WebView_signal_connect_load_failed_with_tls_errors(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "load-failed-with-tls-errors", G_CALLBACK(webview_loadFailedWithTlsErrorsHandler), data);
	}
...
/*
	...
	gboolean webview_runColorChooserHandler(GObject *, WebKitColorChooserRequest *, gpointer);

	static gulong WebView_signal_connect_run_color_chooser(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "run-color-chooser", G_CALLBACK(webview_runColorChooserHandler), data);
	}
...
/*
	...
	gboolean webview_showNotificationHandler(GObject *, WebKitNotification *, gpointer);

	static gulong WebView_signal_connect_show_notification(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "show-notification", G_CALLBACK(webview_showNotificationHandler), data);
	}
...
/*
	...
	void webview_webProcessTerminatedHandler(GObject *, WebKitWebProcessTerminationReason, gpointer);

	static gulong WebView_signal_connect_web_process_terminated(gpointer instance, gpointer data) {
		return g_signal_connect(instance, "web-process-terminated", G_CALLBACK(webview_webProcessTerminatedHandler), data);
	}

*/
import "C"

type EditorTypingAttributes C.WebKitEditorTypingAttributes

const (
	WEBKIT_EDITOR_TYPING_ATTRIBUTE_NONE          EditorTypingAttributes = 2
	WEBKIT_EDITOR_TYPING_ATTRIBUTE_BOLD          EditorTypingAttributes = 4
	WEBKIT_EDITOR_TYPING_ATTRIBUTE_ITALIC        EditorTypingAttributes = 8
	WEBKIT_EDITOR_TYPING_ATTRIBUTE_UNDERLINE     EditorTypingAttributes = 16
	WEBKIT_EDITOR_TYPING_ATTRIBUTE_STRIKETHROUGH EditorTypingAttributes = 32
)
...
type WebsiteDataTypes C.WebKitWebsiteDataTypes

const (
	WEBKIT_WEBSITE_DATA_MEMORY_CACHE              WebsiteDataTypes = 1
	WEBKIT_WEBSITE_DATA_DISK_CACHE                WebsiteDataTypes = 2
	WEBKIT_WEBSITE_DATA_OFFLINE_APPLICATION_CACHE WebsiteDataTypes = 4
	WEBKIT_WEBSITE_DATA_SESSION_STORAGE           WebsiteDataTypes = 8
	WEBKIT_WEBSITE_DATA_LOCAL_STORAGE             WebsiteDataTypes = 16
	WEBKIT_WEBSITE_DATA_WEBSQL_DATABASES          WebsiteDataTypes = 32
	WEBKIT_WEBSITE_DATA_INDEXEDDB_DATABASES       WebsiteDataTypes = 64
	WEBKIT_WEBSITE_DATA_PLUGIN_DATA               WebsiteDataTypes = 128
	WEBKIT_WEBSITE_DATA_COOKIES                   WebsiteDataTypes = 256
	WEBKIT_WEBSITE_DATA_DEVICE_ID_HASH_SALT       WebsiteDataTypes = 512
	WEBKIT_WEBSITE_DATA_HSTS_CACHE                WebsiteDataTypes = 1024
	WEBKIT_WEBSITE_DATA_ALL                       WebsiteDataTypes = 2047
)
...
type signalAuthenticationRequestCancelledDetail struct {
	callback  AuthenticationRequestSignalCancelledCallback
	handlerID C.gulong
}

var signalAuthenticationRequestCancelledId int
var signalAuthenticationRequestCancelledMap = make(map[int]signalAuthenticationRequestCancelledDetail)
var signalAuthenticationRequestCancelledLock sync.RWMutex

// AuthenticationRequestSignalCancelledCallback is a callback function for a 'cancelled' signal emitted from a AuthenticationRequest.
type AuthenticationRequestSignalCancelledCallback func(targetObject *AuthenticationRequest)

/*
ConnectCancelled connects the callback to the 'cancelled' signal for the AuthenticationRequest.

The returned value represents the connection, and may be passed to DisconnectCancelled to remove it.
*/
func (recv *AuthenticationRequest) ConnectCancelled(callback AuthenticationRequestSignalCancelledCallback) int {
	signalAuthenticationRequestCancelledLock.Lock()
	defer signalAuthenticationRequestCancelledLock.Unlock()

	signalAuthenticationRequestCancelledId++
	instance := C.gpointer(recv.native)
	handlerID := C.AuthenticationRequest_signal_connect_cancelled(instance, C.gpointer(uintptr(signalAuthenticationRequestCancelledId)))

	detail := signalAuthenticationRequestCancelledDetail{callback, handlerID}
	signalAuthenticationRequestCancelledMap[signalAuthenticationRequestCancelledId] = detail

	return signalAuthenticationRequestCancelledId
}

/*
DisconnectCancelled disconnects a callback from the 'cancelled' signal for the AuthenticationRequest.

The connectionID should be a value returned from a call to ConnectCancelled.
*/
func (recv *AuthenticationRequest) DisconnectCancelled(connectionID int) {
	signalAuthenticationRequestCancelledLock.Lock()
	defer signalAuthenticationRequestCancelledLock.Unlock()

	detail, exists := signalAuthenticationRequestCancelledMap[connectionID]
	if !exists {
		return
	}
	...
	delete(signalAuthenticationRequestCancelledMap, connectionID)
}

//export authenticationrequest_cancelledHandler
func authenticationrequest_cancelledHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalAuthenticationRequestCancelledLock.RLock()
	defer signalAuthenticationRequestCancelledLock.RUnlock()

	targetObject := AuthenticationRequestNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalAuthenticationRequestCancelledMap[index].callback
	callback(targetObject)
}

// Authenticate is a wrapper around the C function webkit_authentication_request_authenticate.
func (recv *AuthenticationRequest) Authenticate(credential *Credential) {
	c_credential := (*C.WebKitCredential)(C.NULL)
	if credential != nil {
		c_credential = (*C.WebKitCredential)(credential.ToC())
	}

	C.webkit_authentication_request_authenticate((*C.WebKitAuthenticationRequest)(recv.native), c_credential)

	return
}

// CanSaveCredentials is a wrapper around the C function webkit_authentication_request_can_save_credentials.
func (recv *AuthenticationRequest) CanSaveCredentials() bool {
	retC := C.webkit_authentication_request_can_save_credentials((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// Cancel is a wrapper around the C function webkit_authentication_request_cancel.
func (recv *AuthenticationRequest) Cancel() {
	C.webkit_authentication_request_cancel((*C.WebKitAuthenticationRequest)(recv.native))

	return
}

// GetHost is a wrapper around the C function webkit_authentication_request_get_host.
func (recv *AuthenticationRequest) GetHost() string {
	retC := C.webkit_authentication_request_get_host((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetPort is a wrapper around the C function webkit_authentication_request_get_port.
func (recv *AuthenticationRequest) GetPort() uint32 {
	retC := C.webkit_authentication_request_get_port((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// GetProposedCredential is a wrapper around the C function webkit_authentication_request_get_proposed_credential.
func (recv *AuthenticationRequest) GetProposedCredential() *Credential {
	retC := C.webkit_authentication_request_get_proposed_credential((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := CredentialNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetRealm is a wrapper around the C function webkit_authentication_request_get_realm.
func (recv *AuthenticationRequest) GetRealm() string {
	retC := C.webkit_authentication_request_get_realm((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetScheme is a wrapper around the C function webkit_authentication_request_get_scheme.
func (recv *AuthenticationRequest) GetScheme() AuthenticationScheme {
	retC := C.webkit_authentication_request_get_scheme((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := (AuthenticationScheme)(retC)

	return retGo
}

// IsForProxy is a wrapper around the C function webkit_authentication_request_is_for_proxy.
func (recv *AuthenticationRequest) IsForProxy() bool {
	retC := C.webkit_authentication_request_is_for_proxy((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsRetry is a wrapper around the C function webkit_authentication_request_is_retry.
func (recv *AuthenticationRequest) IsRetry() bool {
	retC := C.webkit_authentication_request_is_retry((*C.WebKitAuthenticationRequest)(recv.native))
	retGo := retC == C.TRUE
...
type signalAutomationSessionCreateWebViewDetail struct {
	callback  AutomationSessionSignalCreateWebViewCallback
	handlerID C.gulong
}

var signalAutomationSessionCreateWebViewId int
var signalAutomationSessionCreateWebViewMap = make(map[int]signalAutomationSessionCreateWebViewDetail)
var signalAutomationSessionCreateWebViewLock sync.RWMutex

// AutomationSessionSignalCreateWebViewCallback is a callback function for a 'create-web-view' signal emitted from a AutomationSession.
type AutomationSessionSignalCreateWebViewCallback func(targetObject *AutomationSession) WebView

/*
ConnectCreateWebView connects the callback to the 'create-web-view' signal for the AutomationSession.

The returned value represents the connection, and may be passed to DisconnectCreateWebView to remove it.
*/
func (recv *AutomationSession) ConnectCreateWebView(callback AutomationSessionSignalCreateWebViewCallback) int {
	signalAutomationSessionCreateWebViewLock.Lock()
	defer signalAutomationSessionCreateWebViewLock.Unlock()

	signalAutomationSessionCreateWebViewId++
	instance := C.gpointer(recv.native)
	handlerID := C.AutomationSession_signal_connect_create_web_view(instance, C.gpointer(uintptr(signalAutomationSessionCreateWebViewId)))

	detail := signalAutomationSessionCreateWebViewDetail{callback, handlerID}
	signalAutomationSessionCreateWebViewMap[signalAutomationSessionCreateWebViewId] = detail

	return signalAutomationSessionCreateWebViewId
}

/*
DisconnectCreateWebView disconnects a callback from the 'create-web-view' signal for the AutomationSession.

The connectionID should be a value returned from a call to ConnectCreateWebView.
*/
func (recv *AutomationSession) DisconnectCreateWebView(connectionID int) {
	signalAutomationSessionCreateWebViewLock.Lock()
	defer signalAutomationSessionCreateWebViewLock.Unlock()

	detail, exists := signalAutomationSessionCreateWebViewMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalAutomationSessionCreateWebViewMap, connectionID)
}

//export automationsession_createWebViewHandler
func automationsession_createWebViewHandler(c_targetObject *C.GObject, data C.gpointer) *C.WebKitWebView {
	signalAutomationSessionCreateWebViewLock.RLock()
	defer signalAutomationSessionCreateWebViewLock.RUnlock()

	targetObject := AutomationSessionNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalAutomationSessionCreateWebViewMap[index].callback
	retGo := callback(targetObject)
	retC :=
		(*C.WebKitWebView)(retGo.ToC())
	return retC
}

// GetApplicationInfo is a wrapper around the C function webkit_automation_session_get_application_info.
func (recv *AutomationSession) GetApplicationInfo() *ApplicationInfo {
	retC := C.webkit_automation_session_get_application_info((*C.WebKitAutomationSession)(recv.native))
	retGo := ApplicationInfoNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetId is a wrapper around the C function webkit_automation_session_get_id.
func (recv *AutomationSession) GetId() string {
	retC := C.webkit_automation_session_get_id((*C.WebKitAutomationSession)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// SetApplicationInfo is a wrapper around the C function webkit_automation_session_set_application_info.
func (recv *AutomationSession) SetApplicationInfo(info *ApplicationInfo) {
	c_info := (*C.WebKitApplicationInfo)(C.NULL)
	if info != nil {
		c_info = (*C.WebKitApplicationInfo)(info.ToC())
	}

	C.webkit_automation_session_set_application_info((*C.WebKitAutomationSession)(recv.native), c_info)
...
type signalColorChooserRequestFinishedDetail struct {
	callback  ColorChooserRequestSignalFinishedCallback
	handlerID C.gulong
}

var signalColorChooserRequestFinishedId int
var signalColorChooserRequestFinishedMap = make(map[int]signalColorChooserRequestFinishedDetail)
var signalColorChooserRequestFinishedLock sync.RWMutex

// ColorChooserRequestSignalFinishedCallback is a callback function for a 'finished' signal emitted from a ColorChooserRequest.
type ColorChooserRequestSignalFinishedCallback func(targetObject *ColorChooserRequest)

/*
ConnectFinished connects the callback to the 'finished' signal for the ColorChooserRequest.

The returned value represents the connection, and may be passed to DisconnectFinished to remove it.
*/
func (recv *ColorChooserRequest) ConnectFinished(callback ColorChooserRequestSignalFinishedCallback) int {
	signalColorChooserRequestFinishedLock.Lock()
	defer signalColorChooserRequestFinishedLock.Unlock()

	signalColorChooserRequestFinishedId++
	instance := C.gpointer(recv.native)
	handlerID := C.ColorChooserRequest_signal_connect_finished(instance, C.gpointer(uintptr(signalColorChooserRequestFinishedId)))

	detail := signalColorChooserRequestFinishedDetail{callback, handlerID}
	signalColorChooserRequestFinishedMap[signalColorChooserRequestFinishedId] = detail

	return signalColorChooserRequestFinishedId
}

/*
DisconnectFinished disconnects a callback from the 'finished' signal for the ColorChooserRequest.

The connectionID should be a value returned from a call to ConnectFinished.
*/
func (recv *ColorChooserRequest) DisconnectFinished(connectionID int) {
	signalColorChooserRequestFinishedLock.Lock()
	defer signalColorChooserRequestFinishedLock.Unlock()

	detail, exists := signalColorChooserRequestFinishedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalColorChooserRequestFinishedMap, connectionID)
}

//export colorchooserrequest_finishedHandler
func colorchooserrequest_finishedHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalColorChooserRequestFinishedLock.RLock()
	defer signalColorChooserRequestFinishedLock.RUnlock()

	targetObject := ColorChooserRequestNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalColorChooserRequestFinishedMap[index].callback
	callback(targetObject)
}

// Cancel is a wrapper around the C function webkit_color_chooser_request_cancel.
func (recv *ColorChooserRequest) Cancel() {
	C.webkit_color_chooser_request_cancel((*C.WebKitColorChooserRequest)(recv.native))

	return
}

// Finish is a wrapper around the C function webkit_color_chooser_request_finish.
func (recv *ColorChooserRequest) Finish() {
	C.webkit_color_chooser_request_finish((*C.WebKitColorChooserRequest)(recv.native))

	return
}

// GetElementRectangle is a wrapper around the C function webkit_color_chooser_request_get_element_rectangle.
func (recv *ColorChooserRequest) GetElementRectangle() *gdk.Rectangle {
	var c_rect C.GdkRectangle

	C.webkit_color_chooser_request_get_element_rectangle((*C.WebKitColorChooserRequest)(recv.native), &c_rect)
...
// GetRgba is a wrapper around the C function webkit_color_chooser_request_get_rgba.
func (recv *ColorChooserRequest) GetRgba() *gdk.RGBA {
	var c_rgba C.GdkRGBA

	C.webkit_color_chooser_request_get_rgba((*C.WebKitColorChooserRequest)(recv.native), &c_rgba)
...
// SetRgba is a wrapper around the C function webkit_color_chooser_request_set_rgba.
func (recv *ColorChooserRequest) SetRgba(rgba *gdk.RGBA) {
	...
	C.webkit_color_chooser_request_set_rgba((*C.WebKitColorChooserRequest)(recv.native), c_rgba)
...
// GetUserData is a wrapper around the C function webkit_context_menu_get_user_data.
func (recv *ContextMenu) GetUserData() *glib.Variant {
	retC := C.webkit_context_menu_get_user_data((*C.WebKitContextMenu)(recv.native))
...
// GetGaction is a wrapper around the C function webkit_context_menu_item_get_gaction.
func (recv *ContextMenuItem) GetGaction() *gio.Action {
	retC := C.webkit_context_menu_item_get_gaction((*C.WebKitContextMenuItem)(recv.native))
	retGo := gio.ActionNewFromC(unsafe.Pointer(retC))
...
// Unsupported : webkit_cookie_manager_add_cookie : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// AddCookieFinish is a wrapper around the C function webkit_cookie_manager_add_cookie_finish.
func (recv *CookieManager) AddCookieFinish(result *gio.AsyncResult) (bool, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_cookie_manager_add_cookie_finish((*C.WebKitCookieManager)(recv.native), c_result, &cThrowableError)
	retGo := retC == C.TRUE
...
// Unsupported : webkit_cookie_manager_delete_cookie : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// DeleteCookieFinish is a wrapper around the C function webkit_cookie_manager_delete_cookie_finish.
func (recv *CookieManager) DeleteCookieFinish(result *gio.AsyncResult) (bool, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_cookie_manager_delete_cookie_finish((*C.WebKitCookieManager)(recv.native), c_result, &cThrowableError)
	retGo := retC == C.TRUE
...
// Unsupported : webkit_cookie_manager_get_cookies : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// GetCookiesFinish is a wrapper around the C function webkit_cookie_manager_get_cookies_finish.
func (recv *CookieManager) GetCookiesFinish(result *gio.AsyncResult) (*glib.List, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_cookie_manager_get_cookies_finish((*C.WebKitCookieManager)(recv.native), c_result, &cThrowableError)
	retGo := glib.ListNewFromC(unsafe.Pointer(retC))
...
// GetAllowOverwrite is a wrapper around the C function webkit_download_get_allow_overwrite.
func (recv *Download) GetAllowOverwrite() bool {
	retC := C.webkit_download_get_allow_overwrite((*C.WebKitDownload)(recv.native))
	retGo := retC == C.TRUE
...
// SetAllowOverwrite is a wrapper around the C function webkit_download_set_allow_overwrite.
func (recv *Download) SetAllowOverwrite(allowed bool) {
	c_allowed :=
		boolToGboolean(allowed)

	C.webkit_download_set_allow_overwrite((*C.WebKitDownload)(recv.native), c_allowed)
...
// GetTypingAttributes is a wrapper around the C function webkit_editor_state_get_typing_attributes.
func (recv *EditorState) GetTypingAttributes() uint32 {
	retC := C.webkit_editor_state_get_typing_attributes((*C.WebKitEditorState)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// IsCopyAvailable is a wrapper around the C function webkit_editor_state_is_copy_available.
func (recv *EditorState) IsCopyAvailable() bool {
	retC := C.webkit_editor_state_is_copy_available((*C.WebKitEditorState)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsCutAvailable is a wrapper around the C function webkit_editor_state_is_cut_available.
func (recv *EditorState) IsCutAvailable() bool {
	retC := C.webkit_editor_state_is_cut_available((*C.WebKitEditorState)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsPasteAvailable is a wrapper around the C function webkit_editor_state_is_paste_available.
func (recv *EditorState) IsPasteAvailable() bool {
	retC := C.webkit_editor_state_is_paste_available((*C.WebKitEditorState)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsRedoAvailable is a wrapper around the C function webkit_editor_state_is_redo_available.
func (recv *EditorState) IsRedoAvailable() bool {
	retC := C.webkit_editor_state_is_redo_available((*C.WebKitEditorState)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsUndoAvailable is a wrapper around the C function webkit_editor_state_is_undo_available.
func (recv *EditorState) IsUndoAvailable() bool {
	retC := C.webkit_editor_state_is_undo_available((*C.WebKitEditorState)(recv.native))
	retGo := retC == C.TRUE
...
// Unsupported : webkit_form_submission_request_list_text_fields : unsupported parameter field_names : output array param field_names
...
type signalGeolocationManagerStartDetail struct {
	callback  GeolocationManagerSignalStartCallback
	handlerID C.gulong
}

var signalGeolocationManagerStartId int
var signalGeolocationManagerStartMap = make(map[int]signalGeolocationManagerStartDetail)
var signalGeolocationManagerStartLock sync.RWMutex

// GeolocationManagerSignalStartCallback is a callback function for a 'start' signal emitted from a GeolocationManager.
type GeolocationManagerSignalStartCallback func(targetObject *GeolocationManager) bool

/*
ConnectStart connects the callback to the 'start' signal for the GeolocationManager.

The returned value represents the connection, and may be passed to DisconnectStart to remove it.
*/
func (recv *GeolocationManager) ConnectStart(callback GeolocationManagerSignalStartCallback) int {
	signalGeolocationManagerStartLock.Lock()
	defer signalGeolocationManagerStartLock.Unlock()

	signalGeolocationManagerStartId++
	instance := C.gpointer(recv.native)
	handlerID := C.GeolocationManager_signal_connect_start(instance, C.gpointer(uintptr(signalGeolocationManagerStartId)))

	detail := signalGeolocationManagerStartDetail{callback, handlerID}
	signalGeolocationManagerStartMap[signalGeolocationManagerStartId] = detail

	return signalGeolocationManagerStartId
}

/*
DisconnectStart disconnects a callback from the 'start' signal for the GeolocationManager.

The connectionID should be a value returned from a call to ConnectStart.
*/
func (recv *GeolocationManager) DisconnectStart(connectionID int) {
	signalGeolocationManagerStartLock.Lock()
	defer signalGeolocationManagerStartLock.Unlock()

	detail, exists := signalGeolocationManagerStartMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalGeolocationManagerStartMap, connectionID)
}

//export geolocationmanager_startHandler
func geolocationmanager_startHandler(c_targetObject *C.GObject, data C.gpointer) C.gboolean {
	signalGeolocationManagerStartLock.RLock()
	defer signalGeolocationManagerStartLock.RUnlock()

	targetObject := GeolocationManagerNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalGeolocationManagerStartMap[index].callback
	retGo := callback(targetObject)
	retC :=
		boolToGboolean(retGo)
	return retC
...
type signalGeolocationManagerStopDetail struct {
	callback  GeolocationManagerSignalStopCallback
	handlerID C.gulong
}

var signalGeolocationManagerStopId int
var signalGeolocationManagerStopMap = make(map[int]signalGeolocationManagerStopDetail)
var signalGeolocationManagerStopLock sync.RWMutex

// GeolocationManagerSignalStopCallback is a callback function for a 'stop' signal emitted from a GeolocationManager.
type GeolocationManagerSignalStopCallback func(targetObject *GeolocationManager)

/*
ConnectStop connects the callback to the 'stop' signal for the GeolocationManager.

The returned value represents the connection, and may be passed to DisconnectStop to remove it.
*/
func (recv *GeolocationManager) ConnectStop(callback GeolocationManagerSignalStopCallback) int {
	signalGeolocationManagerStopLock.Lock()
	defer signalGeolocationManagerStopLock.Unlock()

	signalGeolocationManagerStopId++
	instance := C.gpointer(recv.native)
	handlerID := C.GeolocationManager_signal_connect_stop(instance, C.gpointer(uintptr(signalGeolocationManagerStopId)))

	detail := signalGeolocationManagerStopDetail{callback, handlerID}
	signalGeolocationManagerStopMap[signalGeolocationManagerStopId] = detail

	return signalGeolocationManagerStopId
}

/*
DisconnectStop disconnects a callback from the 'stop' signal for the GeolocationManager.

The connectionID should be a value returned from a call to ConnectStop.
*/
func (recv *GeolocationManager) DisconnectStop(connectionID int) {
	signalGeolocationManagerStopLock.Lock()
	defer signalGeolocationManagerStopLock.Unlock()

	detail, exists := signalGeolocationManagerStopMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalGeolocationManagerStopMap, connectionID)
}

//export geolocationmanager_stopHandler
func geolocationmanager_stopHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalGeolocationManagerStopLock.RLock()
	defer signalGeolocationManagerStopLock.RUnlock()

	targetObject := GeolocationManagerNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalGeolocationManagerStopMap[index].callback
	callback(targetObject)
}

// Failed is a wrapper around the C function webkit_geolocation_manager_failed.
func (recv *GeolocationManager) Failed(errorMessage string) {
	...
	C.webkit_geolocation_manager_failed((*C.WebKitGeolocationManager)(recv.native), c_error_message)

	return
}

// GetEnableHighAccuracy is a wrapper around the C function webkit_geolocation_manager_get_enable_high_accuracy.
func (recv *GeolocationManager) GetEnableHighAccuracy() bool {
	retC := C.webkit_geolocation_manager_get_enable_high_accuracy((*C.WebKitGeolocationManager)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// UpdatePosition is a wrapper around the C function webkit_geolocation_manager_update_position.
func (recv *GeolocationManager) UpdatePosition(position *GeolocationPosition) {
	c_position := (*C.WebKitGeolocationPosition)(C.NULL)
	if position != nil {
		c_position = (*C.WebKitGeolocationPosition)(position.ToC())
	}

	C.webkit_geolocation_manager_update_position((*C.WebKitGeolocationManager)(recv.native), c_position)
...
// ContextIsSelection is a wrapper around the C function webkit_hit_test_result_context_is_selection.
func (recv *HitTestResult) ContextIsSelection() bool {
	retC := C.webkit_hit_test_result_context_is_selection((*C.WebKitHitTestResult)(recv.native))
	retGo := retC == C.TRUE
...
// GetDescription is a wrapper around the C function webkit_install_missing_media_plugins_permission_request_get_description.
func (recv *InstallMissingMediaPluginsPermissionRequest) GetDescription() string {
	retC := C.webkit_install_missing_media_plugins_permission_request_get_description((*C.WebKitInstallMissingMediaPluginsPermissionRequest)(recv.native))
	retGo := C.GoString(retC)
...
// GetNavigationAction is a wrapper around the C function webkit_navigation_policy_decision_get_navigation_action.
func (recv *NavigationPolicyDecision) GetNavigationAction() *NavigationAction {
	retC := C.webkit_navigation_policy_decision_get_navigation_action((*C.WebKitNavigationPolicyDecision)(recv.native))
	retGo := NavigationActionNewFromC(unsafe.Pointer(retC))
...
type signalNotificationClickedDetail struct {
	callback  NotificationSignalClickedCallback
	handlerID C.gulong
}

var signalNotificationClickedId int
var signalNotificationClickedMap = make(map[int]signalNotificationClickedDetail)
var signalNotificationClickedLock sync.RWMutex

// NotificationSignalClickedCallback is a callback function for a 'clicked' signal emitted from a Notification.
type NotificationSignalClickedCallback func(targetObject *Notification)

/*
ConnectClicked connects the callback to the 'clicked' signal for the Notification.

The returned value represents the connection, and may be passed to DisconnectClicked to remove it.
*/
func (recv *Notification) ConnectClicked(callback NotificationSignalClickedCallback) int {
	signalNotificationClickedLock.Lock()
	defer signalNotificationClickedLock.Unlock()

	signalNotificationClickedId++
	instance := C.gpointer(recv.native)
	handlerID := C.Notification_signal_connect_clicked(instance, C.gpointer(uintptr(signalNotificationClickedId)))

	detail := signalNotificationClickedDetail{callback, handlerID}
	signalNotificationClickedMap[signalNotificationClickedId] = detail

	return signalNotificationClickedId
}

/*
DisconnectClicked disconnects a callback from the 'clicked' signal for the Notification.

The connectionID should be a value returned from a call to ConnectClicked.
*/
func (recv *Notification) DisconnectClicked(connectionID int) {
	signalNotificationClickedLock.Lock()
	defer signalNotificationClickedLock.Unlock()

	detail, exists := signalNotificationClickedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalNotificationClickedMap, connectionID)
}

//export notification_clickedHandler
func notification_clickedHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalNotificationClickedLock.RLock()
	defer signalNotificationClickedLock.RUnlock()

	targetObject := NotificationNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalNotificationClickedMap[index].callback
	callback(targetObject)
}

type signalNotificationClosedDetail struct {
	callback  NotificationSignalClosedCallback
	handlerID C.gulong
}

var signalNotificationClosedId int
var signalNotificationClosedMap = make(map[int]signalNotificationClosedDetail)
var signalNotificationClosedLock sync.RWMutex

// NotificationSignalClosedCallback is a callback function for a 'closed' signal emitted from a Notification.
type NotificationSignalClosedCallback func(targetObject *Notification)

/*
ConnectClosed connects the callback to the 'closed' signal for the Notification.

The returned value represents the connection, and may be passed to DisconnectClosed to remove it.
*/
func (recv *Notification) ConnectClosed(callback NotificationSignalClosedCallback) int {
	signalNotificationClosedLock.Lock()
	defer signalNotificationClosedLock.Unlock()

	signalNotificationClosedId++
	instance := C.gpointer(recv.native)
	handlerID := C.Notification_signal_connect_closed(instance, C.gpointer(uintptr(signalNotificationClosedId)))

	detail := signalNotificationClosedDetail{callback, handlerID}
	signalNotificationClosedMap[signalNotificationClosedId] = detail

	return signalNotificationClosedId
}

/*
DisconnectClosed disconnects a callback from the 'closed' signal for the Notification.

The connectionID should be a value returned from a call to ConnectClosed.
*/
func (recv *Notification) DisconnectClosed(connectionID int) {
	signalNotificationClosedLock.Lock()
	defer signalNotificationClosedLock.Unlock()

	detail, exists := signalNotificationClosedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalNotificationClosedMap, connectionID)
}

//export notification_closedHandler
func notification_closedHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalNotificationClosedLock.RLock()
	defer signalNotificationClosedLock.RUnlock()

	targetObject := NotificationNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalNotificationClosedMap[index].callback
	callback(targetObject)
}

// Clicked is a wrapper around the C function webkit_notification_clicked.
func (recv *Notification) Clicked() {
	C.webkit_notification_clicked((*C.WebKitNotification)(recv.native))

	return
}

// Close is a wrapper around the C function webkit_notification_close.
func (recv *Notification) Close() {
	C.webkit_notification_close((*C.WebKitNotification)(recv.native))

	return
}

// GetBody is a wrapper around the C function webkit_notification_get_body.
func (recv *Notification) GetBody() string {
	retC := C.webkit_notification_get_body((*C.WebKitNotification)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetId is a wrapper around the C function webkit_notification_get_id.
func (recv *Notification) GetId() uint64 {
	retC := C.webkit_notification_get_id((*C.WebKitNotification)(recv.native))
	retGo := (uint64)(retC)

	return retGo
}

// GetTag is a wrapper around the C function webkit_notification_get_tag.
func (recv *Notification) GetTag() string {
	retC := C.webkit_notification_get_tag((*C.WebKitNotification)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetTitle is a wrapper around the C function webkit_notification_get_title.
func (recv *Notification) GetTitle() string {
	retC := C.webkit_notification_get_title((*C.WebKitNotification)(recv.native))
	retGo := C.GoString(retC)
...
type signalOptionMenuCloseDetail struct {
	callback  OptionMenuSignalCloseCallback
	handlerID C.gulong
}

var signalOptionMenuCloseId int
var signalOptionMenuCloseMap = make(map[int]signalOptionMenuCloseDetail)
var signalOptionMenuCloseLock sync.RWMutex

// OptionMenuSignalCloseCallback is a callback function for a 'close' signal emitted from a OptionMenu.
type OptionMenuSignalCloseCallback func(targetObject *OptionMenu)

/*
ConnectClose connects the callback to the 'close' signal for the OptionMenu.

The returned value represents the connection, and may be passed to DisconnectClose to remove it.
*/
func (recv *OptionMenu) ConnectClose(callback OptionMenuSignalCloseCallback) int {
	signalOptionMenuCloseLock.Lock()
	defer signalOptionMenuCloseLock.Unlock()

	signalOptionMenuCloseId++
	instance := C.gpointer(recv.native)
	handlerID := C.OptionMenu_signal_connect_close(instance, C.gpointer(uintptr(signalOptionMenuCloseId)))

	detail := signalOptionMenuCloseDetail{callback, handlerID}
	signalOptionMenuCloseMap[signalOptionMenuCloseId] = detail

	return signalOptionMenuCloseId
}

/*
DisconnectClose disconnects a callback from the 'close' signal for the OptionMenu.

The connectionID should be a value returned from a call to ConnectClose.
*/
func (recv *OptionMenu) DisconnectClose(connectionID int) {
	signalOptionMenuCloseLock.Lock()
	defer signalOptionMenuCloseLock.Unlock()

	detail, exists := signalOptionMenuCloseMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalOptionMenuCloseMap, connectionID)
}

//export optionmenu_closeHandler
func optionmenu_closeHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalOptionMenuCloseLock.RLock()
	defer signalOptionMenuCloseLock.RUnlock()

	targetObject := OptionMenuNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalOptionMenuCloseMap[index].callback
	callback(targetObject)
}

// ActivateItem is a wrapper around the C function webkit_option_menu_activate_item.
func (recv *OptionMenu) ActivateItem(index uint32) {
	c_index := (C.guint)(index)

	C.webkit_option_menu_activate_item((*C.WebKitOptionMenu)(recv.native), c_index)

	return
}

// Close is a wrapper around the C function webkit_option_menu_close.
func (recv *OptionMenu) Close() {
	C.webkit_option_menu_close((*C.WebKitOptionMenu)(recv.native))

	return
}

// GetItem is a wrapper around the C function webkit_option_menu_get_item.
func (recv *OptionMenu) GetItem(index uint32) *OptionMenuItem {
	c_index := (C.guint)(index)

	retC := C.webkit_option_menu_get_item((*C.WebKitOptionMenu)(recv.native), c_index)
	retGo := OptionMenuItemNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetNItems is a wrapper around the C function webkit_option_menu_get_n_items.
func (recv *OptionMenu) GetNItems() uint32 {
	retC := C.webkit_option_menu_get_n_items((*C.WebKitOptionMenu)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// SelectItem is a wrapper around the C function webkit_option_menu_select_item.
func (recv *OptionMenu) SelectItem(index uint32) {
	c_index := (C.guint)(index)

	C.webkit_option_menu_select_item((*C.WebKitOptionMenu)(recv.native), c_index)
...
type signalPrintCustomWidgetApplyDetail struct {
	callback  PrintCustomWidgetSignalApplyCallback
	handlerID C.gulong
}

var signalPrintCustomWidgetApplyId int
var signalPrintCustomWidgetApplyMap = make(map[int]signalPrintCustomWidgetApplyDetail)
var signalPrintCustomWidgetApplyLock sync.RWMutex

// PrintCustomWidgetSignalApplyCallback is a callback function for a 'apply' signal emitted from a PrintCustomWidget.
type PrintCustomWidgetSignalApplyCallback func(targetObject *PrintCustomWidget)

/*
ConnectApply connects the callback to the 'apply' signal for the PrintCustomWidget.

The returned value represents the connection, and may be passed to DisconnectApply to remove it.
*/
func (recv *PrintCustomWidget) ConnectApply(callback PrintCustomWidgetSignalApplyCallback) int {
	signalPrintCustomWidgetApplyLock.Lock()
	defer signalPrintCustomWidgetApplyLock.Unlock()

	signalPrintCustomWidgetApplyId++
	instance := C.gpointer(recv.native)
	handlerID := C.PrintCustomWidget_signal_connect_apply(instance, C.gpointer(uintptr(signalPrintCustomWidgetApplyId)))

	detail := signalPrintCustomWidgetApplyDetail{callback, handlerID}
	signalPrintCustomWidgetApplyMap[signalPrintCustomWidgetApplyId] = detail

	return signalPrintCustomWidgetApplyId
}

/*
DisconnectApply disconnects a callback from the 'apply' signal for the PrintCustomWidget.

The connectionID should be a value returned from a call to ConnectApply.
*/
func (recv *PrintCustomWidget) DisconnectApply(connectionID int) {
	signalPrintCustomWidgetApplyLock.Lock()
	defer signalPrintCustomWidgetApplyLock.Unlock()

	detail, exists := signalPrintCustomWidgetApplyMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalPrintCustomWidgetApplyMap, connectionID)
}

//export printcustomwidget_applyHandler
func printcustomwidget_applyHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalPrintCustomWidgetApplyLock.RLock()
	defer signalPrintCustomWidgetApplyLock.RUnlock()

	targetObject := PrintCustomWidgetNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalPrintCustomWidgetApplyMap[index].callback
	callback(targetObject)
}

type signalPrintCustomWidgetUpdateDetail struct {
	callback  PrintCustomWidgetSignalUpdateCallback
	handlerID C.gulong
}

var signalPrintCustomWidgetUpdateId int
var signalPrintCustomWidgetUpdateMap = make(map[int]signalPrintCustomWidgetUpdateDetail)
var signalPrintCustomWidgetUpdateLock sync.RWMutex

// PrintCustomWidgetSignalUpdateCallback is a callback function for a 'update' signal emitted from a PrintCustomWidget.
type PrintCustomWidgetSignalUpdateCallback func(targetObject *PrintCustomWidget, pageSetup *gtk.PageSetup, printSettings *gtk.PrintSettings)

/*
ConnectUpdate connects the callback to the 'update' signal for the PrintCustomWidget.

The returned value represents the connection, and may be passed to DisconnectUpdate to remove it.
*/
func (recv *PrintCustomWidget) ConnectUpdate(callback PrintCustomWidgetSignalUpdateCallback) int {
	signalPrintCustomWidgetUpdateLock.Lock()
	defer signalPrintCustomWidgetUpdateLock.Unlock()

	signalPrintCustomWidgetUpdateId++
	instance := C.gpointer(recv.native)
	handlerID := C.PrintCustomWidget_signal_connect_update(instance, C.gpointer(uintptr(signalPrintCustomWidgetUpdateId)))

	detail := signalPrintCustomWidgetUpdateDetail{callback, handlerID}
	signalPrintCustomWidgetUpdateMap[signalPrintCustomWidgetUpdateId] = detail

	return signalPrintCustomWidgetUpdateId
}

/*
DisconnectUpdate disconnects a callback from the 'update' signal for the PrintCustomWidget.

The connectionID should be a value returned from a call to ConnectUpdate.
*/
func (recv *PrintCustomWidget) DisconnectUpdate(connectionID int) {
	signalPrintCustomWidgetUpdateLock.Lock()
	defer signalPrintCustomWidgetUpdateLock.Unlock()

	detail, exists := signalPrintCustomWidgetUpdateMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalPrintCustomWidgetUpdateMap, connectionID)
}

//export printcustomwidget_updateHandler
func printcustomwidget_updateHandler(c_targetObject *C.GObject, c_page_setup *C.GtkPageSetup, c_print_settings *C.GtkPrintSettings, data C.gpointer) {
	signalPrintCustomWidgetUpdateLock.RLock()
	defer signalPrintCustomWidgetUpdateLock.RUnlock()

	pageSetup := gtk.PageSetupNewFromC(unsafe.Pointer(c_page_setup))

	printSettings := gtk.PrintSettingsNewFromC(unsafe.Pointer(c_print_settings))

	targetObject := PrintCustomWidgetNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalPrintCustomWidgetUpdateMap[index].callback
	callback(targetObject, pageSetup, printSettings)
}

// PrintCustomWidgetNew is a wrapper around the C function webkit_print_custom_widget_new.
func PrintCustomWidgetNew(widget *gtk.Widget, title string) *PrintCustomWidget {
	...
	retC := C.webkit_print_custom_widget_new(c_widget, c_title)
	retGo := PrintCustomWidgetNewFromC(unsafe.Pointer(retC))
...
// GetTitle is a wrapper around the C function webkit_print_custom_widget_get_title.
func (recv *PrintCustomWidget) GetTitle() string {
	retC := C.webkit_print_custom_widget_get_title((*C.WebKitPrintCustomWidget)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetWidget is a wrapper around the C function webkit_print_custom_widget_get_widget.
func (recv *PrintCustomWidget) GetWidget() *gtk.Widget {
	retC := C.webkit_print_custom_widget_get_widget((*C.WebKitPrintCustomWidget)(recv.native))
...
// IsMimeTypeSupported is a wrapper around the C function webkit_response_policy_decision_is_mime_type_supported.
func (recv *ResponsePolicyDecision) IsMimeTypeSupported() bool {
	retC := C.webkit_response_policy_decision_is_mime_type_supported((*C.WebKitResponsePolicyDecision)(recv.native))
	retGo := retC == C.TRUE
...
// SettingsFontSizeToPixels is a wrapper around the C function webkit_settings_font_size_to_pixels.
func SettingsFontSizeToPixels(points uint32) uint32 {
	c_points := (C.guint32)(points)

	retC := C.webkit_settings_font_size_to_pixels(c_points)
	retGo := (uint32)(retC)

	return retGo
}

// SettingsFontSizeToPoints is a wrapper around the C function webkit_settings_font_size_to_points.
func SettingsFontSizeToPoints(pixels uint32) uint32 {
	c_pixels := (C.guint32)(pixels)

	retC := C.webkit_settings_font_size_to_points(c_pixels)
	retGo := (uint32)(retC)

	return retGo
}

// GetAllowFileAccessFromFileUrls is a wrapper around the C function webkit_settings_get_allow_file_access_from_file_urls.
func (recv *Settings) GetAllowFileAccessFromFileUrls() bool {
	retC := C.webkit_settings_get_allow_file_access_from_file_urls((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetAllowUniversalAccessFromFileUrls is a wrapper around the C function webkit_settings_get_allow_universal_access_from_file_urls.
func (recv *Settings) GetAllowUniversalAccessFromFileUrls() bool {
	retC := C.webkit_settings_get_allow_universal_access_from_file_urls((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetEnableAccelerated2dCanvas is a wrapper around the C function webkit_settings_get_enable_accelerated_2d_canvas.
func (recv *Settings) GetEnableAccelerated2dCanvas() bool {
	retC := C.webkit_settings_get_enable_accelerated_2d_canvas((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableBackForwardNavigationGestures is a wrapper around the C function webkit_settings_get_enable_back_forward_navigation_gestures.
func (recv *Settings) GetEnableBackForwardNavigationGestures() bool {
	retC := C.webkit_settings_get_enable_back_forward_navigation_gestures((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetEnableEncryptedMedia is a wrapper around the C function webkit_settings_get_enable_encrypted_media.
func (recv *Settings) GetEnableEncryptedMedia() bool {
	retC := C.webkit_settings_get_enable_encrypted_media((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetEnableJavascriptMarkup is a wrapper around the C function webkit_settings_get_enable_javascript_markup.
func (recv *Settings) GetEnableJavascriptMarkup() bool {
	retC := C.webkit_settings_get_enable_javascript_markup((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableMedia is a wrapper around the C function webkit_settings_get_enable_media.
func (recv *Settings) GetEnableMedia() bool {
	retC := C.webkit_settings_get_enable_media((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableMediaCapabilities is a wrapper around the C function webkit_settings_get_enable_media_capabilities.
func (recv *Settings) GetEnableMediaCapabilities() bool {
	retC := C.webkit_settings_get_enable_media_capabilities((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableMediaStream is a wrapper around the C function webkit_settings_get_enable_media_stream.
func (recv *Settings) GetEnableMediaStream() bool {
	retC := C.webkit_settings_get_enable_media_stream((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableMediasource is a wrapper around the C function webkit_settings_get_enable_mediasource.
func (recv *Settings) GetEnableMediasource() bool {
	retC := C.webkit_settings_get_enable_mediasource((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// GetEnableMockCaptureDevices is a wrapper around the C function webkit_settings_get_enable_mock_capture_devices.
func (recv *Settings) GetEnableMockCaptureDevices() bool {
	retC := C.webkit_settings_get_enable_mock_capture_devices((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetEnableSpatialNavigation is a wrapper around the C function webkit_settings_get_enable_spatial_navigation.
func (recv *Settings) GetEnableSpatialNavigation() bool {
	retC := C.webkit_settings_get_enable_spatial_navigation((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetEnableWriteConsoleMessagesToStdout is a wrapper around the C function webkit_settings_get_enable_write_console_messages_to_stdout.
func (recv *Settings) GetEnableWriteConsoleMessagesToStdout() bool {
	retC := C.webkit_settings_get_enable_write_console_messages_to_stdout((*C.WebKitSettings)(recv.native))
	retGo := retC == C.TRUE
...
// GetHardwareAccelerationPolicy is a wrapper around the C function webkit_settings_get_hardware_acceleration_policy.
func (recv *Settings) GetHardwareAccelerationPolicy() HardwareAccelerationPolicy {
	retC := C.webkit_settings_get_hardware_acceleration_policy((*C.WebKitSettings)(recv.native))
	retGo := (HardwareAccelerationPolicy)(retC)
...
// SetAllowFileAccessFromFileUrls is a wrapper around the C function webkit_settings_set_allow_file_access_from_file_urls.
func (recv *Settings) SetAllowFileAccessFromFileUrls(allowed bool) {
	c_allowed :=
		boolToGboolean(allowed)

	C.webkit_settings_set_allow_file_access_from_file_urls((*C.WebKitSettings)(recv.native), c_allowed)
...
// SetAllowUniversalAccessFromFileUrls is a wrapper around the C function webkit_settings_set_allow_universal_access_from_file_urls.
func (recv *Settings) SetAllowUniversalAccessFromFileUrls(allowed bool) {
	c_allowed :=
		boolToGboolean(allowed)

	C.webkit_settings_set_allow_universal_access_from_file_urls((*C.WebKitSettings)(recv.native), c_allowed)
...
// SetEnableAccelerated2dCanvas is a wrapper around the C function webkit_settings_set_enable_accelerated_2d_canvas.
func (recv *Settings) SetEnableAccelerated2dCanvas(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_accelerated_2d_canvas((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableBackForwardNavigationGestures is a wrapper around the C function webkit_settings_set_enable_back_forward_navigation_gestures.
func (recv *Settings) SetEnableBackForwardNavigationGestures(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_back_forward_navigation_gestures((*C.WebKitSettings)(recv.native), c_enabled)
...
// SetEnableEncryptedMedia is a wrapper around the C function webkit_settings_set_enable_encrypted_media.
func (recv *Settings) SetEnableEncryptedMedia(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_encrypted_media((*C.WebKitSettings)(recv.native), c_enabled)
...
// SetEnableJavascriptMarkup is a wrapper around the C function webkit_settings_set_enable_javascript_markup.
func (recv *Settings) SetEnableJavascriptMarkup(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_javascript_markup((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableMedia is a wrapper around the C function webkit_settings_set_enable_media.
func (recv *Settings) SetEnableMedia(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_media((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableMediaCapabilities is a wrapper around the C function webkit_settings_set_enable_media_capabilities.
func (recv *Settings) SetEnableMediaCapabilities(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_media_capabilities((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableMediaStream is a wrapper around the C function webkit_settings_set_enable_media_stream.
func (recv *Settings) SetEnableMediaStream(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_media_stream((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableMediasource is a wrapper around the C function webkit_settings_set_enable_mediasource.
func (recv *Settings) SetEnableMediasource(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_mediasource((*C.WebKitSettings)(recv.native), c_enabled)

	return
}

// SetEnableMockCaptureDevices is a wrapper around the C function webkit_settings_set_enable_mock_capture_devices.
func (recv *Settings) SetEnableMockCaptureDevices(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_mock_capture_devices((*C.WebKitSettings)(recv.native), c_enabled)
...
// SetEnableSpatialNavigation is a wrapper around the C function webkit_settings_set_enable_spatial_navigation.
func (recv *Settings) SetEnableSpatialNavigation(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_spatial_navigation((*C.WebKitSettings)(recv.native), c_enabled)
...
// SetEnableWriteConsoleMessagesToStdout is a wrapper around the C function webkit_settings_set_enable_write_console_messages_to_stdout.
func (recv *Settings) SetEnableWriteConsoleMessagesToStdout(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_settings_set_enable_write_console_messages_to_stdout((*C.WebKitSettings)(recv.native), c_enabled)
...
// SetHardwareAccelerationPolicy is a wrapper around the C function webkit_settings_set_hardware_acceleration_policy.
func (recv *Settings) SetHardwareAccelerationPolicy(policy HardwareAccelerationPolicy) {
	c_policy := (C.WebKitHardwareAccelerationPolicy)(policy)

	C.webkit_settings_set_hardware_acceleration_policy((*C.WebKitSettings)(recv.native), c_policy)
...
// GetHttpMethod is a wrapper around the C function webkit_uri_request_get_http_method.
func (recv *URIRequest) GetHttpMethod() string {
	retC := C.webkit_uri_request_get_http_method((*C.WebKitURIRequest)(recv.native))
	retGo := C.GoString(retC)
...
// GetHttpHeaders is a wrapper around the C function webkit_uri_response_get_http_headers.
func (recv *URIResponse) GetHttpHeaders() *soup.MessageHeaders {
	retC := C.webkit_uri_response_get_http_headers((*C.WebKitURIResponse)(recv.native))
	retGo := soup.MessageHeadersNewFromC(unsafe.Pointer(retC))
...
// FinishError is a wrapper around the C function webkit_uri_scheme_request_finish_error.
func (recv *URISchemeRequest) FinishError(error *glib.Error) {
	...
	C.webkit_uri_scheme_request_finish_error((*C.WebKitURISchemeRequest)(recv.native), c_error)
...
// UserContentFilterStoreNew is a wrapper around the C function webkit_user_content_filter_store_new.
func UserContentFilterStoreNew(storagePath string) *UserContentFilterStore {
	c_storage_path := C.CString(storagePath)
	defer C.free(unsafe.Pointer(c_storage_path))

	retC := C.webkit_user_content_filter_store_new(c_storage_path)
	retGo := UserContentFilterStoreNewFromC(unsafe.Pointer(retC))
...
// Unsupported : webkit_user_content_filter_store_fetch_identifiers : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// FetchIdentifiersFinish is a wrapper around the C function webkit_user_content_filter_store_fetch_identifiers_finish.
func (recv *UserContentFilterStore) FetchIdentifiersFinish(result *gio.AsyncResult) []string {
	c_result := (*C.GAsyncResult)(result.ToC())

	retC := C.webkit_user_content_filter_store_fetch_identifiers_finish((*C.WebKitUserContentFilterStore)(recv.native), c_result)
	retGo := []string{}
	for p := retC; *p != nil; p = (**C.char)(C.gpointer((uintptr(C.gpointer(p)) + uintptr(C.sizeof_gpointer)))) {
		s := C.GoString(*p)
		retGo = append(retGo, s)
...
// GetPath is a wrapper around the C function webkit_user_content_filter_store_get_path.
func (recv *UserContentFilterStore) GetPath() string {
	retC := C.webkit_user_content_filter_store_get_path((*C.WebKitUserContentFilterStore)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// Unsupported : webkit_user_content_filter_store_load : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// LoadFinish is a wrapper around the C function webkit_user_content_filter_store_load_finish.
func (recv *UserContentFilterStore) LoadFinish(result *gio.AsyncResult) (*UserContentFilter, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_user_content_filter_store_load_finish((*C.WebKitUserContentFilterStore)(recv.native), c_result, &cThrowableError)
	retGo := UserContentFilterNewFromC(unsafe.Pointer(retC))
...
// Unsupported : webkit_user_content_filter_store_remove : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// RemoveFinish is a wrapper around the C function webkit_user_content_filter_store_remove_finish.
func (recv *UserContentFilterStore) RemoveFinish(result *gio.AsyncResult) (bool, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_user_content_filter_store_remove_finish((*C.WebKitUserContentFilterStore)(recv.native), c_result, &cThrowableError)
	retGo := retC == C.TRUE
...
// Unsupported : webkit_user_content_filter_store_save : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// SaveFinish is a wrapper around the C function webkit_user_content_filter_store_save_finish.
func (recv *UserContentFilterStore) SaveFinish(result *gio.AsyncResult) (*UserContentFilter, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_user_content_filter_store_save_finish((*C.WebKitUserContentFilterStore)(recv.native), c_result, &cThrowableError)
	retGo := UserContentFilterNewFromC(unsafe.Pointer(retC))
...
// Unsupported : webkit_user_content_filter_store_save_from_file : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// SaveFromFileFinish is a wrapper around the C function webkit_user_content_filter_store_save_from_file_finish.
func (recv *UserContentFilterStore) SaveFromFileFinish(result *gio.AsyncResult) (*UserContentFilter, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_user_content_filter_store_save_from_file_finish((*C.WebKitUserContentFilterStore)(recv.native), c_result, &cThrowableError)
	retGo := UserContentFilterNewFromC(unsafe.Pointer(retC))
...
type signalUserContentManagerScriptMessageReceivedDetail struct {
	callback  UserContentManagerSignalScriptMessageReceivedCallback
	handlerID C.gulong
}

var signalUserContentManagerScriptMessageReceivedId int
var signalUserContentManagerScriptMessageReceivedMap = make(map[int]signalUserContentManagerScriptMessageReceivedDetail)
var signalUserContentManagerScriptMessageReceivedLock sync.RWMutex

// UserContentManagerSignalScriptMessageReceivedCallback is a callback function for a 'script-message-received' signal emitted from a UserContentManager.
type UserContentManagerSignalScriptMessageReceivedCallback func(targetObject *UserContentManager, jsResult *JavascriptResult)

/*
ConnectScriptMessageReceived connects the callback to the 'script-message-received' signal for the UserContentManager.

The returned value represents the connection, and may be passed to DisconnectScriptMessageReceived to remove it.
*/
func (recv *UserContentManager) ConnectScriptMessageReceived(callback UserContentManagerSignalScriptMessageReceivedCallback) int {
	signalUserContentManagerScriptMessageReceivedLock.Lock()
	defer signalUserContentManagerScriptMessageReceivedLock.Unlock()

	signalUserContentManagerScriptMessageReceivedId++
	instance := C.gpointer(recv.native)
	handlerID := C.UserContentManager_signal_connect_script_message_received(instance, C.gpointer(uintptr(signalUserContentManagerScriptMessageReceivedId)))

	detail := signalUserContentManagerScriptMessageReceivedDetail{callback, handlerID}
	signalUserContentManagerScriptMessageReceivedMap[signalUserContentManagerScriptMessageReceivedId] = detail

	return signalUserContentManagerScriptMessageReceivedId
}

/*
DisconnectScriptMessageReceived disconnects a callback from the 'script-message-received' signal for the UserContentManager.

The connectionID should be a value returned from a call to ConnectScriptMessageReceived.
*/
func (recv *UserContentManager) DisconnectScriptMessageReceived(connectionID int) {
	signalUserContentManagerScriptMessageReceivedLock.Lock()
	defer signalUserContentManagerScriptMessageReceivedLock.Unlock()

	detail, exists := signalUserContentManagerScriptMessageReceivedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalUserContentManagerScriptMessageReceivedMap, connectionID)
}

//export usercontentmanager_scriptMessageReceivedHandler
func usercontentmanager_scriptMessageReceivedHandler(c_targetObject *C.GObject, c_js_result *C.WebKitJavascriptResult, data C.gpointer) {
	signalUserContentManagerScriptMessageReceivedLock.RLock()
	defer signalUserContentManagerScriptMessageReceivedLock.RUnlock()

	jsResult := JavascriptResultNewFromC(unsafe.Pointer(c_js_result))

	targetObject := UserContentManagerNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalUserContentManagerScriptMessageReceivedMap[index].callback
	callback(targetObject, jsResult)
}

// UserContentManagerNew is a wrapper around the C function webkit_user_content_manager_new.
func UserContentManagerNew() *UserContentManager {
	retC := C.webkit_user_content_manager_new()
	retGo := UserContentManagerNewFromC(unsafe.Pointer(retC))
...
// AddFilter is a wrapper around the C function webkit_user_content_manager_add_filter.
func (recv *UserContentManager) AddFilter(filter *UserContentFilter) {
	...
	C.webkit_user_content_manager_add_filter((*C.WebKitUserContentManager)(recv.native), c_filter)

	return
}

// AddScript is a wrapper around the C function webkit_user_content_manager_add_script.
func (recv *UserContentManager) AddScript(script *UserScript) {
	c_script := (*C.WebKitUserScript)(C.NULL)
	if script != nil {
		c_script = (*C.WebKitUserScript)(script.ToC())
	}

	C.webkit_user_content_manager_add_script((*C.WebKitUserContentManager)(recv.native), c_script)

	return
}

// AddStyleSheet is a wrapper around the C function webkit_user_content_manager_add_style_sheet.
func (recv *UserContentManager) AddStyleSheet(stylesheet *UserStyleSheet) {
	c_stylesheet := (*C.WebKitUserStyleSheet)(C.NULL)
	if stylesheet != nil {
		c_stylesheet = (*C.WebKitUserStyleSheet)(stylesheet.ToC())
	}

	C.webkit_user_content_manager_add_style_sheet((*C.WebKitUserContentManager)(recv.native), c_stylesheet)

	return
}

// RegisterScriptMessageHandler is a wrapper around the C function webkit_user_content_manager_register_script_message_handler.
func (recv *UserContentManager) RegisterScriptMessageHandler(name string) bool {
	c_name := C.CString(name)
	defer C.free(unsafe.Pointer(c_name))

	retC := C.webkit_user_content_manager_register_script_message_handler((*C.WebKitUserContentManager)(recv.native), c_name)
	retGo := retC == C.TRUE

	return retGo
}

// RegisterScriptMessageHandlerInWorld is a wrapper around the C function webkit_user_content_manager_register_script_message_handler_in_world.
func (recv *UserContentManager) RegisterScriptMessageHandlerInWorld(name string, worldName string) bool {
	c_name := C.CString(name)
	defer C.free(unsafe.Pointer(c_name))

	c_world_name := C.CString(worldName)
	defer C.free(unsafe.Pointer(c_world_name))

	retC := C.webkit_user_content_manager_register_script_message_handler_in_world((*C.WebKitUserContentManager)(recv.native), c_name, c_world_name)
	retGo := retC == C.TRUE

	return retGo
}

// RemoveAllFilters is a wrapper around the C function webkit_user_content_manager_remove_all_filters.
func (recv *UserContentManager) RemoveAllFilters() {
	C.webkit_user_content_manager_remove_all_filters((*C.WebKitUserContentManager)(recv.native))

	return
}

// RemoveAllScripts is a wrapper around the C function webkit_user_content_manager_remove_all_scripts.
func (recv *UserContentManager) RemoveAllScripts() {
	C.webkit_user_content_manager_remove_all_scripts((*C.WebKitUserContentManager)(recv.native))

	return
}

// RemoveAllStyleSheets is a wrapper around the C function webkit_user_content_manager_remove_all_style_sheets.
func (recv *UserContentManager) RemoveAllStyleSheets() {
	C.webkit_user_content_manager_remove_all_style_sheets((*C.WebKitUserContentManager)(recv.native))
...
// RemoveFilterById is a wrapper around the C function webkit_user_content_manager_remove_filter_by_id.
func (recv *UserContentManager) RemoveFilterById(filterId string) {
	c_filter_id := C.CString(filterId)
	defer C.free(unsafe.Pointer(c_filter_id))

	C.webkit_user_content_manager_remove_filter_by_id((*C.WebKitUserContentManager)(recv.native), c_filter_id)

	return
}

// UnregisterScriptMessageHandler is a wrapper around the C function webkit_user_content_manager_unregister_script_message_handler.
func (recv *UserContentManager) UnregisterScriptMessageHandler(name string) {
	c_name := C.CString(name)
	defer C.free(unsafe.Pointer(c_name))

	C.webkit_user_content_manager_unregister_script_message_handler((*C.WebKitUserContentManager)(recv.native), c_name)

	return
}

// UnregisterScriptMessageHandlerInWorld is a wrapper around the C function webkit_user_content_manager_unregister_script_message_handler_in_world.
func (recv *UserContentManager) UnregisterScriptMessageHandlerInWorld(name string, worldName string) {
	...
	C.webkit_user_content_manager_unregister_script_message_handler_in_world((*C.WebKitUserContentManager)(recv.native), c_name, c_world_name)
...
type signalWebContextAutomationStartedDetail struct {
	callback  WebContextSignalAutomationStartedCallback
	handlerID C.gulong
}

var signalWebContextAutomationStartedId int
var signalWebContextAutomationStartedMap = make(map[int]signalWebContextAutomationStartedDetail)
var signalWebContextAutomationStartedLock sync.RWMutex

// WebContextSignalAutomationStartedCallback is a callback function for a 'automation-started' signal emitted from a WebContext.
type WebContextSignalAutomationStartedCallback func(targetObject *WebContext, session *AutomationSession)

/*
ConnectAutomationStarted connects the callback to the 'automation-started' signal for the WebContext.

The returned value represents the connection, and may be passed to DisconnectAutomationStarted to remove it.
*/
func (recv *WebContext) ConnectAutomationStarted(callback WebContextSignalAutomationStartedCallback) int {
	signalWebContextAutomationStartedLock.Lock()
	defer signalWebContextAutomationStartedLock.Unlock()

	signalWebContextAutomationStartedId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebContext_signal_connect_automation_started(instance, C.gpointer(uintptr(signalWebContextAutomationStartedId)))

	detail := signalWebContextAutomationStartedDetail{callback, handlerID}
	signalWebContextAutomationStartedMap[signalWebContextAutomationStartedId] = detail

	return signalWebContextAutomationStartedId
}

/*
DisconnectAutomationStarted disconnects a callback from the 'automation-started' signal for the WebContext.

The connectionID should be a value returned from a call to ConnectAutomationStarted.
*/
func (recv *WebContext) DisconnectAutomationStarted(connectionID int) {
	signalWebContextAutomationStartedLock.Lock()
	defer signalWebContextAutomationStartedLock.Unlock()

	detail, exists := signalWebContextAutomationStartedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebContextAutomationStartedMap, connectionID)
}

//export webcontext_automationStartedHandler
func webcontext_automationStartedHandler(c_targetObject *C.GObject, c_session *C.WebKitAutomationSession, data C.gpointer) {
	signalWebContextAutomationStartedLock.RLock()
	defer signalWebContextAutomationStartedLock.RUnlock()

	session := AutomationSessionNewFromC(unsafe.Pointer(c_session))

	targetObject := WebContextNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebContextAutomationStartedMap[index].callback
	callback(targetObject, session)
}
...
type signalWebContextInitializeNotificationPermissionsDetail struct {
	callback  WebContextSignalInitializeNotificationPermissionsCallback
	handlerID C.gulong
}

var signalWebContextInitializeNotificationPermissionsId int
var signalWebContextInitializeNotificationPermissionsMap = make(map[int]signalWebContextInitializeNotificationPermissionsDetail)
var signalWebContextInitializeNotificationPermissionsLock sync.RWMutex

// WebContextSignalInitializeNotificationPermissionsCallback is a callback function for a 'initialize-notification-permissions' signal emitted from a WebContext.
type WebContextSignalInitializeNotificationPermissionsCallback func(targetObject *WebContext)

/*
ConnectInitializeNotificationPermissions connects the callback to the 'initialize-notification-permissions' signal for the WebContext.

The returned value represents the connection, and may be passed to DisconnectInitializeNotificationPermissions to remove it.
*/
func (recv *WebContext) ConnectInitializeNotificationPermissions(callback WebContextSignalInitializeNotificationPermissionsCallback) int {
	signalWebContextInitializeNotificationPermissionsLock.Lock()
	defer signalWebContextInitializeNotificationPermissionsLock.Unlock()

	signalWebContextInitializeNotificationPermissionsId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebContext_signal_connect_initialize_notification_permissions(instance, C.gpointer(uintptr(signalWebContextInitializeNotificationPermissionsId)))

	detail := signalWebContextInitializeNotificationPermissionsDetail{callback, handlerID}
	signalWebContextInitializeNotificationPermissionsMap[signalWebContextInitializeNotificationPermissionsId] = detail

	return signalWebContextInitializeNotificationPermissionsId
}

/*
DisconnectInitializeNotificationPermissions disconnects a callback from the 'initialize-notification-permissions' signal for the WebContext.

The connectionID should be a value returned from a call to ConnectInitializeNotificationPermissions.
*/
func (recv *WebContext) DisconnectInitializeNotificationPermissions(connectionID int) {
	signalWebContextInitializeNotificationPermissionsLock.Lock()
	defer signalWebContextInitializeNotificationPermissionsLock.Unlock()

	detail, exists := signalWebContextInitializeNotificationPermissionsMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebContextInitializeNotificationPermissionsMap, connectionID)
}

//export webcontext_initializeNotificationPermissionsHandler
func webcontext_initializeNotificationPermissionsHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalWebContextInitializeNotificationPermissionsLock.RLock()
	defer signalWebContextInitializeNotificationPermissionsLock.RUnlock()

	targetObject := WebContextNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebContextInitializeNotificationPermissionsMap[index].callback
	callback(targetObject)
}

type signalWebContextInitializeWebExtensionsDetail struct {
	callback  WebContextSignalInitializeWebExtensionsCallback
	handlerID C.gulong
}

var signalWebContextInitializeWebExtensionsId int
var signalWebContextInitializeWebExtensionsMap = make(map[int]signalWebContextInitializeWebExtensionsDetail)
var signalWebContextInitializeWebExtensionsLock sync.RWMutex

// WebContextSignalInitializeWebExtensionsCallback is a callback function for a 'initialize-web-extensions' signal emitted from a WebContext.
type WebContextSignalInitializeWebExtensionsCallback func(targetObject *WebContext)

/*
ConnectInitializeWebExtensions connects the callback to the 'initialize-web-extensions' signal for the WebContext.

The returned value represents the connection, and may be passed to DisconnectInitializeWebExtensions to remove it.
*/
func (recv *WebContext) ConnectInitializeWebExtensions(callback WebContextSignalInitializeWebExtensionsCallback) int {
	signalWebContextInitializeWebExtensionsLock.Lock()
	defer signalWebContextInitializeWebExtensionsLock.Unlock()

	signalWebContextInitializeWebExtensionsId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebContext_signal_connect_initialize_web_extensions(instance, C.gpointer(uintptr(signalWebContextInitializeWebExtensionsId)))

	detail := signalWebContextInitializeWebExtensionsDetail{callback, handlerID}
	signalWebContextInitializeWebExtensionsMap[signalWebContextInitializeWebExtensionsId] = detail

	return signalWebContextInitializeWebExtensionsId
}

/*
DisconnectInitializeWebExtensions disconnects a callback from the 'initialize-web-extensions' signal for the WebContext.

The connectionID should be a value returned from a call to ConnectInitializeWebExtensions.
*/
func (recv *WebContext) DisconnectInitializeWebExtensions(connectionID int) {
	signalWebContextInitializeWebExtensionsLock.Lock()
	defer signalWebContextInitializeWebExtensionsLock.Unlock()

	detail, exists := signalWebContextInitializeWebExtensionsMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebContextInitializeWebExtensionsMap, connectionID)
}

//export webcontext_initializeWebExtensionsHandler
func webcontext_initializeWebExtensionsHandler(c_targetObject *C.GObject, data C.gpointer) {
	signalWebContextInitializeWebExtensionsLock.RLock()
	defer signalWebContextInitializeWebExtensionsLock.RUnlock()

	targetObject := WebContextNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebContextInitializeWebExtensionsMap[index].callback
	callback(targetObject)
}

// WebContextNew is a wrapper around the C function webkit_web_context_new.
func WebContextNew() *WebContext {
	retC := C.webkit_web_context_new()
...
// WebContextNewEphemeral is a wrapper around the C function webkit_web_context_new_ephemeral.
func WebContextNewEphemeral() *WebContext {
	retC := C.webkit_web_context_new_ephemeral()
	retGo := WebContextNewFromC(unsafe.Pointer(retC))
...
// WebContextNewWithWebsiteDataManager is a wrapper around the C function webkit_web_context_new_with_website_data_manager.
func WebContextNewWithWebsiteDataManager(manager *WebsiteDataManager) *WebContext {
	c_manager := (*C.WebKitWebsiteDataManager)(C.NULL)
	if manager != nil {
		c_manager = (*C.WebKitWebsiteDataManager)(manager.ToC())
	}

	retC := C.webkit_web_context_new_with_website_data_manager(c_manager)
	retGo := WebContextNewFromC(unsafe.Pointer(retC))
...
// AddPathToSandbox is a wrapper around the C function webkit_web_context_add_path_to_sandbox.
func (recv *WebContext) AddPathToSandbox(path string, readOnly bool) {
	...
	C.webkit_web_context_add_path_to_sandbox((*C.WebKitWebContext)(recv.native), c_path, c_read_only)
...
// GetGeolocationManager is a wrapper around the C function webkit_web_context_get_geolocation_manager.
func (recv *WebContext) GetGeolocationManager() *GeolocationManager {
	retC := C.webkit_web_context_get_geolocation_manager((*C.WebKitWebContext)(recv.native))
	retGo := GeolocationManagerNewFromC(unsafe.Pointer(retC))
...
// GetProcessModel is a wrapper around the C function webkit_web_context_get_process_model.
func (recv *WebContext) GetProcessModel() ProcessModel {
	retC := C.webkit_web_context_get_process_model((*C.WebKitWebContext)(recv.native))
	retGo := (ProcessModel)(retC)

	return retGo
}

// GetSandboxEnabled is a wrapper around the C function webkit_web_context_get_sandbox_enabled.
func (recv *WebContext) GetSandboxEnabled() bool {
	retC := C.webkit_web_context_get_sandbox_enabled((*C.WebKitWebContext)(recv.native))
	retGo := retC == C.TRUE
...
// GetWebProcessCountLimit is a wrapper around the C function webkit_web_context_get_web_process_count_limit.
func (recv *WebContext) GetWebProcessCountLimit() uint32 {
	retC := C.webkit_web_context_get_web_process_count_limit((*C.WebKitWebContext)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// GetWebsiteDataManager is a wrapper around the C function webkit_web_context_get_website_data_manager.
func (recv *WebContext) GetWebsiteDataManager() *WebsiteDataManager {
	retC := C.webkit_web_context_get_website_data_manager((*C.WebKitWebContext)(recv.native))
	retGo := WebsiteDataManagerNewFromC(unsafe.Pointer(retC))

	return retGo
}

// InitializeNotificationPermissions is a wrapper around the C function webkit_web_context_initialize_notification_permissions.
func (recv *WebContext) InitializeNotificationPermissions(allowedOrigins *glib.List, disallowedOrigins *glib.List) {
	c_allowed_origins := (*C.GList)(C.NULL)
	if allowedOrigins != nil {
		c_allowed_origins = (*C.GList)(allowedOrigins.ToC())
	}

	c_disallowed_origins := (*C.GList)(C.NULL)
	if disallowedOrigins != nil {
		c_disallowed_origins = (*C.GList)(disallowedOrigins.ToC())
	}

	C.webkit_web_context_initialize_notification_permissions((*C.WebKitWebContext)(recv.native), c_allowed_origins, c_disallowed_origins)

	return
}

// IsAutomationAllowed is a wrapper around the C function webkit_web_context_is_automation_allowed.
func (recv *WebContext) IsAutomationAllowed() bool {
	retC := C.webkit_web_context_is_automation_allowed((*C.WebKitWebContext)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsEphemeral is a wrapper around the C function webkit_web_context_is_ephemeral.
func (recv *WebContext) IsEphemeral() bool {
	retC := C.webkit_web_context_is_ephemeral((*C.WebKitWebContext)(recv.native))
	retGo := retC == C.TRUE
...
// SetAutomationAllowed is a wrapper around the C function webkit_web_context_set_automation_allowed.
func (recv *WebContext) SetAutomationAllowed(allowed bool) {
	c_allowed :=
		boolToGboolean(allowed)

	C.webkit_web_context_set_automation_allowed((*C.WebKitWebContext)(recv.native), c_allowed)
...
// SetNetworkProxySettings is a wrapper around the C function webkit_web_context_set_network_proxy_settings.
func (recv *WebContext) SetNetworkProxySettings(proxyMode NetworkProxyMode, proxySettings *NetworkProxySettings) {
	c_proxy_mode := (C.WebKitNetworkProxyMode)(proxyMode)

	c_proxy_settings := (*C.WebKitNetworkProxySettings)(C.NULL)
	if proxySettings != nil {
		c_proxy_settings = (*C.WebKitNetworkProxySettings)(proxySettings.ToC())
	}

	C.webkit_web_context_set_network_proxy_settings((*C.WebKitWebContext)(recv.native), c_proxy_mode, c_proxy_settings)
...
// SetProcessModel is a wrapper around the C function webkit_web_context_set_process_model.
func (recv *WebContext) SetProcessModel(processModel ProcessModel) {
	c_process_model := (C.WebKitProcessModel)(processModel)

	C.webkit_web_context_set_process_model((*C.WebKitWebContext)(recv.native), c_process_model)

	return
}

// SetSandboxEnabled is a wrapper around the C function webkit_web_context_set_sandbox_enabled.
func (recv *WebContext) SetSandboxEnabled(enabled bool) {
	c_enabled :=
		boolToGboolean(enabled)

	C.webkit_web_context_set_sandbox_enabled((*C.WebKitWebContext)(recv.native), c_enabled)
...
// SetWebProcessCountLimit is a wrapper around the C function webkit_web_context_set_web_process_count_limit.
func (recv *WebContext) SetWebProcessCountLimit(limit uint32) {
	c_limit := (C.guint)(limit)

	C.webkit_web_context_set_web_process_count_limit((*C.WebKitWebContext)(recv.native), c_limit)
...
// GetCanAttach is a wrapper around the C function webkit_web_inspector_get_can_attach.
func (recv *WebInspector) GetCanAttach() bool {
	retC := C.webkit_web_inspector_get_can_attach((*C.WebKitWebInspector)(recv.native))
	retGo := retC == C.TRUE
...
type signalWebResourceFailedWithTlsErrorsDetail struct {
	callback  WebResourceSignalFailedWithTlsErrorsCallback
	handlerID C.gulong
}

var signalWebResourceFailedWithTlsErrorsId int
var signalWebResourceFailedWithTlsErrorsMap = make(map[int]signalWebResourceFailedWithTlsErrorsDetail)
var signalWebResourceFailedWithTlsErrorsLock sync.RWMutex

// WebResourceSignalFailedWithTlsErrorsCallback is a callback function for a 'failed-with-tls-errors' signal emitted from a WebResource.
type WebResourceSignalFailedWithTlsErrorsCallback func(targetObject *WebResource, certificate *gio.TlsCertificate, errors gio.TlsCertificateFlags)

/*
ConnectFailedWithTlsErrors connects the callback to the 'failed-with-tls-errors' signal for the WebResource.

The returned value represents the connection, and may be passed to DisconnectFailedWithTlsErrors to remove it.
*/
func (recv *WebResource) ConnectFailedWithTlsErrors(callback WebResourceSignalFailedWithTlsErrorsCallback) int {
	signalWebResourceFailedWithTlsErrorsLock.Lock()
	defer signalWebResourceFailedWithTlsErrorsLock.Unlock()

	signalWebResourceFailedWithTlsErrorsId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebResource_signal_connect_failed_with_tls_errors(instance, C.gpointer(uintptr(signalWebResourceFailedWithTlsErrorsId)))

	detail := signalWebResourceFailedWithTlsErrorsDetail{callback, handlerID}
	signalWebResourceFailedWithTlsErrorsMap[signalWebResourceFailedWithTlsErrorsId] = detail

	return signalWebResourceFailedWithTlsErrorsId
}

/*
DisconnectFailedWithTlsErrors disconnects a callback from the 'failed-with-tls-errors' signal for the WebResource.

The connectionID should be a value returned from a call to ConnectFailedWithTlsErrors.
*/
func (recv *WebResource) DisconnectFailedWithTlsErrors(connectionID int) {
	signalWebResourceFailedWithTlsErrorsLock.Lock()
	defer signalWebResourceFailedWithTlsErrorsLock.Unlock()

	detail, exists := signalWebResourceFailedWithTlsErrorsMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebResourceFailedWithTlsErrorsMap, connectionID)
}

//export webresource_failedWithTlsErrorsHandler
func webresource_failedWithTlsErrorsHandler(c_targetObject *C.GObject, c_certificate *C.GTlsCertificate, c_errors C.GTlsCertificateFlags, data C.gpointer) {
	signalWebResourceFailedWithTlsErrorsLock.RLock()
	defer signalWebResourceFailedWithTlsErrorsLock.RUnlock()
	...
	index := int(uintptr(data))
	callback := signalWebResourceFailedWithTlsErrorsMap[index].callback
	callback(targetObject, certificate, errors)
}
...
type signalWebViewAuthenticateDetail struct {
	callback  WebViewSignalAuthenticateCallback
	handlerID C.gulong
}

var signalWebViewAuthenticateId int
var signalWebViewAuthenticateMap = make(map[int]signalWebViewAuthenticateDetail)
var signalWebViewAuthenticateLock sync.RWMutex

// WebViewSignalAuthenticateCallback is a callback function for a 'authenticate' signal emitted from a WebView.
type WebViewSignalAuthenticateCallback func(targetObject *WebView, request *AuthenticationRequest) bool

/*
ConnectAuthenticate connects the callback to the 'authenticate' signal for the WebView.

The returned value represents the connection, and may be passed to DisconnectAuthenticate to remove it.
*/
func (recv *WebView) ConnectAuthenticate(callback WebViewSignalAuthenticateCallback) int {
	signalWebViewAuthenticateLock.Lock()
	defer signalWebViewAuthenticateLock.Unlock()

	signalWebViewAuthenticateId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebView_signal_connect_authenticate(instance, C.gpointer(uintptr(signalWebViewAuthenticateId)))

	detail := signalWebViewAuthenticateDetail{callback, handlerID}
	signalWebViewAuthenticateMap[signalWebViewAuthenticateId] = detail

	return signalWebViewAuthenticateId
}

/*
DisconnectAuthenticate disconnects a callback from the 'authenticate' signal for the WebView.

The connectionID should be a value returned from a call to ConnectAuthenticate.
*/
func (recv *WebView) DisconnectAuthenticate(connectionID int) {
	signalWebViewAuthenticateLock.Lock()
	defer signalWebViewAuthenticateLock.Unlock()

	detail, exists := signalWebViewAuthenticateMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebViewAuthenticateMap, connectionID)
}

//export webview_authenticateHandler
func webview_authenticateHandler(c_targetObject *C.GObject, c_request *C.WebKitAuthenticationRequest, data C.gpointer) C.gboolean {
	signalWebViewAuthenticateLock.RLock()
	defer signalWebViewAuthenticateLock.RUnlock()

	request := AuthenticationRequestNewFromC(unsafe.Pointer(c_request))

	targetObject := WebViewNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebViewAuthenticateMap[index].callback
...
type signalWebViewLoadFailedWithTlsErrorsDetail struct {
	callback  WebViewSignalLoadFailedWithTlsErrorsCallback
	handlerID C.gulong
}

var signalWebViewLoadFailedWithTlsErrorsId int
var signalWebViewLoadFailedWithTlsErrorsMap = make(map[int]signalWebViewLoadFailedWithTlsErrorsDetail)
var signalWebViewLoadFailedWithTlsErrorsLock sync.RWMutex

// WebViewSignalLoadFailedWithTlsErrorsCallback is a callback function for a 'load-failed-with-tls-errors' signal emitted from a WebView.
type WebViewSignalLoadFailedWithTlsErrorsCallback func(targetObject *WebView, failingUri string, certificate *gio.TlsCertificate, errors gio.TlsCertificateFlags) bool

/*
ConnectLoadFailedWithTlsErrors connects the callback to the 'load-failed-with-tls-errors' signal for the WebView.

The returned value represents the connection, and may be passed to DisconnectLoadFailedWithTlsErrors to remove it.
*/
func (recv *WebView) ConnectLoadFailedWithTlsErrors(callback WebViewSignalLoadFailedWithTlsErrorsCallback) int {
	signalWebViewLoadFailedWithTlsErrorsLock.Lock()
	defer signalWebViewLoadFailedWithTlsErrorsLock.Unlock()

	signalWebViewLoadFailedWithTlsErrorsId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebView_signal_connect_load_failed_with_tls_errors(instance, C.gpointer(uintptr(signalWebViewLoadFailedWithTlsErrorsId)))

	detail := signalWebViewLoadFailedWithTlsErrorsDetail{callback, handlerID}
	signalWebViewLoadFailedWithTlsErrorsMap[signalWebViewLoadFailedWithTlsErrorsId] = detail

	return signalWebViewLoadFailedWithTlsErrorsId
}

/*
DisconnectLoadFailedWithTlsErrors disconnects a callback from the 'load-failed-with-tls-errors' signal for the WebView.

The connectionID should be a value returned from a call to ConnectLoadFailedWithTlsErrors.
*/
func (recv *WebView) DisconnectLoadFailedWithTlsErrors(connectionID int) {
	signalWebViewLoadFailedWithTlsErrorsLock.Lock()
	defer signalWebViewLoadFailedWithTlsErrorsLock.Unlock()

	detail, exists := signalWebViewLoadFailedWithTlsErrorsMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebViewLoadFailedWithTlsErrorsMap, connectionID)
}

//export webview_loadFailedWithTlsErrorsHandler
func webview_loadFailedWithTlsErrorsHandler(c_targetObject *C.GObject, c_failing_uri *C.gchar, c_certificate *C.GTlsCertificate, c_errors C.GTlsCertificateFlags, data C.gpointer) C.gboolean {
	signalWebViewLoadFailedWithTlsErrorsLock.RLock()
	defer signalWebViewLoadFailedWithTlsErrorsLock.RUnlock()
	...
	index := int(uintptr(data))
	callback := signalWebViewLoadFailedWithTlsErrorsMap[index].callback
	retGo := callback(targetObject, failingUri, certificate, errors)
	retC :=
		boolToGboolean(retGo)
	return retC
}
...
type signalWebViewRunColorChooserDetail struct {
	callback  WebViewSignalRunColorChooserCallback
	handlerID C.gulong
}

var signalWebViewRunColorChooserId int
var signalWebViewRunColorChooserMap = make(map[int]signalWebViewRunColorChooserDetail)
var signalWebViewRunColorChooserLock sync.RWMutex

// WebViewSignalRunColorChooserCallback is a callback function for a 'run-color-chooser' signal emitted from a WebView.
type WebViewSignalRunColorChooserCallback func(targetObject *WebView, request *ColorChooserRequest) bool

/*
ConnectRunColorChooser connects the callback to the 'run-color-chooser' signal for the WebView.

The returned value represents the connection, and may be passed to DisconnectRunColorChooser to remove it.
*/
func (recv *WebView) ConnectRunColorChooser(callback WebViewSignalRunColorChooserCallback) int {
	signalWebViewRunColorChooserLock.Lock()
	defer signalWebViewRunColorChooserLock.Unlock()

	signalWebViewRunColorChooserId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebView_signal_connect_run_color_chooser(instance, C.gpointer(uintptr(signalWebViewRunColorChooserId)))

	detail := signalWebViewRunColorChooserDetail{callback, handlerID}
	signalWebViewRunColorChooserMap[signalWebViewRunColorChooserId] = detail

	return signalWebViewRunColorChooserId
}

/*
DisconnectRunColorChooser disconnects a callback from the 'run-color-chooser' signal for the WebView.

The connectionID should be a value returned from a call to ConnectRunColorChooser.
*/
func (recv *WebView) DisconnectRunColorChooser(connectionID int) {
	signalWebViewRunColorChooserLock.Lock()
	defer signalWebViewRunColorChooserLock.Unlock()

	detail, exists := signalWebViewRunColorChooserMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebViewRunColorChooserMap, connectionID)
}

//export webview_runColorChooserHandler
func webview_runColorChooserHandler(c_targetObject *C.GObject, c_request *C.WebKitColorChooserRequest, data C.gpointer) C.gboolean {
	signalWebViewRunColorChooserLock.RLock()
	defer signalWebViewRunColorChooserLock.RUnlock()

	request := ColorChooserRequestNewFromC(unsafe.Pointer(c_request))

	targetObject := WebViewNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebViewRunColorChooserMap[index].callback
	retGo := callback(targetObject, request)
	retC :=
		boolToGboolean(retGo)
	return retC
...
type signalWebViewShowNotificationDetail struct {
	callback  WebViewSignalShowNotificationCallback
	handlerID C.gulong
}

var signalWebViewShowNotificationId int
var signalWebViewShowNotificationMap = make(map[int]signalWebViewShowNotificationDetail)
var signalWebViewShowNotificationLock sync.RWMutex

// WebViewSignalShowNotificationCallback is a callback function for a 'show-notification' signal emitted from a WebView.
type WebViewSignalShowNotificationCallback func(targetObject *WebView, notification *Notification) bool

/*
ConnectShowNotification connects the callback to the 'show-notification' signal for the WebView.

The returned value represents the connection, and may be passed to DisconnectShowNotification to remove it.
*/
func (recv *WebView) ConnectShowNotification(callback WebViewSignalShowNotificationCallback) int {
	signalWebViewShowNotificationLock.Lock()
	defer signalWebViewShowNotificationLock.Unlock()

	signalWebViewShowNotificationId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebView_signal_connect_show_notification(instance, C.gpointer(uintptr(signalWebViewShowNotificationId)))

	detail := signalWebViewShowNotificationDetail{callback, handlerID}
	signalWebViewShowNotificationMap[signalWebViewShowNotificationId] = detail

	return signalWebViewShowNotificationId
}

/*
DisconnectShowNotification disconnects a callback from the 'show-notification' signal for the WebView.

The connectionID should be a value returned from a call to ConnectShowNotification.
*/
func (recv *WebView) DisconnectShowNotification(connectionID int) {
	signalWebViewShowNotificationLock.Lock()
	defer signalWebViewShowNotificationLock.Unlock()

	detail, exists := signalWebViewShowNotificationMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebViewShowNotificationMap, connectionID)
}

//export webview_showNotificationHandler
func webview_showNotificationHandler(c_targetObject *C.GObject, c_notification *C.WebKitNotification, data C.gpointer) C.gboolean {
	signalWebViewShowNotificationLock.RLock()
	defer signalWebViewShowNotificationLock.RUnlock()

	notification := NotificationNewFromC(unsafe.Pointer(c_notification))

	targetObject := WebViewNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebViewShowNotificationMap[index].callback
	retGo := callback(targetObject, notification)
	retC :=
		boolToGboolean(retGo)
	return retC
}
...
type signalWebViewWebProcessTerminatedDetail struct {
	callback  WebViewSignalWebProcessTerminatedCallback
	handlerID C.gulong
}

var signalWebViewWebProcessTerminatedId int
var signalWebViewWebProcessTerminatedMap = make(map[int]signalWebViewWebProcessTerminatedDetail)
var signalWebViewWebProcessTerminatedLock sync.RWMutex

// WebViewSignalWebProcessTerminatedCallback is a callback function for a 'web-process-terminated' signal emitted from a WebView.
type WebViewSignalWebProcessTerminatedCallback func(targetObject *WebView, reason WebProcessTerminationReason)

/*
ConnectWebProcessTerminated connects the callback to the 'web-process-terminated' signal for the WebView.

The returned value represents the connection, and may be passed to DisconnectWebProcessTerminated to remove it.
*/
func (recv *WebView) ConnectWebProcessTerminated(callback WebViewSignalWebProcessTerminatedCallback) int {
	signalWebViewWebProcessTerminatedLock.Lock()
	defer signalWebViewWebProcessTerminatedLock.Unlock()

	signalWebViewWebProcessTerminatedId++
	instance := C.gpointer(recv.native)
	handlerID := C.WebView_signal_connect_web_process_terminated(instance, C.gpointer(uintptr(signalWebViewWebProcessTerminatedId)))

	detail := signalWebViewWebProcessTerminatedDetail{callback, handlerID}
	signalWebViewWebProcessTerminatedMap[signalWebViewWebProcessTerminatedId] = detail

	return signalWebViewWebProcessTerminatedId
}

/*
DisconnectWebProcessTerminated disconnects a callback from the 'web-process-terminated' signal for the WebView.

The connectionID should be a value returned from a call to ConnectWebProcessTerminated.
*/
func (recv *WebView) DisconnectWebProcessTerminated(connectionID int) {
	signalWebViewWebProcessTerminatedLock.Lock()
	defer signalWebViewWebProcessTerminatedLock.Unlock()

	detail, exists := signalWebViewWebProcessTerminatedMap[connectionID]
	if !exists {
		return
	}
	...
	instance := C.gpointer(recv.native)
	C.g_signal_handler_disconnect(instance, detail.handlerID)
	delete(signalWebViewWebProcessTerminatedMap, connectionID)
}

//export webview_webProcessTerminatedHandler
func webview_webProcessTerminatedHandler(c_targetObject *C.GObject, c_reason C.WebKitWebProcessTerminationReason, data C.gpointer) {
	signalWebViewWebProcessTerminatedLock.RLock()
	defer signalWebViewWebProcessTerminatedLock.RUnlock()

	reason := WebProcessTerminationReason(c_reason)

	targetObject := WebViewNewFromC((unsafe.Pointer)(c_targetObject))

	index := int(uintptr(data))
	callback := signalWebViewWebProcessTerminatedMap[index].callback
	callback(targetObject, reason)
}
...
// WebViewNewWithRelatedView is a wrapper around the C function webkit_web_view_new_with_related_view.
...
// WebViewNewWithSettings is a wrapper around the C function webkit_web_view_new_with_settings.
func WebViewNewWithSettings(settings *Settings) *WebView {
	...
	retC := C.webkit_web_view_new_with_settings(c_settings)
	retGo := WebViewNewFromC(unsafe.Pointer(retC))

	return retGo
}

// WebViewNewWithUserContentManager is a wrapper around the C function webkit_web_view_new_with_user_content_manager.
func WebViewNewWithUserContentManager(userContentManager *UserContentManager) *WebView {
	c_user_content_manager := (*C.WebKitUserContentManager)(C.NULL)
	if userContentManager != nil {
		c_user_content_manager = (*C.WebKitUserContentManager)(userContentManager.ToC())
	}

	retC := C.webkit_web_view_new_with_user_content_manager(c_user_content_manager)
	retGo := WebViewNewFromC(unsafe.Pointer(retC))
...
// ExecuteEditingCommandWithArgument is a wrapper around the C function webkit_web_view_execute_editing_command_with_argument.
func (recv *WebView) ExecuteEditingCommandWithArgument(command string, argument string) {
	c_command := C.CString(command)
	defer C.free(unsafe.Pointer(c_command))

	c_argument := C.CString(argument)
	defer C.free(unsafe.Pointer(c_argument))

	C.webkit_web_view_execute_editing_command_with_argument((*C.WebKitWebView)(recv.native), c_command, c_argument)
...
// GetBackgroundColor is a wrapper around the C function webkit_web_view_get_background_color.
func (recv *WebView) GetBackgroundColor() *gdk.RGBA {
	var c_rgba C.GdkRGBA

	C.webkit_web_view_get_background_color((*C.WebKitWebView)(recv.native), &c_rgba)
...
// GetEditorState is a wrapper around the C function webkit_web_view_get_editor_state.
func (recv *WebView) GetEditorState() *EditorState {
	retC := C.webkit_web_view_get_editor_state((*C.WebKitWebView)(recv.native))
	retGo := EditorStateNewFromC(unsafe.Pointer(retC))
...
// GetSessionState is a wrapper around the C function webkit_web_view_get_session_state.
func (recv *WebView) GetSessionState() *WebViewSessionState {
	retC := C.webkit_web_view_get_session_state((*C.WebKitWebView)(recv.native))
...
// GetUserContentManager is a wrapper around the C function webkit_web_view_get_user_content_manager.
func (recv *WebView) GetUserContentManager() *UserContentManager {
	retC := C.webkit_web_view_get_user_content_manager((*C.WebKitWebView)(recv.native))
	retGo := UserContentManagerNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetWebsiteDataManager is a wrapper around the C function webkit_web_view_get_website_data_manager.
func (recv *WebView) GetWebsiteDataManager() *WebsiteDataManager {
	retC := C.webkit_web_view_get_website_data_manager((*C.WebKitWebView)(recv.native))
	retGo := WebsiteDataManagerNewFromC(unsafe.Pointer(retC))
...
// IsControlledByAutomation is a wrapper around the C function webkit_web_view_is_controlled_by_automation.
func (recv *WebView) IsControlledByAutomation() bool {
	retC := C.webkit_web_view_is_controlled_by_automation((*C.WebKitWebView)(recv.native))
	retGo := retC == C.TRUE
...
// IsEphemeral is a wrapper around the C function webkit_web_view_is_ephemeral.
func (recv *WebView) IsEphemeral() bool {
	retC := C.webkit_web_view_is_ephemeral((*C.WebKitWebView)(recv.native))
	retGo := retC == C.TRUE
...
// IsPlayingAudio is a wrapper around the C function webkit_web_view_is_playing_audio.
func (recv *WebView) IsPlayingAudio() bool {
	retC := C.webkit_web_view_is_playing_audio((*C.WebKitWebView)(recv.native))
	retGo := retC == C.TRUE
...
// RestoreSessionState is a wrapper around the C function webkit_web_view_restore_session_state.
func (recv *WebView) RestoreSessionState(state *WebViewSessionState) {
	c_state := (*C.WebKitWebViewSessionState)(C.NULL)
	if state != nil {
		c_state = (*C.WebKitWebViewSessionState)(state.ToC())
	}

	C.webkit_web_view_restore_session_state((*C.WebKitWebView)(recv.native), c_state)
...
// Unsupported : webkit_web_view_run_javascript_in_world : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// RunJavascriptInWorldFinish is a wrapper around the C function webkit_web_view_run_javascript_in_world_finish.
func (recv *WebView) RunJavascriptInWorldFinish(result *gio.AsyncResult) (*JavascriptResult, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_web_view_run_javascript_in_world_finish((*C.WebKitWebView)(recv.native), c_result, &cThrowableError)
	retGo := JavascriptResultNewFromC(unsafe.Pointer(retC))
...
// SetBackgroundColor is a wrapper around the C function webkit_web_view_set_background_color.
func (recv *WebView) SetBackgroundColor(rgba *gdk.RGBA) {
	...
	C.webkit_web_view_set_background_color((*C.WebKitWebView)(recv.native), c_rgba)
...
// SetEditable is a wrapper around the C function webkit_web_view_set_editable.
func (recv *WebView) SetEditable(editable bool) {
	c_editable :=
		boolToGboolean(editable)

	C.webkit_web_view_set_editable((*C.WebKitWebView)(recv.native), c_editable)
...
// TryClose is a wrapper around the C function webkit_web_view_try_close.
func (recv *WebView) TryClose() {
	C.webkit_web_view_try_close((*C.WebKitWebView)(recv.native))
...
// Unsupported : webkit_website_data_manager_new : unsupported parameter ... : varargs

// WebsiteDataManagerNewEphemeral is a wrapper around the C function webkit_website_data_manager_new_ephemeral.
func WebsiteDataManagerNewEphemeral() *WebsiteDataManager {
	retC := C.webkit_website_data_manager_new_ephemeral()
	retGo := WebsiteDataManagerNewFromC(unsafe.Pointer(retC))
...
// Unsupported : webkit_website_data_manager_clear : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// ClearFinish is a wrapper around the C function webkit_website_data_manager_clear_finish.
func (recv *WebsiteDataManager) ClearFinish(result *gio.AsyncResult) (bool, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_website_data_manager_clear_finish((*C.WebKitWebsiteDataManager)(recv.native), c_result, &cThrowableError)
	retGo := retC == C.TRUE
...
// Unsupported : webkit_website_data_manager_fetch : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// FetchFinish is a wrapper around the C function webkit_website_data_manager_fetch_finish.
func (recv *WebsiteDataManager) FetchFinish(result *gio.AsyncResult) (*glib.List, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_website_data_manager_fetch_finish((*C.WebKitWebsiteDataManager)(recv.native), c_result, &cThrowableError)
	retGo := glib.ListNewFromC(unsafe.Pointer(retC))
...
// GetBaseCacheDirectory is a wrapper around the C function webkit_website_data_manager_get_base_cache_directory.
func (recv *WebsiteDataManager) GetBaseCacheDirectory() string {
	retC := C.webkit_website_data_manager_get_base_cache_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetBaseDataDirectory is a wrapper around the C function webkit_website_data_manager_get_base_data_directory.
func (recv *WebsiteDataManager) GetBaseDataDirectory() string {
	retC := C.webkit_website_data_manager_get_base_data_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetCookieManager is a wrapper around the C function webkit_website_data_manager_get_cookie_manager.
func (recv *WebsiteDataManager) GetCookieManager() *CookieManager {
	retC := C.webkit_website_data_manager_get_cookie_manager((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := CookieManagerNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetDiskCacheDirectory is a wrapper around the C function webkit_website_data_manager_get_disk_cache_directory.
func (recv *WebsiteDataManager) GetDiskCacheDirectory() string {
	retC := C.webkit_website_data_manager_get_disk_cache_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetHstsCacheDirectory is a wrapper around the C function webkit_website_data_manager_get_hsts_cache_directory.
func (recv *WebsiteDataManager) GetHstsCacheDirectory() string {
	retC := C.webkit_website_data_manager_get_hsts_cache_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetIndexeddbDirectory is a wrapper around the C function webkit_website_data_manager_get_indexeddb_directory.
func (recv *WebsiteDataManager) GetIndexeddbDirectory() string {
	retC := C.webkit_website_data_manager_get_indexeddb_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetLocalStorageDirectory is a wrapper around the C function webkit_website_data_manager_get_local_storage_directory.
func (recv *WebsiteDataManager) GetLocalStorageDirectory() string {
	retC := C.webkit_website_data_manager_get_local_storage_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetOfflineApplicationCacheDirectory is a wrapper around the C function webkit_website_data_manager_get_offline_application_cache_directory.
func (recv *WebsiteDataManager) GetOfflineApplicationCacheDirectory() string {
	retC := C.webkit_website_data_manager_get_offline_application_cache_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetWebsqlDirectory is a wrapper around the C function webkit_website_data_manager_get_websql_directory.
func (recv *WebsiteDataManager) GetWebsqlDirectory() string {
	retC := C.webkit_website_data_manager_get_websql_directory((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// IsEphemeral is a wrapper around the C function webkit_website_data_manager_is_ephemeral.
func (recv *WebsiteDataManager) IsEphemeral() bool {
	retC := C.webkit_website_data_manager_is_ephemeral((*C.WebKitWebsiteDataManager)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// Unsupported : webkit_website_data_manager_remove : unsupported parameter callback : no type generator for Gio.AsyncReadyCallback (GAsyncReadyCallback) for param callback

// RemoveFinish is a wrapper around the C function webkit_website_data_manager_remove_finish.
func (recv *WebsiteDataManager) RemoveFinish(result *gio.AsyncResult) (bool, error) {
	c_result := (*C.GAsyncResult)(result.ToC())

	var cThrowableError *C.GError

	retC := C.webkit_website_data_manager_remove_finish((*C.WebKitWebsiteDataManager)(recv.native), c_result, &cThrowableError)
	retGo := retC == C.TRUE
...
const EDITING_COMMAND_CREATE_LINK string = C.WEBKIT_EDITING_COMMAND_CREATE_LINK
const EDITING_COMMAND_CUT string = C.WEBKIT_EDITING_COMMAND_CUT
const EDITING_COMMAND_INSERT_IMAGE string = C.WEBKIT_EDITING_COMMAND_INSERT_IMAGE
...
type AuthenticationScheme C.WebKitAuthenticationScheme

const (
	WEBKIT_AUTHENTICATION_SCHEME_DEFAULT                           AuthenticationScheme = 1
	WEBKIT_AUTHENTICATION_SCHEME_HTTP_BASIC                        AuthenticationScheme = 2
	WEBKIT_AUTHENTICATION_SCHEME_HTTP_DIGEST                       AuthenticationScheme = 3
	WEBKIT_AUTHENTICATION_SCHEME_HTML_FORM                         AuthenticationScheme = 4
	WEBKIT_AUTHENTICATION_SCHEME_NTLM                              AuthenticationScheme = 5
	WEBKIT_AUTHENTICATION_SCHEME_NEGOTIATE                         AuthenticationScheme = 6
	WEBKIT_AUTHENTICATION_SCHEME_CLIENT_CERTIFICATE_REQUESTED      AuthenticationScheme = 7
	WEBKIT_AUTHENTICATION_SCHEME_SERVER_TRUST_EVALUATION_REQUESTED AuthenticationScheme = 8
	WEBKIT_AUTHENTICATION_SCHEME_UNKNOWN                           AuthenticationScheme = 100
)
...
type CredentialPersistence C.WebKitCredentialPersistence

const (
	WEBKIT_CREDENTIAL_PERSISTENCE_NONE        CredentialPersistence = 0
	WEBKIT_CREDENTIAL_PERSISTENCE_FOR_SESSION CredentialPersistence = 1
	WEBKIT_CREDENTIAL_PERSISTENCE_PERMANENT   CredentialPersistence = 2
)
...
type HardwareAccelerationPolicy C.WebKitHardwareAccelerationPolicy

const (
	WEBKIT_HARDWARE_ACCELERATION_POLICY_ON_DEMAND HardwareAccelerationPolicy = 0
	WEBKIT_HARDWARE_ACCELERATION_POLICY_ALWAYS    HardwareAccelerationPolicy = 1
	WEBKIT_HARDWARE_ACCELERATION_POLICY_NEVER     HardwareAccelerationPolicy = 2
)
...
type NetworkProxyMode C.WebKitNetworkProxyMode
...
type ProcessModel C.WebKitProcessModel

const (
	WEBKIT_PROCESS_MODEL_SHARED_SECONDARY_PROCESS     ProcessModel = 0
	WEBKIT_PROCESS_MODEL_MULTIPLE_SECONDARY_PROCESSES ProcessModel = 1
)
...
type UserContentFilterError C.WebKitUserContentFilterError

const (
	WEBKIT_USER_CONTENT_FILTER_ERROR_INVALID_SOURCE UserContentFilterError = 0
	WEBKIT_USER_CONTENT_FILTER_ERROR_NOT_FOUND      UserContentFilterError = 1
)

// UserContentFilterErrorQuark is a wrapper around the C function webkit_user_content_filter_error_quark.
func UserContentFilterErrorQuark() glib.Quark {
	retC := C.webkit_user_content_filter_error_quark()
	retGo := (glib.Quark)(retC)

	return retGo
}

type UserContentInjectedFrames C.WebKitUserContentInjectedFrames

const (
	WEBKIT_USER_CONTENT_INJECT_ALL_FRAMES UserContentInjectedFrames = 0
	WEBKIT_USER_CONTENT_INJECT_TOP_FRAME  UserContentInjectedFrames = 1
)

type UserScriptInjectionTime C.WebKitUserScriptInjectionTime

const (
	WEBKIT_USER_SCRIPT_INJECT_AT_DOCUMENT_START UserScriptInjectionTime = 0
	WEBKIT_USER_SCRIPT_INJECT_AT_DOCUMENT_END   UserScriptInjectionTime = 1
)

type UserStyleLevel C.WebKitUserStyleLevel

const (
	WEBKIT_USER_STYLE_LEVEL_USER   UserStyleLevel = 0
	WEBKIT_USER_STYLE_LEVEL_AUTHOR UserStyleLevel = 1
)

type WebProcessTerminationReason C.WebKitWebProcessTerminationReason

const (
	WEBKIT_WEB_PROCESS_CRASHED               WebProcessTerminationReason = 0
	WEBKIT_WEB_PROCESS_EXCEEDED_MEMORY_LIMIT WebProcessTerminationReason = 1
)
...
// UriForDisplay is a wrapper around the C function webkit_uri_for_display.
func UriForDisplay(uri string) string {
	c_uri := C.CString(uri)
	defer C.free(unsafe.Pointer(c_uri))

	retC := C.webkit_uri_for_display(c_uri)
	retGo := C.GoString(retC)
	defer C.free(unsafe.Pointer(retC))
...
// UserMediaPermissionIsForAudioDevice is a wrapper around the C function webkit_user_media_permission_is_for_audio_device.
func UserMediaPermissionIsForAudioDevice(request *UserMediaPermissionRequest) bool {
	c_request := (*C.WebKitUserMediaPermissionRequest)(C.NULL)
	if request != nil {
		c_request = (*C.WebKitUserMediaPermissionRequest)(request.ToC())
	}

	retC := C.webkit_user_media_permission_is_for_audio_device(c_request)
	retGo := retC == C.TRUE

	return retGo
}

// UserMediaPermissionIsForVideoDevice is a wrapper around the C function webkit_user_media_permission_is_for_video_device.
func UserMediaPermissionIsForVideoDevice(request *UserMediaPermissionRequest) bool {
	...
	retC := C.webkit_user_media_permission_is_for_video_device(c_request)
	retGo := retC == C.TRUE
...
// ApplicationInfoNew is a wrapper around the C function webkit_application_info_new.
func ApplicationInfoNew() *ApplicationInfo {
	retC := C.webkit_application_info_new()
	retGo := ApplicationInfoNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetName is a wrapper around the C function webkit_application_info_get_name.
func (recv *ApplicationInfo) GetName() string {
	retC := C.webkit_application_info_get_name((*C.WebKitApplicationInfo)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetVersion is a wrapper around the C function webkit_application_info_get_version.
func (recv *ApplicationInfo) GetVersion() (uint64, uint64, uint64) {
	var c_major C.guint64

	var c_minor C.guint64

	var c_micro C.guint64

	C.webkit_application_info_get_version((*C.WebKitApplicationInfo)(recv.native), &c_major, &c_minor, &c_micro)

	major := (uint64)(c_major)

	minor := (uint64)(c_minor)

	micro := (uint64)(c_micro)

	return major, minor, micro
}

// Ref is a wrapper around the C function webkit_application_info_ref.
func (recv *ApplicationInfo) Ref() *ApplicationInfo {
	retC := C.webkit_application_info_ref((*C.WebKitApplicationInfo)(recv.native))
	retGo := ApplicationInfoNewFromC(unsafe.Pointer(retC))

	return retGo
}

// SetName is a wrapper around the C function webkit_application_info_set_name.
func (recv *ApplicationInfo) SetName(name string) {
	c_name := C.CString(name)
	defer C.free(unsafe.Pointer(c_name))

	C.webkit_application_info_set_name((*C.WebKitApplicationInfo)(recv.native), c_name)

	return
}

// SetVersion is a wrapper around the C function webkit_application_info_set_version.
func (recv *ApplicationInfo) SetVersion(major uint64, minor uint64, micro uint64) {
	c_major := (C.guint64)(major)

	c_minor := (C.guint64)(minor)

	c_micro := (C.guint64)(micro)

	C.webkit_application_info_set_version((*C.WebKitApplicationInfo)(recv.native), c_major, c_minor, c_micro)

	return
}

// Unref is a wrapper around the C function webkit_application_info_unref.
func (recv *ApplicationInfo) Unref() {
	C.webkit_application_info_unref((*C.WebKitApplicationInfo)(recv.native))
...
// CredentialNew is a wrapper around the C function webkit_credential_new.
func CredentialNew(username string, password string, persistence CredentialPersistence) *Credential {
	...
	c_persistence := (C.WebKitCredentialPersistence)(persistence)

	retC := C.webkit_credential_new(c_username, c_password, c_persistence)
	retGo := CredentialNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Copy is a wrapper around the C function webkit_credential_copy.
func (recv *Credential) Copy() *Credential {
	retC := C.webkit_credential_copy((*C.WebKitCredential)(recv.native))
	retGo := CredentialNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Free is a wrapper around the C function webkit_credential_free.
func (recv *Credential) Free() {
	C.webkit_credential_free((*C.WebKitCredential)(recv.native))

	return
}

// GetPassword is a wrapper around the C function webkit_credential_get_password.
func (recv *Credential) GetPassword() string {
	retC := C.webkit_credential_get_password((*C.WebKitCredential)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetPersistence is a wrapper around the C function webkit_credential_get_persistence.
func (recv *Credential) GetPersistence() CredentialPersistence {
	retC := C.webkit_credential_get_persistence((*C.WebKitCredential)(recv.native))
	retGo := (CredentialPersistence)(retC)

	return retGo
}

// GetUsername is a wrapper around the C function webkit_credential_get_username.
func (recv *Credential) GetUsername() string {
	retC := C.webkit_credential_get_username((*C.WebKitCredential)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// HasPassword is a wrapper around the C function webkit_credential_has_password.
func (recv *Credential) HasPassword() bool {
	retC := C.webkit_credential_has_password((*C.WebKitCredential)(recv.native))
	retGo := retC == C.TRUE
...
// GeolocationPosition is a wrapper around the C record WebKitGeolocationPosition.
type GeolocationPosition struct {
	native *C.WebKitGeolocationPosition
}

func GeolocationPositionNewFromC(u unsafe.Pointer) *GeolocationPosition {
	c := (*C.WebKitGeolocationPosition)(u)
	if c == nil {
		return nil
	}

	g := &GeolocationPosition{native: c}

	return g
}

func (recv *GeolocationPosition) ToC() unsafe.Pointer {
...
// GeolocationPositionNew is a wrapper around the C function webkit_geolocation_position_new.
func GeolocationPositionNew(latitude float64, longitude float64, accuracy float64) *GeolocationPosition {
	c_latitude := (C.double)(latitude)

	c_longitude := (C.double)(longitude)

	c_accuracy := (C.double)(accuracy)

	retC := C.webkit_geolocation_position_new(c_latitude, c_longitude, c_accuracy)
	retGo := GeolocationPositionNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Copy is a wrapper around the C function webkit_geolocation_position_copy.
func (recv *GeolocationPosition) Copy() *GeolocationPosition {
	retC := C.webkit_geolocation_position_copy((*C.WebKitGeolocationPosition)(recv.native))
	retGo := GeolocationPositionNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Free is a wrapper around the C function webkit_geolocation_position_free.
func (recv *GeolocationPosition) Free() {
	C.webkit_geolocation_position_free((*C.WebKitGeolocationPosition)(recv.native))

	return
}

// SetAltitude is a wrapper around the C function webkit_geolocation_position_set_altitude.
func (recv *GeolocationPosition) SetAltitude(altitude float64) {
	c_altitude := (C.double)(altitude)

	C.webkit_geolocation_position_set_altitude((*C.WebKitGeolocationPosition)(recv.native), c_altitude)

	return
}

// SetAltitudeAccuracy is a wrapper around the C function webkit_geolocation_position_set_altitude_accuracy.
func (recv *GeolocationPosition) SetAltitudeAccuracy(altitudeAccuracy float64) {
	c_altitude_accuracy := (C.double)(altitudeAccuracy)

	C.webkit_geolocation_position_set_altitude_accuracy((*C.WebKitGeolocationPosition)(recv.native), c_altitude_accuracy)

	return
}

// SetHeading is a wrapper around the C function webkit_geolocation_position_set_heading.
func (recv *GeolocationPosition) SetHeading(heading float64) {
	c_heading := (C.double)(heading)

	C.webkit_geolocation_position_set_heading((*C.WebKitGeolocationPosition)(recv.native), c_heading)

	return
}

// SetSpeed is a wrapper around the C function webkit_geolocation_position_set_speed.
func (recv *GeolocationPosition) SetSpeed(speed float64) {
	c_speed := (C.double)(speed)

	C.webkit_geolocation_position_set_speed((*C.WebKitGeolocationPosition)(recv.native), c_speed)

	return
}

// SetTimestamp is a wrapper around the C function webkit_geolocation_position_set_timestamp.
func (recv *GeolocationPosition) SetTimestamp(timestamp uint64) {
	c_timestamp := (C.guint64)(timestamp)

	C.webkit_geolocation_position_set_timestamp((*C.WebKitGeolocationPosition)(recv.native), c_timestamp)
...
// GetJsValue is a wrapper around the C function webkit_javascript_result_get_js_value.
func (recv *JavascriptResult) GetJsValue() *javascriptcore.Value {
	retC := C.webkit_javascript_result_get_js_value((*C.WebKitJavascriptResult)(recv.native))
	retGo := javascriptcore.ValueNewFromC(unsafe.Pointer(retC))
...
// Copy is a wrapper around the C function webkit_navigation_action_copy.
func (recv *NavigationAction) Copy() *NavigationAction {
	retC := C.webkit_navigation_action_copy((*C.WebKitNavigationAction)(recv.native))
	retGo := NavigationActionNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Free is a wrapper around the C function webkit_navigation_action_free.
func (recv *NavigationAction) Free() {
	C.webkit_navigation_action_free((*C.WebKitNavigationAction)(recv.native))

	return
}

// GetModifiers is a wrapper around the C function webkit_navigation_action_get_modifiers.
func (recv *NavigationAction) GetModifiers() uint32 {
	retC := C.webkit_navigation_action_get_modifiers((*C.WebKitNavigationAction)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// GetMouseButton is a wrapper around the C function webkit_navigation_action_get_mouse_button.
func (recv *NavigationAction) GetMouseButton() uint32 {
	retC := C.webkit_navigation_action_get_mouse_button((*C.WebKitNavigationAction)(recv.native))
	retGo := (uint32)(retC)

	return retGo
}

// GetNavigationType is a wrapper around the C function webkit_navigation_action_get_navigation_type.
func (recv *NavigationAction) GetNavigationType() NavigationType {
	retC := C.webkit_navigation_action_get_navigation_type((*C.WebKitNavigationAction)(recv.native))
	retGo := (NavigationType)(retC)

	return retGo
}

// GetRequest is a wrapper around the C function webkit_navigation_action_get_request.
func (recv *NavigationAction) GetRequest() *URIRequest {
	retC := C.webkit_navigation_action_get_request((*C.WebKitNavigationAction)(recv.native))
	retGo := URIRequestNewFromC(unsafe.Pointer(retC))

	return retGo
}

// IsRedirect is a wrapper around the C function webkit_navigation_action_is_redirect.
func (recv *NavigationAction) IsRedirect() bool {
	retC := C.webkit_navigation_action_is_redirect((*C.WebKitNavigationAction)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsUserGesture is a wrapper around the C function webkit_navigation_action_is_user_gesture.
func (recv *NavigationAction) IsUserGesture() bool {
	retC := C.webkit_navigation_action_is_user_gesture((*C.WebKitNavigationAction)(recv.native))
	retGo := retC == C.TRUE
...
// NetworkProxySettingsNew is a wrapper around the C function webkit_network_proxy_settings_new.
func NetworkProxySettingsNew(defaultProxyUri string, ignoreHosts []string) *NetworkProxySettings {
	c_default_proxy_uri := C.CString(defaultProxyUri)
	defer C.free(unsafe.Pointer(c_default_proxy_uri))

	c_ignore_hosts_array := make([]*C.gchar, len(ignoreHosts)+1, len(ignoreHosts)+1)
	for i, item := range ignoreHosts {
		c := C.CString(item)
		defer C.free(unsafe.Pointer(c))
		c_ignore_hosts_array[i] = c
	}
	c_ignore_hosts_array[len(ignoreHosts)] = nil
	c_ignore_hosts_arrayPtr := &c_ignore_hosts_array[0]
	c_ignore_hosts := (**C.gchar)(unsafe.Pointer(c_ignore_hosts_arrayPtr))

	retC := C.webkit_network_proxy_settings_new(c_default_proxy_uri, c_ignore_hosts)
	retGo := NetworkProxySettingsNewFromC(unsafe.Pointer(retC))

	return retGo
}

// AddProxyForScheme is a wrapper around the C function webkit_network_proxy_settings_add_proxy_for_scheme.
func (recv *NetworkProxySettings) AddProxyForScheme(scheme string, proxyUri string) {
	c_scheme := C.CString(scheme)
	defer C.free(unsafe.Pointer(c_scheme))

	c_proxy_uri := C.CString(proxyUri)
	defer C.free(unsafe.Pointer(c_proxy_uri))

	C.webkit_network_proxy_settings_add_proxy_for_scheme((*C.WebKitNetworkProxySettings)(recv.native), c_scheme, c_proxy_uri)

	return
}

// Copy is a wrapper around the C function webkit_network_proxy_settings_copy.
func (recv *NetworkProxySettings) Copy() *NetworkProxySettings {
	retC := C.webkit_network_proxy_settings_copy((*C.WebKitNetworkProxySettings)(recv.native))
	retGo := NetworkProxySettingsNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Free is a wrapper around the C function webkit_network_proxy_settings_free.
func (recv *NetworkProxySettings) Free() {
	C.webkit_network_proxy_settings_free((*C.WebKitNetworkProxySettings)(recv.native))
...
// Copy is a wrapper around the C function webkit_option_menu_item_copy.
func (recv *OptionMenuItem) Copy() *OptionMenuItem {
	retC := C.webkit_option_menu_item_copy((*C.WebKitOptionMenuItem)(recv.native))
	retGo := OptionMenuItemNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Free is a wrapper around the C function webkit_option_menu_item_free.
func (recv *OptionMenuItem) Free() {
	C.webkit_option_menu_item_free((*C.WebKitOptionMenuItem)(recv.native))

	return
}

// GetLabel is a wrapper around the C function webkit_option_menu_item_get_label.
func (recv *OptionMenuItem) GetLabel() string {
	retC := C.webkit_option_menu_item_get_label((*C.WebKitOptionMenuItem)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetTooltip is a wrapper around the C function webkit_option_menu_item_get_tooltip.
func (recv *OptionMenuItem) GetTooltip() string {
	retC := C.webkit_option_menu_item_get_tooltip((*C.WebKitOptionMenuItem)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// IsEnabled is a wrapper around the C function webkit_option_menu_item_is_enabled.
func (recv *OptionMenuItem) IsEnabled() bool {
	retC := C.webkit_option_menu_item_is_enabled((*C.WebKitOptionMenuItem)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsGroupChild is a wrapper around the C function webkit_option_menu_item_is_group_child.
func (recv *OptionMenuItem) IsGroupChild() bool {
	retC := C.webkit_option_menu_item_is_group_child((*C.WebKitOptionMenuItem)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsGroupLabel is a wrapper around the C function webkit_option_menu_item_is_group_label.
func (recv *OptionMenuItem) IsGroupLabel() bool {
	retC := C.webkit_option_menu_item_is_group_label((*C.WebKitOptionMenuItem)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// IsSelected is a wrapper around the C function webkit_option_menu_item_is_selected.
func (recv *OptionMenuItem) IsSelected() bool {
	retC := C.webkit_option_menu_item_is_selected((*C.WebKitOptionMenuItem)(recv.native))
	retGo := retC == C.TRUE
...
// Close is a wrapper around the C function webkit_script_dialog_close.
func (recv *ScriptDialog) Close() {
	C.webkit_script_dialog_close((*C.WebKitScriptDialog)(recv.native))
...
// Ref is a wrapper around the C function webkit_script_dialog_ref.
func (recv *ScriptDialog) Ref() *ScriptDialog {
	retC := C.webkit_script_dialog_ref((*C.WebKitScriptDialog)(recv.native))
	retGo := ScriptDialogNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_script_dialog_unref.
func (recv *ScriptDialog) Unref() {
	C.webkit_script_dialog_unref((*C.WebKitScriptDialog)(recv.native))
...
// SecurityOriginNew is a wrapper around the C function webkit_security_origin_new.
func SecurityOriginNew(protocol string, host string, port uint16) *SecurityOrigin {
	...
	retC := C.webkit_security_origin_new(c_protocol, c_host, c_port)
	retGo := SecurityOriginNewFromC(unsafe.Pointer(retC))

	return retGo
}

// SecurityOriginNewForUri is a wrapper around the C function webkit_security_origin_new_for_uri.
func SecurityOriginNewForUri(uri string) *SecurityOrigin {
	c_uri := C.CString(uri)
	defer C.free(unsafe.Pointer(c_uri))

	retC := C.webkit_security_origin_new_for_uri(c_uri)
	retGo := SecurityOriginNewFromC(unsafe.Pointer(retC))

	return retGo
}

// GetHost is a wrapper around the C function webkit_security_origin_get_host.
func (recv *SecurityOrigin) GetHost() string {
	retC := C.webkit_security_origin_get_host((*C.WebKitSecurityOrigin)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetPort is a wrapper around the C function webkit_security_origin_get_port.
func (recv *SecurityOrigin) GetPort() uint16 {
	retC := C.webkit_security_origin_get_port((*C.WebKitSecurityOrigin)(recv.native))
	retGo := (uint16)(retC)

	return retGo
}

// GetProtocol is a wrapper around the C function webkit_security_origin_get_protocol.
func (recv *SecurityOrigin) GetProtocol() string {
	retC := C.webkit_security_origin_get_protocol((*C.WebKitSecurityOrigin)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// IsOpaque is a wrapper around the C function webkit_security_origin_is_opaque.
func (recv *SecurityOrigin) IsOpaque() bool {
	retC := C.webkit_security_origin_is_opaque((*C.WebKitSecurityOrigin)(recv.native))
	retGo := retC == C.TRUE

	return retGo
}

// Ref is a wrapper around the C function webkit_security_origin_ref.
func (recv *SecurityOrigin) Ref() *SecurityOrigin {
	retC := C.webkit_security_origin_ref((*C.WebKitSecurityOrigin)(recv.native))
	retGo := SecurityOriginNewFromC(unsafe.Pointer(retC))

	return retGo
}

// ToString is a wrapper around the C function webkit_security_origin_to_string.
func (recv *SecurityOrigin) ToString() string {
	retC := C.webkit_security_origin_to_string((*C.WebKitSecurityOrigin)(recv.native))
	retGo := C.GoString(retC)
	defer C.free(unsafe.Pointer(retC))
...
// Unref is a wrapper around the C function webkit_security_origin_unref.
func (recv *SecurityOrigin) Unref() {
	C.webkit_security_origin_unref((*C.WebKitSecurityOrigin)(recv.native))
...
// GetIdentifier is a wrapper around the C function webkit_user_content_filter_get_identifier.
func (recv *UserContentFilter) GetIdentifier() string {
	retC := C.webkit_user_content_filter_get_identifier((*C.WebKitUserContentFilter)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// Ref is a wrapper around the C function webkit_user_content_filter_ref.
func (recv *UserContentFilter) Ref() *UserContentFilter {
	retC := C.webkit_user_content_filter_ref((*C.WebKitUserContentFilter)(recv.native))
	retGo := UserContentFilterNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_user_content_filter_unref.
func (recv *UserContentFilter) Unref() {
	C.webkit_user_content_filter_unref((*C.WebKitUserContentFilter)(recv.native))
...
// UserScriptNew is a wrapper around the C function webkit_user_script_new.
func UserScriptNew(source string, injectedFrames UserContentInjectedFrames, injectionTime UserScriptInjectionTime, whitelist []string, blacklist []string) *UserScript {
	...
	c_injected_frames := (C.WebKitUserContentInjectedFrames)(injectedFrames)

	c_injection_time := (C.WebKitUserScriptInjectionTime)(injectionTime)

	c_whitelist_array := make([]*C.gchar, len(whitelist)+1, len(whitelist)+1)
	for i, item := range whitelist {
		c := C.CString(item)
		defer C.free(unsafe.Pointer(c))
		c_whitelist_array[i] = c
	}
	c_whitelist_array[len(whitelist)] = nil
	c_whitelist_arrayPtr := &c_whitelist_array[0]
	c_whitelist := (**C.gchar)(unsafe.Pointer(c_whitelist_arrayPtr))

	c_blacklist_array := make([]*C.gchar, len(blacklist)+1, len(blacklist)+1)
	for i, item := range blacklist {
		c := C.CString(item)
		defer C.free(unsafe.Pointer(c))
		c_blacklist_array[i] = c
	}
	c_blacklist_array[len(blacklist)] = nil
	c_blacklist_arrayPtr := &c_blacklist_array[0]
	c_blacklist := (**C.gchar)(unsafe.Pointer(c_blacklist_arrayPtr))

	retC := C.webkit_user_script_new(c_source, c_injected_frames, c_injection_time, c_whitelist, c_blacklist)
	retGo := UserScriptNewFromC(unsafe.Pointer(retC))

	return retGo
}

// UserScriptNewForWorld is a wrapper around the C function webkit_user_script_new_for_world.
func UserScriptNewForWorld(source string, injectedFrames UserContentInjectedFrames, injectionTime UserScriptInjectionTime, worldName string, whitelist []string, blacklist []string) *UserScript {
	...
	retC := C.webkit_user_script_new_for_world(c_source, c_injected_frames, c_injection_time, c_world_name, c_whitelist, c_blacklist)
	retGo := UserScriptNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Ref is a wrapper around the C function webkit_user_script_ref.
func (recv *UserScript) Ref() *UserScript {
	retC := C.webkit_user_script_ref((*C.WebKitUserScript)(recv.native))
	retGo := UserScriptNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_user_script_unref.
func (recv *UserScript) Unref() {
	C.webkit_user_script_unref((*C.WebKitUserScript)(recv.native))
...
// UserStyleSheetNew is a wrapper around the C function webkit_user_style_sheet_new.
func UserStyleSheetNew(source string, injectedFrames UserContentInjectedFrames, level UserStyleLevel, whitelist []string, blacklist []string) *UserStyleSheet {
	...
	c_level := (C.WebKitUserStyleLevel)(level)
	...
	retC := C.webkit_user_style_sheet_new(c_source, c_injected_frames, c_level, c_whitelist, c_blacklist)
	retGo := UserStyleSheetNewFromC(unsafe.Pointer(retC))

	return retGo
}

// UserStyleSheetNewForWorld is a wrapper around the C function webkit_user_style_sheet_new_for_world.
func UserStyleSheetNewForWorld(source string, injectedFrames UserContentInjectedFrames, level UserStyleLevel, worldName string, whitelist []string, blacklist []string) *UserStyleSheet {
	...
	retC := C.webkit_user_style_sheet_new_for_world(c_source, c_injected_frames, c_level, c_world_name, c_whitelist, c_blacklist)
	retGo := UserStyleSheetNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Ref is a wrapper around the C function webkit_user_style_sheet_ref.
func (recv *UserStyleSheet) Ref() *UserStyleSheet {
	retC := C.webkit_user_style_sheet_ref((*C.WebKitUserStyleSheet)(recv.native))
	retGo := UserStyleSheetNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_user_style_sheet_unref.
func (recv *UserStyleSheet) Unref() {
	C.webkit_user_style_sheet_unref((*C.WebKitUserStyleSheet)(recv.native))
...
func (recv *WebViewSessionState) Ref() *WebViewSessionState {
	retC := C.webkit_web_view_session_state_ref((*C.WebKitWebViewSessionState)(recv.native))
	retGo := WebViewSessionStateNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Serialize is a wrapper around the C function webkit_web_view_session_state_serialize.
func (recv *WebViewSessionState) Serialize() *glib.Bytes {
	retC := C.webkit_web_view_session_state_serialize((*C.WebKitWebViewSessionState)(recv.native))
	retGo := glib.BytesNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_web_view_session_state_unref.
func (recv *WebViewSessionState) Unref() {
	C.webkit_web_view_session_state_unref((*C.WebKitWebViewSessionState)(recv.native))
...
// GetName is a wrapper around the C function webkit_website_data_get_name.
func (recv *WebsiteData) GetName() string {
	retC := C.webkit_website_data_get_name((*C.WebKitWebsiteData)(recv.native))
	retGo := C.GoString(retC)

	return retGo
}

// GetSize is a wrapper around the C function webkit_website_data_get_size.
func (recv *WebsiteData) GetSize(types WebsiteDataTypes) uint64 {
	c_types := (C.WebKitWebsiteDataTypes)(types)

	retC := C.webkit_website_data_get_size((*C.WebKitWebsiteData)(recv.native), c_types)
	retGo := (uint64)(retC)

	return retGo
}

// GetTypes is a wrapper around the C function webkit_website_data_get_types.
func (recv *WebsiteData) GetTypes() WebsiteDataTypes {
	retC := C.webkit_website_data_get_types((*C.WebKitWebsiteData)(recv.native))
	retGo := (WebsiteDataTypes)(retC)

	return retGo
}

// Ref is a wrapper around the C function webkit_website_data_ref.
func (recv *WebsiteData) Ref() *WebsiteData {
	retC := C.webkit_website_data_ref((*C.WebKitWebsiteData)(recv.native))
	retGo := WebsiteDataNewFromC(unsafe.Pointer(retC))

	return retGo
}

// Unref is a wrapper around the C function webkit_website_data_unref.
func (recv *WebsiteData) Unref() {
	C.webkit_website_data_unref((*C.WebKitWebsiteData)(recv.native))
