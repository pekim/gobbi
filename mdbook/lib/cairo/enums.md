...
C - `cairo_region_overlap_t`
 ...
 %!s(int=15)
- CAIRO_SURFACE_TYPE_RECORDING = %!s(int=16)
- CAIRO_SURFACE_TYPE_VG = %!s(int=17)
- CAIRO_SURFACE_TYPE_GL = %!s(int=18)
- CAIRO_SURFACE_TYPE_DRM = %!s(int=19)
- CAIRO_SURFACE_TYPE_TEE = %!s(int=20)
- CAIRO_SURFACE_TYPE_XML = %!s(int=21)
- CAIRO_SURFACE_TYPE_SKIA = %!s(int=22)
- CAIRO_SURFACE_TYPE_SUBSURFACE = %!s(int=23)
- CAIRO_SURFACE_TYPE_COGL = %!s(int=24)
## `Format`
...
- CAIRO_FORMAT_INVALID = %!s(int=-1)
- CAIRO_FORMAT_ARGB32 = %!s(int=0)
- CAIRO_FORMAT_RGB24 = %!s(int=1)
- CAIRO_FORMAT_A8 = %!s(int=2)
- CAIRO_FORMAT_A1 = %!s(int=3)
- CAIRO_FORMAT_RGB16_565 = %!s(int=4)
- CAIRO_FORMAT_RGB30 = %!s(int=5)
## `PatternType`
...
- CAIRO_PATTERN_TYPE_SOLID = %!s(int=0)
- CAIRO_PATTERN_TYPE_SURFACE = %!s(int=1)
- CAIRO_PATTERN_TYPE_LINEAR = %!s(int=2)
- CAIRO_PATTERN_TYPE_RADIAL = %!s(int=3)
- CAIRO_PATTERN_TYPE_MESH = %!s(int=4)
- CAIRO_PATTERN_TYPE_RASTER_SOURCE = %!s(int=5)
## `Extend`
...
- CAIRO_EXTEND_NONE = %!s(int=0)
- CAIRO_EXTEND_REPEAT = %!s(int=1)
- CAIRO_EXTEND_REFLECT = %!s(int=2)
- CAIRO_EXTEND_PAD = %!s(int=3)
## `Filter`
...
- CAIRO_FILTER_FAST = %!s(int=0)
- CAIRO_FILTER_GOOD = %!s(int=1)
- CAIRO_FILTER_BEST = %!s(int=2)
- CAIRO_FILTER_NEAREST = %!s(int=3)
- CAIRO_FILTER_BILINEAR = %!s(int=4)
- CAIRO_FILTER_GAUSSIAN = %!s(int=5)
## `RegionOverlap`
...
- CAIRO_REGION_OVERLAP_IN = %!s(int=0)
- CAIRO_REGION_OVERLAP_OUT = %!s(int=1)
- CAIRO_REGION_OVERLAP_PART = %!s(int=2)
